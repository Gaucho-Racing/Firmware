...
void sendMSG(){
		...
		GRCAN_INVERTER_STATUS_3_MSG sendInverterStatus3_msg = {
			.motor_temperature = 105,
			.fault_bits = 0x24
		};

		memcpy(sendInverterStatus3.data, &sendInverterStatus3_msg, sizeof(sendInverterStatus3_msg));
