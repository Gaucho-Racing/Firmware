...
#define REAL_NUM_TOTAL_IC                                                      \
	10U // only used in defining struct so no mem leaks LOL
...
#define GET_INDEX(x, y)                                                        \
	((x * NUM_CELL_IC) + y) // get the index of the cell in the array
...
#define IMD_Isolation_ACU                                                      \
	0x18FF02F4 // IMD sends IMD iso info to ACU (CAN3) (prev 0x18EFF4FE)
#define IMD_Voltage_ACU                                                        \
	0x18FF03F4 // IMD sends IMD voltage to ACU (CAN3) (prev 0x18EFF4FE)
#define IMD_IT_System_ACU                                                      \
	0x18FF04F4 // IMD sends IMD it-system to ACU (CAN3) (prev 0x18EFF4FE)
#define IMD_Request_ACU                                                        \
	0x18EFF4FE // IMD sends IMD request to ACU (CAN3) (Should be 1CEF00F4)
