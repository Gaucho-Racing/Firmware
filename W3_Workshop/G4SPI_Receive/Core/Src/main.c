...
static void MX_SPI2_Init(void)
{
  ...
  hspi2.Init.NSS = SPI_NSS_HARD_INPUT; //Must select this option for the SPI slave to listen to the Chip select line, otherwise
  //CS line is ignored completely, regardless of whether the master pulls it high or low
