...
int main(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_12, GPIO_PIN_RESET); //Set the CS line to active low to enable the slave
  while (1)
  {
    /* USER CODE END WHILE */
...
static void MX_SPI2_Init(void)
{
  ...
  hspi2.Init.NSS = SPI_NSS_SOFT; //If software, the master must manually set the CS line to Active Low
