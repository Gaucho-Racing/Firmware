...
typedef struct {
	...
	__IOM uint32_t ITCMCR; /*!< Offset: 0x10 (R/W)  Instruction
				  Tightly-Coupled Memory Control Register */
	__IOM uint32_t DTCMCR; /*!< Offset: 0x14 (R/W)  Data Tightly-Coupled
...
#define TPI_ITATBCTR2_AFVALID2S_Msk                                            \
	(0x1UL << TPI_ITATBCTR2_AFVALID2S_Pos) /*!< TPI ITATBCTR2: AFVALID2SS  \
						  Mask */
...
#define TPI_ITATBCTR2_AFVALID1S_Msk                                            \
	(0x1UL << TPI_ITATBCTR2_AFVALID1S_Pos) /*!< TPI ITATBCTR2: AFVALID1SS  \
						  Mask */
...
#define TPI_ITATBCTR0_AFVALID2S_Msk                                            \
	(0x1UL << TPI_ITATBCTR0_AFVALID2S_Pos) /*!< TPI ITATBCTR0: AFVALID2SS  \
						  Mask */
...
#define TPI_ITATBCTR0_AFVALID1S_Msk                                            \
	(0x1UL << TPI_ITATBCTR0_AFVALID1S_Pos) /*!< TPI ITATBCTR0: AFVALID1SS  \
						  Mask */
...
__NO_RETURN __STATIC_INLINE void __SW_SystemReset(void)
{
	...
	SCB->AIRCR =
	    (uint32_t)((0x5FAUL << SCB_AIRCR_VECTKEY_Pos) |
		       (SCB->AIRCR &
			SCB_AIRCR_BFHFNMINS_Msk) | /* Keep BFHFNMINS unchanged.
						      Use this Reset function in
						      case your case need to
						      keep it */
		       (SCB->AIRCR &
			SCB_AIRCR_PRIGROUP_Msk) | /* Keep priority group
						     unchanged */
...
#define __SCB_DCACHE_LINE_SIZE                                                 \
	32U /*!< STAR-MC1 cache line size is fixed to 32 bytes (8 words). See  \
