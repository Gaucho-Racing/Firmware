 ...
 *         (write access to IWDG_PR, IWDG_RLR, IWDG_WINR, IWDG_EWCR registers
 * disabled).
 * @param  __HANDLE__  IWDG handle
 * @retval None
 */
...
/**
 * @brief  Enable write access to IWDG_PR, IWDG_RLR, IWDG_WINR, IWDG_EWCR
 * registers.
 * @param  __HANDLE__  IWDG handle
 * @retval None
 */
...
/**
 * @brief  Disable write access to IWDG_PR, IWDG_RLR, IWDG_WINR, IWDG_EWCR
 * registers.
 * @param  __HANDLE__  IWDG handle
 * @retval None
 */
