...
typedef enum {
	...
	HAL_GFXTIM_STATE_READY =
	    0x01U, /*!< GFXTIM initialized and ready for use */
...
#endif /* USE_HAL_GFXTIM_REGISTER_CALLBACKS */
{
	...
	void (*HAL_GFXTIM_AbsoluteTimer_AFCC1Callback)(
		...
		*hgfxtim); /*!< GFXTIM Absolute frame counter compare 1 callback
			    */
	void (*HAL_GFXTIM_AbsoluteTimer_AFCOFCallback)(
	    struct __GFXTIM_HandleTypeDef
		*hgfxtim); /*!< GFXTIM Absolute frame counter overflow callback
			    */
	void (*HAL_GFXTIM_AbsoluteTimer_ALCC1Callback)(
	    struct __GFXTIM_HandleTypeDef
		*hgfxtim); /*!< GFXTIM Absolute line counter compare 1 callback
			    */
	void (*HAL_GFXTIM_AbsoluteTimer_ALCC2Callback)(
	    struct __GFXTIM_HandleTypeDef
		*hgfxtim); /*!< GFXTIM Absolute line counter compare 2 callback
			    */
	void (*HAL_GFXTIM_AbsoluteTimer_ALCOFCallback)(
	    struct __GFXTIM_HandleTypeDef *
		hgfxtim); /*!< GFXTIM Absolute line counter overflow callback */
	void (*HAL_GFXTIM_RelativeTimer_RFC1RCallback)(
	    struct __GFXTIM_HandleTypeDef
		*hgfxtim); /*!< GFXTIM Relative frame counter 1 reload callback
			    */
	void (*HAL_GFXTIM_RelativeTimer_RFC2RCallback)(
	    struct __GFXTIM_HandleTypeDef
		*hgfxtim); /*!< GFXTIM Relative frame counter 2 reload callback
			    */
	void (*HAL_GFXTIM_TECallback)(
	    struct __GFXTIM_HandleTypeDef
		*hgfxtim); /*!< GFXTIM Tearing effect callback */
	void (*HAL_GFXTIM_EventGenerator_EV1Callback)(
	    struct __GFXTIM_HandleTypeDef
		*hgfxtim); /*!< GFXTIM Event events 1 callback */
	void (*HAL_GFXTIM_EventGenerator_EV2Callback)(
	    struct __GFXTIM_HandleTypeDef
		*hgfxtim); /*!< GFXTIM Event events 2 callback */
	void (*HAL_GFXTIM_EventGenerator_EV3Callback)(
	    struct __GFXTIM_HandleTypeDef
		*hgfxtim); /*!< GFXTIM Event events 3 callback */
	void (*HAL_GFXTIM_EventGenerator_EV4Callback)(
	    struct __GFXTIM_HandleTypeDef
		*hgfxtim); /*!< GFXTIM Event events 4 callback */
	void (*HAL_GFXTIM_WatchdogTimer_AlarmCallback)(
	    struct __GFXTIM_HandleTypeDef
		*hgfxtim); /*!< GFXTIM Watchdog alarm callback */
	void (*HAL_GFXTIM_WatchdogTimer_PreAlarmCallback)(
	    struct __GFXTIM_HandleTypeDef
		*hgfxtim); /*!< GFXTIM Watchdog pre alarm callback */
	void (*ErrorCallback)(struct __GFXTIM_HandleTypeDef
				  *hgfxtim); /*!< GFXTIM error callback */
	void (*MspInitCallback)(
	    struct __GFXTIM_HandleTypeDef
		*hgfxtim); /*!< GFXTIM MSP initialization user callback */
	void (*MspDeInitCallback)(
	    struct __GFXTIM_HandleTypeDef
		*hgfxtim); /*!< GFXTIM MSP de-initialization user callback */
#endif			   /* USE_HAL_GFXTIM_REGISTER_CALLBACKS */
 ...
 */
typedef enum {
	HAL_GFXTIM_AFC_COMPARE1_CB_ID =
	    1U, /*!< GFXTIM Absolute frame counter compare 1 callback ID */
	HAL_GFXTIM_AFC_OVERFLOW_CB_ID =
	    2U, /*!< GFXTIM Absolute frame counter overflow callback ID */
	HAL_GFXTIM_ALC_COMPARE1_CB_ID =
	    3U, /*!< GFXTIM Absolute line counter compare 1 callback ID */
	HAL_GFXTIM_ALC_COMPARE2_CB_ID =
	    4U, /*!< GFXTIM Absolute line counter compare 2 callback ID */
	HAL_GFXTIM_ALC_OVERFLOW_CB_ID =
	    5U, /*!< GFXTIM Absolute line counter overflow callback ID */
	HAL_GFXTIM_RFC1_RELOAD_CB_ID =
	    6U, /*!< GFXTIM Relative frame counter 1 reload callback ID */
	HAL_GFXTIM_RFC2_RELOAD_CB_ID =
	    7U, /*!< GFXTIM Relative frame counter 2 reload callback ID */
	HAL_GFXTIM_TE_CB_ID =
	    8U, /*!< GFXTIM External tearing effect callback ID */
	...
	HAL_GFXTIM_WDG_ALARM_CB_ID =
	    13U, /*!< GFXTIM Watchdog alarm callback ID */
	HAL_GFXTIM_WDG_PREALARM_CB_ID =
	    14U, /*!< GFXTIM Watchdog pre alarm callback ID */
	HAL_GFXTIM_ERROR_CB_ID = 15U, /*!< GFXTIM error callback ID */
	HAL_GFXTIM_MSP_INIT_CB_ID =
	    16U, /*!< GFXTIM MSP initialization user callback ID */
	HAL_GFXTIM_MSP_DEINIT_CB_ID =
	    17U, /*!< GFXTIM MSP de-initialization user callback ID */
...
typedef struct {
	...
	uint32_t
	    FrameOverflowInterrupt; /*!< Absolute Frame Counter Overflow
	...
	uint32_t
	    LineOverflowInterrupt; /*!< Absolute Line Counter Overflow Interrupt
...
typedef struct {
	...
	uint32_t
	    FrameEvent; /*!< Frmae event selection
...
typedef struct {
	...
	uint32_t
	    PreAlarmInterrupt; /*!< Interrupt Enable or Disable when watchdog
...
#define GFXTIM_SYNC_SRC_HSYNC_VSYNC_3                                          \
	(GFXTIM_CR_SYNCS_0 |                                                   \
	 GFXTIM_CR_SYNCS_1) /*!< gfxtim_hsync[3] and gfxtim_vsync[3] are used  \
...
#define GFXTIM_TE_SRC_HSYNC                                                    \
	GFXTIM_CR_TES_1 /*!< HSYNC (see SynchroSrc) rising */
#define GFXTIM_TE_SRC_VSYNC                                                    \
	(GFXTIM_CR_TES_0 |                                                     \
	 GFXTIM_CR_TES_1) /*!< VSYNC (see SynchroSrc) rising  */
/**
 * @}
 */
...
#define GFXTIM_TE_FALLING_EDGE                                                 \
	GFXTIM_CR_TEPOL /*!< Tearing Effect active on falling edge */
/**
 * @}
 */

/** @defgroup GFXTIM_LCCHwReloadSrc GFXTIM Line Clock Counter Hardware Reload
 * Source
 * @{
 */
#define GFXTIM_LCC_HW_RELOAD_SRC_NONE 0U /*!< No hardware reload */
#define GFXTIM_LCC_HW_RELOAD_SRC_FCC_UNDERFLOW                                 \
	GFXTIM_CGCR_LCCHRS_0 /*!< FCC underflow */
#define GFXTIM_LCC_HW_RELOAD_SRC_HSYNC_RISING                                  \
	GFXTIM_CGCR_LCCHRS_1 /*!< HSYNC rising */
#define GFXTIM_LCC_HW_RELOAD_SRC_HSYNC_FALLING                                 \
	(GFXTIM_CGCR_LCCHRS_0 | GFXTIM_CGCR_LCCHRS_1) /*!< HSYNC falling */
#define GFXTIM_LCC_HW_RELOAD_SRC_VSYNC_RISING                                  \
	GFXTIM_CGCR_LCCHRS_2 /*!< VSYNC rising */
#define GFXTIM_LCC_HW_RELOAD_SRC_VSYNC_FALLING                                 \
	(GFXTIM_CGCR_LCCHRS_2 | GFXTIM_CGCR_LCCHRS_0) /*!< VSYNC falling */
#define GFXTIM_LCC_HW_RELOAD_SRC_TE_RISING                                     \
	(GFXTIM_CGCR_LCCHRS_2 | GFXTIM_CGCR_LCCHRS_1) /*!< TE rising */
#define GFXTIM_LCC_HW_RELOAD_SRC_TE_FALLING                                    \
	(GFXTIM_CGCR_LCCHRS_2 | GFXTIM_CGCR_LCCHRS_1 |                         \
	 GFXTIM_CGCR_LCCHRS_0) /*!< TE falling */
/**
 * @}
 */
...
#define GFXTIM_LCC_CLK_SRC_SYSCLOCK                                            \
	GFXTIM_CGCR_LCCCS /*!< System clock as line clock counter source*/
/**
 * @}
 */
 ...
 * @{
 */
#define GFXTIM_LINE_CLK_SRC_LCC_UNDERFLOW                                      \
	0U /*!< Line Clock Counter underflow */
#define GFXTIM_LINE_CLK_SRC_FCC_UNDERFLOW                                      \
	GFXTIM_CGCR_LCS_0 /*!< Frame Clock Counter underflow */
#define GFXTIM_LINE_CLK_SRC_HSYNC_RISING                                       \
	GFXTIM_CGCR_LCS_1 /*!< HSYNC rising edge */
#define GFXTIM_LINE_CLK_SRC_HSYNC_FALLING                                      \
	(GFXTIM_CGCR_LCS_0 | GFXTIM_CGCR_LCS_1) /*!< HSYNC falling edge*/
#define GFXTIM_LINE_CLK_SRC_VSYNC_RISING                                       \
	GFXTIM_CGCR_LCS_2 /*!< VSYNC rising edge*/
#define GFXTIM_LINE_CLK_SRC_VSYNC_FALLING                                      \
	(GFXTIM_CGCR_LCS_2 | GFXTIM_CGCR_LCS_0) /*!< VSYNC falling edge*/
#define GFXTIM_LINE_CLK_SRC_TE_RISING                                          \
	(GFXTIM_CGCR_LCS_2 | GFXTIM_CGCR_LCS_1) /*!< TE rising edge*/
#define GFXTIM_LINE_CLK_SRC_TE_FALLING                                         \
	(GFXTIM_CGCR_LCS_2 | GFXTIM_CGCR_LCS_1 |                               \
	 GFXTIM_CGCR_LCS_0) /*!< TE falling edge*/
/**
 * @}
 */

/** @defgroup GFXTIM_FCCHwReloadSrc GFXTIM Frame Clock Counter Hardware Reload
 * source
 * @{
 */
#define GFXTIM_FCC_HW_RELOAD_SRC_NONE 0U /*!< No hardware reload */
#define GFXTIM_FCC_HW_RELOAD_SRC_LCC_UNDERFLOW                                 \
	GFXTIM_CGCR_FCCHRS_0 /*!< Line Clock Counter underflow */
#define GFXTIM_FCC_HW_RELOAD_SRC_HSYNC_RISING                                  \
	GFXTIM_CGCR_FCCHRS_1 /*!< HSYNC rising edge */
#define GFXTIM_FCC_HW_RELOAD_SRC_HSYNC_FALLING                                 \
	(GFXTIM_CGCR_FCCHRS_0 | GFXTIM_CGCR_FCCHRS_1) /*!< HSYNC falling edge  \
						       */
#define GFXTIM_FCC_HW_RELOAD_SRC_VSYNC_RISING                                  \
	GFXTIM_CGCR_FCCHRS_2 /*!< VSYNC rising edge */
#define GFXTIM_FCC_HW_RELOAD_SRC_VSYNC_FALLING                                 \
	(GFXTIM_CGCR_FCCHRS_2 | GFXTIM_CGCR_FCCHRS_0) /*!< VSYNC falling edge  \
						       */
#define GFXTIM_FCC_HW_RELOAD_SRC_TE_RISING                                     \
	(GFXTIM_CGCR_FCCHRS_2 | GFXTIM_CGCR_FCCHRS_1) /*!< TE rising edge */
#define GFXTIM_FCC_HW_RELOAD_SRC_TE_FALLING                                    \
	(GFXTIM_CGCR_FCCHRS_2 | GFXTIM_CGCR_FCCHRS_1 |                         \
	 GFXTIM_CGCR_FCCHRS_0) /*!< TE falling edge */
/**
 * @}
 */
...
#define GFXTIM_FCC_CLK_SRC_LCC_UNDERFLOW                                       \
	GFXTIM_CGCR_FCCCS_0 /*!< Line Clock Counter underflow */
#define GFXTIM_FCC_CLK_SRC_HSYNC_RISING                                        \
	GFXTIM_CGCR_FCCCS_1 /*!< HSYNC rising edge */
#define GFXTIM_FCC_CLK_SRC_HSYNC_FALLING                                       \
	(GFXTIM_CGCR_FCCCS_0 | GFXTIM_CGCR_FCCCS_1) /*!< HSYNC falling edge */
#define GFXTIM_FCC_CLK_SRC_VSYNC_RISING                                        \
	GFXTIM_CGCR_FCCCS_2 /*!< VSYNC rising edge */
#define GFXTIM_FCC_CLK_SRC_VSYNC_FALLING                                       \
	(GFXTIM_CGCR_FCCCS_2 | GFXTIM_CGCR_FCCCS_0) /*!< VSYNC falling edge */
#define GFXTIM_FCC_CLK_SRC_TE_RISING                                           \
	(GFXTIM_CGCR_FCCCS_2 | GFXTIM_CGCR_FCCCS_1) /*!< TE rising edge */
#define GFXTIM_FCC_CLK_SRC_TE_FALLING                                          \
	(GFXTIM_CGCR_FCCCS_2 | GFXTIM_CGCR_FCCCS_1 |                           \
	 GFXTIM_CGCR_FCCCS_0) /*!< TE falling edge */
/**
 * @}
 */
 ...
 * @{
 */
#define GFXTIM_FRAME_CLK_SRC_LCC_UNDERFLOW                                     \
	0U /*!< Line Clock Counter underflow */
#define GFXTIM_FRAME_CLK_SRC_FCC_UNDERFLOW                                     \
	GFXTIM_CGCR_FCS_0 /*!< Frame Clock Counter underflow */
#define GFXTIM_FRAME_CLK_SRC_HSYNC_RISING                                      \
	GFXTIM_CGCR_FCS_1 /*!< HSYNC rising edge */
#define GFXTIM_FRAME_CLK_SRC_HSYNC_FALLING                                     \
	(GFXTIM_CGCR_FCS_0 | GFXTIM_CGCR_FCS_1) /*!< HSYNC falling edge */
#define GFXTIM_FRAME_CLK_SRC_VSYNC_RISING                                      \
	GFXTIM_CGCR_FCS_2 /*!< VSYNC rising edge */
#define GFXTIM_FRAME_CLK_SRC_VSYNC_FALLING                                     \
	(GFXTIM_CGCR_FCS_2 | GFXTIM_CGCR_FCS_0) /*!< VSYNC falling edge */
#define GFXTIM_FRAME_CLK_SRC_TE_RISING                                         \
	(GFXTIM_CGCR_FCS_2 | GFXTIM_CGCR_FCS_1) /*!< TE rising edge */
#define GFXTIM_FRAME_CLK_SRC_TE_FALLING                                        \
	(GFXTIM_CGCR_FCS_2 | GFXTIM_CGCR_FCS_1 |                               \
	 GFXTIM_CGCR_FCS_0) /*!< TE falling edge */
/**
 * @}
 */
...
/** @defgroup GFXTIM_FrameClockCalib GFXTIM Frame Clock Calibration Output (for
 * debug purpose)
 * @{
 */
#define GFXTIM_FRAME_CLK_CALIB_DISABLE                                         \
	0U /*!< Frame clock output calibration Disable */
#define GFXTIM_FRAME_CLK_CALIB_ENABLE                                          \
	GFXTIM_CR_FCCOE /*!< Frame clock output calibration Enable */
/**
 * @}
 */
 ...
 * @{
 */
#define GFXTIM_ABSOLUTE_GLOBAL_TIME                                            \
...
#define GFXTIM_LINE_EVENT_ALC2_COMPARE                                         \
	(5U << GFXTIM_EVSR_LES1_Pos) /*!< Absolute line counter 2 compare */
/**
 * @}
 */
...
#define GFXTIM_FRAME_EVENT_AFC_OVERFLOW                                        \
	(1U << GFXTIM_EVSR_FES1_Pos) /*!< Absolute frame counter overflow */
#define GFXTIM_FRAME_EVENT_AFC_COMPARE                                         \
	(2U << GFXTIM_EVSR_FES1_Pos) /*!< Absolute frame counter compare */
#define GFXTIM_FRAME_EVENT_RFC1_RELOAD                                         \
	(4U << GFXTIM_EVSR_FES1_Pos) /*!< Relative frame counter 1 reload */
#define GFXTIM_FRAME_EVENT_RFC2_RELOAD                                         \
	(5U << GFXTIM_EVSR_FES1_Pos) /*!< Relative frame counter 1 reload */
/**
 * @}
 */
...
/** @defgroup GFXTIM_WatchdogHwReloadConfig GFXTIM Watchdog hardware reload
 * configuration
 * @{
 */
 ...
 * @{
 */
#define GFXTIM_WATCHDOG_CLK_SRC_LINE_CLK                                       \
	(0U << GFXTIM_WDGTCR_WDGCS_Pos) /*!< Line Clock */
#define GFXTIM_WATCHDOG_CLK_SRC_FRAME_CLK                                      \
	(1U << GFXTIM_WDGTCR_WDGCS_Pos) /*!< Frame Clock */
#define GFXTIM_WATCHDOG_CLK_SRC_HSYNC_RISING                                   \
	(2U << GFXTIM_WDGTCR_WDGCS_Pos) /*!< HSYNC rising edge */
#define GFXTIM_WATCHDOG_CLK_SRC_HSYNC_FALLING                                  \
	(3U << GFXTIM_WDGTCR_WDGCS_Pos) /*!< HSYNC falling edge */
#define GFXTIM_WATCHDOG_CLK_SRC_VSYNC_RISING                                   \
	(4U << GFXTIM_WDGTCR_WDGCS_Pos) /*!< VSYNC rising edge */
#define GFXTIM_WATCHDOG_CLK_SRC_VSYNC_FALLING                                  \
	(5U << GFXTIM_WDGTCR_WDGCS_Pos) /*!< VSYNC falling edge */
#define GFXTIM_WATCHDOG_CLK_SRC_TE_RISING                                      \
	(6U << GFXTIM_WDGTCR_WDGCS_Pos) /*!< Tearing Effect rising edge */
#define GFXTIM_WATCHDOG_CLK_SRC_TE_FALLING                                     \
	(7U << GFXTIM_WDGTCR_WDGCS_Pos) /*!< Tearing Effect falling edge */
#define GFXTIM_WATCHDOG_CLK_SRC_EVENT_1                                        \
	(8U << GFXTIM_WDGTCR_WDGCS_Pos) /*!< Event Generator 1 output */
#define GFXTIM_WATCHDOG_CLK_SRC_EVENT_2                                        \
	(9U << GFXTIM_WDGTCR_WDGCS_Pos) /*!< Event Generator 2 output */
#define GFXTIM_WATCHDOG_CLK_SRC_EVENT_3                                        \
	(10U << GFXTIM_WDGTCR_WDGCS_Pos) /*!< Event Generator 3 output */
#define GFXTIM_WATCHDOG_CLK_SRC_EVENT_4                                        \
	(11U << GFXTIM_WDGTCR_WDGCS_Pos) /*!< Event Generator 4 output */
/**
 * @}
 */
 ...
 * @{
 */
#define GFXTIM_FLAG_AFCO                                                       \
	GFXTIM_ISR_AFCOF /* Absolute Frame Counter Overflow Flag */
#define GFXTIM_FLAG_ALCO                                                       \
	GFXTIM_ISR_ALCOF	      /* Absolute Line Counter Overflow Flag */
#define GFXTIM_FLAG_TE GFXTIM_ISR_TEF /* Tearing Effect Flag */
#define GFXTIM_FLAG_AFCC1                                                      \
	GFXTIM_ISR_AFCC1F /* Absolute Frame Counter Compare 1 Flag */
#define GFXTIM_FLAG_ALCC1                                                      \
	GFXTIM_ISR_ALCC1F /* Absolute Line Counter Compare 1 Flag */
#define GFXTIM_FLAG_ALCC2                                                      \
	GFXTIM_ISR_ALCC2F /* Absolute Line Counter Compare 2 Flag */
#define GFXTIM_FLAG_RFC1R                                                      \
	GFXTIM_ISR_RFC1RF /* Relative Frame Counter 1 Reload Flag */
#define GFXTIM_FLAG_RFC2R                                                      \
	GFXTIM_ISR_RFC2RF /* Relative Frame Counter 2 Reload Flag */
 ...
 * @{
 */
#define IS_GFXTIM_INTERRUPT(PARAM)                                             \
	(((PARAM) == GFXTIM_IT_ENABLE) || ((PARAM) == GFXTIM_IT_DISABLE))

#define IS_GFXTIM_SYNC_SRC(PARAM)                                              \
	(((PARAM) == GFXTIM_SYNC_SRC_HSYNC_VSYNC_0) ||                         \
...
#define IS_GFXTIM_TE_SRC(PARAM)                                                \
	(((PARAM) == GFXTIM_TE_SRC_GPIO) || ((PARAM) == GFXTIM_TE_SRC_ITE) ||  \
	 ((PARAM) == GFXTIM_TE_SRC_HSYNC) || ((PARAM) == GFXTIM_TE_SRC_VSYNC))

#define IS_GFXTIM_TE_POLARITY(PARAM)                                           \
	(((PARAM) == GFXTIM_TE_RISING_EDGE) ||                                 \
	 ((PARAM) == GFXTIM_TE_FALLING_EDGE))

#define IS_GFXTIM_LCC_HW_RELOAD_SRC(PARAM)                                     \
	(((PARAM) == GFXTIM_LCC_HW_RELOAD_SRC_NONE) ||                         \
...
#define IS_GFXTIM_LCC_CLK_SRC(PARAM)                                           \
	(((PARAM) == GFXTIM_LCC_CLK_SRC_DISABLE) ||                            \
	 ((PARAM) == GFXTIM_LCC_CLK_SRC_SYSCLOCK))

#define IS_GFXTIM_LINE_CLK_SRC(PARAM)                                          \
	(((PARAM) == GFXTIM_LINE_CLK_SRC_LCC_UNDERFLOW) ||                     \
...
#define IS_GFXTIM_FCC_HW_RELOAD_SRC(PARAM)                                     \
	(((PARAM) == GFXTIM_FCC_HW_RELOAD_SRC_NONE) ||                         \
...
#define IS_GFXTIM_FCC_CLK_SRC(PARAM)                                           \
	(((PARAM) == GFXTIM_FCC_CLK_SRC_DISABLE) ||                            \
...
#define IS_GFXTIM_FRAME_CLK_SRC(PARAM)                                         \
	(((PARAM) == GFXTIM_FRAME_CLK_SRC_LCC_UNDERFLOW) ||                    \
...
#define IS_GFXTIM_EVENT_GENERATOR(PARAM)                                       \
	(((PARAM) == GFXTIM_EVENT_GENERATOR_1) ||                              \
...
#define IS_GFXTIM_WATCHDOG_HW_RELOAD_CONFIG(PARAM)                             \
	(((PARAM) == GFXTIM_WATCHDOG_HW_RELOAD_DISABLE) ||                     \
...
#define IS_GFXTIM_WATCHDOG_CLOCK_SRC(PARAM)                                    \
	(((PARAM) == GFXTIM_WATCHDOG_CLK_SRC_LINE_CLK) ||                      \
...
HAL_StatusTypeDef
HAL_GFXTIM_WatchdogTimer_Enable(GFXTIM_HandleTypeDef *hgfxtim);
HAL_StatusTypeDef
...
HAL_GFXTIM_StateTypeDef
HAL_GFXTIM_GetState(const GFXTIM_HandleTypeDef *hgfxtim);
