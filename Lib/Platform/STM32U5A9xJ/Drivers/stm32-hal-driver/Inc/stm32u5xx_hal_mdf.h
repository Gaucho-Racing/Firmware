...
typedef struct {
	uint32_t
	    InterleavedFilters; /*!< Number of filters in interleaved mode with
...
typedef struct {
	...
	uint32_t ClockSource; /*!< Serial interface clock source.
				 ...
				 MDF_SitfClockSource */
	uint32_t
	    Threshold; /*!< SPI threshold for clock absence detection or
...
typedef struct {
	...
	MDF_SerialInterfaceTypeDef
	    SerialInterface;	 /*!< MDF serial interface parameters */
...
#if (USE_HAL_MDF_REGISTER_CALLBACKS == 1)
	void (*OldCallback)(
	    struct __MDF_HandleTypeDef *hmdf,
	    uint32_t Threshold); /*!< MDF out-off limit detector callback.
				      @note Not used for ADF instance */
	void (*AcqCpltCallback)(
	    struct __MDF_HandleTypeDef
		*hmdf); /*!< MDF acquisition complete callback */
	void (*AcqHalfCpltCallback)(
	    struct __MDF_HandleTypeDef
		*hmdf); /*!< MDF acquisition half complete callback */
	void (*SndLvCallback)(
	    struct __MDF_HandleTypeDef *hmdf, uint32_t SoundLevel,
	    uint32_t AmbientNoise); /*!< MDF sound level callback.
					 @note Not used for MDF instance */
	void (*SadCallback)(
	    struct __MDF_HandleTypeDef
		*hmdf); /*!< MDF sound activity detector callback.
			     @note Not used for MDF instance */
	void (*ErrorCallback)(
	    struct __MDF_HandleTypeDef *hmdf); /*!< MDF error callback */
	void (*MspInitCallback)(
	    struct __MDF_HandleTypeDef *hmdf); /*!< MDF MSP init callback */
	void (*MspDeInitCallback)(
	    struct __MDF_HandleTypeDef *hmdf); /*!< MDF MSP de-init callback */
#endif /* USE_HAL_MDF_REGISTER_CALLBACKS */
} MDF_HandleTypeDef;
...
typedef enum {
	HAL_MDF_OLD_CB_ID = 0x00U, /*!< MDF out-off limit detector callback ID.
					@note Not used for ADF instance */
	HAL_MDF_ACQ_COMPLETE_CB_ID =
	    0x01U, /*!< MDF acquisition complete callback ID */
	HAL_MDF_ACQ_HALFCOMPLETE_CB_ID =
	    0x02U, /*!< MDF acquisition half complete callback ID */
...
typedef void (*pMDF_OldCallbackTypeDef)(MDF_HandleTypeDef *hmdf,
					uint32_t Threshold);
typedef void (*pMDF_SndLvlCallbackTypeDef)(MDF_HandleTypeDef *hmdf,
					   uint32_t SoundLevel,
...
typedef struct {
	FunctionalState
	    Activation;	    /*!< Sound activity detector enable/disable */
	...
	uint32_t FrameSize; /*!< Size of one frame to compute short-term signal
			       ...
			       MDF_SadFrameSize */
	FunctionalState
	    Hysteresis;		     /*!< Hysteresis enable/disable.
	...
	FunctionalState
	    SoundLevelInterrupt; /*!< Sound level interrupt enable/disable.
...
typedef struct {
	...
	int32_t
	    Offset;   /*!< Filter offset error compensation.
			   This parameter must be a number between Min_Data =
	...
	int32_t Gain; /*!< Filter gain in step of around 3db (from -48db to
			 ...
			 = -16 and Max_Data = 24 */
	MDF_ReshapeFilterTypeDef
	    ReshapeFilter; /*!< Reshape filter configuration */
	MDF_HighPassFilterTypeDef
	    HighPassFilter;		  /*!< High pass filter configuration */
	MDF_IntegratorTypeDef Integrator; /*!< Integrator configuration.
					       @note This parameter is not used
					     for ADF instance */
	MDF_SoundActivityTypeDef
	    SoundActivity;	  /*!< Sound activity detector configuration.
	...
	MDF_FilterTriggerTypeDef
	    Trigger; /*!< Filter trigger configuration.
...
typedef struct {
	...
	uint32_t DecimationCounter; /*!< Decimation counter value when snapshot
				       trigger occurs */
	uint32_t
	    IntegratorCounter; /*!< Integrator counter value when snapshot
...
typedef struct {
	...
	FunctionalState
	    MsbOnly; /*!< Transfer only the 16MSB of the acquistion data */
...
typedef struct {
	uint32_t OldCicMode; /*!< Out-off limit detector CIC filter mode.
				...
				MDF_OldCicMode */
	uint32_t
	    OldDecimationRatio; /*!< Out-off limit detector decimation ratio.
				     This parameter must be a number between
...
#define MDF_ERROR_ACQUISITION_OVERFLOW                                         \
	0x00000001U /*!< Overflow occurs during acquisition */
#define MDF_ERROR_RSF_OVERRUN                                                  \
	0x00000002U /*!< Overrun occurs on reshape filter */
#define MDF_ERROR_CLOCK_ABSENCE                                                \
	0x00000004U /*!< Clock absence detection occurs */
...
#if (USE_HAL_MDF_REGISTER_CALLBACKS == 1)
#define MDF_ERROR_INVALID_CALLBACK                                             \
	0x00000080U /*!< Invalid callback error occurs */
#endif		    /* USE_HAL_MDF_REGISTER_CALLBACKS */
/**
 * @}
 */
...
#define MDF_CLOCK_TRIG_TIM4_TRGO                                               \
	(MDF_CKGCR_TRGSRC_0 | MDF_CKGCR_TRGSRC_1 |                             \
	 MDF_CKGCR_TRGSRC_2) /*!< @note Not available for ADF instance */
#define MDF_CLOCK_TRIG_TIM16_OC1                                               \
...
#define MDF_CLOCK_TRIG_SAD_DET                                                 \
	(MDF_CKGCR_TRGSRC_0 | MDF_CKGCR_TRGSRC_1 |                             \
	 MDF_CKGCR_TRGSRC_3) /*!< @note Not available for ADF instance */
#define MDF_CLOCK_TRIG_EXTI11                                                  \
	(MDF_CKGCR_TRGSRC_2 |                                                  \
	 MDF_CKGCR_TRGSRC_3) /*!< @note Not available for ADF instance */
#define MDF_CLOCK_TRIG_EXTI15                                                  \
	(MDF_CKGCR_TRGSRC_0 | MDF_CKGCR_TRGSRC_2 | MDF_CKGCR_TRGSRC_3)
#define MDF_CLOCK_TRIG_LPTIM1_OUT                                              \
	(MDF_CKGCR_TRGSRC_1 | MDF_CKGCR_TRGSRC_2 |                             \
	 MDF_CKGCR_TRGSRC_3) /*!< @note Not available for ADF instance */
#define MDF_CLOCK_TRIG_SAD_TRGO                                                \
	MDF_CKGCR_TRGSRC /*!< @note Not available for ADF instance */
/**
 * @}
 */
 ...
 * @{
 */
#define MDF_OUTPUT_CLOCK_0                                                     \
	MDF_CKGCR_CCK0DIR /*!< MDF_CCK0 is used as output clock */
#define MDF_OUTPUT_CLOCK_1                                                     \
	MDF_CKGCR_CCK1DIR /*!< MDF_CCK1 is used as output clock */
 ...
 * @{
 */
#define MDF_SITF_LF_MASTER_SPI_MODE                                            \
	0x00000000U /*!< Low frequency master SPI mode */
...
#define MDF_BITSTREAM1_RISING                                                  \
	MDF_BSMXCR_BSSEL_1 /*!< @note Not available for ADF instance */
#define MDF_BITSTREAM1_FALLING                                                 \
	(MDF_BSMXCR_BSSEL_0 |                                                  \
	 MDF_BSMXCR_BSSEL_1) /*!< @note Not available for ADF instance */
#if !defined(STM32U535xx) && !defined(STM32U545xx)
#define MDF_BITSTREAM2_RISING                                                  \
	MDF_BSMXCR_BSSEL_2 /*!< @note Not available for ADF instance */
#define MDF_BITSTREAM2_FALLING                                                 \
	(MDF_BSMXCR_BSSEL_0 |                                                  \
	 MDF_BSMXCR_BSSEL_2) /*!< @note Not available for ADF instance */
#define MDF_BITSTREAM3_RISING                                                  \
	(MDF_BSMXCR_BSSEL_1 |                                                  \
	 MDF_BSMXCR_BSSEL_2) /*!< @note Not available for ADF instance */
#define MDF_BITSTREAM3_FALLING                                                 \
	(MDF_BSMXCR_BSSEL_0 | MDF_BSMXCR_BSSEL_1 |                             \
	 MDF_BSMXCR_BSSEL_2) /*!< @note Not available for ADF instance */
#define MDF_BITSTREAM4_RISING                                                  \
	MDF_BSMXCR_BSSEL_3 /*!< @note Not available for ADF instance */
#define MDF_BITSTREAM4_FALLING                                                 \
	(MDF_BSMXCR_BSSEL_0 |                                                  \
	 MDF_BSMXCR_BSSEL_3) /*!< @note Not available for ADF instance */
#define MDF_BITSTREAM5_RISING                                                  \
	(MDF_BSMXCR_BSSEL_1 |                                                  \
	 MDF_BSMXCR_BSSEL_3) /*!< @note Not available for ADF instance */
 ...
 * @{
 */
#define MDF_RSF_DECIMATION_RATIO_4                                             \
	0x00000000U /*!< Reshape filter decimation ratio is 4 */
#define MDF_RSF_DECIMATION_RATIO_1                                             \
	MDF_DFLTRSFR_RSFLTD /*!< Reshape filter decimation ratio is 1 */
/**
 * @}
 */
 ...
 * @{
 */
#define MDF_HPF_CUTOFF_0_000625FPCM                                            \
	0x00000000U /*!< Cut-off frequency of 0.000625xFpcm */
#define MDF_HPF_CUTOFF_0_00125FPCM                                             \
	MDF_DFLTRSFR_HPFC_0 /*!< Cut-off frequency of 0.00125xFpcm */
#define MDF_HPF_CUTOFF_0_0025FPCM                                              \
	MDF_DFLTRSFR_HPFC_1 /*!< Cut-off frequency of 0.0025xFpcm */
#define MDF_HPF_CUTOFF_0_0095FPCM                                              \
	MDF_DFLTRSFR_HPFC /*!< Cut-off frequency of 0.0095xFpcm */
/**
 * @}
 */
 ...
 * @{
 */
#define MDF_INTEGRATOR_OUTPUT_DIV_128                                          \
	0x00000000U /*!< Integrator data outputs divided by 128 */
#define MDF_INTEGRATOR_OUTPUT_DIV_32                                           \
	MDF_DFLTINTR_INTDIV_0 /*!< Integrator data outputs divided by 32 */
#define MDF_INTEGRATOR_OUTPUT_DIV_4                                            \
	MDF_DFLTINTR_INTDIV_1 /*!< Integrator data outputs divided by 4 */
#define MDF_INTEGRATOR_OUTPUT_NO_DIV                                           \
	MDF_DFLTINTR_INTDIV /*!< Integrator data outputs not divided */
/**
 * @}
 */
 ...
 * @{
 */
#define MDF_SAD_VOICE_ACTIVITY_DETECTOR                                        \
	0x00000000U /*!< Voice activity detector */
#define MDF_SAD_SOUND_DETECTOR MDF_SADCR_SADMOD_0 /*!< Sound detector */
#define MDF_SAD_AMBIENT_NOISE_DETECTOR                                         \
	MDF_SADCR_SADMOD /*!< Ambient noise detector */
/**
 * @}
 */
...
#define MDF_SAD_16_PCM_SAMPLES                                                 \
	MDF_SADCR_FRSIZE_0 /*!< Frame size of 16 PCM samples */
#define MDF_SAD_32_PCM_SAMPLES                                                 \
	MDF_SADCR_FRSIZE_1 /*!< Frame size of 32 PCM samples */
#define MDF_SAD_64_PCM_SAMPLES                                                 \
	(MDF_SADCR_FRSIZE_0 |                                                  \
	 MDF_SADCR_FRSIZE_1) /*!< Frame size of 64 PCM samples */
#define MDF_SAD_128_PCM_SAMPLES                                                \
	MDF_SADCR_FRSIZE_2 /*!< Frame size of 128 PCM samples */
#define MDF_SAD_256_PCM_SAMPLES                                                \
	(MDF_SADCR_FRSIZE_0 |                                                  \
	 MDF_SADCR_FRSIZE_2) /*!< Frame size of 256 PCM samples */
#define MDF_SAD_512_PCM_SAMPLES                                                \
	MDF_SADCR_FRSIZE /*!< Frame size of 512 PCM samples */
/**
 * @}
 */
 ...
 * @{
 */
#define MDF_SAD_ENTER_DETECT                                                   \
	0x00000000U /*!< Event when SAD enters in detect state */
...
/** @defgroup MDF_SadDataMemoryTransfer MDF sound activity detector data memory
 * transfer mode
 * @{
 */
#define MDF_SAD_NO_MEMORY_TRANSFER 0x00000000U /*!< No memory transfer */
#define MDF_SAD_MEMORY_TRANSFER_IN_DETECT                                      \
	MDF_SADCR_DATCAP_0 /*!< Memory transfer only in detect state */
#define MDF_SAD_MEMORY_TRANSFER_ALWAYS                                         \
	MDF_SADCR_DATCAP /*!< Memory transfer always */
/**
 * @}
 */

/** @defgroup MDF_SadHangoverWindow MDF sound activity detector data hangover
 * time window
 * @{
 */
#define MDF_SAD_HANGOVER_4_FRAMES                                              \
	0x00000000U /*!< Hangover window of 4 frames */
#define MDF_SAD_HANGOVER_8_FRAMES                                              \
	MDF_SADCFGR_HGOVR_0 /*!< Hangover window of 8 frames */
#define MDF_SAD_HANGOVER_16_FRAMES                                             \
	MDF_SADCFGR_HGOVR_1 /*!< Hangover window of 16 frames */
#define MDF_SAD_HANGOVER_32_FRAMES                                             \
	(MDF_SADCFGR_HGOVR_0 |                                                 \
	 MDF_SADCFGR_HGOVR_1) /*!< Hangover window of 32 frames */
#define MDF_SAD_HANGOVER_64_FRAMES                                             \
	MDF_SADCFGR_HGOVR_2 /*!< Hangover window of 64 frames */
#define MDF_SAD_HANGOVER_128_FRAMES                                            \
	(MDF_SADCFGR_HGOVR_0 |                                                 \
	 MDF_SADCFGR_HGOVR_2) /*!< Hangover window of 128 frames */
#define MDF_SAD_HANGOVER_256_FRAMES                                            \
	(MDF_SADCFGR_HGOVR_1 |                                                 \
...
/** @defgroup MDF_SadLearningFrames MDF sound activity detector data learning
 * frames
 * @{
 */
...
/** @defgroup MDF_SadSignalNoiseThreshold MDF sound activity detector data
 * signal to noise threshold
 * @{
 */
#define MDF_SAD_SIGNAL_NOISE_3_5DB                                             \
	0x00000000U /*!< Signal to noise threshold is 3.5dB */
#define MDF_SAD_SIGNAL_NOISE_6DB                                               \
	MDF_SADCFGR_SNTHR_0 /*!< Signal to noise threshold is 6dB */
#define MDF_SAD_SIGNAL_NOISE_9_5DB                                             \
	MDF_SADCFGR_SNTHR_1 /*!< Signal to noise threshold is 9.5dB */
#define MDF_SAD_SIGNAL_NOISE_12DB                                              \
	(MDF_SADCFGR_SNTHR_0 |                                                 \
	 MDF_SADCFGR_SNTHR_1) /*!< Signal to noise threshold is 12dB */
#define MDF_SAD_SIGNAL_NOISE_15_6DB                                            \
	MDF_SADCFGR_SNTHR_2 /*!< Signal to noise threshold is 15.6dB */
...
#define MDF_SAD_SIGNAL_NOISE_24_1DB                                            \
	(MDF_SADCFGR_SNTHR_0 | MDF_SADCFGR_SNTHR_1 |                           \
	 MDF_SADCFGR_SNTHR_2) /*!< Signal to noise threshold is 24.1dB */
#define MDF_SAD_SIGNAL_NOISE_27_6DB                                            \
	MDF_SADCFGR_SNTHR_3 /*!< Signal to noise threshold is 27.6dB */
...
#define MDF_FILTER_TRIG_OLD_EVENT                                              \
	MDF_DFLTCR_TRGSRC_0 /*!< @note Not available for ADF instance */
#define MDF_FILTER_TRIG_TIM1_TRGO                                              \
	MDF_DFLTCR_TRGSRC_1 /*!< @note Not available for ADF instance */
#define MDF_FILTER_TRIG_TIM1_TRGO2                                             \
	(MDF_DFLTCR_TRGSRC_0 |                                                 \
	 MDF_DFLTCR_TRGSRC_1) /*!< @note Not available for ADF instance */
#define MDF_FILTER_TRIG_TIM8_TRGO                                              \
...
#define MDF_FILTER_TRIG_TIM4_TRGO                                              \
	(MDF_DFLTCR_TRGSRC_0 | MDF_DFLTCR_TRGSRC_1 |                           \
	 MDF_DFLTCR_TRGSRC_2) /*!< @note Not available for ADF instance */
#define MDF_FILTER_TRIG_TIM16_OC1                                              \
...
#define MDF_FILTER_TRIG_EXTI11                                                 \
	(MDF_DFLTCR_TRGSRC_2 |                                                 \
	 MDF_DFLTCR_TRGSRC_3) /*!< @note Not available for ADF instance */
#define MDF_FILTER_TRIG_EXTI15                                                 \
	(MDF_DFLTCR_TRGSRC_0 | MDF_DFLTCR_TRGSRC_2 | MDF_DFLTCR_TRGSRC_3)
#define MDF_FILTER_TRIG_LPTIM1_OUT                                             \
	(MDF_DFLTCR_TRGSRC_1 | MDF_DFLTCR_TRGSRC_2 |                           \
	 MDF_DFLTCR_TRGSRC_3) /*!< @note Not available for ADF instance */
#define MDF_FILTER_TRIG_ADF_TRGO                                               \
	MDF_DFLTCR_TRGSRC /*!< @note Not available for ADF instance */
/**
 * @}
 */
...
#define MDF_TWO_FILTERS_MCIC_SINC3                                             \
	(MDF_DFLTCICR_CICMOD_0 |                                               \
	 MDF_DFLTCICR_CICMOD_1) /*!< Two filters, main filter in Sinc3 order.  \
				     @note Not available for ADF instance */
#define MDF_ONE_FILTER_SINC4                                                   \
	MDF_DFLTCICR_CICMOD_2 /*!< One filter in Sinc4 order */
#define MDF_ONE_FILTER_SINC5                                                   \
	(MDF_DFLTCICR_CICMOD_0 |                                               \
 ...
 * @{
 */
#define MDF_MODE_ASYNC_CONT                                                    \
	0x00000000U /*!< Asynchronous, continuous acquisition mode */
#define MDF_MODE_ASYNC_SINGLE                                                  \
	MDF_DFLTCR_ACQMOD_0 /*!< Asynchronous, single-shot acquisition mode.   \
				 @note Not available for ADF instance with SAD \
			       usage */
#define MDF_MODE_SYNC_CONT                                                     \
	MDF_DFLTCR_ACQMOD_1 /*!< Synchronous, continuous acquisition mode */
 ...
 * @{
 */
#define MDF_FIFO_THRESHOLD_NOT_EMPTY                                           \
	0x00000000U /*!< Event generated when RXFIFO is not empty */
#define MDF_FIFO_THRESHOLD_HALF_FULL                                           \
	MDF_DFLTCR_FTH /*!< Event generated when RXFIFO is half_full */
/**
 * @}
 */
 ...
 * @{
 */
#define MDF_SNAPSHOT_23BITS                                                    \
	0x00000000U /*!< Snapshot data resolution of 23 bits */
#define MDF_SNAPSHOT_16BITS                                                    \
	MDF_DFLTCR_SNPSFMT /*!< Snapshot data resolution of 16 bits */
/**
 * @}
 */
 ...
 * @{
 */
#define MDF_OLD_FILTER_FASTSINC                                                \
	0x00000000U /*!< Out-off limit detector filter in FastSinc order */
#define MDF_OLD_FILTER_SINC1                                                   \
	MDF_OLDCR_ACICN_0 /*!< Out-off limit detector filter in Sinc1 order */
#define MDF_OLD_FILTER_SINC2                                                   \
	MDF_OLDCR_ACICN_1 /*!< Out-off limit detector filter in Sinc2 order */
#define MDF_OLD_FILTER_SINC3                                                   \
	MDF_OLDCR_ACICN /*!< Out-off limit detector filter in Sinc3 order */
/**
 * @}
 */
...
/** @defgroup MDF_OldThresholdInfo MDF out-off limit detector threshold
 * information
 * @{
 */
...
HAL_MDF_UnRegisterCallback(MDF_HandleTypeDef *hmdf,
			   HAL_MDF_CallbackIDTypeDef CallbackID);
HAL_StatusTypeDef
HAL_MDF_RegisterOldCallback(MDF_HandleTypeDef *hmdf,
 ...
 */
HAL_StatusTypeDef
HAL_MDF_AcqStart(MDF_HandleTypeDef *hmdf,
...
HAL_StatusTypeDef HAL_MDF_GetGain(const MDF_HandleTypeDef *hmdf,
				  int32_t *pGain);
...
void HAL_MDF_SndLvlCallback(MDF_HandleTypeDef *hmdf, uint32_t SoundLevel,
			    uint32_t AmbientNoise);
 ...
 * @{
 */
HAL_StatusTypeDef HAL_MDF_PollForCkab(MDF_HandleTypeDef *hmdf,
				      uint32_t Timeout);
...
#define IS_MDF_INSTANCE(PARAM)                                                 \
	(((PARAM) == MDF1_Filter0) || ((PARAM) == MDF1_Filter1))
#else /* defined(STM32U535xx) || defined(STM32U545xx) */
#define IS_MDF_INSTANCE(PARAM)                                                 \
	(((PARAM) == MDF1_Filter0) || ((PARAM) == MDF1_Filter1) ||             \
	 ((PARAM) == MDF1_Filter2) || ((PARAM) == MDF1_Filter3) ||             \
	 ((PARAM) == MDF1_Filter4) || ((PARAM) == MDF1_Filter5))
#endif /* defined(STM32U535xx) || defined(STM32U545xx) */
...
#define IS_MDF_OUTPUT_CLOCK_PINS(PARAM)                                        \
	(((PARAM) == MDF_OUTPUT_CLOCK_0) || ((PARAM) == MDF_OUTPUT_CLOCK_1) || \
...
#define IS_MDF_OUTPUT_CLOCK_TRIGGER_EDGE(PARAM)                                \
	(((PARAM) == MDF_CLOCK_TRIG_RISING_EDGE) ||                            \
	 ((PARAM) == MDF_CLOCK_TRIG_FALLING_EDGE))

#define IS_MDF_SITF_MODE(PARAM)                                                \
	(((PARAM) == MDF_SITF_LF_MASTER_SPI_MODE) ||                           \
...
#define IS_MDF_CIC_MODE(PARAM)                                                 \
	(((PARAM) == MDF_TWO_FILTERS_MCIC_FASTSINC) ||                         \
...
#define IS_ADF_TRIGGER_SOURCE(PARAM)                                           \
	(((PARAM) == MDF_FILTER_TRIG_TRGO) ||                                  \
	 ((PARAM) == MDF_FILTER_TRIG_EXTI15))

#define IS_MDF_TRIGGER_EDGE(PARAM)                                             \
	(((PARAM) == MDF_FILTER_TRIG_RISING_EDGE) ||                           \
	 ((PARAM) == MDF_FILTER_TRIG_FALLING_EDGE))

#define IS_MDF_SNAPSHOT_FORMAT(PARAM)                                          \
	(((PARAM) == MDF_SNAPSHOT_23BITS) || ((PARAM) == MDF_SNAPSHOT_16BITS))

#if defined(ADC2)
#define IS_MDF_DATA_SOURCE(PARAM)                                              \
	(((PARAM) == MDF_DATA_SOURCE_BSMX) ||                                  \
...
#define IS_MDF_INTEGRATOR_OUTPUT_DIV(PARAM)                                    \
	(((PARAM) == MDF_INTEGRATOR_OUTPUT_DIV_128) ||                         \
...
#define IS_MDF_SAD_SOUND_TRIGGER(PARAM)                                        \
	(((PARAM) == MDF_SAD_ENTER_DETECT) ||                                  \
	 ((PARAM) == MDF_SAD_ENTER_EXIT_DETECT))

#define IS_MDF_SAD_DATA_MEMORY_TRANSFER(PARAM)                                 \
	(((PARAM) == MDF_SAD_NO_MEMORY_TRANSFER) ||                            \
...
#define IS_MDF_SAD_HANGOVER_WINDOW(PARAM)                                      \
	(((PARAM) == MDF_SAD_HANGOVER_4_FRAMES) ||                             \
...
#define IS_MDF_SAD_LEARNING_FRAMES(PARAM)                                      \
	(((PARAM) == MDF_SAD_LEARNING_2_FRAMES) ||                             \
...
#define IS_MDF_SAD_SIGNAL_NOISE_THRESHOLD(PARAM)                               \
	(((PARAM) == MDF_SAD_SIGNAL_NOISE_3_5DB) ||                            \
...
#define IS_MDF_OLD_THRESHOLD(PARAM)                                            \
	((-33554432 <= (PARAM)) && ((PARAM) <= 33554431))

#define IS_MDF_OLD_EVENT_CONFIG(PARAM)                                         \
	(((PARAM) == MDF_OLD_SIGNAL_OUTSIDE_THRESHOLDS) ||                     \
