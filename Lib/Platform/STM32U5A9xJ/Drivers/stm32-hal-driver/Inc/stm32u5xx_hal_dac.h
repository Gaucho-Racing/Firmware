...
typedef struct {
	...
	uint32_t DAC_AutonomousMode; /*!< Specifies whether the autonomous mode
					state This parameter can be a value of
					@ref DAC_AutonomousMode Note:
					HAL_DACEx_SetConfigAutonomousMode() API
					allows to select and update the
					autonomous mode state afterwards */
	...
	uint32_t DAC_Trigger; /*!< Specifies the external trigger for the
				 ...
				 value of @ref DAC_trigger_selection */
...
#define DAC_TRIGGER_NONE                                                       \
	0x00000000UL /*!< conversion is automatic once the DAC_DHRxxxx         \
			register has been loaded, and not by external trigger  \
		      */
#define DAC_TRIGGER_SOFTWARE                                                   \
	(DAC_CR_TEN1) /*!< conversion started by software trigger for DAC      \
			 channel */
#define DAC_TRIGGER_T1_TRGO                                                    \
	(DAC_CR_TSEL1_0 |                                                      \
	 DAC_CR_TEN1) /*!< TIM1 TRGO selected as external conversion trigger   \
			 for DAC channel. */
#define DAC_TRIGGER_T2_TRGO                                                    \
	(DAC_CR_TSEL1_1 |                                                      \
	 DAC_CR_TEN1) /*!< TIM2 TRGO selected as external conversion trigger   \
			 for DAC channel */
#define DAC_TRIGGER_T4_TRGO                                                    \
	(DAC_CR_TSEL1_1 | DAC_CR_TSEL1_0 |                                     \
	 DAC_CR_TEN1) /*!< TIM4 TRGO selected as external conversion trigger   \
			 for DAC channel */
#define DAC_TRIGGER_T5_TRGO                                                    \
	(DAC_CR_TSEL1_2 |                                                      \
	 DAC_CR_TEN1) /*!< TIM5 TRGO selected as external conversion trigger   \
			 for DAC channel */
#define DAC_TRIGGER_T6_TRGO                                                    \
	(DAC_CR_TSEL1_2 | DAC_CR_TSEL1_0 |                                     \
	 DAC_CR_TEN1) /*!< TIM6 TRGO selected as external conversion trigger   \
			 for DAC channel */
#define DAC_TRIGGER_T7_TRGO                                                    \
	(DAC_CR_TSEL1_2 | DAC_CR_TSEL1_1 |                                     \
	 DAC_CR_TEN1) /*!< TIM7 TRGO selected as external conversion trigger   \
			 for DAC channel */
#define DAC_TRIGGER_T8_TRGO                                                    \
	(DAC_CR_TSEL1_2 | DAC_CR_TSEL1_1 | DAC_CR_TSEL1_0 |                    \
	 DAC_CR_TEN1) /*!< TIM8 TRGO selected as external conversion trigger   \
			 for DAC channel */
#define DAC_TRIGGER_T15_TRGO                                                   \
	(DAC_CR_TSEL1_3 |                                                      \
	 DAC_CR_TEN1) /*!< TIM15 TRGO selected as external conversion trigger  \
			 for DAC channel */
#define DAC_TRIGGER_LPTIM1_CH1                                                 \
	(DAC_CR_TSEL1_3 | DAC_CR_TSEL1_1 | DAC_CR_TSEL1_0 |                    \
	 DAC_CR_TEN1) /*!< LPTIM1 CH1 selected as external conversion trigger  \
			 for DAC channel */
#define DAC_TRIGGER_LPTIM3_CH1                                                 \
	(DAC_CR_TSEL1_3 | DAC_CR_TSEL1_2 |                                     \
	 DAC_CR_TEN1) /*!< LPTIM3 CH1 selected as external conversion trigger  \
			 for DAC channel */
#define DAC_TRIGGER_EXT_IT9                                                    \
	(DAC_CR_TSEL1_3 | DAC_CR_TSEL1_2 | DAC_CR_TSEL1_0 |                    \
	 DAC_CR_TEN1) /*!< EXTI Line9 event selected as external conversion    \
...
#define DAC_CHIPCONNECT_INTERNAL                                               \
	(1UL                                                                   \
	 << 1) /*!< DAC channel  output is connected to on-chip peripherals    \
 ...
 * @{
 */
#define DAC_TRIGGER_STOP_LPTIM1_CH1                                            \
	DAC_TRIGGER_LPTIM1_CH1 /*!< LPTIM1 output selected as DAC trigger in   \
				  stop mode */
#define DAC_TRIGGER_STOP_LPTIM3_CH1                                            \
	DAC_TRIGGER_LPTIM3_CH1 /*!< LPTIM3 output selected as DAC trigger in   \
				  stop mode */
#define DAC_TRIGGER_STOP_EXT_IT9                                               \
	DAC_TRIGGER_EXT_IT9 /*!< EXTI line 9 selected as DAC trigger in stop   \
			       mode   */
/**
 * @}
 */
