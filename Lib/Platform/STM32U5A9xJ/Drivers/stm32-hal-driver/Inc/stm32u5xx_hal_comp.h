...
#define COMP_POWERMODE_ULTRALOWPOWER                                           \
	(COMP_CSR_PWRMODE_1 | COMP_CSR_PWRMODE_0) /*!< Ultra-low power */
/**
 * @}
 */
...
#define __HAL_COMP_COMP1_EXTI_ENABLE_IT()                                      \
	SET_BIT(EXTI->IMR1, COMP_EXTI_LINE_COMP1)
...
#define __HAL_COMP_COMP1_EXTI_DISABLE_IT()                                     \
	CLEAR_BIT(EXTI->IMR1, COMP_EXTI_LINE_COMP1)
...
#define __HAL_COMP_COMP1_EXTI_ENABLE_EVENT()                                   \
	SET_BIT(EXTI->EMR1, COMP_EXTI_LINE_COMP1)
...
#define __HAL_COMP_COMP1_EXTI_DISABLE_EVENT()                                  \
	CLEAR_BIT(EXTI->EMR1, COMP_EXTI_LINE_COMP1)

/**
 * @brief  Check whether the COMP1 EXTI line rising flag is set or not.
 * @retval RESET or SET
 */
#define __HAL_COMP_COMP1_EXTI_GET_RISING_FLAG()                                \
	READ_BIT(EXTI->RPR1, COMP_EXTI_LINE_COMP1)

/**
 * @brief  Check whether the COMP1 EXTI line falling flag is set or not.
 * @retval RESET or SET
 */
#define __HAL_COMP_COMP1_EXTI_GET_FALLING_FLAG()                               \
	READ_BIT(EXTI->FPR1, COMP_EXTI_LINE_COMP1)

/**
 * @brief  Clear the COMP1 EXTI raising flag.
 * @retval None
 */
#define __HAL_COMP_COMP1_EXTI_CLEAR_RISING_FLAG()                              \
	WRITE_REG(EXTI->RPR1, COMP_EXTI_LINE_COMP1)

/**
 * @brief  Clear the COMP1 EXTI falling flag.
 * @retval None
 */
#define __HAL_COMP_COMP1_EXTI_CLEAR_FALLING_FLAG()                             \
	WRITE_REG(EXTI->FPR1, COMP_EXTI_LINE_COMP1)
...
#define __HAL_COMP_COMP2_EXTI_ENABLE_IT()                                      \
	SET_BIT(EXTI->IMR1, COMP_EXTI_LINE_COMP2)
...
#define __HAL_COMP_COMP2_EXTI_DISABLE_IT()                                     \
	CLEAR_BIT(EXTI->IMR1, COMP_EXTI_LINE_COMP2)
...
#define __HAL_COMP_COMP2_EXTI_ENABLE_EVENT()                                   \
	SET_BIT(EXTI->EMR1, COMP_EXTI_LINE_COMP2)
...
#define __HAL_COMP_COMP2_EXTI_DISABLE_EVENT()                                  \
	CLEAR_BIT(EXTI->EMR1, COMP_EXTI_LINE_COMP2)

/**
 * @brief  Check whether the COMP2 EXTI line raising flag is set or not.
 * @retval RESET or SET
 */
#define __HAL_COMP_COMP2_EXTI_GET_RISING_FLAG()                                \
	READ_BIT(EXTI->RPR1, COMP_EXTI_LINE_COMP2)

/**
 * @brief  Check whether the COMP2 EXTI line falling flag is set or not.
 * @retval RESET or SET
 */
#define __HAL_COMP_COMP2_EXTI_GET_FALLING_FLAG()                               \
	READ_BIT(EXTI->FPR1, COMP_EXTI_LINE_COMP2)

/**
 * @brief  Clear the the COMP2 EXTI raising flag.
 * @retval None
 */
#define __HAL_COMP_COMP2_EXTI_CLEAR_RISING_FLAG()                              \
	WRITE_REG(EXTI->RPR1, COMP_EXTI_LINE_COMP2)

/**
 * @brief  Clear the the COMP2 EXTI falling flag.
 * @retval None
 */
#define __HAL_COMP_COMP2_EXTI_CLEAR_FALLING_FLAG()                             \
	WRITE_REG(EXTI->FPR1, COMP_EXTI_LINE_COMP2)
...
#define COMP_EXTI_LINE_COMP1                                                   \
	(EXTI_IMR1_IM17) /*!< EXTI line 17 connected to COMP1 output */
#if defined(COMP2)
#define COMP_EXTI_LINE_COMP2                                                   \
	(EXTI_IMR1_IM18) /*!< EXTI line 18 connected to COMP2 output */
#endif			 /* COMP2 */
/**
 * @}
 */
...
#define IS_COMP_WINDOWOUTPUT(__WINDOWOUTPUT__)                                 \
	(((__WINDOWOUTPUT__) == COMP_WINDOWOUTPUT_EACH_COMP) ||                \
