 ...
 */
#define PWR_UVM                                                                \
	PWR_SVMCR_UVMEN /*!< Independent USB voltage monitor (VDDUSB           \
			   versus 1.2 V)    */
#define PWR_IO2VM                                                              \
	PWR_SVMCR_IO2VMEN /*!< Independent VDDIO2 voltage monitor (VDDIO2      \
			     versus 0.9 V) */
#define PWR_AVM1                                                               \
	PWR_SVMCR_AVM1EN /*!< Independent VDDA voltage monitor (VDDA           \
			    versus 1.6 V)     */
#define PWR_AVM2                                                               \
	PWR_SVMCR_AVM2EN /*!< Independent VDDA voltage monitor (VDDA           \
			    versus 1.8 V)     */
/**
 * @}
 */
 ...
 * @{
 */
#define PWR_SRD_DOMAIN_STOP                                                    \
	(0U) /*!< SRD in Stop mode when system goes to Stop 0/1/2 mode */
#define PWR_SRD_DOMAIN_RUN                                                     \
	PWR_CR2_SRDRUN /*!< SRD in Run mode when system goes to Stop 0/1/2     \
			  mode  */
/**
 * @}
 */

/** @defgroup PWREx_RAM_Contents_Stop_Retention PWR Extended RAM Contents Stop
 * Retention
 * @{
 */
/* SRAM1 pages retention defines */
#define PWR_SRAM1_PAGE1_STOP                                                   \
	(SRAM1_ID | PAGE01_ID) /*!< SRAM1 page 1 (64 KB) retention in Stop     \
				  modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM1_PAGE2_STOP                                                   \
	(SRAM1_ID | PAGE02_ID) /*!< SRAM1 page 2 (64 KB) retention in Stop     \
				  modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM1_PAGE3_STOP                                                   \
	(SRAM1_ID | PAGE03_ID) /*!< SRAM1 page 3 (64 KB) retention in Stop     \
				  modes (Stop 0, 1, 2, 3)    */
#if defined(PWR_CR4_SRAM1PDS4)
#define PWR_SRAM1_PAGE4_STOP                                                   \
	(SRAM1_ID | PAGE04_ID) /*!< SRAM1 page 4 (64 KB) retention in Stop     \
				  modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM1_PAGE5_STOP                                                   \
	(SRAM1_ID | PAGE05_ID) /*!< SRAM1 page 5 (64 KB) retention in Stop     \
				  modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM1_PAGE6_STOP                                                   \
	(SRAM1_ID | PAGE06_ID) /*!< SRAM1 page 6 (64 KB) retention in Stop     \
				  modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM1_PAGE7_STOP                                                   \
	(SRAM1_ID | PAGE07_ID) /*!< SRAM1 page 7 (64 KB) retention in Stop     \
				  modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM1_PAGE8_STOP                                                   \
	(SRAM1_ID | PAGE08_ID) /*!< SRAM1 page 8 (64 KB) retention in Stop     \
				  modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM1_PAGE9_STOP                                                   \
	(SRAM1_ID | PAGE09_ID) /*!< SRAM1 page 9 (64 KB) retention in Stop     \
				  modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM1_PAGE10_STOP                                                  \
	(SRAM1_ID | PAGE10_ID) /*!< SRAM1 page 10 (64 KB) retention in Stop    \
				  modes (Stop 0, 1, 2, 3)   */
#define PWR_SRAM1_PAGE11_STOP                                                  \
	(SRAM1_ID | PAGE11_ID) /*!< SRAM1 page 11 (64 KB) retention in Stop    \
				  modes (Stop 0, 1, 2, 3)   */
#define PWR_SRAM1_PAGE12_STOP                                                  \
	(SRAM1_ID | PAGE12_ID) /*!< SRAM1 page 12 (64 KB) retention in Stop    \
				  modes (Stop 0, 1, 2, 3)   */
#define PWR_SRAM1_FULL_STOP                                                    \
	(SRAM1_ID | 0x0FFFU) /*!< SRAM1 all pages retention in Stop modes      \
				(Stop 0, 1, 2, 3)         */
#else
#define PWR_SRAM1_FULL_STOP                                                    \
	(SRAM1_ID | 0x07U) /*!< SRAM1 all pages retention in Stop modes (Stop  \
			      0, 1, 2, 3)         */
#endif			   /* defined (PWR_CR4_SRAM1PDS4) */

/* SRAM2 pages retention defines */
#define PWR_SRAM2_PAGE1_STOP                                                   \
	(SRAM2_ID | PAGE01_ID) /*!< SRAM2 page 1 (8 KB) retention in Stop      \
				  modes  (Stop 0, 1, 2)       */
...
#define PWR_SRAM3_PAGE1_STOP                                                   \
	(SRAM3_ID | PAGE01_ID) /*!< SRAM3 page 1 (64 KB) retention in Stop     \
				  modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM3_PAGE2_STOP                                                   \
	(SRAM3_ID | PAGE02_ID) /*!< SRAM3 page 2 (64 KB) retention in Stop     \
				  modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM3_PAGE3_STOP                                                   \
	(SRAM3_ID | PAGE03_ID) /*!< SRAM3 page 3 (64 KB) retention in Stop     \
				  modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM3_PAGE4_STOP                                                   \
	(SRAM3_ID | PAGE04_ID) /*!< SRAM3 page 4 (64 KB) retention in Stop     \
				  modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM3_PAGE5_STOP                                                   \
	(SRAM3_ID | PAGE05_ID) /*!< SRAM3 page 5 (64 KB) retention in Stop     \
				  modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM3_PAGE6_STOP                                                   \
	(SRAM3_ID | PAGE06_ID) /*!< SRAM3 page 6 (64 KB) retention in Stop     \
				  modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM3_PAGE7_STOP                                                   \
	(SRAM3_ID | PAGE07_ID) /*!< SRAM3 page 7 (64 KB) retention in Stop     \
				  modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM3_PAGE8_STOP                                                   \
	(SRAM3_ID | PAGE08_ID) /*!< SRAM3 page 8 (64 KB) retention in Stop     \
				  modes (Stop 0, 1, 2, 3)    */
#if defined(PWR_CR4_SRAM3PDS9)
#define PWR_SRAM3_PAGE9_STOP                                                   \
	(SRAM3_ID | PAGE09_ID) /*!< SRAM3 page 9 (64 KB) retention in Stop     \
				  modes  (Stop 0, 1, 2, 3)   */
#define PWR_SRAM3_PAGE10_STOP                                                  \
	(SRAM3_ID | PAGE10_ID) /*!< SRAM3 page 10 (64 KB) retention in Stop    \
				  modes (Stop 0, 1, 2, 3)   */
#define PWR_SRAM3_PAGE11_STOP                                                  \
	(SRAM3_ID | PAGE11_ID) /*!< SRAM3 page 11 (64 KB) retention in Stop    \
				  modes (Stop 0, 1, 2, 3)   */
#define PWR_SRAM3_PAGE12_STOP                                                  \
	(SRAM3_ID | PAGE12_ID) /*!< SRAM3 page 12 (64 KB) retention in Stop    \
				  modes (Stop 0, 1, 2, 3)   */
#define PWR_SRAM3_PAGE13_STOP                                                  \
	(SRAM3_ID | PAGE13_ID) /*!< SRAM3 page 13 (64 KB) retention in Stop    \
				  modes (Stop 0, 1, 2, 3)   */
#define PWR_SRAM3_FULL_STOP                                                    \
	(SRAM3_ID | 0x1FFFU) /*!< SRAM3 all pages retention in Stop modes      \
				(Stop 0, 1, 2, 3)   */
#else
#define PWR_SRAM3_FULL_STOP                                                    \
...
#define PWR_SRAM4_FULL_STOP                                                    \
	(SRAM4_ID |                                                            \
	 PAGE01_ID) /*!< SRAM4 retention in Stop modes (Stop 0, 1, 2, 3) */

#if defined(PWR_CR4_SRAM5PDS1)
/* SRAM5 pages retention defines */
#define PWR_SRAM5_PAGE1_STOP                                                   \
	(SRAM5_ID | PAGE01_ID) /*!< SRAM5 page 1 (64 KB) retention in Stop     \
				  modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM5_PAGE2_STOP                                                   \
	(SRAM5_ID | PAGE02_ID) /*!< SRAM5 page 2 (64 KB) retention in Stop     \
				  modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM5_PAGE3_STOP                                                   \
	(SRAM5_ID | PAGE03_ID) /*!< SRAM5 page 3 (64 KB) retention in Stop     \
				  modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM5_PAGE4_STOP                                                   \
	(SRAM5_ID | PAGE04_ID) /*!< SRAM5 page 4 (64 KB) retention in Stop     \
				  modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM5_PAGE5_STOP                                                   \
	(SRAM5_ID | PAGE05_ID) /*!< SRAM5 page 5 (64 KB) retention in Stop     \
				  modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM5_PAGE6_STOP                                                   \
	(SRAM5_ID | PAGE06_ID) /*!< SRAM5 page 6 (64 KB) retention in Stop     \
				  modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM5_PAGE7_STOP                                                   \
	(SRAM5_ID | PAGE07_ID) /*!< SRAM5 page 7 (64 KB) retention in Stop     \
				  modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM5_PAGE8_STOP                                                   \
	(SRAM5_ID | PAGE08_ID) /*!< SRAM5 page 8 (64 KB) retention in Stop     \
				  modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM5_PAGE9_STOP                                                   \
	(SRAM5_ID | PAGE09_ID) /*!< SRAM5 page 9 (64 KB) retention in Stop     \
				  modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM5_PAGE10_STOP                                                  \
	(SRAM5_ID | PAGE10_ID) /*!< SRAM5 page 10 (64 KB) retention in Stop    \
				  modes (Stop 0, 1, 2, 3)   */
#define PWR_SRAM5_PAGE11_STOP                                                  \
	(SRAM5_ID | PAGE11_ID) /*!< SRAM5 page 11 (64 KB) retention in Stop    \
				  modes (Stop 0, 1, 2, 3)   */
#define PWR_SRAM5_PAGE12_STOP                                                  \
	(SRAM5_ID | PAGE12_ID) /*!< SRAM5 page 12 (64 KB) retention in Stop    \
				  modes (Stop 0, 1, 2, 3)   */
#define PWR_SRAM5_PAGE13_STOP                                                  \
	(SRAM5_ID | PAGE13_ID) /*!< SRAM5 page 13 (64 KB) retention in Stop    \
				  modes (Stop 0, 1, 2, 3)   */
#define PWR_SRAM5_FULL_STOP                                                    \
	(SRAM5_ID | 0x1FFFU) /*!< SRAM5 all pages retention in Stop modes      \
				(Stop 0, 1, 2, 3)    */
...
#define PWR_SRAM6_PAGE1_STOP                                                   \
	(SRAM6_ID | PAGE01_ID) /*!< SRAM6 page 1 (64 KB) retention in Stop     \
				  modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM6_PAGE2_STOP                                                   \
	(SRAM6_ID | PAGE02_ID) /*!< SRAM6 page 2 (64 KB) retention in Stop     \
				  modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM6_PAGE3_STOP                                                   \
	(SRAM6_ID | PAGE03_ID) /*!< SRAM6 page 3 (64 KB) retention in Stop     \
				  modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM6_PAGE4_STOP                                                   \
	(SRAM6_ID | PAGE04_ID) /*!< SRAM6 page 4 (64 KB) retention in Stop     \
				  modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM6_PAGE5_STOP                                                   \
	(SRAM6_ID | PAGE05_ID) /*!< SRAM6 page 5 (64 KB) retention in Stop     \
				  modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM6_PAGE6_STOP                                                   \
	(SRAM6_ID | PAGE06_ID) /*!< SRAM6 page 6 (64 KB) retention in Stop     \
				  modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM6_PAGE7_STOP                                                   \
	(SRAM6_ID | PAGE07_ID) /*!< SRAM6 page 7 (64 KB) retention in Stop     \
				  modes (Stop 0, 1, 2, 3)    */
...
#define PWR_ICACHE_FULL_STOP                                                   \
	(ICACHERAM_ID | PAGE01_ID) /*!< ICACHE page retention in Stop modes    \
				      (Stop 0, 1, 2, 3)             */
#define PWR_DCACHE1_FULL_STOP                                                  \
	(DCACHE1RAM_ID | PAGE01_ID) /*!< DCACHE1 page retention in Stop modes  \
				       (Stop 0, 1, 2, 3)            */
#if defined(PWR_CR2_DC2RAMPDS)
#define PWR_DCACHE2_FULL_STOP                                                  \
	(DCACHE2RAM_ID | PAGE01_ID) /*!< DCACHE2 page retention in Stop modes  \
				       (Stop 0, 1, 2, 3)            */
...
#define PWR_DMA2DRAM_FULL_STOP                                                 \
	(DMA2DRAM_ID | PAGE01_ID) /*!< DMA2D RAM retention in Stop modes (Stop \
				     0, 1, 2, 3)               */
#endif				  /* PWR_CR2_DMA2DRAMPDS */

/* FMAC, FDCAN and USB RAMs retention defines */
#define PWR_PERIPHRAM_FULL_STOP                                                \
	(PERIPHRAM_ID | PAGE01_ID) /*!< FMAC, FDCAN and USB RAM retention in   \
				      Stop modes (Stop 0, 1, 2, 3) */

/* PKA32 RAM retention defines */
#define PWR_PKA32RAM_FULL_STOP                                                 \
	(PKARAM_ID | PAGE01_ID) /*!< PKA32 RAM retention in Stop modes (Stop   \
				   0, 1, 2, 3)               */

#if defined(PWR_CR2_GPRAMPDS)
/* Graphic peripherals RAM retention defines */
#define PWR_GRAPHICPRAM_FULL_STOP                                              \
	(GRAPHIPRAM_ID | PAGE01_ID) /*!< LTDC, GFXMMU retention in Stop modes  \
				       (Stop 0, 1, 2, 3)            */
...
#define PWR_DSIRAM_FULL_STOP                                                   \
	(DSIRAM_ID |                                                           \
	 PAGE01_ID) /*!< DSI RAM retention in Stop modes (Stop 0, 1, 2, 3) */
...
#define PWR_JPEGRAM_FULL_STOP                                                  \
	(JPEGRAM_ID |                                                          \
	 PAGE01_ID) /*!< JPEG RAM retention in Stop modes (Stop 0, 1, 2, 3) */
#endif		    /* defined (PWR_CR2_JPEGRAMPDS) */
/**
 * @}
 */

/** @defgroup PWREx_SRAM2_Contents_Standby_Retention PWR Extended SRAM2 Contents
 * Standby Retention
...
/** @defgroup PWREx_SRAMx_Contents_Run_Retention PWR Extended SRAM Contents Run
 * Retention
 * @{
 */
#define PWR_SRAM1_FULL_RUN                                                     \
	PWR_CR1_SRAM1PD /*!< SRAM1 full retention in Run mode */
#define PWR_SRAM2_FULL_RUN                                                     \
	PWR_CR1_SRAM2PD /*!< SRAM2 full retention in Run mode */
#if defined(PWR_CR1_SRAM3PD)
#define PWR_SRAM3_FULL_RUN                                                     \
	PWR_CR1_SRAM3PD /*!< SRAM3 full retention in Run mode */
#endif			/* PWR_CR1_SRAM3PD */
#define PWR_SRAM4_FULL_RUN                                                     \
	PWR_CR1_SRAM4PD /*!< SRAM4 full retention in Run mode */
#if defined(PWR_CR1_SRAM5PD)
#define PWR_SRAM5_FULL_RUN                                                     \
	PWR_CR1_SRAM5PD /*!< SRAM5 full retention in Run mode */
#endif			/* defined (PWR_CR1_SRAM5PD) */
#if defined(PWR_CR1_SRAM6PD)
#define PWR_SRAM6_FULL_RUN                                                     \
	PWR_CR1_SRAM6PD /*!< SRAM6 full retention in Run mode */
...
#define PWR_REGULATOR_VOLTAGE_SCALE1                                           \
	(PWR_VOSR_VOS_0 | PWR_VOSR_VOS_1) /*!< Voltage scaling range 1 */
...
#define PWR_BATTERY_CHARGING_RESISTOR_1_5                                      \
	PWR_BDCR2_VBRS /*!< VBAT charging through a 1.5 kOhms resistor */
/**
 * @}
 */
 ...
 * @retval None.
 */
#define __HAL_PWR_UVM_EXTI_DISABLE_EVENT()                                     \
	CLEAR_BIT(EXTI->EMR1, PWR_EXTI_LINE_UVM)

/**
 * @brief  Enable the UVM Extended Interrupt Rising Trigger.
 * @retval None.
 */
#define __HAL_PWR_UVM_EXTI_ENABLE_RISING_EDGE()                                \
	SET_BIT(EXTI->RTSR1, PWR_EXTI_LINE_UVM)

/**
 * @brief  Disable the UVM Extended Interrupt Rising Trigger.
 * @retval None.
 */
#define __HAL_PWR_UVM_EXTI_DISABLE_RISING_EDGE()                               \
	CLEAR_BIT(EXTI->RTSR1, PWR_EXTI_LINE_UVM)

/**
 * @brief  Enable the UVM Extended Interrupt Falling Trigger.
 * @retval None.
 */
#define __HAL_PWR_UVM_EXTI_ENABLE_FALLING_EDGE()                               \
	SET_BIT(EXTI->FTSR1, PWR_EXTI_LINE_UVM)

/**
 * @brief  Disable the UVM Extended Interrupt Falling Trigger.
 * @retval None.
 */
#define __HAL_PWR_UVM_EXTI_DISABLE_FALLING_EDGE()                              \
	CLEAR_BIT(EXTI->FTSR1, PWR_EXTI_LINE_UVM)
 ...
 * @retval None
 */
#define __HAL_PWR_UVM_EXTI_GENERATE_SWIT()                                     \
	SET_BIT(EXTI->SWIER1, PWR_EXTI_LINE_UVM)

/**
 * @brief  Check whether the specified UVM EXTI flag is set or not.
 * @retval EXTI UVM Line Status.
 */
#define __HAL_PWR_UVM_EXTI_GET_FLAG()                                          \
	((EXTI->RPR1 | EXTI->FPR1) & PWR_EXTI_LINE_UVM)
 ...
 * @retval None.
 */
#define __HAL_PWR_IO2VM_EXTI_ENABLE_IT()                                       \
	SET_BIT(EXTI->IMR1, PWR_EXTI_LINE_IO2VM)

/**
 * @brief  Disable the IO2VM Extended Interrupt Line.
 * @retval None.
 */
#define __HAL_PWR_IO2VM_EXTI_DISABLE_IT()                                      \
	CLEAR_BIT(EXTI->IMR1, PWR_EXTI_LINE_IO2VM)

/**
 * @brief  Enable the IO2VM Event Line.
 * @retval None.
 */
#define __HAL_PWR_IO2VM_EXTI_ENABLE_EVENT()                                    \
	SET_BIT(EXTI->EMR1, PWR_EXTI_LINE_IO2VM)

/**
 * @brief  Disable the IO2VM Event Line.
 * @retval None.
 */
#define __HAL_PWR_IO2VM_EXTI_DISABLE_EVENT()                                   \
 ...
 * @retval None.
 */
#define __HAL_PWR_IO2VM_EXTI_ENABLE_RISING_EDGE()                              \
	SET_BIT(EXTI->RTSR1, PWR_EXTI_LINE_IO2VM)

/**
 * @brief  Disable the IO2VM Extended Interrupt Rising Trigger.
 * @retval None.
 */
#define __HAL_PWR_IO2VM_EXTI_DISABLE_RISING_EDGE()                             \
	CLEAR_BIT(EXTI->RTSR1, PWR_EXTI_LINE_IO2VM)

/**
 * @brief  Enable the IO2VM Extended Interrupt Falling Trigger.
 * @retval None.
 */
#define __HAL_PWR_IO2VM_EXTI_ENABLE_FALLING_EDGE()                             \
	SET_BIT(EXTI->FTSR1, PWR_EXTI_LINE_IO2VM)

/**
 * @brief  Disable the IO2VM Extended Interrupt Falling Trigger.
 * @retval None.
 */
#define __HAL_PWR_IO2VM_EXTI_DISABLE_FALLING_EDGE()                            \
	CLEAR_BIT(EXTI->FTSR1, PWR_EXTI_LINE_IO2VM)
 ...
 * @retval None
 */
#define __HAL_PWR_IO2VM_EXTI_GENERATE_SWIT()                                   \
	SET_BIT(EXTI->SWIER1, PWR_EXTI_LINE_IO2VM)

/**
 * @brief  Check whether the specified IO2VM EXTI flag is set or not.
 * @retval EXTI IO2VM Line Status.
 */
#define __HAL_PWR_IO2VM_EXTI_GET_FLAG()                                        \
	((EXTI->RPR1 | EXTI->FPR1) & PWR_EXTI_LINE_IO2VM)
 ...
 * @retval None.
 */
#define __HAL_PWR_AVM1_EXTI_DISABLE_IT()                                       \
	CLEAR_BIT(EXTI->IMR1, PWR_EXTI_LINE_AVM1)

/**
 * @brief  Enable the AVM1 Event Line.
 * @retval None.
 */
#define __HAL_PWR_AVM1_EXTI_ENABLE_EVENT()                                     \
	SET_BIT(EXTI->EMR1, PWR_EXTI_LINE_AVM1)

/**
 * @brief  Disable the AVM1 Event Line.
 * @retval None.
 */
#define __HAL_PWR_AVM1_EXTI_DISABLE_EVENT()                                    \
	CLEAR_BIT(EXTI->EMR1, PWR_EXTI_LINE_AVM1)

/**
 * @brief  Enable the AVM1 Extended Interrupt Rising Trigger.
 * @retval None.
 */
#define __HAL_PWR_AVM1_EXTI_ENABLE_RISING_EDGE()                               \
	SET_BIT(EXTI->RTSR1, PWR_EXTI_LINE_AVM1)

/**
 * @brief  Disable the AVM1 Extended Interrupt Rising Trigger.
 * @retval None.
 */
#define __HAL_PWR_AVM1_EXTI_DISABLE_RISING_EDGE()                              \
	CLEAR_BIT(EXTI->RTSR1, PWR_EXTI_LINE_AVM1)

/**
 * @brief  Enable the AVM1 Extended Interrupt Falling Trigger.
 * @retval None.
 */
#define __HAL_PWR_AVM1_EXTI_ENABLE_FALLING_EDGE()                              \
 ...
 * @retval None.
 */
#define __HAL_PWR_AVM1_EXTI_DISABLE_FALLING_EDGE()                             \
	CLEAR_BIT(EXTI->FTSR1, PWR_EXTI_LINE_AVM1)
 ...
 * @retval None
 */
#define __HAL_PWR_AVM1_EXTI_GENERATE_SWIT()                                    \
	SET_BIT(EXTI->SWIER1, PWR_EXTI_LINE_AVM1)

/**
 * @brief  Check whether the specified AVM1 EXTI flag is set or not.
 * @retval EXTI AVM1 Line Status.
 */
#define __HAL_PWR_AVM1_EXTI_GET_FLAG()                                         \
	((EXTI->RPR1 | EXTI->FPR1) & PWR_EXTI_LINE_AVM1)
 ...
 * @retval None.
 */
#define __HAL_PWR_AVM2_EXTI_DISABLE_IT()                                       \
	CLEAR_BIT(EXTI->IMR1, PWR_EXTI_LINE_AVM2)

/**
 * @brief  Enable the AVM2 Event Line.
 * @retval None.
 */
#define __HAL_PWR_AVM2_EXTI_ENABLE_EVENT()                                     \
	SET_BIT(EXTI->EMR1, PWR_EXTI_LINE_AVM2)

/**
 * @brief  Disable the AVM2 Event Line.
 * @retval None.
 */
#define __HAL_PWR_AVM2_EXTI_DISABLE_EVENT()                                    \
	CLEAR_BIT(EXTI->EMR1, PWR_EXTI_LINE_AVM2)

/**
 * @brief  Enable the AVM2 Extended Interrupt Rising Trigger.
 * @retval None.
 */
#define __HAL_PWR_AVM2_EXTI_ENABLE_RISING_EDGE()                               \
	SET_BIT(EXTI->RTSR1, PWR_EXTI_LINE_AVM2)

/**
 * @brief  Disable the AVM2 Extended Interrupt Rising Trigger.
 * @retval None.
 */
#define __HAL_PWR_AVM2_EXTI_DISABLE_RISING_EDGE()                              \
	CLEAR_BIT(EXTI->RTSR1, PWR_EXTI_LINE_AVM2)

/**
 * @brief  Enable the AVM2 Extended Interrupt Falling Trigger.
 * @retval None.
 */
#define __HAL_PWR_AVM2_EXTI_ENABLE_FALLING_EDGE()                              \
	SET_BIT(EXTI->FTSR1, PWR_EXTI_LINE_AVM2)

/**
 * @brief  Disable the AVM2 Extended Interrupt Falling Trigger.
 * @retval None.
 */
#define __HAL_PWR_AVM2_EXTI_DISABLE_FALLING_EDGE()                             \
	CLEAR_BIT(EXTI->FTSR1, PWR_EXTI_LINE_AVM2)
 ...
 * @retval None
 */
#define __HAL_PWR_AVM2_EXTI_GENERATE_SWIT()                                    \
	SET_BIT(EXTI->SWIER1, PWR_EXTI_LINE_AVM2)

/**
 * @brief  Check whether the specified AVM2 EXTI flag is set or not.
 * @retval EXTI AVM2 Line Status.
 */
#define __HAL_PWR_AVM2_EXTI_GET_FLAG()                                         \
 ...
 * voltage output scale 1. Provides a typical output voltage at 1.2 V. Used when
 * system clock frequency is up to 160 MHz.
 *                         @arg @ref PWR_REGULATOR_VOLTAGE_SCALE2 : Regulator
 * voltage output scale 2. Provides a typical output voltage at 1.1 V. Used when
 * system clock frequency is up to 100 MHz.
 *                         @arg @ref PWR_REGULATOR_VOLTAGE_SCALE3 : Regulator
 * voltage output scale 3. Provides a typical output voltage at 1.0 V. Used when
 * system clock frequency is up to 50 MHz.
 *                         @arg @ref PWR_REGULATOR_VOLTAGE_SCALE4 : Regulator
 * voltage output scale 4. Provides a typical output voltage at 0.9 V. Used when
...
#define PWR_ALL_RAM_RUN_MASK                                                   \
	(PWR_SRAM1_FULL_RUN | PWR_SRAM2_FULL_RUN | PWR_SRAM3_FULL_RUN |        \
	 PWR_SRAM4_FULL_RUN | PWR_SRAM5_FULL_RUN | PWR_SRAM6_FULL_RUN)
#elif defined(PWR_CR1_SRAM5PD)
#define PWR_ALL_RAM_RUN_MASK                                                   \
	(PWR_SRAM1_FULL_RUN | PWR_SRAM2_FULL_RUN | PWR_SRAM3_FULL_RUN |        \
	 PWR_SRAM4_FULL_RUN | PWR_SRAM5_FULL_RUN)
...
#else
#define PWR_ALL_RAM_RUN_MASK                                                   \
	(PWR_SRAM1_FULL_RUN | PWR_SRAM2_FULL_RUN | PWR_SRAM4_FULL_RUN)
#endif /* defined (PWR_CR1_SRAM5PD) */
/**
 * @}
 */
...
#define IS_PWR_PVM_TYPE(TYPE)                                                  \
	(((TYPE) == PWR_UVM) || ((TYPE) == PWR_IO2VM) ||                       \
	 ((TYPE) == PWR_AVM1) || ((TYPE) == PWR_AVM2))
...
#define IS_PWR_SUPPLY(PWR_SOURCE)                                              \
	(((PWR_SOURCE) == PWR_LDO_SUPPLY) || ((PWR_SOURCE) == PWR_SMPS_SUPPLY))
...
#define IS_PWR_GPIO_PORT(GPIO_PORT)                                            \
	(((GPIO_PORT) == PWR_GPIO_A) || ((GPIO_PORT) == PWR_GPIO_B) ||         \
	 ((GPIO_PORT) == PWR_GPIO_C) || ((GPIO_PORT) == PWR_GPIO_D) ||         \
	 ((GPIO_PORT) == PWR_GPIO_E) || ((GPIO_PORT) == PWR_GPIO_F) ||         \
	 ((GPIO_PORT) == PWR_GPIO_G) || ((GPIO_PORT) == PWR_GPIO_H) ||         \
	 ((GPIO_PORT) == PWR_GPIO_I) || ((GPIO_PORT) == PWR_GPIO_J))
...
#define IS_PWR_GPIO_PORT(GPIO_PORT)                                            \
	(((GPIO_PORT) == PWR_GPIO_A) || ((GPIO_PORT) == PWR_GPIO_B) ||         \
	 ((GPIO_PORT) == PWR_GPIO_C) || ((GPIO_PORT) == PWR_GPIO_D) ||         \
	 ((GPIO_PORT) == PWR_GPIO_E) || ((GPIO_PORT) == PWR_GPIO_G) ||         \
...
HAL_StatusTypeDef HAL_PWREx_EnableGPIOPullUp(uint32_t GPIO_Port,
					     uint32_t GPIO_Pin);
HAL_StatusTypeDef HAL_PWREx_DisableGPIOPullUp(uint32_t GPIO_Port,
					      uint32_t GPIO_Pin);
HAL_StatusTypeDef HAL_PWREx_EnableGPIOPullDown(uint32_t GPIO_Port,
					       uint32_t GPIO_Pin);
HAL_StatusTypeDef HAL_PWREx_DisableGPIOPullDown(uint32_t GPIO_Port,
						uint32_t GPIO_Pin);
/**
 * @}
 */
