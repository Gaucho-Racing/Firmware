...
#define PWR_PVDLEVEL_1                                                         \
	(PWR_SVMCR_PVDLS_0) /*!< PVD threshold around 2.2 V       */
#define PWR_PVDLEVEL_2                                                         \
	(PWR_SVMCR_PVDLS_1) /*!< PVD threshold around 2.4 V       */
#define PWR_PVDLEVEL_3                                                         \
	(PWR_SVMCR_PVDLS_0 |                                                   \
	 PWR_SVMCR_PVDLS_1) /*!< PVD threshold around 2.5 V       */
#define PWR_PVDLEVEL_4                                                         \
	(PWR_SVMCR_PVDLS_2) /*!< PVD threshold around 2.6 V       */
#define PWR_PVDLEVEL_5                                                         \
	(PWR_SVMCR_PVDLS_0 |                                                   \
	 PWR_SVMCR_PVDLS_2) /*!< PVD threshold around 2.8 V       */
#define PWR_PVDLEVEL_6                                                         \
	(PWR_SVMCR_PVDLS_1 |                                                   \
	 PWR_SVMCR_PVDLS_2) /*!< PVD threshold around 2.9 V       */
...
#define PWR_FLAG_TEMPL                                                         \
	(0x0DU) /*!< Temperature level flag (versus low threshold) */
...
#define PWR_WAKEUP_PIN1_HIGH_0                                                 \
	(PWR_WUCR1_WUPEN1 |                                                    \
	 PWR_WAKEUP1_SOURCE_SELECTION_0) /*!< PA0  : Wakeup pin 1 (high        \
					    polarity) */
#define PWR_WAKEUP_PIN1_HIGH_1                                                 \
	(PWR_WUCR1_WUPEN1 |                                                    \
	 PWR_WAKEUP1_SOURCE_SELECTION_1) /*!< PB2  : Wakeup pin 1 (high        \
					    polarity) */
#define PWR_WAKEUP_PIN1_HIGH_2                                                 \
	(PWR_WUCR1_WUPEN1 |                                                    \
	 PWR_WAKEUP1_SOURCE_SELECTION_2) /*!< PE4  : Wakeup pin 1 (high        \
					    polarity) */

#define PWR_WAKEUP_PIN2_HIGH_0                                                 \
	(PWR_WUCR1_WUPEN2 |                                                    \
	 PWR_WAKEUP2_SOURCE_SELECTION_0) /*!< PA4  : Wakeup pin 2 (high        \
					    polarity) */
#define PWR_WAKEUP_PIN2_HIGH_1                                                 \
	(PWR_WUCR1_WUPEN2 |                                                    \
	 PWR_WAKEUP2_SOURCE_SELECTION_1) /*!< PC13 : Wakeup pin 2 (high        \
					    polarity) */
#define PWR_WAKEUP_PIN2_HIGH_2                                                 \
	(PWR_WUCR1_WUPEN2 |                                                    \
	 PWR_WAKEUP2_SOURCE_SELECTION_2) /*!< PE5  : Wakeup pin 2 (high        \
					    polarity) */

#define PWR_WAKEUP_PIN3_HIGH_0                                                 \
	(PWR_WUCR1_WUPEN3 |                                                    \
	 PWR_WAKEUP3_SOURCE_SELECTION_0) /*!< PE6  : Wakeup pin 3 (high        \
					    polarity) */
#define PWR_WAKEUP_PIN3_HIGH_1                                                 \
	(PWR_WUCR1_WUPEN3 |                                                    \
	 PWR_WAKEUP3_SOURCE_SELECTION_1) /*!< PA1  : Wakeup pin 3 (high        \
					    polarity) */
#define PWR_WAKEUP_PIN3_HIGH_2                                                 \
	(PWR_WUCR1_WUPEN3 |                                                    \
	 PWR_WAKEUP3_SOURCE_SELECTION_2) /*!< PB6  : Wakeup pin 3 (high        \
					    polarity) */

#define PWR_WAKEUP_PIN4_HIGH_0                                                 \
	(PWR_WUCR1_WUPEN4 |                                                    \
	 PWR_WAKEUP4_SOURCE_SELECTION_0) /*!< PA2  : Wakeup pin 4 (high        \
					    polarity) */
#define PWR_WAKEUP_PIN4_HIGH_1                                                 \
	(PWR_WUCR1_WUPEN4 |                                                    \
	 PWR_WAKEUP4_SOURCE_SELECTION_1) /*!< PB1  : Wakeup pin 4 (high        \
					    polarity) */
#define PWR_WAKEUP_PIN4_HIGH_2                                                 \
	(PWR_WUCR1_WUPEN4 |                                                    \
	 PWR_WAKEUP4_SOURCE_SELECTION_2) /*!< PB7  : Wakeup pin 4 (high        \
					    polarity) */

#define PWR_WAKEUP_PIN5_HIGH_0                                                 \
	(PWR_WUCR1_WUPEN5 |                                                    \
	 PWR_WAKEUP5_SOURCE_SELECTION_0) /*!< PC5  : Wakeup pin 5 (high        \
					    polarity) */
#define PWR_WAKEUP_PIN5_HIGH_1                                                 \
	(PWR_WUCR1_WUPEN5 |                                                    \
	 PWR_WAKEUP5_SOURCE_SELECTION_1) /*!< PA3  : Wakeup pin 5 (high        \
					    polarity) */
#define PWR_WAKEUP_PIN5_HIGH_2                                                 \
	(PWR_WUCR1_WUPEN5 |                                                    \
	 PWR_WAKEUP5_SOURCE_SELECTION_2) /*!< PB8  : Wakeup pin 5 (high        \
					    polarity) */

#define PWR_WAKEUP_PIN6_HIGH_0                                                 \
	(PWR_WUCR1_WUPEN6 |                                                    \
	 PWR_WAKEUP6_SOURCE_SELECTION_0) /*!< PB5  : Wakeup pin 6 (high        \
					    polarity) */
#define PWR_WAKEUP_PIN6_HIGH_1                                                 \
	(PWR_WUCR1_WUPEN6 |                                                    \
	 PWR_WAKEUP6_SOURCE_SELECTION_1) /*!< PA5  : Wakeup pin 6 (high        \
					    polarity) */
#define PWR_WAKEUP_PIN6_HIGH_2                                                 \
	(PWR_WUCR1_WUPEN6 |                                                    \
	 PWR_WAKEUP6_SOURCE_SELECTION_2) /*!< PE7  : Wakeup pin 6 (high        \
					    polarity) */
#define PWR_WAKEUP_PIN6_HIGH_3                                                 \
	(PWR_WUCR1_WUPEN6 |                                                    \
	 PWR_WAKEUP6_SOURCE_SELECTION_3) /*!< RTC  : Wakeup pin 6 (high        \
					    polarity) */

#define PWR_WAKEUP_PIN7_HIGH_0                                                 \
	(PWR_WUCR1_WUPEN7 |                                                    \
	 PWR_WAKEUP7_SOURCE_SELECTION_0) /*!< PB15 : Wakeup pin 7 (high        \
					    polarity) */
#define PWR_WAKEUP_PIN7_HIGH_1                                                 \
	(PWR_WUCR1_WUPEN7 |                                                    \
	 PWR_WAKEUP7_SOURCE_SELECTION_1) /*!< PA6  : Wakeup pin 7 (high        \
					    polarity) */
#define PWR_WAKEUP_PIN7_HIGH_2                                                 \
	(PWR_WUCR1_WUPEN7 |                                                    \
	 PWR_WAKEUP7_SOURCE_SELECTION_2) /*!< PE8  : Wakeup pin 7 (high        \
					    polarity) */
#define PWR_WAKEUP_PIN7_HIGH_3                                                 \
	(PWR_WUCR1_WUPEN7 |                                                    \
	 PWR_WAKEUP7_SOURCE_SELECTION_3) /*!< RTC  : Wakeup pin 7 (high        \
					    polarity) */

#define PWR_WAKEUP_PIN8_HIGH_0                                                 \
	(PWR_WUCR1_WUPEN8 |                                                    \
	 PWR_WAKEUP8_SOURCE_SELECTION_0) /*!< PF2  : Wakeup pin 8 (high        \
					    polarity) */
#define PWR_WAKEUP_PIN8_HIGH_1                                                 \
	(PWR_WUCR1_WUPEN8 |                                                    \
	 PWR_WAKEUP8_SOURCE_SELECTION_1) /*!< PA7  : Wakeup pin 8 (high        \
					    polarity) */
#define PWR_WAKEUP_PIN8_HIGH_2                                                 \
	(PWR_WUCR1_WUPEN8 |                                                    \
	 PWR_WAKEUP8_SOURCE_SELECTION_2) /*!< PB10 : Wakeup pin 8 (high        \
					    polarity) */
#define PWR_WAKEUP_PIN8_HIGH_3                                                 \
	(PWR_WUCR1_WUPEN8 |                                                    \
	 PWR_WAKEUP8_SOURCE_SELECTION_3) /*!< RTC  : Wakeup pin 8 (high        \
					    polarity) */
/**
 * @}
 */
...
#define PWR_WAKEUP_PIN1_LOW_0                                                  \
	(PWR_WUCR1_WUPEN1 | PWR_WAKEUP1_POLARITY_LOW |                         \
	 PWR_WAKEUP1_SOURCE_SELECTION_0) /*!< PA0  : Wakeup pin 1 (low         \
					    polarity) */
#define PWR_WAKEUP_PIN1_LOW_1                                                  \
	(PWR_WUCR1_WUPEN1 | PWR_WAKEUP1_POLARITY_LOW |                         \
	 PWR_WAKEUP1_SOURCE_SELECTION_1) /*!< PB2  : Wakeup pin 1 (low         \
					    polarity) */
#define PWR_WAKEUP_PIN1_LOW_2                                                  \
	(PWR_WUCR1_WUPEN1 | PWR_WAKEUP1_POLARITY_LOW |                         \
	 PWR_WAKEUP1_SOURCE_SELECTION_2) /*!< PE4  : Wakeup pin 1 (low         \
					    polarity) */

#define PWR_WAKEUP_PIN2_LOW_0                                                  \
	(PWR_WUCR1_WUPEN2 | PWR_WAKEUP2_POLARITY_LOW |                         \
	 PWR_WAKEUP2_SOURCE_SELECTION_0) /*!< PA4  : Wakeup pin 2 (low         \
					    polarity) */
#define PWR_WAKEUP_PIN2_LOW_1                                                  \
	(PWR_WUCR1_WUPEN2 | PWR_WAKEUP2_POLARITY_LOW |                         \
	 PWR_WAKEUP2_SOURCE_SELECTION_1) /*!< PC13 : Wakeup pin 2 (low         \
					    polarity) */
#define PWR_WAKEUP_PIN2_LOW_2                                                  \
	(PWR_WUCR1_WUPEN2 | PWR_WAKEUP2_POLARITY_LOW |                         \
	 PWR_WAKEUP2_SOURCE_SELECTION_2) /*!< PE5  : Wakeup pin 2 (low         \
					    polarity) */

#define PWR_WAKEUP_PIN3_LOW_0                                                  \
	(PWR_WUCR1_WUPEN3 | PWR_WAKEUP3_POLARITY_LOW |                         \
	 PWR_WAKEUP3_SOURCE_SELECTION_0) /*!< PE6  : Wakeup pin 3 (low         \
					    polarity) */
#define PWR_WAKEUP_PIN3_LOW_1                                                  \
	(PWR_WUCR1_WUPEN3 | PWR_WAKEUP3_POLARITY_LOW |                         \
	 PWR_WAKEUP3_SOURCE_SELECTION_1) /*!< PA1  : Wakeup pin 3 (low         \
					    polarity) */
#define PWR_WAKEUP_PIN3_LOW_2                                                  \
	(PWR_WUCR1_WUPEN3 | PWR_WAKEUP3_POLARITY_LOW |                         \
	 PWR_WAKEUP3_SOURCE_SELECTION_2) /*!< PB6  : Wakeup pin 3 (low         \
					    polarity) */

#define PWR_WAKEUP_PIN4_LOW_0                                                  \
	(PWR_WUCR1_WUPEN4 | PWR_WAKEUP4_POLARITY_LOW |                         \
	 PWR_WAKEUP4_SOURCE_SELECTION_0) /*!< PA2  : Wakeup pin 4 (low         \
					    polarity) */
#define PWR_WAKEUP_PIN4_LOW_1                                                  \
	(PWR_WUCR1_WUPEN4 | PWR_WAKEUP4_POLARITY_LOW |                         \
	 PWR_WAKEUP4_SOURCE_SELECTION_1) /*!< PB1  : Wakeup pin 4 (low         \
					    polarity) */
#define PWR_WAKEUP_PIN4_LOW_2                                                  \
	(PWR_WUCR1_WUPEN4 | PWR_WAKEUP4_POLARITY_LOW |                         \
	 PWR_WAKEUP4_SOURCE_SELECTION_2) /*!< PB7  : Wakeup pin 4 (low         \
					    polarity) */

#define PWR_WAKEUP_PIN5_LOW_0                                                  \
	(PWR_WUCR1_WUPEN5 | PWR_WAKEUP5_POLARITY_LOW |                         \
	 PWR_WAKEUP5_SOURCE_SELECTION_0) /*!< PC5  : Wakeup pin 5 (low         \
					    polarity) */
#define PWR_WAKEUP_PIN5_LOW_1                                                  \
	(PWR_WUCR1_WUPEN5 | PWR_WAKEUP5_POLARITY_LOW |                         \
	 PWR_WAKEUP5_SOURCE_SELECTION_1) /*!< PA3  : Wakeup pin 5 (low         \
					    polarity) */
#define PWR_WAKEUP_PIN5_LOW_2                                                  \
	(PWR_WUCR1_WUPEN5 | PWR_WAKEUP5_POLARITY_LOW |                         \
	 PWR_WAKEUP5_SOURCE_SELECTION_2) /*!< PB8  : Wakeup pin 5 (low         \
					    polarity) */

#define PWR_WAKEUP_PIN6_LOW_0                                                  \
	(PWR_WUCR1_WUPEN6 | PWR_WAKEUP6_POLARITY_LOW |                         \
	 PWR_WAKEUP6_SOURCE_SELECTION_0) /*!< PB5  : Wakeup pin 6 (low         \
					    polarity) */
#define PWR_WAKEUP_PIN6_LOW_1                                                  \
	(PWR_WUCR1_WUPEN6 | PWR_WAKEUP6_POLARITY_LOW |                         \
	 PWR_WAKEUP6_SOURCE_SELECTION_1) /*!< PA5  : Wakeup pin 6 (low         \
					    polarity) */
#define PWR_WAKEUP_PIN6_LOW_2                                                  \
	(PWR_WUCR1_WUPEN6 | PWR_WAKEUP6_POLARITY_LOW |                         \
	 PWR_WAKEUP6_SOURCE_SELECTION_2) /*!< PE7  : Wakeup pin 6 (low         \
					    polarity) */
#define PWR_WAKEUP_PIN6_LOW_3                                                  \
	(PWR_WUCR1_WUPEN6 | PWR_WAKEUP6_POLARITY_LOW |                         \
	 PWR_WAKEUP6_SOURCE_SELECTION_3) /*!< RTC  : Wakeup pin 6 (low         \
					    polarity) */

#define PWR_WAKEUP_PIN7_LOW_0                                                  \
	(PWR_WUCR1_WUPEN7 | PWR_WAKEUP7_POLARITY_LOW |                         \
	 PWR_WAKEUP7_SOURCE_SELECTION_0) /*!< PB15 : Wakeup pin 7 (low         \
					    polarity) */
#define PWR_WAKEUP_PIN7_LOW_1                                                  \
	(PWR_WUCR1_WUPEN7 | PWR_WAKEUP7_POLARITY_LOW |                         \
	 PWR_WAKEUP7_SOURCE_SELECTION_1) /*!< PA6  : Wakeup pin 7 (low         \
					    polarity) */
#define PWR_WAKEUP_PIN7_LOW_2                                                  \
	(PWR_WUCR1_WUPEN7 | PWR_WAKEUP7_POLARITY_LOW |                         \
	 PWR_WAKEUP7_SOURCE_SELECTION_2) /*!< PE8  : Wakeup pin 7 (low         \
					    polarity) */
#define PWR_WAKEUP_PIN7_LOW_3                                                  \
	(PWR_WUCR1_WUPEN7 | PWR_WAKEUP7_POLARITY_LOW |                         \
	 PWR_WAKEUP7_SOURCE_SELECTION_3) /*!< RTC  : Wakeup pin 7 (low         \
					    polarity) */

#define PWR_WAKEUP_PIN8_LOW_0                                                  \
	(PWR_WUCR1_WUPEN8 | PWR_WAKEUP8_POLARITY_LOW |                         \
	 PWR_WAKEUP8_SOURCE_SELECTION_0) /*!< PF2  : Wakeup pin 8 (low         \
					    polarity) */
#define PWR_WAKEUP_PIN8_LOW_1                                                  \
	(PWR_WUCR1_WUPEN8 | PWR_WAKEUP8_POLARITY_LOW |                         \
	 PWR_WAKEUP8_SOURCE_SELECTION_1) /*!< PA7  : Wakeup pin 8 (low         \
					    polarity) */
#define PWR_WAKEUP_PIN8_LOW_2                                                  \
	(PWR_WUCR1_WUPEN8 | PWR_WAKEUP8_POLARITY_LOW |                         \
	 PWR_WAKEUP8_SOURCE_SELECTION_2) /*!< PB10 : Wakeup pin 8 (low         \
					    polarity) */
#define PWR_WAKEUP_PIN8_LOW_3                                                  \
	(PWR_WUCR1_WUPEN8 | PWR_WAKEUP8_POLARITY_LOW |                         \
	 PWR_WAKEUP8_SOURCE_SELECTION_3) /*!< RTC  : Wakeup pin 8 (low         \
					    polarity) */
/**
 * @}
 */

/** @defgroup PWR_WakeUp_Pins PWR Wake Up Pins (Default polarity and default pin
 * selection)
 * @{
 */
#define PWR_WAKEUP_PIN1                                                        \
	(PWR_WUCR1_WUPEN1) /*!< PA0  : Wakeup pin 1 (high polarity) */
#define PWR_WAKEUP_PIN2                                                        \
	(PWR_WUCR1_WUPEN2) /*!< PA4  : Wakeup pin 2 (high polarity) */
#define PWR_WAKEUP_PIN3                                                        \
	(PWR_WUCR1_WUPEN3) /*!< PE6  : Wakeup pin 3 (high polarity) */
#define PWR_WAKEUP_PIN4                                                        \
	(PWR_WUCR1_WUPEN4) /*!< PA2  : Wakeup pin 4 (high polarity) */
#define PWR_WAKEUP_PIN5                                                        \
	(PWR_WUCR1_WUPEN5) /*!< PC5  : Wakeup pin 5 (high polarity) */
#define PWR_WAKEUP_PIN6                                                        \
	(PWR_WUCR1_WUPEN6) /*!< PB5  : Wakeup pin 6 (high polarity) */
#define PWR_WAKEUP_PIN7                                                        \
	(PWR_WUCR1_WUPEN7) /*!< PB15 : Wakeup pin 7 (high polarity) */
#define PWR_WAKEUP_PIN8                                                        \
	(PWR_WUCR1_WUPEN8) /*!< PF2  : Wakeup pin 8 (high polarity) */
/**
 * @}
 */
 ...
 *                    @arg @ref PWR_FLAG_VOSRDY      : Voltage scaling ready
 * flag. Indicates that the Vcore level at or above VOS selected level.
 *                    @arg @ref PWR_FLAG_BOOSTRDY    : EPOD booster ready flag.
 *                                                     Indicates that EPOD
 * booster ready, frequency could be higher than 50 MHz.
 *                    @arg @ref PWR_FLAG_USBBOOSTRDY : USB EPOD booster ready
 * flag. Indicates that USB EPOD booster ready, frequency could be higher than
 * 50 MHz. This flag is available only for STM32U59xxx and STM32U5Axxx devices.
 ...
 *                    @arg @ref PWR_FLAG_VDDA2RDY    : VDDA2 ready flag
 * (versus 1.8 V threshold). Indicates that VDDA is equal or above the threshold
 *                                                     of the VDDA voltage
 * monitor 2 (around 1.8 V).
 *                    @arg @ref PWR_FLAG_VDDA1RDY    : VDDA1 ready flag
 * (versus 1.6 V threshold). Indicates that VDDA is equal or above the threshold
 *                                                     of the VDDA voltage
 * monitor 1 (around 1.6 V).
 ...
 *                    @arg @ref PWR_FLAG_ACTVOSRDY   : Currently applied VOS
 * ready flag. Indicates that Vcore is equal to the current voltage scaling
 * provided by ACTVOS.
 *                    @arg @ref PWR_FLAG_PVDO VDD    : Voltage detector output
 ...
 * threshold.
 *                    @arg @ref PWR_FLAG_VBATH       : Backup domain voltage
 * level flag (versus high threshold). Indicates the backup domain voltage level
 * is equal or above high threshold.
...
#define __HAL_PWR_GET_FLAG(__FLAG__)                                           \
	(((__FLAG__) == PWR_FLAG_VOSRDY)                                       \
	 ...
	 : ((__FLAG__) == PWR_FLAG_USBBOOSTRDY)                                \
	     ? (READ_BIT(PWR->VOSR, PWR_VOSR_USBBOOSTRDY) ==                   \
	 ...
	 : ((__FLAG__) == PWR_FLAG_VDDA2RDY)                                   \
	     ? (READ_BIT(PWR->SVMSR, PWR_SVMSR_VDDA2RDY) ==                    \
		PWR_SVMSR_VDDA2RDY)                                            \
	 : ((__FLAG__) == PWR_FLAG_VDDA1RDY)                                   \
	     ? (READ_BIT(PWR->SVMSR, PWR_SVMSR_VDDA1RDY) ==                    \
		PWR_SVMSR_VDDA1RDY)                                            \
	 : ((__FLAG__) == PWR_FLAG_VDDIO2RDY)                                  \
	     ? (READ_BIT(PWR->SVMSR, PWR_SVMSR_VDDIO2RDY) ==                   \
		PWR_SVMSR_VDDIO2RDY)                                           \
	 : ((__FLAG__) == PWR_FLAG_VDDUSBRDY)                                  \
	     ? (READ_BIT(PWR->SVMSR, PWR_SVMSR_VDDUSBRDY) ==                   \
		PWR_SVMSR_VDDUSBRDY)                                           \
	 : ((__FLAG__) == PWR_FLAG_ACTVOSRDY)                                  \
	     ? (READ_BIT(PWR->SVMSR, PWR_SVMSR_ACTVOSRDY) ==                   \
		PWR_SVMSR_ACTVOSRDY)                                           \
	 : ((__FLAG__) == PWR_FLAG_PVDO)                                       \
	     ? (READ_BIT(PWR->SVMSR, PWR_SVMSR_PVDO) == PWR_SVMSR_PVDO)        \
	 : ((__FLAG__) == PWR_FLAG_REGS)                                       \
	     ? (READ_BIT(PWR->SVMSR, PWR_SVMSR_REGS) == PWR_SVMSR_REGS)        \
...
#define __HAL_PWR_PVD_EXTI_GET_FLAG()                                          \
	((EXTI->RPR1 | EXTI->FPR1) & PWR_EXTI_LINE_PVD)
...
#define PWR_WAKEUP1_SOURCE_SELECTION_1                                         \
	(PWR_WUCR3_WUSEL1_0                                                    \
	 << PWR_WUP_SELECT_SIGNAL_SHIFT) /*!< Internal constant used to        \
...
#define PWR_WAKEUP1_POLARITY_LOW                                               \
	(                                                                      \
	    PWR_WUCR2_WUPP1                                                    \
	    << PWR_WUP_POLARITY_SHIFT) /*!< Internal constant used to retrieve \
...
#define IS_PWR_WAKEUP_PIN(PIN)                                                 \
	(((PIN) == PWR_WAKEUP_PIN1_HIGH_0) ||                                  \
	 ...
	 ((PIN) == PWR_WAKEUP_PIN8_LOW_3) || ((PIN) == PWR_WAKEUP_PIN1) ||     \
	 ((PIN) == PWR_WAKEUP_PIN2) || ((PIN) == PWR_WAKEUP_PIN3) ||           \
...
#define IS_PWR_ATTRIBUTES(ATTRIBUTES)                                          \
	((((~(((ATTRIBUTES) & 0xF0U) >> 4U)) & ((ATTRIBUTES) & 0x0FU)) ==      \
	  0U) &&                                                               \
