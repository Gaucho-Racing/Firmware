...
typedef struct {
	uint32_t
	    FifoThreshold; /*!< This is the threshold used by the Peripheral to
	...
	uint32_t SampleShifting; /*!< It allows to delay to 1/2 cycle the data
				    ...
				    be a value of @ref OSPI_SampleShifting */
	uint32_t DelayHoldQuarterCycle; /*!< It allows to hold to 1/4 cycle the
					   data. This parameter can be a value
					   of @ref OSPI_DelayHoldQuarterCycle */
	uint32_t
	...
	uint32_t MaxTran; /*!< It enables the communication regulation feature.
			     ...
			     when the other OctoSPI request the access to the
			     bus. This parameter can be a value between 0 and
			     255 */
...
typedef struct {
	uint32_t
	    OperationType; /*!< It indicates if the configuration applies to the
			      ...
			      of @ref OSPI_OperationType */
	uint32_t FlashId;  /*!< It indicates which external device is selected
			      for this command (it  applies only if Dualquad is
			      disabled in the initialization structure).  This
			      parameter can be a value of @ref OSPI_FlashID */
	...
	uint32_t DataMode;		/*!< It indicates the mode of the data.
					     This parameter can be a value of @ref
					   OSPI_DataMode */
	uint32_t NbData; /*!< It indicates the number of data transferred with
...
typedef struct {
	uint32_t
	    RWRecoveryTime;  /*!< It indicates the number of cycles for the
				device read write recovery time.  This parameter
				can be a value between 0 and 255 */
	uint32_t AccessTime; /*!< It indicates the number of cycles for the
	...
	uint32_t WriteZeroLatency; /*!< It enables or not the latency for the
				      ...
				      value of @ref OSPI_WriteZeroLatency */
 ...
 */
typedef struct {
	uint32_t Match; /*!< Specifies the value to be compared with the masked
			   status register to get a match. This parameter can be
			   any value between 0 and 0xFFFFFFFF */
 ...
 */
typedef struct {
	uint32_t ClkPort; /*!< It indicates which port of the OSPI IO Manager is
			     used for the CLK pins. This parameter can be a
			     value between 1 and 8 */
	uint32_t DQSPort; /*!< It indicates which port of the OSPI IO Manager is
			     used for the DQS pin. This parameter can be a value
			     between 0 and 8, 0 means that signal not used */
	uint32_t NCSPort; /*!< It indicates which port of the OSPI IO Manager is
			     used for the NCS pin. This parameter can be a value
			     between 1 and 8 */
	uint32_t IOLowPort;  /*!< It indicates which port of the OSPI IO Manager
				is used for the IO[3:0] pins.  This parameter can
				be a value of @ref OSPIM_IOPort */
	uint32_t IOHighPort; /*!< It indicates which port of the OSPI IO Manager
	...
	uint32_t Req2AckTime; /*!< It indicates the minimum switching duration
				 ...
				 signals are multiplexed in the OSPI IO Manager
				 with the other OSPI. This parameter can be a
...
typedef enum {
	...
	HAL_OSPI_FIFO_THRESHOLD_CB_ID =
	    0x02U, /*!< OSPI FIFO Threshold Callback ID   */
	HAL_OSPI_CMD_CPLT_CB_ID =
	    0x03U, /*!< OSPI Command Complete Callback ID */
	...
	HAL_OSPI_RX_HALF_CPLT_CB_ID =
	    0x06U, /*!< OSPI Rx Half Complete Callback ID */
	HAL_OSPI_TX_HALF_CPLT_CB_ID =
	    0x07U, /*!< OSPI Tx Half Complete Callback ID */
	HAL_OSPI_STATUS_MATCH_CB_ID =
	    0x08U, /*!< OSPI Status Match Callback ID     */
...
#define HAL_OSPI_DUALQUAD_ENABLE                                               \
	((uint32_t)OCTOSPI_CR_DMM) /*!< Dual-Quad mode enabled  */
/**
 * @}
 */
...
#define HAL_OSPI_FREERUNCLK_ENABLE                                             \
	((uint32_t)                                                            \
	     OCTOSPI_DCR1_FRCK) /*!< CLK is free running (always provided) */
/**
 * @}
 */
...
#define HAL_OSPI_CLOCK_MODE_3                                                  \
	((uint32_t)                                                            \
	     OCTOSPI_DCR1_CKMODE) /*!< CLK must stay high while nCS is high */
/**
 * @}
 */
...
#define HAL_OSPI_WRAP_NOT_SUPPORTED                                            \
	((uint32_t)0x00000000U) /*!< wrapped reads are not supported by the    \
				   memory   */
#define HAL_OSPI_WRAP_16_BYTES                                                 \
	((uint32_t)OCTOSPI_DCR2_WRAPSIZE_1) /*!< external memory supports wrap \
					       size of 16 bytes  */
#define HAL_OSPI_WRAP_32_BYTES                                                 \
	((uint32_t)(OCTOSPI_DCR2_WRAPSIZE_0 |                                  \
		    OCTOSPI_DCR2_WRAPSIZE_1)) /*!< external memory supports    \
						 wrap size of 32 bytes  */
#define HAL_OSPI_WRAP_64_BYTES                                                 \
	((uint32_t)OCTOSPI_DCR2_WRAPSIZE_2) /*!< external memory supports wrap \
					       size of 64 bytes  */
#define HAL_OSPI_WRAP_128_BYTES                                                \
	((uint32_t)(OCTOSPI_DCR2_WRAPSIZE_0 |                                  \
		    OCTOSPI_DCR2_WRAPSIZE_2)) /*!< external memory supports    \
						 wrap size of 128 bytes */
/**
 * @}
 */
...
#define HAL_OSPI_INSTRUCTION_4_LINES                                           \
	((uint32_t)(OCTOSPI_CCR_IMODE_0 |                                      \
		    OCTOSPI_CCR_IMODE_1)) /*!< Instruction on four lines    */
...
#define HAL_OSPI_INSTRUCTION_DTR_ENABLE                                        \
	((uint32_t)                                                            \
	     OCTOSPI_CCR_IDTR) /*!< DTR mode enabled for instruction phase  */
/**
 * @}
 */
...
#define HAL_OSPI_ADDRESS_4_LINES                                               \
	((uint32_t)(OCTOSPI_CCR_ADMODE_0 |                                     \
		    OCTOSPI_CCR_ADMODE_1)) /*!< Address on four lines    */
...
#define HAL_OSPI_ADDRESS_DTR_ENABLE                                            \
	((uint32_t)                                                            \
	     OCTOSPI_CCR_ADDTR) /*!< DTR mode enabled for address phase  */
/**
 * @}
 */
...
#define HAL_OSPI_ALTERNATE_BYTES_1_LINE                                        \
	((uint32_t)                                                            \
	     OCTOSPI_CCR_ABMODE_0) /*!< Alternate bytes on a single line */
...
#define HAL_OSPI_ALTERNATE_BYTES_8_LINES                                       \
	((uint32_t)                                                            \
	     OCTOSPI_CCR_ABMODE_2) /*!< Alternate bytes on eight lines   */
/**
 * @}
 */
...
#define HAL_OSPI_NO_LATENCY_ON_WRITE                                           \
	((uint32_t)OCTOSPI_HLCR_WZL) /*!< No latency on write accesses */
/**
 * @}
 */
...
#define HAL_OSPI_MATCH_MODE_AND                                                \
	((uint32_t)0x00000000U) /*!< AND match mode between unmasked bits */
#define HAL_OSPI_MATCH_MODE_OR                                                 \
	((uint32_t)OCTOSPI_CR_PMM) /*!< OR match mode between unmasked bits */
/**
 * @}
 */
...
#define IS_OSPI_CLOCK_MODE(MODE)                                               \
	(((MODE) == HAL_OSPI_CLOCK_MODE_0) || ((MODE) == HAL_OSPI_CLOCK_MODE_3))
...
#define IS_OSPI_DATA_MODE(MODE)                                                \
	(((MODE) == HAL_OSPI_DATA_NONE) || ((MODE) == HAL_OSPI_DATA_1_LINE) || \
...
#define IS_OSPI_DQS_MODE(MODE)                                                 \
	(((MODE) == HAL_OSPI_DQS_DISABLE) || ((MODE) == HAL_OSPI_DQS_ENABLE))
