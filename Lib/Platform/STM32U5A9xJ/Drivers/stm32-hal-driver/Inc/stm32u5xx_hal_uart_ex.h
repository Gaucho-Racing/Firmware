...
typedef struct {
	...
	uint32_t
	    TriggerSelection; /*!< Specifies which trigger will activate the
...
/** @defgroup UARTEx_Autonomous_Trigger_Polarity UARTEx Autonomous Trigger
 * Polarity
 * @brief    UART Trigger polarity edge selection
 * @{
 */
#define UART_TRIG_POLARITY_RISING                                              \
	0x00000000U /*!< UART triggered on rising edge  */
#define UART_TRIG_POLARITY_FALLING                                             \
	USART_AUTOCR_TRIGPOL /*!< UART triggered on falling edge */
/**
 * @}
 */
 ...
 * @{
 */
#define UART_IDLE_FRAME_ENABLE                                                 \
	0x00000000U /*!< IDLE Frame sent after enabling the transmitter */
#define UART_IDLE_FRAME_DISABLE                                                \
...
/** @defgroup UARTEx_Autonomous_Trigger_selection UARTEx Autonomous trigger
 * selection
 * @brief    UART Autonomous Trigger selection
 * @{
 */
#define UART_GPDMA1_CH0_TCF_TRG                                                \
	0U /*!< UART GPDMA1 channel0 Internal Trigger  */
#define UART_GPDMA1_CH1_TCF_TRG                                                \
	1U /*!< UART GPDMA1 channel1 Internal Trigger  */
#define UART_GPDMA1_CH2_TCF_TRG                                                \
	2U /*!< UART GPDMA1 channel2 Internal Trigger  */
#define UART_GPDMA1_CH3_TCF_TRG                                                \
	3U		       /*!< UART GPDMA1 channel3 Internal Trigger  */
...
/** @defgroup UARTEx_Low_Power_Autonomous_Trigger_selection UARTEx Low Power
 ...
 * **********************************************/
HAL_StatusTypeDef HAL_UARTEx_SetConfigAutonomousMode(
    UART_HandleTypeDef *huart, const UART_AutonomousModeConfTypeDef *sConfig);
HAL_StatusTypeDef
HAL_UARTEx_GetConfigAutonomousMode(const UART_HandleTypeDef *huart,
				   UART_AutonomousModeConfTypeDef *sConfig);
HAL_StatusTypeDef
HAL_UARTEx_ClearConfigAutonomousMode(UART_HandleTypeDef *huart);
...
#define IS_UART_TRIGGER_POLARITY(__POLARITY__)                                 \
	(((__POLARITY__) == UART_TRIG_POLARITY_RISING) ||                      \
...
#define IS_UART_IDLE_FRAME_TRANSMIT(__IDLE__)                                  \
	(((__IDLE__) == UART_IDLE_FRAME_ENABLE) ||                             \
