...
typedef struct {
	...
	uint32_t
	    rtcNonSecureFeatures; /*!< Specifies the non-secure features.
	...
	uint32_t
	    backupRegisterStartZone2; /*!< Specifies the backup register start
	...
	uint32_t
	    MonotonicCounterSecure; /*!< Specifies If the monotonic counter is
...
typedef struct {
	...
	uint32_t
	    rtcPrivilegeFeatures; /*!< Specifies the privileged features.
				       This parameter is only relevant if RTC is
	...
	uint32_t
	    tampPrivilegeFull; /*!< Specifies If the TAMP is fully privileged or
				  not execpt monotonic counters and BackUp
				  registers. This parameter can be a value of
				  @ref RTCEx_TAMP_Privilege_Full. */

	uint32_t
	    backupRegisterPrivZone; /*!< Specifies backup register zone to be
	...
	uint32_t
	    backupRegisterStartZone3; /*!< Specifies the backup register start
...
#define RTC_INT_TAMPER_ALL                                                     \
	(RTC_INT_TAMPER_1 | RTC_INT_TAMPER_2 | RTC_INT_TAMPER_3 |              \
	 ...
	 RTC_INT_TAMPER_8 | RTC_INT_TAMPER_9 | RTC_INT_TAMPER_11 |             \
...
#define RTC_IT_INT_TAMP_12                                                     \
	TAMP_IER_ITAMP9IE /*!< Tamper 12 internal Interrupt */
#define RTC_IT_INT_TAMP_13                                                     \
	TAMP_IER_ITAMP11IE /*!< Tamper 13 internal Interrupt */
#define RTC_IT_INT_TAMP_ALL                                                    \
	(RTC_IT_INT_TAMP_1 | RTC_IT_INT_TAMP_2 | RTC_IT_INT_TAMP_3 |           \
	 ...
	 RTC_IT_INT_TAMP_8 | RTC_IT_INT_TAMP_9 | RTC_IT_INT_TAMP_11 |          \
...
#define RTC_FLAG_TAMP_ALL                                                      \
	(RTC_FLAG_TAMP_1 | RTC_FLAG_TAMP_2 | RTC_FLAG_TAMP_3 |                 \
...
#define RTC_FLAG_INT_TAMP_ALL                                                  \
	(RTC_FLAG_INT_TAMP_1 | RTC_FLAG_INT_TAMP2 | RTC_FLAG_INT_TAMP_3 |      \
	 RTC_FLAG_INT_TAMP5 | RTC_FLAG_INT_TAMP_6 | RTC_FLAG_INT_TAMP7 |       \
	 RTC_FLAG_INT_TAMP_8 | RTC_FLAG_INT_TAMP9 | RTC_FLAG_INT_TAMP_11 |     \
...
#define RTC_ALARMSUBSECONDBINMASK_SS31_1                                       \
	(1UL                                                                   \
	 << RTC_ALRMASSR_MASKSS_Pos) /*!< SS[31:1] are don't care in Alarm     \
...
#define RTC_NONSECURE_FEATURE_NONE                                             \
...
#define IS_RTC_NONSECURE_FEATURES(__FEATURES__)                                \
	(((__FEATURES__) & ~RTC_NONSECURE_FEATURE_NONE) == 0U)
