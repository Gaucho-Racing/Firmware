...
#if (USE_HAL_RAMCFG_REGISTER_CALLBACKS == 1)
	void (*MspInitCallback)(struct __RAMCFG_HandleTypeDef
...
#define RAMCFG_WAITSTATE_3                                                     \
	(RAMCFG_CR_WSC_0 | RAMCFG_CR_WSC_1)  /*!< RAMCFG 3 Wait State */
#define RAMCFG_WAITSTATE_4 (RAMCFG_CR_WSC_2) /*!< RAMCFG 4 Wait State */
#define RAMCFG_WAITSTATE_5                                                     \
	(RAMCFG_CR_WSC_0 | RAMCFG_CR_WSC_2) /*!< RAMCFG 5 Wait State */
#define RAMCFG_WAITSTATE_6                                                     \
	(RAMCFG_CR_WSC_1 | RAMCFG_CR_WSC_2) /*!< RAMCFG 6 Wait State */
#define RAMCFG_WAITSTATE_7                                                     \
	(RAMCFG_CR_WSC_0 | RAMCFG_CR_WSC_1 |                                   \
	 RAMCFG_CR_WSC_2) /*!< RAMCFG 7 Wait State */
/**
 * @}
 */
...
#define IS_RAMCFG_WAITSTATE(WAITSTATE)                                         \
	(((WAITSTATE) == RAMCFG_WAITSTATE_0) ||                                \
	 ((WAITSTATE) == RAMCFG_WAITSTATE_1) ||                                \
	 ((WAITSTATE) == RAMCFG_WAITSTATE_2) ||                                \
	 ((WAITSTATE) == RAMCFG_WAITSTATE_3) ||                                \
	 ((WAITSTATE) == RAMCFG_WAITSTATE_4) ||                                \
	 ((WAITSTATE) == RAMCFG_WAITSTATE_5) ||                                \
	 ((WAITSTATE) == RAMCFG_WAITSTATE_6) ||                                \
	 ((WAITSTATE) == RAMCFG_WAITSTATE_7))
