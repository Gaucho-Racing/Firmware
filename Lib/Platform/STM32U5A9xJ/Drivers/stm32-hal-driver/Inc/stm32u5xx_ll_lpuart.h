...
#define LL_LPUART_DIRECTION_TX_RX                                              \
	(USART_CR1_TE |                                                        \
	 USART_CR1_RE) /*!< Transmitter and Receiver are enabled            */
/**
 * @}
 */
 ...
 * @{
 */
#define LL_LPUART_LPDMA1_CH0_TCF_TRG                                           \
	0U /*!< LPUART LPDMA1 channel0 Internal Trigger  */
#define LL_LPUART_LPDMA1_CH1_TCF_TRG                                           \
	1U /*!< LPUART LPDMA1 channel1 Internal Trigger  */
#define LL_LPUART_LPDMA1_CH2_TCF_TRG                                           \
	2U /*!< LPUART LPDMA1 channel2 Internal Trigger  */
#define LL_LPUART_LPDMA1_CH3_TCF_TRG                                           \
	3U /*!< LPUART LPDMA1 channel3 Internal Trigger  */
#define LL_LPUART_EXTI_LINE6_TRG                                               \
	4U /*!< LPUART EXTI line 6 Internal Trigger      */
#define LL_LPUART_EXTI_LINE8_TRG                                               \
	5U /*!< LPUART EXTI line 8 Internal Trigger      */
#define LL_LPUART_LPTIM1_OUT_TRG                                               \
	6U /*!< LPUART LPTIM1 out Internal Trigger       */
#define LL_LPUART_LPTIM3_OUT_TRG                                               \
	7U /*!< LPUART LPTIM3 out Internal Trigger       */
#define LL_LPUART_COMP1_OUT_TRG                                                \
	8U /*!< LPUART COMP1 out Internal Trigger        */
#define LL_LPUART_COMP2_OUT_TRG                                                \
	9U /*!< LPUART COMP2 out Internal Trigger        */
#define LL_LPUART_RTC_ALRA_TRG                                                 \
	10U /*!< LPUART RTC alarm Internal Trigger        */
#define LL_LPUART_RTC_WUT_TRG                                                  \
	11U /*!< LPUART RTC wakeup Internal Trigger       */
/**
 * @}
 */
 ...
 * @{
 */
#define LL_LPUART_TRIG_POLARITY_RISING                                         \
	0x00000000U /*!< LPUART triggered on rising edge  */
...
{
	return (
	    uint32_t)(READ_BIT(LPUARTx->CR3, USART_CR3_RTSE | USART_CR3_CTSE));
}
					   ...
					   uint32_t BaudRate)
{
	if (BaudRate != 0U) {
		LPUARTx->BRR =
		    __LL_LPUART_DIV(PeriphClk, PrescalerValue, BaudRate);
	}
}
...
/** @defgroup LPUART_LL_EF_AutonomousMode Configuration functions related to
 ...
 */
__STATIC_INLINE uint32_t
LL_LPUART_IsEnabled_SelectedTrigger(const USART_TypeDef *LPUARTx)
{
	return ((READ_BIT(LPUARTx->AUTOCR, USART_AUTOCR_TRIGEN) ==
		 (USART_AUTOCR_TRIGEN))
		    ? 1UL
		    : 0UL);
}
...
LL_LPUART_Enable_AutonomousSendIdleFrame(USART_TypeDef *LPUARTx)
{
 ...
 */
__STATIC_INLINE void
LL_LPUART_Disable_AutonomousSendIdleFrame(USART_TypeDef *LPUARTx)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_LPUART_IsEnabled_AutonomousSendIdleFrame(const USART_TypeDef *LPUARTx)
{
	return ((READ_BIT(LPUARTx->AUTOCR, USART_AUTOCR_IDLEDIS) ==
		 (USART_AUTOCR_IDLEDIS))
		    ? 0UL
		    : 1UL);
}
 ...
 * @retval None
 */
__STATIC_INLINE void LL_LPUART_SetNbTxData(USART_TypeDef *LPUARTx,
					   uint32_t Nbdata)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_LPUART_SetTriggerPolarity(USART_TypeDef *LPUARTx,
						  uint32_t Polarity)
{
 ...
 */
__STATIC_INLINE uint32_t
LL_LPUART_GetTriggerPolarity(const USART_TypeDef *LPUARTx)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_LPUART_SetSelectedTrigger(USART_TypeDef *LPUARTx,
						  uint32_t Trigger)
{
	MODIFY_REG(LPUARTx->AUTOCR, USART_AUTOCR_TRIGSEL,
		   (Trigger << USART_AUTOCR_TRIGSEL_Pos));
}
 ...
 */
__STATIC_INLINE uint32_t
LL_LPUART_GetSelectedTrigger(const USART_TypeDef *LPUARTx)
{
	return (uint32_t)((READ_BIT(LPUARTx->AUTOCR, USART_AUTOCR_TRIGSEL) >>
			   USART_AUTOCR_TRIGSEL_Pos));
}
