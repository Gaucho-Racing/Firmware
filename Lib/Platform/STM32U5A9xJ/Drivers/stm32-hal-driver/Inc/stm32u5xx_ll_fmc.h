...
typedef struct {
	...
	uint32_t
	    BurstAccessMode; /*!< Enables or disables the burst access mode for
	...
	uint32_t
	    AsynchronousWait; /*!< Enables or disables wait signal during
	...
	FunctionalState
	    MaxChipSelectPulse; /*!< Enables or disables the maximum chip select
