...
typedef struct {
	...
	FunctionalState
	    WRPLock;	   /*!< Write protection lock (used for OPTIONBYTE_WRP).
	...
	uint32_t
	    WMSecConfig; /*!< Configuration of the Watermark-based Secure Area
	...
	uint32_t WMSecEndPage;	 /*!< End page of secure area (used for
				    ...
				    of pages in the bank - 1) */
	uint32_t
	    WMHDPEndPage;  /*!< End page of the secure hide protection (used for
...
#define FLASH_FLAG_PROGERR                                                     \
	FLASH_SECSR_PROGERR /*!< FLASH Programming error flag */
#define FLASH_FLAG_WRPERR                                                      \
	FLASH_SECSR_WRPERR /*!< FLASH Write protection error flag */
#define FLASH_FLAG_PGAERR                                                      \
	FLASH_SECSR_PGAERR /*!< FLASH Programming alignment error flag */
#define FLASH_FLAG_SIZERR FLASH_SECSR_SIZERR /*!< FLASH Size error flag */
#define FLASH_FLAG_PGSERR                                                      \
	FLASH_SECSR_PGSERR /*!< FLASH Programming sequence error flag */
#define FLASH_FLAG_OPTWERR                                                     \
	FLASH_NSSR_OPTWERR /*!< FLASH Option modification error flag  */
...
#define FLASH_FLAG_ALL_ERRORS                                                  \
	(FLASH_FLAG_SR_ERRORS | FLASH_FLAG_OPTWERR | FLASH_FLAG_ECCR_ERRORS)
#else
...
#define FLASH_FLAG_PROGERR                                                     \
	FLASH_NSSR_PROGERR /*!< FLASH Programming error flag */
#define FLASH_FLAG_WRPERR                                                      \
	FLASH_NSSR_WRPERR /*!< FLASH Write protection error flag */
#define FLASH_FLAG_PGAERR                                                      \
	FLASH_NSSR_PGAERR /*!< FLASH Programming alignment error flag */
#define FLASH_FLAG_SIZERR FLASH_NSSR_SIZERR /*!< FLASH Size error flag  */
#define FLASH_FLAG_PGSERR                                                      \
	FLASH_NSSR_PGSERR /*!< FLASH Programming sequence error flag */
#define FLASH_FLAG_OPTWERR                                                     \
	FLASH_NSSR_OPTWERR /*!< FLASH Option modification error flag  */
...
#if defined(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)
#define FLASH_IT_EOP                                                           \
	FLASH_SECCR_EOPIE /*!< End of FLASH Operation Interrupt source */
...
#else
#define FLASH_IT_EOP                                                           \
	FLASH_NSCR_EOPIE /*!< End of FLASH Operation Interrupt source */
...
#define FLASH_TYPEERASE_MASSERASE_NS                                           \
	(FLASH_NSCR_MER1 | FLASH_NSCR_MER2 |                                   \
	 FLASH_NON_SECURE_MASK) /*!< Non-secure flash                          \
			mass erase activation */
#else
#define FLASH_TYPEERASE_PAGES FLASH_NSCR_PER /*!< Pages erase activation */
#define FLASH_TYPEERASE_MASSERASE                                              \
	(FLASH_NSCR_MER1 | FLASH_NSCR_MER2) /*!< Flash mass erase activation   \
					     */
#endif					    /* __ARM_FEATURE_CMSE */
/**
 * @}
...
#define FLASH_TYPEPROGRAM_QUADWORD_NS                                          \
	(FLASH_NSCR_PG |                                                       \
	 FLASH_NON_SECURE_MASK) /*!< Program a quad-word (128-bit)             \
				     at a specified non-secure address */
#define FLASH_TYPEPROGRAM_BURST                                                \
	(FLASH_SECCR_PG |                                                      \
	 FLASH_SECCR_BWR) /*!< Program a burst (8xquad-word)                   \
			       at a specified secure address */
#define FLASH_TYPEPROGRAM_BURST_NS                                             \
	(FLASH_NSCR_PG | FLASH_NSCR_BWR | FLASH_NON_SECURE_MASK) /*!< Program  \
a burst (8xquad-word) at a specified non-secure address */
#else
#define FLASH_TYPEPROGRAM_QUADWORD                                             \
...
#define OPTIONBYTE_BOOTADDR                                                    \
	0x00000008U /*!< Boot address option byte configuration */
#if defined(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)
#define OPTIONBYTE_WMSEC                                                       \
	0x00000010U /*!< Watermark-based secure area option byte configuration \
		     */
...
#define OB_USER_SRAM_RST                                                       \
	0x00000010U /*!< All SRAMs (except SRAM2 and BKPSRAM) erase upon       \
		       system reset */
#define OB_USER_IWDG_SW 0x00000020U /*!< Independent watchdog selection */
#define OB_USER_IWDG_STOP                                                      \
	0x00000040U /*!< Independent watchdog counter freeze in stop mode */
#define OB_USER_IWDG_STDBY                                                     \
	0x00000080U /*!< Independent watchdog counter freeze in standby mode   \
		     */
...
#define OB_USER_DUALBANK                                                       \
	0x00000400U /*!< Dual-Bank on 1MB/512kB Flash memory devices */
#define OB_USER_BKPRAM_ECC                                                     \
	0x00000800U /*!< Backup RAM ECC detection and correction enable */
#if defined(SRAM3_BASE)
#define OB_USER_SRAM3_ECC                                                      \
	0x00001000U /*!< SRAM3 ECC detection and correction enable */
#endif		    /* SRAM3_BASE */
#define OB_USER_SRAM2_ECC                                                      \
	0x00002000U /*!< SRAM2 ECC detection and correction enable */
...
#define OB_USER_IO_VDD_HSLV                                                    \
	0x00040000U /*!< High speed IO at low voltage configuration bit */
#define OB_USER_IO_VDDIO2_HSLV                                                 \
	0x00080000U /*!< High speed IO at low VDDIO2 voltage configuration bit \
		     */
...
/** @defgroup FLASH_OB_USER_SRAM_RST FLASH Option Bytes User SRAM Erase On Reset
 * Type
 * @{
 */
...
#define OB_SRAM_RST_NOT_ERASE                                                  \
	FLASH_OPTR_SRAM_RST /*!< All SRAMs (except SRAM2 and BKPSRAM) not      \
			       erased when a system reset occurs */
/**
 * @}
 */
...
#define OB_SWAP_BANK_ENABLE                                                    \
	FLASH_OPTR_SWAP_BANK /*!< Bank 1 is located at address offset          \
				0x100000, Bank 2 is located at 0x0 */
/**
 * @}
 */
...
#define OB_BKPRAM_ECC_DISABLE                                                  \
	FLASH_OPTR_BKPRAM_ECC /*!< BKPRAM ECC check disable */
/**
 * @}
 */
...
#define OB_SRAM3_ECC_DISABLE                                                   \
	FLASH_OPTR_SRAM3_ECC /*!< SRAM3 ECC check disable */
/**
 * @}
 */
...
#define OB_SRAM2_ECC_DISABLE                                                   \
	FLASH_OPTR_SRAM2_ECC /*!< SRAM2 ECC check disable */
/**
 * @}
 */
...
#define OB_SRAM2_RST_NOT_ERASE                                                 \
	FLASH_OPTR_SRAM2_RST /*!< SRAM2 is not erased when a system reset      \
				occurs */
/**
 * @}
 */
...
/** @defgroup FLASH_OB_USER_PA15_PUPEN FLASH Option Bytes User PA15 pull-up
 * enable option bit
 * @{
 */
...
/** @defgroup FLASH_OB_USER_IO_VDD_HSLV FLASH Option Bytes User High speed IO at
...
#define OB_IO_VDD_HSLV_ENABLE                                                  \
	FLASH_OPTR_IO_VDD_HSLV /*!< High-speed IO at low VDD voltage feature   \
				  enabled (VDD remains below 2.5 V) */
/**
 * @}
 */

/** @defgroup FLASH_OB_USER_IO_VDDIO2_HSLV FLASH Option Bytes User High speed IO
 * at low VDDIO2 voltage configuration bit
 * @{
 */
...
#define OB_BOOT_LOCK_ENABLE                                                    \
	FLASH_SECBOOTADD0R_BOOT_LOCK /*!< Boot lock enable */
/**
 * @}
 */

/** @defgroup FLASH_OB_WMSEC FLASH Option Bytes Watermarked-based security
 * configuration
 * @{
 */
#define OB_WMSEC_AREA1                                                         \
	FLASH_BANK_1 /*!< Watermarked-based security area for bank 1 */
#define OB_WMSEC_AREA2                                                         \
	FLASH_BANK_2 /*!< Watermarked-based security area for bank 2 */

#define OB_WMSEC_SECURE_AREA_CONFIG                                            \
	0x00000010U /*!< Configure Watermarked-based security area       */
#define OB_WMSEC_HDP_AREA_CONFIG                                               \
	0x00000020U /*!< Configure Watermarked-based secure hide area    */
#define OB_WMSEC_HDP_AREA_ENABLE                                               \
	0x00000080U /*!< Enable Watermarked-based secure hide area       */
#define OB_WMSEC_HDP_AREA_DISABLE                                              \
	0x00000100U /*!< Disable Watermarked-based secure hide area      */
/**
 * @}
 */
#endif /* __ARM_FEATURE_CMSE */
...
#define FLASH_PDKEY1_2                                                         \
	0xFAFBFCFDU /*!< Flash Bank 1 power down key2: used with               \
		       FLASH_PDKEY1_1 to unlock the PDREQ1 bit in FLASH_ACR */

#define FLASH_PDKEY2_1 0x40516273U /*!< Flash Bank 2 power down key1 */
#define FLASH_PDKEY2_2                                                         \
	0xAFBFCFDFU /*!< Flash Bank 2 power down key2: used with               \
		       FLASH_PDKEY2_1 to unlock the PDREQ2 bit in FLASH_ACR */
 ...
 *     @arg FLASH_FLAG_SIZERR: FLASH Size error flag
 *     @arg FLASH_FLAG_PGSERR: FLASH Programming sequence error flag
 *     @arg FLASH_FLAG_OPTWERR: FLASH Option modification error flag (Only in
 * non-secure)
 *     @arg FLASH_FLAG_ECCC: FLASH one ECC error has been detected and corrected
 *     @arg FLASH_FLAG_ECCD: FLASH two ECC errors have been detected
...
#define __HAL_FLASH_CLEAR_FLAG(__FLAG__)                                       \
	do {                                                                   \
		...
		if (((__FLAG__) & FLASH_FLAG_OPTWERR) != 0U) {                 \
			SET_BIT(FLASH->NSSR,                                   \
				((__FLAG__) & (FLASH_FLAG_OPTWERR)));          \
		}                                                              \
		if (((__FLAG__) &                                              \
		     ~(FLASH_FLAG_ECCR_ERRORS | FLASH_FLAG_OPTWERR)) != 0U) {  \
			WRITE_REG(FLASH->SECSR,                                \
				  ((__FLAG__) & ~(FLASH_FLAG_ECCR_ERRORS |     \
						  FLASH_FLAG_OPTWERR)));       \
		}                                                              \
	} while (0)
...
#define IS_OB_USER_SRAM_RST(VALUE)                                             \
	(((VALUE) == OB_SRAM_RST_ERASE) || ((VALUE) == OB_SRAM_RST_NOT_ERASE))
...
#define IS_OB_USER_BKPRAM_ECC(VALUE)                                           \
	(((VALUE) == OB_BKPRAM_ECC_ENABLE) ||                                  \
	 ((VALUE) == OB_BKPRAM_ECC_DISABLE))
...
#define IS_OB_USER_PA15_PUPEN(VALUE)                                           \
	(((VALUE) == OB_PA15_PUP_DISABLE) || ((VALUE) == OB_PA15_PUP_ENABLE))

#define IS_OB_USER_IO_VDD_HSLV(VALUE)                                          \
	(((VALUE) == OB_IO_VDD_HSLV_DISABLE) ||                                \
...
#define IS_OB_WMSEC_CONFIG(CFG)                                                \
	((((CFG) & 0x7F3U) != 0U) && (((CFG) & 0x3U) != 0U) &&                 \
	 (((CFG) & 0xFFFFF80CU) == 0U))
...
#define IS_OB_BOOTADDR_CONFIG(CFG)                                             \
	(((CFG) == OB_BOOTADDR_NS0) || ((CFG) == OB_BOOTADDR_NS1) ||           \
...
#define IS_OB_RDP_KEY_TYPE(TYPE)                                               \
	(((TYPE) == OB_RDP_KEY_OEM1) || ((TYPE) == OB_RDP_KEY_OEM2))
