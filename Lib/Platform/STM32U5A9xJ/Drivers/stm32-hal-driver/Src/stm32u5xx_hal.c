...
#define __STM32U5xx_HAL_VERSION                                                \
	((__STM32U5xx_HAL_VERSION_MAIN << 24U) |                               \
...
/** @defgroup HAL_Exported_Functions_Group1 HAL Initialization and
 ...
 * function to be optionally defined in user file stm32u5xx_hal_msp.c.
 *
...
__weak void HAL_MspInit(void)
{
	/* NOTE : This function Should not be modified, when the callback is
	   needed, the HAL_MspInit could be implemented in the user file
	 */
}
...
{
	/* NOTE : This function Should not be modified, when the callback is
	   needed, the HAL_MspDeInit could be implemented in the user file
	 */
}
...
void HAL_SYSCFG_Lock(uint32_t Item)
{
	...
	SYSCFG->CSLCKR = ((0xFFFF0000U & Item) >>
...
#if defined(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)
/** @defgroup HAL_Exported_Functions_Group6 HAL SYSCFG attributes management
functions
...
void HAL_SYSCFG_SetOTGPHYPowerDownConfig(uint32_t PowerDownConfig)
{
	...
	MODIFY_REG(SYSCFG->OTGHSPHYCR, SYSCFG_OTGHSPHYCR_PDCTRL,
		   PowerDownConfig);
}
...
/**
  ...
  * @param  RefClkSelection Defines the OTG PHY reference clock selection.
	    This parameter can be one of the @ref
  SYSCFG_OTG_PHY_RefenceClockSelection
  * @retval None
  */
...
/**
  ...
  * @param  DisconnectThreshold Defines the voltage level for the threshold used
  to detect a disconnect event. This parameter can be one of the @ref
  SYSCFG_OTG_PHYTUNER_DisconnectThreshold
  * @retval None
  */
...
/**
  * @brief  Adjust the voltage level for the threshold used to detect valid high
  speed data.
  * @param  SquelchThreshold Defines the voltage level.
	    This parameter can be onez of the @ref
  SYSCFG_OTG_PHYTUNER_SquelchThreshold
...
/**
  ...
  * @param  PreemphasisCurrent Defines the current configuration.
	    This parameter can be one of the @ref
  SYSCFG_OTG_PHYTUNER_PreemphasisCurrent
