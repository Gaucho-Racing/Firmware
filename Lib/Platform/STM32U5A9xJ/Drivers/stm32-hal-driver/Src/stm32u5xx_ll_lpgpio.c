...
/**
 * @brief  De-initialize LPGPIO registers (Registers restored to their default
 * values).
...
/**
 * @brief  Initialize LPGPIO registers according to the specified parameters in
 * LPGPIO_InitStruct.
 * @param  LPGPIOx LPGPIO Port
 * @param  LPGPIO_InitStruct: pointer to a @ref LL_LPGPIO_InitTypeDef structure
 *         that contains the configuration information for the specified LPGPIO
 * peripheral.
 * @retval An ErrorStatus enumeration value:
 *          - SUCCESS: LPGPIO registers are initialized according to
