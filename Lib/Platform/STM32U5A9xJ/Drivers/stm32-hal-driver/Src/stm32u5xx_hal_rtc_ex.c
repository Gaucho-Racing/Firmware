/**
  ...
  ******************************************************************************
  ...
  [..]
    ...
    (+) Configure the RTC prescalers (asynchronous and synchronous), the RTC
  mode (binary, BCD or mix) and the RTC hour format using the HAL_RTC_Init()
  function.
    (+) In order to reconfigure the RTC peripheral, it is necessary to use
  HAL_RTC_DeInit() first, then use HAL_RTC_Init() again.
					    ...
					    uint32_t RTC_TimeStampPin)
{
	...
	/* Configure the Time Stamp TSEDGE before Enable bit to avoid unwanted
	 * TSF setting. */
						      ...
						      uint32_t Instance)
{
	...
	UNUSED(hrtc);
	UNUSED(Instance);
	/* This register is read-only only and is incremented by one when a
	   write access is done to this register. This register cannot roll-over
	   and is frozen when reaching the maximum value. */
			   ...
			   RTC_ActiveTampersTypeDef *sAllTamper)
{
	...
	if (READ_BIT(TAMP->ATOR, TAMP_ATOR_INITS) != 0U) {
		/* Disable all actives tampers with
		   HAL_RTCEx_DeactivateActiveTampers. No need to check return
		   value because it returns always HAL_OK */
...
HAL_StatusTypeDef HAL_RTCEx_DeactivateActiveTampers(RTC_HandleTypeDef *hrtc)
{
	...
	/* Clear all active tampers interrupt mode configuration but not
	 * passives tampers */
...
__weak void HAL_RTCEx_Tamper4EventCallback(RTC_HandleTypeDef *hrtc)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_RTCEx_Tamper4EventCallback could be implemented in
	   the user file
	 */
}
...
__weak void HAL_RTCEx_Tamper5EventCallback(RTC_HandleTypeDef *hrtc)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_RTCEx_Tamper5EventCallback could be implemented in
	   the user file
	 */
}
...
__weak void HAL_RTCEx_Tamper6EventCallback(RTC_HandleTypeDef *hrtc)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_RTCEx_Tamper6EventCallback could be implemented in
	   the user file
	 */
}
...
__weak void HAL_RTCEx_Tamper7EventCallback(RTC_HandleTypeDef *hrtc)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_RTCEx_Tamper7EventCallback could be implemented in
	   the user file
	 */
}
...
__weak void HAL_RTCEx_Tamper8EventCallback(RTC_HandleTypeDef *hrtc)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_RTCEx_Tamper8EventCallback could be implemented in
	   the user file
	 */
}
...
__weak void HAL_RTCEx_InternalTamper1EventCallback(RTC_HandleTypeDef *hrtc)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_RTCEx_InternalTamper1EventCallback could be
...
__weak void HAL_RTCEx_InternalTamper2EventCallback(RTC_HandleTypeDef *hrtc)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_RTCEx_InternalTamper2EventCallback could be
	   implemented in the user file
	 */
}
...
__weak void HAL_RTCEx_InternalTamper3EventCallback(RTC_HandleTypeDef *hrtc)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_RTCEx_InternalTamper3EventCallback could be
	   implemented in the user file
	 */
}
...
__weak void HAL_RTCEx_InternalTamper5EventCallback(RTC_HandleTypeDef *hrtc)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_RTCEx_InternalTamper5EventCallback could be
	   implemented in the user file
	 */
}
...
__weak void HAL_RTCEx_InternalTamper6EventCallback(RTC_HandleTypeDef *hrtc)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_RTCEx_InternalTamper6EventCallback could be
	   implemented in the user file
	 */
}
...
__weak void HAL_RTCEx_InternalTamper7EventCallback(RTC_HandleTypeDef *hrtc)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_RTCEx_InternalTamper7EventCallback could be
	   implemented in the user file
	 */
}
...
__weak void HAL_RTCEx_InternalTamper8EventCallback(RTC_HandleTypeDef *hrtc)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_RTCEx_InternalTamper8EventCallback could be
	   implemented in the user file
	 */
}
...
__weak void HAL_RTCEx_InternalTamper9EventCallback(RTC_HandleTypeDef *hrtc)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_RTCEx_InternalTamper9EventCallback could be
	   implemented in the user file
	 */
}
...
__weak void HAL_RTCEx_InternalTamper11EventCallback(RTC_HandleTypeDef *hrtc)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_RTCEx_InternalTamper11EventCallback could be
	   implemented in the user file
	 */
}
...
__weak void HAL_RTCEx_InternalTamper12EventCallback(RTC_HandleTypeDef *hrtc)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_RTCEx_InternalTamper12EventCallback could be
	   implemented in the user file
	 */
}
...
__weak void HAL_RTCEx_InternalTamper13EventCallback(RTC_HandleTypeDef *hrtc)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_RTCEx_InternalTamper13EventCallback could be
	   implemented in the user file
	 */
}
/**
...
/**
 * @brief  Block the access to the RTC Backup data Register and the device
 * secrets.
 * @param  hrtc RTC handle
 * @retval None
 */
 ...
 *          This parameter can be one of the following values:
 *             @arg TAMP_SECRETDEVICE_ERASE_ENABLE: Configurable device secrets
 * are is included in the device secrets protected by TAMP peripheral.
 *             @arg TAMP_SECRETDEVICE_ERASE_DISABLE: Configurable device secrets
			   ...
			   RTC_PrivilegeStateTypeDef *privilegeState)
{
	...
	/* Backup register start zone
	   ...
	   trustzone is disabled. In non secure mode, a notification is
