...
typedef struct {
	...
	uint32_t RepetitionCounter; /*!< Specifies the repetition counter value.
					 ...
					 This means in PWM mode that (N+1)
					  ...
					  Advanced timers: this parameter must
...
typedef struct {
	...
	uint32_t BreakState; /*!< TIM Break State, This parameter can be a value
				of @ref TIM_Break_Input_enable_disable */

	uint32_t BreakPolarity; /*!< TIM Break input polarity, This parameter
				   can be a value of @ref TIM_Break_Polarity */

	uint32_t BreakFilter; /*!< Specifies the break input filter.This
				 parameter can be a number between Min_Data =
				 0x0 and Max_Data = 0xF */
	...
	uint32_t
	    Break2State; /*!< TIM Break2 State, This parameter can be a value of
			    @ref TIM_Break2_Input_enable_disable */

	uint32_t
	    Break2Polarity; /*!< TIM Break2 input polarity, This parameter can
			       be a value of @ref TIM_Break2_Polarity */

	uint32_t
	    Break2Filter; /*!< TIM break2 input filter.This parameter can be a
...
#define __HAL_TIM_SET_ICPRESCALER(__HANDLE__, __CHANNEL__, __ICPSC__)          \
	do {                                                                   \
		...
		TIM_SET_ICPRESCALERVALUE((__HANDLE__), (__CHANNEL__),          \
					 (__ICPSC__));                         \
	} while (0)
...
#define __HAL_TIM_SET_CAPTUREPOLARITY(__HANDLE__, __CHANNEL__, __POLARITY__)   \
	do {                                                                   \
		...
		TIM_SET_CAPTUREPOLARITY((__HANDLE__), (__CHANNEL__),           \
					(__POLARITY__));                       \
	} while (0)
...
#define IS_TIM_DMA_BASE(__BASE__)                                              \
	(((__BASE__) == TIM_DMABASE_CR1) || ((__BASE__) == TIM_DMABASE_CR2) || \
	 ...
	 ((__BASE__) == TIM_DMABASE_DIER) || ((__BASE__) == TIM_DMABASE_SR) || \
	 ((__BASE__) == TIM_DMABASE_EGR) ||                                    \
	 ((__BASE__) == TIM_DMABASE_CCMR1) ||                                  \
	 ((__BASE__) == TIM_DMABASE_CCMR2) ||                                  \
	 ((__BASE__) == TIM_DMABASE_CCER) ||                                   \
	 ((__BASE__) == TIM_DMABASE_CNT) || ((__BASE__) == TIM_DMABASE_PSC) || \
	 ((__BASE__) == TIM_DMABASE_ARR) || ((__BASE__) == TIM_DMABASE_RCR) || \
	 ...
	 ((__BASE__) == TIM_DMABASE_ECR) || ((__BASE__) == TIM_DMABASE_OR1))
