...
typedef struct {
	...
	uint32_t
	    BBAttributesType; /*!< Block-Based Attributes type. This parameter
...
#define FLASH_INV_ENABLE                                                       \
	FLASH_SECCR_INV /*!< Security state of Flash is inverted */
/**
 * @}
 */
...
#define FLASH_OPERATION_TYPE_BURST                                             \
	FLASH_OPSR_CODE_OP_1 /*!< Burst write operation   */
#define FLASH_OPERATION_TYPE_PAGEERASE                                         \
	(FLASH_OPSR_CODE_OP_1 |                                                \
	 FLASH_OPSR_CODE_OP_0) /*!< Page erase operation    */
...
#define FLASH_OPERATION_AREA_BANK_1                                            \
	00000000U /*!< Operation in Bank 1              */
#define FLASH_OPERATION_AREA_BANK_2                                            \
	FLASH_OPSR_BK_OP /*!< Operation in Bank 2              */
...
#define IS_FLASH_CFGLPM(CFG)                                                   \
	(((CFG) == FLASH_LPM_DISABLE) || ((CFG) == FLASH_LPM_ENABLE))
/**
 * @}
 */
