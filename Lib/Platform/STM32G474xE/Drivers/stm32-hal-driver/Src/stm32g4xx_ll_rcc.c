...
uint32_t LL_RCC_GetSAIClockFreq(uint32_t SAIxSource)
{
	...
	if (SAIxSource == LL_RCC_SAI1_CLKSOURCE) {
		...
		case LL_RCC_SAI1_CLKSOURCE_SYSCLK: /* System clock used as SAI1
						      clock source */
		...
		case LL_RCC_SAI1_CLKSOURCE_HSI: /* HSI clock used as SAI1 clock
						   source */
		default:
			if (LL_RCC_HSI_IsReady() != 0U) {
...
uint32_t LL_RCC_GetFDCANClockFreq(uint32_t FDCANxSource)
{
	...
	case LL_RCC_FDCAN_CLKSOURCE_PCLK1: /* PCLK1 clock used as FDCAN kernel
					      clock */
...
uint32_t LL_RCC_GetADCClockFreq(uint32_t ADCxSource)
{
	...
	if (ADCxSource == LL_RCC_ADC12_CLKSOURCE) {
		...
		case LL_RCC_ADC12_CLKSOURCE_PLL: /* PLL clock used as ADC12
						    clock source */
			if (LL_RCC_PLL_IsReady() != 0U) {
		...
		case LL_RCC_ADC12_CLKSOURCE_SYSCLK: /* System clock used as
						       ADC12 clock source */
			adc_frequency = RCC_GetSystemClockFreq();
			break;

		case LL_RCC_ADC12_CLKSOURCE_NONE: /* No clock used as ADC12
						     clock source */
		default:
		...
		switch (LL_RCC_GetADCClockSource(ADCxSource)) {
		case LL_RCC_ADC345_CLKSOURCE_PLL: /* PLL clock used as ADC345
						     clock source */
			if (LL_RCC_PLL_IsReady() != 0U) {
				if (LL_RCC_PLL_IsEnabledDomain_ADC() != 0U) {
					adc_frequency =
		...
		case LL_RCC_ADC345_CLKSOURCE_SYSCLK: /* System clock used as
							ADC345 clock source */
			adc_frequency = RCC_GetSystemClockFreq();
			break;

		case LL_RCC_ADC345_CLKSOURCE_NONE: /* No clock used as ADC345
						      clock source */
		default:
			adc_frequency = LL_RCC_PERIPH_FREQUENCY_NA;
			break;
