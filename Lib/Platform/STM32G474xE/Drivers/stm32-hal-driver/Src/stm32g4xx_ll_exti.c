		...
		if (EXTI_InitStruct->Line_0_31 != LL_EXTI_LINE_NONE) {
			...
			if (EXTI_InitStruct->Trigger != LL_EXTI_TRIGGER_NONE) {
				...
				case LL_EXTI_TRIGGER_RISING:
					/* First Disable Falling Trigger on
					 * provided Lines */
				...
				case LL_EXTI_TRIGGER_FALLING:
					/* First Disable Rising Trigger on
					 * provided Lines */
					LL_EXTI_DisableRisingTrig_0_31(
					    EXTI_InitStruct->Line_0_31);
					/* Then Enable Falling Trigger on
					 * provided Lines */
					LL_EXTI_EnableFallingTrig_0_31(
					    EXTI_InitStruct->Line_0_31);
					break;
				case LL_EXTI_TRIGGER_RISING_FALLING:
					/* Enable Rising Trigger on provided
					 * Lines */
					LL_EXTI_EnableRisingTrig_0_31(
					    EXTI_InitStruct->Line_0_31);
					/* Enable Falling Trigger on provided
					 * Lines */
					LL_EXTI_EnableFallingTrig_0_31(
					    EXTI_InitStruct->Line_0_31);
					break;
