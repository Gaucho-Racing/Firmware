...
typedef struct {
	uint32_t
	    HRTIMInterruptRequests; /*!< Specifies which interrupts requests
...
#endif /* USE_HAL_HRTIM_REGISTER_CALLBACKS */
{
	...
	void (*SystemFaultCallback)(struct __HRTIM_HandleTypeDef *
					hhrtim); /*!< System fault interrupt
...
typedef struct {
	...
	uint32_t
	    EventPolarity; /*!< Specifies the polarity of the external event (in
...
typedef struct {
	...
	uint32_t
	    DACSynchro; /*!< Relevant for all HRTIM timers, including the
...
typedef struct {
	...
	uint32_t
	    GreaterCMP3; /*!<  Relevant for Timer A to Timer F.
	...
	uint32_t
	    GreaterCMP1; /*!<  Relevant for Timer A to Timer F.
...
typedef struct {
	...
	uint32_t
	    AutoDelayedTimeout; /*!< Specifies compare value for timing unit 1
...
typedef struct {
	...
	uint32_t
	    RisingLock; /*!< Specifies whether or not dead-time rising settings
			   (value and sign) are write protected. This parameter
			   can be a value of @ref HRTIM_Deadtime_Rising_Lock */
	uint32_t
	    RisingSignLock; /*!< Specifies whether or not dead-time rising sign
...
typedef struct {
	...
	uint32_t Sensitivity; /*!< Specifies the sensitivity of the external
				 ...
				 HRTIM_External_Event_Sensitivity */
	uint32_t
	    Filter; /*!< Defines the frequency used to sample the External Event
...
typedef struct {
	...
	uint32_t
	    Counter; /*!< Specifies the External Event Counter Threshold.
...
#define HRTIM_DACSYNC_DACTRIGOUT_3                                             \
	(HRTIM_MCR_DACSYNC_1 |                                                 \
	 HRTIM_MCR_DACSYNC_0) /*!< DAC update generated on DACTrigOut3 output  \
				 upon timer update */
/**
 * @}
 */
...
#define HRTIM_TIMER_D_E_DELAYEDPROTECTION_DELAYEDBOTH_EEV8                     \
	(HRTIM_OUTR_DLYPRT_1 |                                                 \
	 HRTIM_OUTR_DLYPRTEN) /*!< Timers D, E: Output 1 and output 2 delayed  \
...
#define HRTIM_TIMER_D_E_DELAYEDPROTECTION_DELAYEDBOTH_EEV9                     \
	(HRTIM_OUTR_DLYPRT_2 | HRTIM_OUTR_DLYPRT_1 |                           \
	 HRTIM_OUTR_DLYPRTEN) /*!< Timers D, E: Output 1 and output2 delayed   \
...
#define HRTIM_TIMER_F_DELAYEDPROTECTION_DELAYEDBOTH_EEV8                       \
	(HRTIM_OUTR_DLYPRT_1 |                                                 \
	 HRTIM_OUTR_DLYPRTEN) /*!< Timers F: Output 1 and output 2 delayed     \
				 Idle on external Event 6U */
...
#define HRTIM_TIMER_F_DELAYEDPROTECTION_DELAYEDBOTH_EEV9                       \
	(HRTIM_OUTR_DLYPRT_2 | HRTIM_OUTR_DLYPRT_1 |                           \
	 HRTIM_OUTR_DLYPRTEN) /*!< Timers F: Output 1 and output2 delayed Idle \
 ...
 */
#define HRTIM_EVENTCOUNTER_A                                                   \
	(HRTIM_EEFR3_EEVACE) /*!< External Event Counter A */
#define HRTIM_EVENTCOUNTER_B                                                   \
	(HRTIM_EEFR3_EEVBCE) /*!< External Event Counter B */
/**
 * @}
 */
...
#define HRTIM_EEV1SRC_ADC1_AWD1                                                \
	(HRTIM_EECR1_EE1SRC_1 |                                                \
	 HRTIM_EECR1_EE1SRC_0) /*!< External event source 4U for External      \
				  Event 1 */
...
#define HRTIM_EVENTFILTER_5                                                    \
	(HRTIM_EECR3_EE6F_2 |                                                  \
	 HRTIM_EECR3_EE6F_0) /*!< fSAMPLING= fEEVS/2U, N=8U */
#define HRTIM_EVENTFILTER_6                                                    \
	(HRTIM_EECR3_EE6F_2 |                                                  \
	 HRTIM_EECR3_EE6F_1) /*!< fSAMPLING= fEEVS/4U, N=6U */
...
#define HRTIM_EVENTFILTER_9                                                    \
	(HRTIM_EECR3_EE6F_3 |                                                  \
	 HRTIM_EECR3_EE6F_0) /*!< fSAMPLING= fEEVS/8U, N=8U */
#define HRTIM_EVENTFILTER_10                                                   \
	(HRTIM_EECR3_EE6F_3 |                                                  \
	 HRTIM_EECR3_EE6F_1) /*!< fSAMPLING= fEEVS/16U, N=5U */
...
#define HRTIM_EVENTFILTER_12                                                   \
	(HRTIM_EECR3_EE6F_3 |                                                  \
	 HRTIM_EECR3_EE6F_2) /*!< fSAMPLING= fEEVS/16U, N=8U */
...
#define IS_HRTIM_TIMERSWAP(TIMERSWAP)                                          \
	(((TIMERSWAP) & 0xFFC0FFFFU) == 0x00000000U)
	...
	do {                                                                   \
		...
		if (((__TIMERS__) & HRTIM_TIMERINDEX_TIMER_D) ==               \
			...
			CLEAR_BIT(                                             \
			    (__HANDLE__)                                       \
				->Instance                                     \
				->sTimerxRegs[(HRTIM_TIMERINDEX_TIMER_D)]      \
				.TIMxCR2,                                      \
			    (HRTIM_TIMCR2_UDM));                               \
		}                                                              \
...
#define __HAL_HRTIM_TIMER_OUTPUT_SWAP(__HANDLE__, __TIMERS__)                  \
	do {                                                                   \
		...
		if (((__TIMERS__) & HRTIM_TIMERID_TIMER_F) ==                  \
 ...
 * @retval None
 */
#define __HAL_HRTIM_EXTERNAL_EVENT_COUNTER_ENABLE(__HANDLE__, __TIMER__,       \
						  __EVENT__)                   \
	do {                                                                   \
		if (((__TIMER__) & HRTIM_TIMERINDEX_TIMER_A) ==                \
		    HRTIM_TIMERINDEX_TIMER_A) {                                \
			if (((__EVENT__) & HRTIM_EVENTCOUNTER_A) ==            \
		...
		if (((__TIMER__) & HRTIM_TIMERINDEX_TIMER_B) ==                \
			...
			if (((__EVENT__) & HRTIM_EVENTCOUNTER_B) ==            \
 ...
 * @retval None
 */
#define __HAL_HRTIM_EXTERNAL_EVENT_COUNTER_DISABLE(__HANDLE__, __TIMER__,      \
						   __EVENT__)                  \
	do {                                                                   \
		if (((__TIMER__) & HRTIM_TIMERINDEX_TIMER_A) ==                \
		    HRTIM_TIMERINDEX_TIMER_A) {                                \
 ...
 * @retval None
 */
#define __HAL_HRTIM_EXTERNAL_EVENT_COUNTER_RESET(__HANDLE__, __TIMER__,        \
						 __EVENT__)                    \
	do {                                                                   \
		if (((__TIMER__) & HRTIM_TIMERINDEX_TIMER_A) ==                \
		    HRTIM_TIMERINDEX_TIMER_A) {                                \
...
#define __HAL_HRTIM_TIMER_CLEAR_IT(__HANDLE__, __TIMER__, __INTERRUPT__)       \
	((__HANDLE__)->Instance->sTimerxRegs[(__TIMER__)].TIMxICR =            \
	     (__INTERRUPT__))
