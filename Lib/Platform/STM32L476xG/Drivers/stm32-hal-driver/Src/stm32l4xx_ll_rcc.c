	...
	if (I2CxSource == LL_RCC_I2C1_CLKSOURCE) {
		...
		if (I2CxSource == LL_RCC_I2C3_CLKSOURCE) {
			...
			if (I2CxSource == LL_RCC_I2C4_CLKSOURCE) {
				...
				switch (LL_RCC_GetI2CClockSource(I2CxSource)) {
				case LL_RCC_I2C4_CLKSOURCE_SYSCLK: /* I2C4 Clock
								      is System
								      Clock */
					i2c_frequency =
					    RCC_GetSystemClockFreq();
				...
				case LL_RCC_I2C4_CLKSOURCE_HSI: /* I2C4 Clock is
								   HSI Osc. */
					if (LL_RCC_HSI_IsReady() != 0U) {
						i2c_frequency = HSI_VALUE;
					}
				...
				case LL_RCC_I2C4_CLKSOURCE_PCLK1: /* I2C4 Clock
								     is PCLK1 */
					i2c_frequency = RCC_GetPCLK1ClockFreq(
...
uint32_t LL_RCC_GetSAIClockFreq(uint32_t SAIxSource)
{
	...
	if (SAIxSource == LL_RCC_SAI1_CLKSOURCE) {
		...
		case LL_RCC_SAI1_CLKSOURCE_PLLSAI1: /* PLLSAI1 clock used as
						       SAI1 clock source */
...
#if defined(RCC_PLLSAI2_SUPPORT)
		case LL_RCC_SAI1_CLKSOURCE_PLLSAI2: /* PLLSAI2 clock used as
						       SAI1 clock source */
...
#endif						/* RCC_PLLSAI2_SUPPORT */
		case LL_RCC_SAI1_CLKSOURCE_PLL: /* PLL clock used as SAI1 clock
						   source */
		...
		if (SAIxSource == LL_RCC_SAI2_CLKSOURCE) {
			...
			switch (LL_RCC_GetSAIClockSource(SAIxSource)) {
			case LL_RCC_SAI2_CLKSOURCE_PLLSAI1: /* PLLSAI1 clock
							       used as SAI2
							       clock source */
				if (LL_RCC_PLLSAI1_IsReady() != 0U) {
					if (LL_RCC_PLLSAI1_IsEnabledDomain_SAI() !=
...
#if defined(RCC_PLLSAI2_SUPPORT)
			case LL_RCC_SAI2_CLKSOURCE_PLLSAI2: /* PLLSAI2 clock
							       used as SAI2
							       clock source */
				if (LL_RCC_PLLSAI2_IsReady() != 0U) {
					if (LL_RCC_PLLSAI2_IsEnabledDomain_SAI() !=
...
#endif /* RCC_PLLSAI2_SUPPORT */
			case LL_RCC_SAI2_CLKSOURCE_PLL: /* PLL clock used as
							   SAI2 clock source */
				if (LL_RCC_PLL_IsReady() != 0U) {
...
uint32_t LL_RCC_GetSDMMCKernelClockFreq(uint32_t SDMMCxSource)
{
	...
	case LL_RCC_SDMMC1_KERNELCLKSOURCE_48CLK: /* 48MHz clock from internal
						     multiplexor used as SDMMC1
						     clock source */
		sdmmc_frequency =
		    LL_RCC_GetSDMMCClockFreq(LL_RCC_SDMMC1_CLKSOURCE);
		break;

	case LL_RCC_SDMMC1_KERNELCLKSOURCE_PLLP: /* PLL "P" output (PLLSAI3CLK)
						    clock used as SDMMC1 clock
						    source */
		if (LL_RCC_PLL_IsReady() != 0U) {
			if (LL_RCC_PLL_IsEnabledDomain_SAI() != 0U) {
...
uint32_t LL_RCC_GetSDMMCClockFreq(uint32_t SDMMCxSource)
{
	...
	case LL_RCC_SDMMC1_CLKSOURCE_PLLSAI1: /* PLLSAI1 clock used as SDMMC1
						 clock source */
		if (LL_RCC_PLLSAI1_IsReady() != 0U) {
	...
	case LL_RCC_SDMMC1_CLKSOURCE_PLL: /* PLL clock used as SDMMC1 clock
					     source */
		if (LL_RCC_PLL_IsReady() != 0U) {
	...
	case LL_RCC_SDMMC1_CLKSOURCE_MSI: /* MSI clock used as SDMMC1 clock
					     source */
	...
	case LL_RCC_SDMMC1_CLKSOURCE_HSI48: /* HSI48 used as SDMMC1 clock source
		...
		break;
#else
	case LL_RCC_SDMMC1_CLKSOURCE_NONE: /* No clock used as SDMMC1 clock
					      source */
#endif
	default:
		sdmmc_frequency = LL_RCC_PERIPH_FREQUENCY_NA;
...
#if defined(RCC_PLLSAI1_SUPPORT)
	case LL_RCC_RNG_CLKSOURCE_PLLSAI1: /* PLLSAI1 clock used as RNG clock
					      source */
		if (LL_RCC_PLLSAI1_IsReady() != 0U) {
			if (LL_RCC_PLLSAI1_IsEnabledDomain_48M() != 0U) {
...
#if defined(RCC_PLLSAI1_SUPPORT)
	case LL_RCC_USB_CLKSOURCE_PLLSAI1: /* PLLSAI1 clock used as USB clock
					      source */
		if (LL_RCC_PLLSAI1_IsReady() != 0U) {
			if (LL_RCC_PLLSAI1_IsEnabledDomain_48M() != 0U) {
...
uint32_t LL_RCC_GetADCClockFreq(uint32_t ADCxSource)
{
...
#if defined(RCC_PLLSAI1_SUPPORT)
	case LL_RCC_ADC_CLKSOURCE_PLLSAI1: /* PLLSAI1 clock used as ADC clock
					      source */
		if (LL_RCC_PLLSAI1_IsReady() != 0U) {
	...
	case LL_RCC_ADC_CLKSOURCE_PLLSAI2: /* PLLSAI2 clock used as ADC clock
					      source */
		if (LL_RCC_PLLSAI2_IsReady() != 0U) {
...
uint32_t LL_RCC_GetDFSDMAudioClockFreq(uint32_t DFSDMxSource)
{
	...
	case LL_RCC_DFSDM1_AUDIO_CLKSOURCE_SAI1: /* SAI1 clock used as DFSDM1
						    audio clock */
		dfsdm_frequency = LL_RCC_GetSAIClockFreq(LL_RCC_SAI1_CLKSOURCE);
		break;

	case LL_RCC_DFSDM1_AUDIO_CLKSOURCE_MSI: /* MSI clock used as DFSDM1
						   audio clock */
		if (LL_RCC_MSI_IsReady() != 0U) {
	...
	case LL_RCC_DFSDM1_AUDIO_CLKSOURCE_HSI: /* HSI clock used as DFSDM1
						   audio clock */
	default:
		if (LL_RCC_HSI_IsReady() != 0U) {
