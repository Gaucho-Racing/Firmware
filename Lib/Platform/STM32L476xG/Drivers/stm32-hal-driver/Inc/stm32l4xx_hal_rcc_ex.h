...
typedef struct {
	...
	uint32_t
	    PLLSAI1N; /*!< PLLSAI1N: specifies the multiplication factor for
...
typedef struct {
	...
	uint32_t
	    PLLSAI2N; /*!< PLLSAI2N: specifies the multiplication factor for
...
typedef struct {
	...
	uint32_t
	    UsbClockSelection; /*!< Specifies USB clock source (warning: same
	...
	uint32_t
	    RngClockSelection; /*!< Specifies RNG clock source (warning: same
...
#define __HAL_RCC_DFSDM1AUDIO_CONFIG(__DFSDM1AUDIO_CLKSOURCE__)                \
	MODIFY_REG(RCC->CCIPR2, RCC_CCIPR2_ADFSDM1SEL,                         \
