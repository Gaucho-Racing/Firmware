...
typedef struct {
	...
	__IO uint32_t WPR;  /*!< RTC write protection register,  Address offset:
			       0x24 */
 ...
 */
typedef struct {
	__IO uint32_t CR1; /*!< TAMP configuration register 1,   Address offset:
			      0x00 */
	__IO uint32_t CR2; /*!< TAMP configuration register 2,   Address offset:
			      0x04 */
	uint32_t RESERVED0;  /*!< Reserved,  Address offset: 0x08 */
	__IO uint32_t FLTCR; /*!< TAMP filter control register, Address offset:
				0x0C */
	uint32_t RESERVED1[7]; /*!< Reserved, Address offset: 0x10 -- 0x28 */
	__IO uint32_t IER; /*!< TAMP interrupt enable register, Address offset:
			      0x2C */
...
#define PWR_CR3_ENULP                                                          \
	PWR_CR3_ENULP_Msk /*!< Enable ULP BORL, BORH and PVD for STOP2 and     \
			     Standby modes */
...
#define TAMP_CR2_BKERASE_Msk                                                   \
	(0x1UL << TAMP_CR2_BKERASE_Pos) /*!< 0x00800000                        \
					 */
...
#define LPTIM_IER_UEIE                                                         \
	LPTIM_IER_UEIE_Msk /*!< Update event Interrupt Enable                  \
			    */
...
#define LPTIM_IER_REPOKIE                                                      \
	LPTIM_IER_REPOKIE_Msk /*!< Repetition register update OK Interrupt     \
				 Enable */
