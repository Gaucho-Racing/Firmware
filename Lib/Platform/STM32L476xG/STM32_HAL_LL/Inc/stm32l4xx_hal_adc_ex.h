...
typedef struct {
	...
	uint32_t
	    InjectedOffset; /*!< Defines the offset to be subtracted from the
...
#define ADC_CFGR_FIELDS                                                        \
	(ADC_CFGR_AWD1CH | ADC_CFGR_JAUTO | ADC_CFGR_JAWD1EN |                 \
	 ...
	 ADC_CFGR_EXTSEL | ADC_CFGR_ALIGN | ADC_CFGR_RES | ADC_CFGR_DFSDMCFG | \
...
#define ADC_CFGR_FIELDS_2                                                      \
	((ADC_CFGR_DMACFG | ADC_CFGR_AUTDLY | ADC_CFGR_DFSDMCFG))
#else
...
#define ADC_IS_INDEPENDENT(__HANDLE__)                                         \
    ...
    defined(STM32L452xx) || defined(STM32L462xx) || defined(STM32L4R5xx) ||    \
    defined(STM32L4R7xx) || defined(STM32L4R9xx) || defined(STM32L4S5xx) ||    \
    defined(STM32L4S7xx) || defined(STM32L4S9xx)
#define ADC_IS_INDEPENDENT(__HANDLE__) (SET)
#elif defined(STM32L412xx) || defined(STM32L422xx) || defined(STM32L4P5xx) ||  \
    defined(STM32L4Q5xx)
...
#define ADC_AWD23THRESHOLD_SHIFT_RESOLUTION(__HANDLE__, __THRESHOLD__)         \
	((((__HANDLE__)->Instance->CFGR & ADC_CFGR_RES) !=                     \
	  (ADC_CFGR_RES_1 | ADC_CFGR_RES_0))                                   \
	     ? ((__THRESHOLD__) >>                                             \
		((4UL -                                                        \
		  ((((__HANDLE__)->Instance->CFGR & ADC_CFGR_RES) >> 3UL) *    \
		   2UL)) &                                                     \
		 0x1FUL))                                                      \
	     : ((__THRESHOLD__) << 2UL))
...
#if defined(STM32L412xx) || defined(STM32L422xx) || defined(STM32L471xx) ||    \
