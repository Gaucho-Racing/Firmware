 ...
 * @{
 */
#define LL_OPAMP_POWERMODE_NORMALPOWER                                         \
	(OPAMP_POWERMODE_OTR_REGOFFSET) /*!< OPAMP power mode normal */
#define LL_OPAMP_POWERMODE_LOWPOWER                                            \
	(OPAMP_POWERMODE_LPOTR_REGOFFSET |                                     \
	 OPAMP_CSR_OPALPM) /*!< OPAMP power mode low-power */
...
#define LL_OPAMP_TRIMMING_PMOS                                                 \
	(OPAMP_OTR_TRIMOFFSETP |                                               \
	 OPAMP1_CSR_CALSEL) /*!< OPAMP trimming of transistors differential    \
			       pair PMOS */
/**
 * @}
 */
...
LL_OPAMP_GetCommonPowerRange(OPAMP_Common_TypeDef *OPAMPxy_COMMON)
{
	/* Prevent unused parameter warning */
	(void)(*OPAMPxy_COMMON);
...
__STATIC_INLINE void LL_OPAMP_SetPowerMode(OPAMP_TypeDef *OPAMPx,
					   uint32_t PowerMode)
{
	MODIFY_REG(OPAMPx->CSR, OPAMP_CSR_OPALPM,
