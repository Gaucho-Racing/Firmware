...
#define LL_TIM_DMABURST_BASEADDR_CCMR3                                         \
	(TIM_DCR_DBA_4 | TIM_DCR_DBA_2 |                                       \
	 TIM_DCR_DBA_0) /*!< TIMx_CCMR3 register is the DMA base address for   \
			   DMA burst */
#define LL_TIM_DMABURST_BASEADDR_CCR5                                          \
	(TIM_DCR_DBA_4 | TIM_DCR_DBA_2 |                                       \
	 TIM_DCR_DBA_1) /*!< TIMx_CCR5 register is the DMA base address for    \
			   DMA burst */
...
#define LL_TIM_DMABURST_BASEADDR_OR3                                           \
	(TIM_DCR_DBA_4 | TIM_DCR_DBA_3 |                                       \
	 TIM_DCR_DBA_0) /*!< TIMx_OR3 register is the DMA base address for DMA \
			   burst */
/**
 * @}
 */
...
#define LL_TIM_TIM1_ETR_ADC1_RMP_AWD1                                          \
	(TIM1_OR1_ETR_ADC1_RMP_0 |                                             \
	 TIM1_OR1_RMP_MASK) /*!< TIM1_ETR is connected to ADC1 analog watchdog \
			       1 */
...
#define LL_TIM_TIM1_ETR_ADC3_RMP_AWD1                                          \
	(TIM1_OR1_ETR_ADC3_RMP_0 |                                             \
	 TIM1_OR1_RMP_MASK) /*!< TIM1_ETR is connected to ADC3 analog watchdog \
			       1 */
...
#define LL_TIM_TIM2_TI4_RMP_COMP1_COMP2                                        \
	(TIM2_OR1_TI4_RMP |                                                    \
	 TIM2_OR1_RMP_MASK) /*!< TIM2 input capture 4 is connected to logical  \
...
#define LL_TIM_TIM3_TI1_RMP_COMP1_COMP2                                        \
	(TIM3_OR1_TI1_RMP |                                                    \
	 TIM3_OR1_RMP_MASK) /*!< TIM3 input capture 1 is connected to logical  \
			       OR between COMP1_OUT and COMP2_OUT */
/**
 * @}
 */
...
#define LL_TIM_TIM8_ETR_ADC3_RMP_AWD1                                          \
	(TIM8_OR1_ETR_ADC3_RMP_0 |                                             \
	 TIM8_OR1_RMP_MASK) /*!< TIM8_ETR is connected to ADC3 analog watchdog \
			       1 */
...
#define LL_TIM_TIM15_ENCODERMODE_TIM2                                          \
	(TIM15_OR1_ENCODER_MODE_0 |                                            \
	 TIM15_OR1_RMP_MASK) /*!< TIM2 IC1 and TIM2 IC2 are connected to TIM15 \
				IC1 and TIM15 IC2 respectively */
#define LL_TIM_TIM15_ENCODERMODE_TIM3                                          \
	(TIM15_OR1_ENCODER_MODE_1 |                                            \
	 TIM15_OR1_RMP_MASK) /*!< TIM3 IC1 and TIM3 IC2 are connected to TIM15 \
				IC1 and TIM15 IC2 respectivel y*/
#define LL_TIM_TIM15_ENCODERMODE_TIM4                                          \
	(TIM15_OR1_ENCODER_MODE |                                              \
	 TIM15_OR1_RMP_MASK) /*!< TIM4 IC1 and TIM4 IC2 are connected to TIM15 \
				IC1 and TIM15 IC2 respectively */
/**
 * @}
 */
...
#define LL_TIM_TIM16_TI1_RMP_RTC                                               \
	(TIM16_OR1_TI1_RMP_1 | TIM16_OR1_TI1_RMP_0 |                           \
	 TIM16_OR1_RMP_MASK) /*!< TIM16 input capture 1 is connected to RTC    \
				wakeup interrupt */
