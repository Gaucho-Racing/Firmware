...
#define LL_RCC_USART3_CLKSOURCE_PCLK1                                          \
	(RCC_CCIPR_USART3SEL                                                   \
	 << 16U) /*!< PCLK1 clock used as USART3 clock source */
...
#define LL_RCC_SAI1_CLKSOURCE_PLLSAI2                                          \
	((RCC_CCIPR2_SAI1SEL << 16U) |                                         \
	 RCC_CCIPR2_SAI1SEL_0) /*!< PLLSAI2 (PLLSAI2CLK) clock used as SAI1    \
				  clock source */
#define LL_RCC_SAI1_CLKSOURCE_PLL                                              \
	((RCC_CCIPR2_SAI1SEL << 16U) |                                         \
	 RCC_CCIPR2_SAI1SEL_1) /*!< PLL (PLLSAI3CLK) clock used as SAI1 clock  \
				  source */
...
#define LL_RCC_SAI1_CLKSOURCE_PLL                                              \
	(RCC_CCIPR_SAI1SEL |                                                   \
	 (RCC_CCIPR_SAI1SEL_1 >>                                               \
	  16U)) /*!< PLL clock used as SAI1 clock source */
#define LL_RCC_SAI1_CLKSOURCE_PIN                                              \
	(RCC_CCIPR_SAI1SEL |                                                   \
	 (RCC_CCIPR_SAI1SEL >>                                                 \
...
#define LL_RCC_SAI2_CLKSOURCE_PLLSAI2                                          \
	((RCC_CCIPR2_SAI2SEL << 16U) |                                         \
	 RCC_CCIPR2_SAI2SEL_0) /*!< PLLSAI2 (PLLSAI2CLK) clock used as SAI2    \
				  clock source */
#define LL_RCC_SAI2_CLKSOURCE_PLL                                              \
	((RCC_CCIPR2_SAI2SEL << 16U) |                                         \
	 RCC_CCIPR2_SAI2SEL_1) /*!< PLL (PLLSAI3CLK) clock used as SAI2 clock  \
				  source */
...
#define LL_RCC_SAI2_CLKSOURCE_PLL                                              \
	(RCC_CCIPR_SAI2SEL |                                                   \
	 (RCC_CCIPR_SAI2SEL_1 >>                                               \
	  16U)) /*!< PLL clock used as SAI2 clock source */
#define LL_RCC_SAI2_CLKSOURCE_PIN                                              \
	(RCC_CCIPR_SAI2SEL |                                                   \
	 (RCC_CCIPR_SAI2SEL >>                                                 \
...
#define LL_RCC_PLLM_DIV_11                                                     \
	(RCC_PLLCFGR_PLLM_3 |                                                  \
	 RCC_PLLCFGR_PLLM_1) /*!< Main PLL division factor for PLLM input by   \
				11 */
...
#define LL_RCC_PLLM_DIV_13                                                     \
	(RCC_PLLCFGR_PLLM_3 |                                                  \
	 RCC_PLLCFGR_PLLM_2) /*!< Main PLL division factor for PLLM input by   \
				13 */
...
#define LL_RCC_PLLSAI2DIVR_DIV_16                                              \
	(RCC_CCIPR2_PLLSAI2DIVR_1 |                                            \
	 RCC_CCIPR2_PLLSAI2DIVR_0) /*!< PLLSAI2 division factor for            \
...
#define __LL_RCC_CALC_HCLK_FREQ(__SYSCLKFREQ__, __AHBPRESCALER__)              \
	((__SYSCLKFREQ__) >>                                                   \
	 AHBPrescTable[((__AHBPRESCALER__) & RCC_CFGR_HPRE) >>                 \
		       RCC_CFGR_HPRE_Pos])
...
#define __LL_RCC_CALC_PCLK1_FREQ(__HCLKFREQ__, __APB1PRESCALER__)              \
	((__HCLKFREQ__) >>                                                     \
	 APBPrescTable[(__APB1PRESCALER__) >> RCC_CFGR_PPRE1_Pos])
...
#define __LL_RCC_CALC_PCLK2_FREQ(__HCLKFREQ__, __APB2PRESCALER__)              \
	((__HCLKFREQ__) >>                                                     \
	 APBPrescTable[(__APB2PRESCALER__) >> RCC_CFGR_PPRE2_Pos])
...
{
	return ((READ_BIT(RCC->CR, RCC_CR_MSIRDY) == RCC_CR_MSIRDY) ? 1UL
								    : 0UL);
}
...
__STATIC_INLINE uint32_t LL_RCC_GetI2CClockSource(uint32_t I2Cx)
{
	...
	return (
	    uint32_t)((READ_BIT(*reg, 3UL << ((I2Cx & 0x001F0000U) >> 16U)) >>
...
{
	return (
	    (READ_BIT(RCC->PLLCFGR, RCC_PLLCFGR_PLLPEN) == (RCC_PLLCFGR_PLLPEN))
		? 1UL
		: 0UL);
}
...
{
	return (
	    (READ_BIT(RCC->PLLCFGR, RCC_PLLCFGR_PLLQEN) == (RCC_PLLCFGR_PLLQEN))
		? 1UL
		: 0UL);
}
...
{
	return (
	    (READ_BIT(RCC->PLLCFGR, RCC_PLLCFGR_PLLREN) == (RCC_PLLCFGR_PLLREN))
		? 1UL
		: 0UL);
}
...
{
	return (
	    uint32_t)(READ_BIT(RCC->PLLSAI1CFGR, RCC_PLLSAI1CFGR_PLLSAI1N) >>
...
{
	return (
	    uint32_t)(READ_BIT(RCC->PLLSAI1CFGR, RCC_PLLSAI1CFGR_PLLSAI1PDIV));
}
#else
/**
 * @brief  Get SAI1PLL division factor for PLLSAI1P
...
{
	return (
	    uint32_t)(READ_BIT(RCC->PLLSAI2CFGR, RCC_PLLSAI2CFGR_PLLSAI2N) >>
...
{
	return (
	    uint32_t)(READ_BIT(RCC->PLLSAI2CFGR, RCC_PLLSAI2CFGR_PLLSAI2PDIV));
}
#else
/**
 * @brief  Get SAI2PLL division factor for PLLSAI2P
...
{
	return ((READ_BIT(RCC->CSR, RCC_CSR_FWRSTF) == RCC_CSR_FWRSTF) ? 1UL
								       : 0UL);
}
