...
typedef enum {
	HAL_TSC_STATE_RESET =
	    0x00UL, /*!< TSC registers have their reset value */
	HAL_TSC_STATE_READY =
	    0x01UL, /*!< TSC registers are initialized or acquisition is
...
typedef struct {
	...
	uint32_t
	    PulseGeneratorPrescaler;	   /*!< Pulse generator prescaler
						This parameter can be a value of @ref
...
#define TSC_GROUPX_NOT_SUPPORTED                                               \
	0xFF000000UL /*!< TSC GroupX not supported       */
...
#define TSC_GROUP5_IO1                                                         \
	(uint32_t)(                                                            \
	    0x00000010UL |                                                     \
	    TSC_GROUPX_NOT_SUPPORTED) /*!< TSC Group5 IO1 not supported   */
...
#define TSC_GROUP6_IO1                                                         \
	(uint32_t)(                                                            \
	    0x00000020UL |                                                     \
	    TSC_GROUPX_NOT_SUPPORTED) /*!< TSC Group6 IO1 not supported   */
...
#define TSC_GROUP7_IO1                                                         \
	(uint32_t)(                                                            \
	    0x00000040UL |                                                     \
	    TSC_GROUPX_NOT_SUPPORTED) /*!< TSC Group7 IO1 not supported   */
...
#define TSC_GROUP8_IO1                                                         \
	(uint32_t)(                                                            \
	    0x00000080UL |                                                     \
	    TSC_GROUPX_NOT_SUPPORTED) /*!< TSC Group8 IO1 not supported   */
...
#define __HAL_TSC_GET_FLAG(__HANDLE__, __FLAG__)                               \
	((((__HANDLE__)->Instance->ISR & (__FLAG__)) == (__FLAG__)) ? SET      \
								    : RESET)
...
#define IS_TSC_SS_PRESC(__VALUE__)                                             \
	(((__VALUE__) == TSC_SS_PRESC_DIV1) ||                                 \
	 ((__VALUE__) == TSC_SS_PRESC_DIV2))
...
#define IS_TSC_IODEF(__VALUE__)                                                \
	(((__VALUE__) == TSC_IODEF_OUT_PP_LOW) ||                              \
	 ((__VALUE__) == TSC_IODEF_IN_FLOAT))
...
#define IS_TSC_GROUP(__VALUE__)                                                \
	((((__VALUE__) & TSC_GROUPX_NOT_SUPPORTED) !=                          \
