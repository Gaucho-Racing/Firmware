...
#define IS_TSC_CTPH(__VALUE__)                                                                                         \
	(((__VALUE__) == TSC_CTPH_1CYCLE) || ((__VALUE__) == TSC_CTPH_2CYCLES) || ((__VALUE__) == TSC_CTPH_3CYCLES) || \
	 ((__VALUE__) == TSC_CTPH_4CYCLES) || ((__VALUE__) == TSC_CTPH_5CYCLES) ||                                     \
	 ((__VALUE__) == TSC_CTPH_6CYCLES) || ((__VALUE__) == TSC_CTPH_7CYCLES) ||                                     \
	 ((__VALUE__) == TSC_CTPH_8CYCLES) || ((__VALUE__) == TSC_CTPH_9CYCLES) ||                                     \
	 ((__VALUE__) == TSC_CTPH_10CYCLES) || ((__VALUE__) == TSC_CTPH_11CYCLES) ||                                   \
	 ((__VALUE__) == TSC_CTPH_12CYCLES) || ((__VALUE__) == TSC_CTPH_13CYCLES) ||                                   \
	 ((__VALUE__) == TSC_CTPH_14CYCLES) || ((__VALUE__) == TSC_CTPH_15CYCLES) ||                                   \
...
#define IS_TSC_CTPL(__VALUE__)                                                                                         \
	(((__VALUE__) == TSC_CTPL_1CYCLE) || ((__VALUE__) == TSC_CTPL_2CYCLES) || ((__VALUE__) == TSC_CTPL_3CYCLES) || \
	 ((__VALUE__) == TSC_CTPL_4CYCLES) || ((__VALUE__) == TSC_CTPL_5CYCLES) ||                                     \
	 ((__VALUE__) == TSC_CTPL_6CYCLES) || ((__VALUE__) == TSC_CTPL_7CYCLES) ||                                     \
	 ((__VALUE__) == TSC_CTPL_8CYCLES) || ((__VALUE__) == TSC_CTPL_9CYCLES) ||                                     \
	 ((__VALUE__) == TSC_CTPL_10CYCLES) || ((__VALUE__) == TSC_CTPL_11CYCLES) ||                                   \
	 ((__VALUE__) == TSC_CTPL_12CYCLES) || ((__VALUE__) == TSC_CTPL_13CYCLES) ||                                   \
	 ((__VALUE__) == TSC_CTPL_14CYCLES) || ((__VALUE__) == TSC_CTPL_15CYCLES) ||                                   \
...
#define IS_TSC_PG_PRESC(__VALUE__)                                                                                     \
	(((__VALUE__) == TSC_PG_PRESC_DIV1) || ((__VALUE__) == TSC_PG_PRESC_DIV2) ||                                   \
	 ...
	 ((__VALUE__) == TSC_PG_PRESC_DIV16) || ((__VALUE__) == TSC_PG_PRESC_DIV32) ||                                 \
	 ((__VALUE__) == TSC_PG_PRESC_DIV64) || ((__VALUE__) == TSC_PG_PRESC_DIV128))

#define IS_TSC_PG_PRESC_VS_CTPL(__PGPSC__, __CTPL__)                                                                   \
	((((__PGPSC__) == TSC_PG_PRESC_DIV1) &&                                                                        \
	  (((__CTPL__) == TSC_CTPL_1CYCLE) || ((__CTPL__) > TSC_CTPL_2CYCLES))) ||                                     \
