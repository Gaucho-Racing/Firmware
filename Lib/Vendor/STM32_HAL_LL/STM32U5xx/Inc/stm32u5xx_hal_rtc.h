...
typedef struct {
	...
	uint32_t
	    SecondFraction; /*!< Specifies the range or granularity of Sub
...
{
	RTC_TypeDef
	    *Instance; /*!< Legacy register base address. Not used anymore, the
...
#define RTC_ALARMSUBSECONDMASK_SS14_3                                          \
	(RTC_ALRMASSR_MASKSS_0 |                                               \
	 RTC_ALRMASSR_MASKSS_1) /*!< SS[14:3] not used in Alarm comparison.    \
...
#define RTC_ALARMSUBSECONDMASK_SS14_5                                          \
	(RTC_ALRMASSR_MASKSS_0 |                                               \
	 RTC_ALRMASSR_MASKSS_2) /*!< SS[14:5] not used in Alarm comparison.    \
				   Only SS[4:0] are compared  */
#define RTC_ALARMSUBSECONDMASK_SS14_6                                          \
	(RTC_ALRMASSR_MASKSS_1 |                                               \
	 RTC_ALRMASSR_MASKSS_2) /*!< SS[14:6] not used in Alarm comparison.    \
				   Only SS[5:0] are compared  */
#define RTC_ALARMSUBSECONDMASK_SS14_7                                          \
	(RTC_ALRMASSR_MASKSS_0 | RTC_ALRMASSR_MASKSS_1 |                       \
	 RTC_ALRMASSR_MASKSS_2) /*!< SS[14:7] not used in Alarm comparison.    \
...
#define RTC_ALARMSUBSECONDMASK_SS14_9                                          \
	(RTC_ALRMASSR_MASKSS_0 |                                               \
	 RTC_ALRMASSR_MASKSS_3) /*!< SS[14:9] not used in Alarm comparison.    \
				   Only SS[8:0] are compared  */
#define RTC_ALARMSUBSECONDMASK_SS14_10                                         \
	(RTC_ALRMASSR_MASKSS_1 |                                               \
	 RTC_ALRMASSR_MASKSS_3) /*!< SS[14:10] not used in Alarm comparison.   \
				   Only SS[9:0] are compared  */
#define RTC_ALARMSUBSECONDMASK_SS14_11                                         \
	(RTC_ALRMASSR_MASKSS_0 | RTC_ALRMASSR_MASKSS_1 |                       \
	 RTC_ALRMASSR_MASKSS_3) /*!< SS[14:11] not used in Alarm comparison.   \
...
#define RTC_ALARMSUBSECONDMASK_SS14_13                                         \
	(RTC_ALRMASSR_MASKSS_0 | RTC_ALRMASSR_MASKSS_2 |                       \
	 RTC_ALRMASSR_MASKSS_3) /*!< SS[14:13] not used in Alarm comparison.   \
 ...
 * RTC_BINARY_MIX).
 */
#define __HAL_RTC_GET_BINARY_MODE(__HANDLE__)                                  \
	(READ_REG(RTC->ICSR & RTC_ICSR_BIN))
...
#define IS_RTC_OUTPUT(OUTPUT)                                                  \
	(((OUTPUT) == RTC_OUTPUT_DISABLE) ||                                   \
	 ((OUTPUT) == RTC_OUTPUT_ALARMA) || ((OUTPUT) == RTC_OUTPUT_ALARMB) || \
