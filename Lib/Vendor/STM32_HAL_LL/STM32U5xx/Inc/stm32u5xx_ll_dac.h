...
/* Exported types ------------------------------------------------------------*/
	...
	typedef struct
	{
		uint32_t TriggerSource; /*!< Set the conversion trigger source for the
					   selected DAC channel: internal (SW start) or
					   from external peripheral (timer event,
					   external interrupt line). This parameter can
					   be a value of @ref DAC_LL_EC_TRIGGER_SOURCE
...
#define LL_DAC_CHANNEL_1                                                                                                                                                                               \
	(DAC_REG_SHSR1_REGOFFSET | DAC_REG_DOR1_REGOFFSET | DAC_REG_DHR12R1_REGOFFSET | DAC_REG_DHR12L1_REGOFFSET | DAC_REG_DHR8R1_REGOFFSET | DAC_CR_CH1_BITOFFSET |                                  \
	 DAC_SWTR_CH1) /*!< DAC channel 1 */
#define LL_DAC_CHANNEL_2                                                                                                                                                                               \
	(DAC_REG_SHSR2_REGOFFSET | DAC_REG_DOR2_REGOFFSET | DAC_REG_DHR12R2_REGOFFSET | DAC_REG_DHR12L2_REGOFFSET | DAC_REG_DHR8R2_REGOFFSET | DAC_CR_CH2_BITOFFSET |                                  \
...
#define __LL_DAC_CALC_VOLTAGE_TO_DATA(__VREFANALOG_VOLTAGE__, __DAC_VOLTAGE__, __DAC_RESOLUTION__) ((__DAC_VOLTAGE__) * __LL_DAC_DIGITAL_SCALE(__DAC_RESOLUTION__) / (__VREFANALOG_VOLTAGE__))
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DAC_EnableAutonomousMode(DAC_TypeDef *DACx) { SET_BIT(DACx->AUTOCR, DAC_AUTOCR_AUTOMODE); }
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DAC_DisableAutonomousMode(DAC_TypeDef *DACx) { CLEAR_BIT(DACx->AUTOCR, DAC_AUTOCR_AUTOMODE); }

	/**
	 * @brief  Get DAC autonomous mode state.
	 *         (0: DAC autonomous mode is disabled, 1: DAC autonomous mode is
	 * enabled)
	 * @param  DACx DAC instance
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_DAC_IsAutonomousModeEnabled(const DAC_TypeDef *DACx) { return ((READ_BIT(DACx->AUTOCR, DAC_AUTOCR_AUTOMODE) == (DAC_AUTOCR_AUTOMODE)) ? 1UL : 0UL); }
