...
#endif /* USE_HAL_HCD_REGISTER_CALLBACKS */
{
...
#if defined(USB_DRD_FS)
	uint32_t ep0_PmaAllocState; /*!< EP0 PMA allocation State (allocated,
				       virtual Ch, EP0 direction) */
	uint16_t
	...
	HCD_HostStateTypeDef
	    HostState;		     /*!< USB current state
					DICONNECT/CONNECT/RUN/SUSPEND/RESUME */
#endif				     /* defined (USB_DRD_FS) */
	...
	void (*ConnectCallback)(struct __HCD_HandleTypeDef
	...
	void (*MspInitCallback)(struct __HCD_HandleTypeDef *
