...
typedef struct {
	...
	DCMI_CodesInitTypeDef SyncroCode; /*!< Specifies the code of the line/frame start
					     delimiter and the line/frame end delimiter */
...
#define DCMI_FLAG_FRAMEMI                                                                                                                                                                              \
	((uint32_t)DCMI_MIS_INDEX | DCMI_MIS_FRAME_MIS)		      /*!< DCMI Frame                                                                                                                  \
...
#define DCMI_OEBS_ODD                                                                                                                                                                                  \
	(0x00000000U) /*!< Interface captures first data from the frame/line                                                                                                                           \
