...
#define LL_RTC_UNSECURE_FEATURE_CAL                                            \
	~RTC_SECCFGR_CALSEC /*!< Calibration feature is not secure */
#define LL_RTC_UNSECURE_FEATURE_TS                                             \
	~RTC_SECCFGR_TSSEC /*!< Time stamp feature is not secure */
#define LL_RTC_UNSECURE_FEATURE_WUT                                            \
	~RTC_SECCFGR_WUTSEC /*!< Wake up timer feature is not secure */
#define LL_RTC_UNSECURE_FEATURE_ALRA                                           \
	~RTC_SECCFGR_ALRASEC /*!< Alarm A feature is not secure */
#define LL_RTC_UNSECURE_FEATURE_ALRB                                           \
	~RTC_SECCFGR_ALRBSEC /*!< Alarm B feature is not secure */
/**
 * @}
 */
...
__STATIC_INLINE uint32_t LL_RTC_TIME_Get(const RTC_TypeDef *RTCx)
{
	...
	temp = READ_BIT(RTCx->TR, (RTC_TR_HT | RTC_TR_HU | RTC_TR_MNT |
				   RTC_TR_MNU | RTC_TR_ST | RTC_TR_SU));
...
__STATIC_INLINE uint32_t LL_RTC_DATE_Get(const RTC_TypeDef *RTCx)
{
	...
	temp =
	    READ_BIT(RTCx->DR, (RTC_DR_WDU | RTC_DR_MT | RTC_DR_MU | RTC_DR_DT |
...
LL_RTC_TAMPER_ATAMP_SetSharedOuputSelection(uint32_t OutputSelection)
{
	MODIFY_REG(TAMP->ATCR2,
		   (TAMP_ATCR2_ATOSEL1 | TAMP_ATCR2_ATOSEL2 |
...
{
	return (
	    READ_BIT(TAMP->ATCR2, (TAMP_ATCR2_ATOSEL1 | TAMP_ATCR2_ATOSEL2 |
				   TAMP_ATCR2_ATOSEL3 | TAMP_ATCR2_ATOSEL4 |
				   TAMP_ATCR2_ATOSEL5 | TAMP_ATCR2_ATOSEL6 |
				   TAMP_ATCR2_ATOSEL7 | TAMP_ATCR2_ATOSEL8)));
}
...
{
	return ((READ_BIT(RTCx->MISR, RTC_MISR_SSRUMF) == (RTC_MISR_SSRUMF))
		    ? 1U
		    : 0U);
}
...
{
	UNUSED(RTCx);
	return ((READ_BIT(TAMP->SR, TAMP_SR_ITAMP9F) == (TAMP_SR_ITAMP9F))
		    ? 1U
		    : 0U);
}
...
{
	UNUSED(RTCx);
	return ((READ_BIT(TAMP->SR, TAMP_SR_ITAMP11F) == (TAMP_SR_ITAMP11F))
		    ? 1U
		    : 0U);
}
...
{
	UNUSED(RTCx);
	return ((READ_BIT(TAMP->SR, TAMP_SR_ITAMP12F) == (TAMP_SR_ITAMP12F))
		    ? 1U
		    : 0U);
}
/**
...
{
	UNUSED(RTCx);
	return ((READ_BIT(TAMP->SR, TAMP_SR_ITAMP13F) == (TAMP_SR_ITAMP13F))
		    ? 1U
		    : 0U);
}
...
__STATIC_INLINE uint32_t LL_RTC_GetRtcSecure(const RTC_TypeDef *RTCx)
{
	return READ_BIT(RTCx->SECCFGR,
			RTC_SECCFGR_SEC | RTC_SECCFGR_INITSEC |
...
{
	return ((READ_BIT(RTCx->CR, RTC_CR_SSRUIE) == (RTC_CR_SSRUIE)) ? 1U
								       : 0U);
}
...
{
	UNUSED(RTCx);
	return ((READ_BIT(TAMP->IER, TAMP_IER_ITAMP8IE) == (TAMP_IER_ITAMP8IE))
		    ? 1U
		    : 0U);
}
...
{
	UNUSED(RTCx);
	return ((READ_BIT(TAMP->IER, TAMP_IER_ITAMP9IE) == (TAMP_IER_ITAMP9IE))
		    ? 1U
		    : 0U);
}
...
__STATIC_INLINE uint32_t LL_RTC_IsEnabledIT_ITAMP11(const RTC_TypeDef *RTCx)
{
	UNUSED(RTCx);
	return (
	    (READ_BIT(TAMP->IER, TAMP_IER_ITAMP11IE) == (TAMP_IER_ITAMP11IE))
		? 1U
		: 0U);
}
...
__STATIC_INLINE uint32_t LL_RTC_IsEnabledIT_ITAMP12(const RTC_TypeDef *RTCx)
{
	UNUSED(RTCx);
	return (
	    (READ_BIT(TAMP->IER, TAMP_IER_ITAMP12IE) == (TAMP_IER_ITAMP12IE))
		? 1U
		: 0U);
}
...
__STATIC_INLINE uint32_t LL_RTC_IsEnabledIT_ITAMP13(const RTC_TypeDef *RTCx)
{
	UNUSED(RTCx);
	return (
	    (READ_BIT(TAMP->IER, TAMP_IER_ITAMP13IE) == (TAMP_IER_ITAMP13IE))
		? 1U
		: 0U);
}
