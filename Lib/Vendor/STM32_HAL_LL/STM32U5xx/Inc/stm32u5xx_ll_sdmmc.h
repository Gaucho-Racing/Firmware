...
#define SDMMC_CMD_ALL_SEND_CID                                                                                                                                                                         \
	2U			  /*!< Asks any card connected to the host to send the CID numbers on                                                                                                  \
				     the CMD line.             */
...
#define SDMMC_CMD_HS_SEND_EXT_CSD                                                                                                                                                                      \
	8U /*!< Sends SD Memory Card interface condition, which includes host                                                                                                                          \
	      supply voltage information  and asks the card whether card                                                                                                                               \
	      supports voltage.                      */
#define SDMMC_CMD_SEND_CSD                                                                                                                                                                             \
	9U /*!< Addressed card sends its card specific data (CSD) on the CMD                                                                                                                           \
	      line.                       */
#define SDMMC_CMD_SEND_CID                                                                                                                                                                             \
	10U				/*!< Addressed card sends its card identification (CID) on the CMD                                                                                             \
					   line.                      */
...
#define SDMMC_CMD_SET_BLOCKLEN                                                                                                                                                                         \
	16U /*!< Sets the block length (in bytes for SDSC) for all following                                                                                                                           \
	       block commands (read, write, lock). Default block length is                                                                                                                             \
	       fixed to 512 Bytes. Not effective        */
/*!< for SDHS and SDXC. */
...
#define SDMMC_CMD_WRITE_SINGLE_BLOCK                                                                                                                                                                   \
	24U /*!< Writes single block of size selected by SET_BLOCKLEN in case                                                                                                                          \
	       of SDSC, and a block of fixed 512 bytes in case of SDHC and                                                                                                                             \
	       SDXC.                                   */
...
#define SDMMC_CMD_SD_ERASE_GRP_START                                                                                                                                                                   \
	32U /*!< Sets the address of the first write block to be erased. (For                                                                                                                          \
	       SD card only).              */
...
#define SDMMC_CMD_ERASE_GRP_START                                                                                                                                                                      \
	35U /*!< Sets the address of the first write block to be erased.                                                                                                                               \
	       Reserved for each command system set by switch function command                                                                                                                         \
	       (CMD6).                                  */
...
#define SDMMC_CMD_LOCK_UNLOCK                                                                                                                                                                          \
	42U /*!< Sets/resets the password or lock/unlock the card. The size of                                                                                                                         \
	       the data block is set by the SET_BLOCK_LEN command. */
