...
static const uint8_t LL_LPTIM_OFFSET_TAB_ICx[8][4] = {{2U, 7U, 9U, 13U}, {3U, 5U, 6U, 8U}, {2U, 3U, 4U, 5U}, {2U, 2U, 3U, 3U}, {2U, 2U, 2U, 2U}, {2U, 2U, 2U, 2U}, {2U, 2U, 2U, 2U}, {2U, 2U, 2U, 2U}};
...
typedef struct {
	...
	uint32_t Waveform; /*!< Specifies the waveform shape.
				...
				This feature can be modified afterwards using
			      unitary function @ref LL_LPTIM_SetWaveform().*/
...
#define LL_LPTIM_OUTPUT_POLARITY_INVERSE                                                                                                                                                               \
	LPTIM_CCMR1_CC1P_0 /*!<The LPTIM output reflects the inverse of the                                                                                                                            \
			      compare results between LPTIMx_ARR and                                                                                                                                   \
			      LPTIMx_CCx registers*/
/**
 * @}
 */
...
#define LL_LPTIM_ICPSC_DIV1                                                                                                                                                                            \
	0x00000000UL				 /*!< Capture performed each time an edge is detected on                                                                                               \
						    the capture input */
...
#define LL_LPTIM_ICFLT_CLOCK_DIV2                                                                                                                                                                      \
	LPTIM_CCMR1_IC1F_0 /*!< external input capture signal level change                                                                                                                             \
			      must be stable for at least 2 clock periods                                                                                                                              \
			      before it is considered as valid transition */
#define LL_LPTIM_ICFLT_CLOCK_DIV4                                                                                                                                                                      \
	LPTIM_CCMR1_IC1F_1 /*!< external input capture signal level change                                                                                                                             \
			      must be stable for at least 4 clock periods                                                                                                                              \
			      before it is considered as valid transition */
#define LL_LPTIM_ICFLT_CLOCK_DIV8                                                                                                                                                                      \
	(LPTIM_CCMR1_IC1F_0 | LPTIM_CCMR1_IC1F_1) /*!< external input capture signal level change                                                                                                      \
						     must be stable for at least 8 clock periods                                                                                                       \
						     before it is considered as valid transition */
/**
 * @}
 */
...
#define LL_LPTIM_TRIG_SOURCE_LPDMA_CH0_TCF                                                                                                                                                             \
	(LPTIM_CFGR_TRIGSEL_1 | LPTIM_CFGR_TRIGSEL_0) /*!<External input trigger is connected to                                                                                                       \
							 LPDMA CH0 transfer complete */
#define LL_LPTIM_TRIG_SOURCE_LPDMA_CH1_TCF                                                                                                                                                             \
	LPTIM_CFGR_TRIGSEL_2 /*!<External input trigger is connected to LPDMA                                                                                                                          \
				CH1 transfer complete */
#define LL_LPTIM_TRIG_SOURCE_LPDMA_CH2_TCF                                                                                                                                                             \
	(LPTIM_CFGR_TRIGSEL_2 | LPTIM_CFGR_TRIGSEL_0) /*!<External input trigger is connected to                                                                                                       \
							 LPDMA CH2 transfer complete */
#define LL_LPTIM_TRIG_SOURCE_GPDMA_CH0_TCF                                                                                                                                                             \
	LPTIM_CFGR_TRIGSEL_2 /*!<External input trigger is connected to GPDMA                                                                                                                          \
				CH0 transfer complete */
 ...
 * @retval offset value
 */
#define LL_LPTIM_IC_GET_OFFSET(__PSC__, __FLT__) LL_LPTIM_OFFSET_TAB_ICx[((__PSC__) & LPTIM_CFGR_PRESC_Msk) >> LPTIM_CFGR_PRESC_Pos][((__FLT__) & LPTIM_CCMR1_IC1F_Msk) >> LPTIM_CCMR1_IC1F_Pos]
/**
 * @}
 */
 ...
 * @retval None
 */
__STATIC_INLINE void LL_LPTIM_CC_EnableChannel(LPTIM_TypeDef *LPTIMx, uint32_t Channel) { SET_BIT(LPTIMx->CCMR1, 0x1UL << LL_LPTIM_SHIFT_TAB_CCxE[Channel]); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_LPTIM_CC_DisableChannel(LPTIM_TypeDef *LPTIMx, uint32_t Channel) { CLEAR_BIT(LPTIMx->CCMR1, 0x1UL << LL_LPTIM_SHIFT_TAB_CCxE[Channel]); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_LPTIM_OC_SetCompareCH1(LPTIM_TypeDef *LPTIMx, uint32_t CompareValue) { MODIFY_REG(LPTIMx->CCR1, LPTIM_CCR1_CCR1, CompareValue); }
 ...
 */
__STATIC_INLINE uint32_t LL_LPTIM_OC_GetCompareCH1(const LPTIM_TypeDef *LPTIMx) { return (uint32_t)(READ_BIT(LPTIMx->CCR1, LPTIM_CCR1_CCR1)); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_LPTIM_OC_SetCompareCH2(LPTIM_TypeDef *LPTIMx, uint32_t CompareValue) { MODIFY_REG(LPTIMx->CCR2, LPTIM_CCR2_CCR2, CompareValue); }
 ...
 * @retval CompareValue Value between Min_Data=0x00 and Max_Data=0xFFFF
 */
__STATIC_INLINE uint32_t LL_LPTIM_OC_GetCompareCH2(const LPTIM_TypeDef *LPTIMx) { return (uint32_t)(READ_BIT(LPTIMx->CCR2, LPTIM_CCR2_CCR2)); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_LPTIM_SetInput1Src(LPTIM_TypeDef *LPTIMx, uint32_t Src) { MODIFY_REG(LPTIMx->CFGR2, LPTIM_CFGR2_IN1SEL, Src); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_LPTIM_SetInput2Src(LPTIM_TypeDef *LPTIMx, uint32_t Src) { MODIFY_REG(LPTIMx->CFGR2, LPTIM_CFGR2_IN2SEL, Src); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_LPTIM_SetRemap(LPTIM_TypeDef *LPTIMx, uint32_t Src) { MODIFY_REG(LPTIMx->CFGR2, LPTIM_CFGR2_IC1SEL | LPTIM_CFGR2_IC2SEL, Src); }
...
{
	MODIFY_REG(LPTIMx->CCMR1, LPTIM_CCMR1_CC1SEL << LL_LPTIM_SHIFT_TAB_CCxSEL[Channel], CCMode << LL_LPTIM_SHIFT_TAB_CCxSEL[Channel]);
}
...
{
	return (uint32_t)((READ_BIT(LPTIMx->CCMR1, LPTIM_CCMR1_CC1SEL << LL_LPTIM_SHIFT_TAB_CCxSEL[Channel])) >> LL_LPTIM_SHIFT_TAB_CCxSEL[Channel]);
}
 ...
 */
__STATIC_INLINE uint32_t LL_LPTIM_IC_GetCaptureCH1(const LPTIM_TypeDef *LPTIMx) { return (uint32_t)(READ_BIT(LPTIMx->CCR1, LPTIM_CCR1_CCR1)); }
 ...
 * @retval CapturedValue (between Min_Data=0 and Max_Data=65535)
 */
__STATIC_INLINE uint32_t LL_LPTIM_IC_GetCaptureCH2(const LPTIM_TypeDef *LPTIMx) { return (uint32_t)(READ_BIT(LPTIMx->CCR2, LPTIM_CCR2_CCR2)); }
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_CC1(const LPTIM_TypeDef *LPTIMx) { return (((READ_BIT(LPTIMx->ISR, LPTIM_ISR_CC1IF) == LPTIM_ISR_CC1IF) ? 1UL : 0UL)); }
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_CC2(const LPTIM_TypeDef *LPTIMx) { return (((READ_BIT(LPTIMx->ISR, LPTIM_ISR_CC2IF) == LPTIM_ISR_CC2IF) ? 1UL : 0UL)); }
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_CC1O(const LPTIM_TypeDef *LPTIMx) { return (((READ_BIT(LPTIMx->ISR, LPTIM_ISR_CC1OF) == LPTIM_ISR_CC1OF) ? 1UL : 0UL)); }
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_CC2O(const LPTIM_TypeDef *LPTIMx) { return (((READ_BIT(LPTIMx->ISR, LPTIM_ISR_CC2OF) == LPTIM_ISR_CC2OF) ? 1UL : 0UL)); }
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_CMP1OK(const LPTIM_TypeDef *LPTIMx) { return (((READ_BIT(LPTIMx->ISR, LPTIM_ISR_CMP1OK) == LPTIM_ISR_CMP1OK) ? 1UL : 0UL)); }
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_CMP2OK(const LPTIM_TypeDef *LPTIMx) { return (((READ_BIT(LPTIMx->ISR, LPTIM_ISR_CMP2OK) == LPTIM_ISR_CMP2OK) ? 1UL : 0UL)); }
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPTIM_IsActiveFlag_DIEROK(const LPTIM_TypeDef *LPTIMx) { return ((READ_BIT(LPTIMx->ISR, LPTIM_ISR_DIEROK) == (LPTIM_ISR_DIEROK)) ? 1UL : 0UL); }
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_CC1(const LPTIM_TypeDef *LPTIMx) { return (((READ_BIT(LPTIMx->DIER, LPTIM_DIER_CC1IE) == LPTIM_DIER_CC1IE) ? 1UL : 0UL)); }
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_CC2(const LPTIM_TypeDef *LPTIMx) { return (((READ_BIT(LPTIMx->DIER, LPTIM_DIER_CC2IE) == LPTIM_DIER_CC2IE) ? 1UL : 0UL)); }
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_CC1O(const LPTIM_TypeDef *LPTIMx) { return (((READ_BIT(LPTIMx->DIER, LPTIM_DIER_CC1OIE) == LPTIM_DIER_CC1OIE) ? 1UL : 0UL)); }
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_CC2O(const LPTIM_TypeDef *LPTIMx) { return (((READ_BIT(LPTIMx->DIER, LPTIM_DIER_CC2OIE) == LPTIM_DIER_CC2OIE) ? 1UL : 0UL)); }
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_ARRM(const LPTIM_TypeDef *LPTIMx) { return (((READ_BIT(LPTIMx->DIER, LPTIM_DIER_ARRMIE) == LPTIM_DIER_ARRMIE) ? 1UL : 0UL)); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_LPTIM_DisableIT_EXTTRIG(LPTIM_TypeDef *LPTIMx) { CLEAR_BIT(LPTIMx->DIER, LPTIM_DIER_EXTTRIGIE); }
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_EXTTRIG(const LPTIM_TypeDef *LPTIMx) { return (((READ_BIT(LPTIMx->DIER, LPTIM_DIER_EXTTRIGIE) == LPTIM_DIER_EXTTRIGIE) ? 1UL : 0UL)); }
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_CMP1OK(const LPTIM_TypeDef *LPTIMx) { return (((READ_BIT(LPTIMx->DIER, LPTIM_DIER_CMP1OKIE) == LPTIM_DIER_CMP1OKIE) ? 1UL : 0UL)); }
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_CMP2OK(const LPTIM_TypeDef *LPTIMx) { return (((READ_BIT(LPTIMx->DIER, LPTIM_DIER_CMP2OKIE) == LPTIM_DIER_CMP2OKIE) ? 1UL : 0UL)); }
 ...
 * @retval State of bit(1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_ARROK(const LPTIM_TypeDef *LPTIMx) { return (((READ_BIT(LPTIMx->DIER, LPTIM_DIER_ARROKIE) == LPTIM_DIER_ARROKIE) ? 1UL : 0UL)); }
 ...
 * @retval State of bit(1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_UP(const LPTIM_TypeDef *LPTIMx) { return (((READ_BIT(LPTIMx->DIER, LPTIM_DIER_UPIE) == LPTIM_DIER_UPIE) ? 1UL : 0UL)); }
 ...
 * @retval State of bit(1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_DOWN(const LPTIM_TypeDef *LPTIMx) { return ((READ_BIT(LPTIMx->DIER, LPTIM_DIER_DOWNIE) == LPTIM_DIER_DOWNIE) ? 1UL : 0UL); }
 ...
 * @retval State of bit(1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_REPOK(const LPTIM_TypeDef *LPTIMx) { return ((READ_BIT(LPTIMx->DIER, LPTIM_DIER_REPOKIE) == (LPTIM_DIER_REPOKIE)) ? 1UL : 0UL); }
 ...
 *@ retval State of bit(1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledIT_UE(const LPTIM_TypeDef *LPTIMx) { return ((READ_BIT(LPTIMx->DIER, LPTIM_DIER_UEIE) == (LPTIM_DIER_UEIE)) ? 1UL : 0UL); }
/**
 * @}
 */
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledDMAReq_UPDATE(const LPTIM_TypeDef *LPTIMx) { return ((READ_BIT(LPTIMx->DIER, LPTIM_DIER_UEDE) == (LPTIM_DIER_UEDE)) ? 1UL : 0UL); }
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledDMAReq_CC1(const LPTIM_TypeDef *LPTIMx) { return ((READ_BIT(LPTIMx->DIER, LPTIM_DIER_CC1DE) == (LPTIM_DIER_CC1DE)) ? 1UL : 0UL); }
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_LPTIM_IsEnabledDMAReq_CC2(const LPTIM_TypeDef *LPTIMx) { return ((READ_BIT(LPTIMx->DIER, LPTIM_DIER_CC2DE) == (LPTIM_DIER_CC2DE)) ? 1UL : 0UL); }
