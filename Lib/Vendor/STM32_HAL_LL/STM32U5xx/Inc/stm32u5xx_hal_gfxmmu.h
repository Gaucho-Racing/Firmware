...
typedef struct {
	FunctionalState
	    Activation;		  /*!< Cache and pre-fetch enable/disable.
				       @note: All following parameters are useful only if
				     cache	   and pre-fetch are enabled. */
	...
	uint32_t CacheLockBuffer; /*!< Buffer on which the cache is locked.
				     ...
				     GFXMMU_CacheLockBuffer.
				       @note: Useful only when lock of the cache
				     is enabled. */
	uint32_t CacheForce; /*!< Forcing the cache regardless MPU attributes.
				  This parameter can be a value of @ref
				GFXMMU_CacheForce.
				  @note: Useful only when lock of the cache is
				enabled. */
	uint32_t
	    OutterBufferability; /*!< Bufferability of an access generated by
				    the GFXMMU cache. This parameter can be a
				    value of @ref GFXMMU_OutterBufferability. */
	uint32_t
	    OutterCachability; /*!< Cachability of an access generated by the
				  GFXMMU cache. This parameter can be a value of
				  @ref GFXMMU_OutterCachability. */
...
typedef struct {
	FunctionalState Activation; /*!< Address Cache and enable/disable.
				    @note: All following parameters are useful
				    only if address cache is enabled. */
	uint32_t
	    AddressCacheLockBuffer; /*!< Buffer on which the address cache is
				    locked. This parameter can be a value of
				    @ref GFXMMU_AddressCacheLockBuffer.
				    @note: Useful only when lock of the address
				    cache is enabled. */
...
#if defined(GFXMMU_CR_ACE)
	GFXMMU_AddressCacheTypeDef
	    AddressCache;		     /*!< Address Cache parameters. */
#endif					     /* GFXMMU_CR_ACE */
 ...
 *  @{
 */
#define GFXMMU_ADDRESSCACHE_LOCK_BUFFER0                                       \
	0x00000000U /*!< Address Cache locked to buffer 0 */
#define GFXMMU_ADDRESSCACHE_LOCK_BUFFER1                                       \
	GFXMMU_CR_ACLB_0 /*!< Address Cache locked to buffer 1 */
#define GFXMMU_ADDRESSCACHE_LOCK_BUFFER2                                       \
	GFXMMU_CR_ACLB_1 /*!< Address Cache locked to buffer 2 */
#define GFXMMU_ADDRESSCACHE_LOCK_BUFFER3                                       \
	GFXMMU_CR_ACLB /*!< Address Cache locked to buffer 3 */
/**
 * @}
 */
...
HAL_StatusTypeDef
HAL_GFXMMU_ConfigLutLine(const GFXMMU_HandleTypeDef *hgfxmmu,
...
HAL_StatusTypeDef
HAL_GFXMMU_ModifyBuffers(GFXMMU_HandleTypeDef *hgfxmmu,
...
/* State function *************************************************************/
HAL_GFXMMU_StateTypeDef
HAL_GFXMMU_GetState(const GFXMMU_HandleTypeDef *hgfxmmu);
...
#define IS_GFXMMU_ADDRESSCACHE_LOCK_BUFFER(VALUE)                              \
	(((VALUE) == GFXMMU_ADDRESSCACHE_LOCK_BUFFER0) ||                      \
...
#define IS_GFXMMU_CACHE_FORCE_ACTION(VALUE)                                    \
	(((VALUE) == GFXMMU_CACHE_FORCE_FLUSH) ||                              \
	 ...
	 ((VALUE) ==                                                           \
	  (GFXMMU_CACHE_FORCE_FLUSH | GFXMMU_CACHE_FORCE_INVALIDATE)))
