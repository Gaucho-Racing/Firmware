...
#define IS_DAC_TRIGGER(TRIGGER)                                                                                        \
	(((TRIGGER) == DAC_TRIGGER_NONE) || ((TRIGGER) == DAC_TRIGGER_T1_TRGO) ||                                      \
	 ...
	 ((TRIGGER) == DAC_TRIGGER_LPTIM3_CH1) || ((TRIGGER) == DAC_TRIGGER_EXT_IT9) ||                                \
	 ((TRIGGER) == DAC_TRIGGER_STOP_LPTIM1_CH1) || ((TRIGGER) == DAC_TRIGGER_STOP_LPTIM3_CH1) ||                   \
	 ((TRIGGER) == DAC_TRIGGER_STOP_EXT_IT9) || ((TRIGGER) == DAC_TRIGGER_SOFTWARE))
...
#define IS_DAC_AUTONOMOUS(AUTONOMOUS)                                                                                  \
	(((AUTONOMOUS) == DAC_AUTONOMOUS_MODE_DISABLE) || ((AUTONOMOUS) == DAC_AUTONOMOUS_MODE_ENABLE))
/**
 * @}
 */
