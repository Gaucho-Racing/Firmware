...
#define IS_DAC_TRIGGER(TRIGGER)                                                                                                                                                                        \
	(((TRIGGER) == DAC_TRIGGER_NONE) || ((TRIGGER) == DAC_TRIGGER_T1_TRGO) || ((TRIGGER) == DAC_TRIGGER_T2_TRGO) || ((TRIGGER) == DAC_TRIGGER_T4_TRGO) || ((TRIGGER) == DAC_TRIGGER_T5_TRGO) ||    \
	 ...
	 ((TRIGGER) == DAC_TRIGGER_LPTIM1_CH1) || ((TRIGGER) == DAC_TRIGGER_LPTIM3_CH1) || ((TRIGGER) == DAC_TRIGGER_EXT_IT9) || ((TRIGGER) == DAC_TRIGGER_STOP_LPTIM1_CH1) ||                         \
	 ((TRIGGER) == DAC_TRIGGER_STOP_LPTIM3_CH1) || ((TRIGGER) == DAC_TRIGGER_STOP_EXT_IT9) || ((TRIGGER) == DAC_TRIGGER_SOFTWARE))
