...
#define LL_SPI_GRP1_GPDMA_CH0_TCF_TRG                                          \
	(uint32_t)(LL_SPI_TRIG_GRP1 | (0x00000000U))
...
#define LL_SPI_GRP1_EXTI4_TRG                                                  \
	(uint32_t)(LL_SPI_TRIG_GRP1 | (0x4U << SPI_AUTOCR_TRIGSEL_Pos))
/*!< HW Trigger signal is EXTI9_TRG         */
#define LL_SPI_GRP1_EXTI9_TRG                                                  \
	(uint32_t)(LL_SPI_TRIG_GRP1 | (0x5U << SPI_AUTOCR_TRIGSEL_Pos))
/*!< HW Trigger signal is LPTIM1_CH1_TRG    */
#define LL_SPI_GRP1_LPTIM1_CH1_TRG                                             \
	(uint32_t)(LL_SPI_TRIG_GRP1 | (0x6U << SPI_AUTOCR_TRIGSEL_Pos))
/*!< HW Trigger signal is LPTIM2_CH1_TRG    */
#define LL_SPI_GRP1_LPTIM2_CH1_TRG                                             \
	(uint32_t)(LL_SPI_TRIG_GRP1 | (0x7U << SPI_AUTOCR_TRIGSEL_Pos))
/*!< HW Trigger signal is COMP1_TRG         */
#define LL_SPI_GRP1_COMP1_TRG                                                  \
	(uint32_t)(LL_SPI_TRIG_GRP1 | (0x8U << SPI_AUTOCR_TRIGSEL_Pos))
/*!< HW Trigger signal is COMP2_TRG         */
#define LL_SPI_GRP1_COMP2_TRG                                                  \
	(uint32_t)(LL_SPI_TRIG_GRP1 | (0x9U << SPI_AUTOCR_TRIGSEL_Pos))
/*!< HW Trigger signal is RTC_ALRA_TRG      */
#define LL_SPI_GRP1_RTC_ALRA_TRG                                               \
	(uint32_t)(LL_SPI_TRIG_GRP1 | (0xAU << SPI_AUTOCR_TRIGSEL_Pos))
/*!< HW Trigger signal is RTC_WUT_TRG       */
#define LL_SPI_GRP1_RTC_WUT_TRG                                                \
	(uint32_t)(LL_SPI_TRIG_GRP1 | (0xBU << SPI_AUTOCR_TRIGSEL_Pos))

#if defined(LL_SPI_TRIG_GRP2)
/*!< HW Trigger signal is LPDMA_CH0_TRG     */
#define LL_SPI_GRP2_LPDMA_CH0_TCF_TRG                                          \
	(uint32_t)(LL_SPI_TRIG_GRP2 | (0x00000000U))
...
/*!< HW Trigger signal is EXTI4_TRG         */
#define LL_SPI_GRP2_EXTI4_TRG                                                  \
	(uint32_t)(LL_SPI_TRIG_GRP2 | (0x4U << SPI_AUTOCR_TRIGSEL_Pos))
/*!< HW Trigger signal is EXTI8_TRG         */
#define LL_SPI_GRP2_EXTI8_TRG                                                  \
	(uint32_t)(LL_SPI_TRIG_GRP2 | (0x5U << SPI_AUTOCR_TRIGSEL_Pos))
/*!< HW Trigger signal is LPTIM1_CH1_TRG    */
#define LL_SPI_GRP2_LPTIM1_CH1_TRG                                             \
	(uint32_t)(LL_SPI_TRIG_GRP2 | (0x6U << SPI_AUTOCR_TRIGSEL_Pos))
/*!< HW Trigger signal is LPTIM3_CH1_TRG    */
#define LL_SPI_GRP2_LPTIM3_CH1_TRG                                             \
	(uint32_t)(LL_SPI_TRIG_GRP2 | (0x7U << SPI_AUTOCR_TRIGSEL_Pos))
/*!< HW Trigger signal is COMP1_TRG         */
#define LL_SPI_GRP2_COMP1_TRG                                                  \
	(uint32_t)(LL_SPI_TRIG_GRP2 | (0x8U << SPI_AUTOCR_TRIGSEL_Pos))
/*!< HW Trigger signal is COMP2_TRG         */
#define LL_SPI_GRP2_COMP2_TRG                                                  \
	(uint32_t)(LL_SPI_TRIG_GRP2 | (0x9U << SPI_AUTOCR_TRIGSEL_Pos))
/*!< HW Trigger signal is RTC_ALRA_TRG      */
#define LL_SPI_GRP2_RTC_ALRA_TRG                                               \
	(uint32_t)(LL_SPI_TRIG_GRP2 | (0xAU << SPI_AUTOCR_TRIGSEL_Pos))
/*!< HW Trigger signal is RTC_WUT_TRG       */
#define LL_SPI_GRP2_RTC_WUT_TRG                                                \
	(uint32_t)(LL_SPI_TRIG_GRP2 | (0xBU << SPI_AUTOCR_TRIGSEL_Pos))
 ...
 * @{
 */
#define LL_SPI_TRIG_POLARITY_RISING                                            \
	0x00000000U /*!< SPI triggered on rising edge  */
#define LL_SPI_TRIG_POLARITY_FALLING                                           \
	SPI_AUTOCR_TRIGPOL /*!< SPI triggered on falling edge */
/**
 * @}
 */
...
{
	return ((READ_BIT(SPIx->CR1, SPI_CR1_MASRX) == (SPI_CR1_MASRX)) ? 1UL
									: 0UL);
}
...
{
	return (
	    uint32_t)(READ_BIT(SPIx->CFG1, (SPI_CFG1_MBR | SPI_CFG1_BPASS)));
}
						 ...
						 uint32_t TransferDirection)
{
	...
	MODIFY_REG(SPIx->CFG2, SPI_CFG2_COMM,
		   TransferDirection & SPI_CFG2_COMM);
}
						   ...
						   uint32_t HalfDuplexDirection)
{
	MODIFY_REG(SPIx->CR1, SPI_CR1_HDDIR,
		   HalfDuplexDirection & SPI_CR1_HDDIR);
}
...
{
	return ((READ_BIT(SPIx->CFG1, SPI_CFG1_CRCEN) == SPI_CFG1_CRCEN) ? 1UL
									 : 0UL);
}
...
{
	return ((READ_BIT(SPIx->IER, SPI_IER_RXPIE) == (SPI_IER_RXPIE)) ? 1UL
									: 0UL);
}
...
{
	return ((READ_BIT(SPIx->IER, SPI_IER_TXPIE) == (SPI_IER_TXPIE)) ? 1UL
									: 0UL);
}
...
{
	return ((READ_BIT(SPIx->IER, SPI_IER_DXPIE) == (SPI_IER_DXPIE)) ? 1UL
									: 0UL);
}
...
{
	return ((READ_BIT(SPIx->IER, SPI_IER_EOTIE) == (SPI_IER_EOTIE)) ? 1UL
									: 0UL);
}
...
{
	return ((READ_BIT(SPIx->IER, SPI_IER_UDRIE) == (SPI_IER_UDRIE)) ? 1UL
									: 0UL);
}
...
{
	return ((READ_BIT(SPIx->IER, SPI_IER_OVRIE) == (SPI_IER_OVRIE)) ? 1UL
									: 0UL);
}
 ...
 */
__STATIC_INLINE uint32_t
LL_SPI_IsEnabled_SelectedTrigger(const SPI_TypeDef *SPIx)
{
	return (
	    (READ_BIT(SPIx->AUTOCR, SPI_AUTOCR_TRIGEN) == (SPI_AUTOCR_TRIGEN))
		? 1UL
		: 0UL);
}
 ...
 * @retval None
 */
__STATIC_INLINE void LL_SPI_SetTriggerPolarity(SPI_TypeDef *SPIx,
					       uint32_t Polarity)
{
 ...
 * @retval None
 */
__STATIC_INLINE void LL_SPI_SetSelectedTrigger(SPI_TypeDef *SPIx,
					       uint32_t Trigger)
{
	MODIFY_REG(SPIx->AUTOCR, SPI_AUTOCR_TRIGSEL,
		   (Trigger & SPI_AUTOCR_TRIGSEL_Msk));
}
