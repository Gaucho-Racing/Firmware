/**
  ...
  ******************************************************************************
  ...
  default weak (overridden) function. HAL_DCMI_UnRegisterCallback() takes as
  ...
  legacy weak (overridden) functions in the HAL_DCMI_Init and HAL_DCMI_DeInit
...
HAL_StatusTypeDef HAL_DCMI_Init(DCMI_HandleTypeDef *hdcmi)
{
	...
	{
		hdcmi->Instance->ESCR = (((uint32_t)hdcmi->Init.SyncroCode.FrameStartCode) | ((uint32_t)hdcmi->Init.SyncroCode.LineStartCode << DCMI_ESCR_LSC_Pos) |
					 ((uint32_t)hdcmi->Init.SyncroCode.LineEndCode << DCMI_ESCR_LEC_Pos) | ((uint32_t)hdcmi->Init.SyncroCode.FrameEndCode << DCMI_ESCR_FEC_Pos));
	}
...
__weak void HAL_DCMI_MspInit(DCMI_HandleTypeDef *hdcmi)
{
	...
	/* NOTE : This function Should not be modified, when the callback is
	   needed, the HAL_DCMI_MspInit could be implemented in the user file
	 */
}
...
__weak void HAL_DCMI_MspDeInit(DCMI_HandleTypeDef *hdcmi)
{
	...
	/* NOTE : This function Should not be modified, when the callback is
	   needed, the HAL_DCMI_MspDeInit could be implemented in the user file
	 */
}
...
void HAL_DCMI_IRQHandler(DCMI_HandleTypeDef *hdcmi)
{
	...
	{
		/* When snapshot mode, disable Vsync, Error and Overrun
		 * interrupts */
...
__weak void HAL_DCMI_ErrorCallback(DCMI_HandleTypeDef *hdcmi)
{
	...
	/* NOTE : This function Should not be modified, when the callback is
	   needed, the HAL_DCMI_ErrorCallback could be implemented in the user
	   file
	 */
}
...
__weak void HAL_DCMI_LineEventCallback(DCMI_HandleTypeDef *hdcmi)
{
	...
	UNUSED(hdcmi);
	/* NOTE : This function Should not be modified, when the callback is
	   needed, the HAL_DCMI_LineEventCallback could be implemented in the
	   user file
	 */
}
...
__weak void HAL_DCMI_VsyncEventCallback(DCMI_HandleTypeDef *hdcmi)
{
	...
	/* NOTE : This function Should not be modified, when the callback is
	   needed, the HAL_DCMI_VsyncEventCallback could be implemented in the
	   user file
	 */
}
...
__weak void HAL_DCMI_FrameEventCallback(DCMI_HandleTypeDef *hdcmi)
{
	...
	/* NOTE : This function Should not be modified, when the callback is
	   needed, the HAL_DCMI_FrameEventCallback could be implemented in the
	   user file
	 */
}
