...
__weak void HAL_TIM_Base_MspInit(TIM_HandleTypeDef *htim)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_TIM_Base_MspInit could be implemented in the user
	   file
	 */
}
...
__weak void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef *htim)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_TIM_Base_MspDeInit could be implemented in the user
	   file
	 */
}
...
__weak void HAL_TIM_OC_MspInit(TIM_HandleTypeDef *htim)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_TIM_OC_MspInit could be implemented in the user file
	 */
}
...
__weak void HAL_TIM_OC_MspDeInit(TIM_HandleTypeDef *htim)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_TIM_OC_MspDeInit could be implemented in the user
	   file
	 */
}
...
__weak void HAL_TIM_PWM_MspInit(TIM_HandleTypeDef *htim)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_TIM_PWM_MspInit could be implemented in the user file
	 */
}
...
__weak void HAL_TIM_PWM_MspDeInit(TIM_HandleTypeDef *htim)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_TIM_PWM_MspDeInit could be implemented in the user
	   file
	 */
}
...
__weak void HAL_TIM_IC_MspInit(TIM_HandleTypeDef *htim)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_TIM_IC_MspInit could be implemented in the user file
	 */
}
...
__weak void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef *htim)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_TIM_IC_MspDeInit could be implemented in the user
	   file
	 */
}
...
__weak void HAL_TIM_OnePulse_MspInit(TIM_HandleTypeDef *htim)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_TIM_OnePulse_MspInit could be implemented in the user
	   file
	 */
}
...
__weak void HAL_TIM_OnePulse_MspDeInit(TIM_HandleTypeDef *htim)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_TIM_OnePulse_MspDeInit could be implemented in the
	   user file
	 */
}
...
HAL_StatusTypeDef HAL_TIM_OnePulse_Start(TIM_HandleTypeDef *htim, uint32_t OutputChannel)
{
	...
	/* Enable the Capture compare and the Input Capture channels
	  ...
	  TIM_CHANNEL_1 and TIM_CHANNEL_2) if TIM_CHANNEL_1 is used as output,
	  the TIM_CHANNEL_2 will be used as input and if TIM_CHANNEL_1 is used
	  as input, the TIM_CHANNEL_2 will be used as output whatever the
	  combination, the TIM_CHANNEL_1 and TIM_CHANNEL_2 should be enabled
	  together
...
HAL_StatusTypeDef HAL_TIM_OnePulse_Stop(TIM_HandleTypeDef *htim, uint32_t OutputChannel)
{
	...
	TIM_CHANNEL_2 will be used as input and if TIM_CHANNEL_1 is used as
	input, the TIM_CHANNEL_2 will be used as output whatever the
	combination, the TIM_CHANNEL_1 and TIM_CHANNEL_2 should be disabled
	together */
...
__weak void HAL_TIM_Encoder_MspInit(TIM_HandleTypeDef *htim)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_TIM_Encoder_MspInit could be implemented in the user
	   file
	 */
}
...
__weak void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef *htim)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_TIM_Encoder_MspDeInit could be implemented in the
	   user file
	 */
}
...
HAL_StatusTypeDef HAL_TIM_OnePulse_ConfigChannel(TIM_HandleTypeDef *htim, TIM_OnePulse_InitTypeDef *sConfig, uint32_t OutputChannel, uint32_t InputChannel)
{
	...
	if (OutputChannel != InputChannel) {
		...
		/* Extract the Output compare configuration from sConfig
		 * structure */
...
HAL_StatusTypeDef HAL_TIM_DMABurst_WriteStart(TIM_HandleTypeDef *htim, uint32_t BurstBaseAddress, uint32_t BurstRequestSrc, const uint32_t *BurstBuffer, uint32_t BurstLength)
{
	...
	if (hdma != NULL) {
		...
		if (((hdma->Mode & DMA_LINKEDLIST) == DMA_LINKEDLIST) && (hdma->LinkedListQueue != 0U) && (hdma->LinkedListQueue->Head != 0U)) {
		...
		if (status == HAL_OK) {
			status = HAL_TIM_DMABurst_MultiWriteStart(htim, BurstBaseAddress, BurstRequestSrc, BurstBuffer, BurstLength, BlockDataLength);
		}
	}
...
HAL_StatusTypeDef HAL_TIM_DMABurst_MultiWriteStart(TIM_HandleTypeDef *htim, uint32_t BurstBaseAddress, uint32_t BurstRequestSrc, const uint32_t *BurstBuffer, uint32_t BurstLength, uint32_t DataLength)
{
	...
	switch (BurstRequestSrc) {
		case TIM_DMA_UPDATE: {
			...
			/* Enable the DMA channel */
			if (TIM_DMA_Start_IT(htim->hdma[TIM_DMA_ID_UPDATE], (uint32_t)BurstBuffer, (uint32_t)&htim->Instance->DMAR, DataLength) != HAL_OK) {
				/* Return error status */
				return HAL_ERROR;
			}
		...
		case TIM_DMA_CC1: {
			...
			/* Enable the DMA channel */
			if (TIM_DMA_Start_IT(htim->hdma[TIM_DMA_ID_CC1], (uint32_t)BurstBuffer, (uint32_t)&htim->Instance->DMAR, DataLength) != HAL_OK) {
				/* Return error status */
				return HAL_ERROR;
			}
			/* Configure the DMA Burst Source Selection */
		...
		case TIM_DMA_CC2: {
			...
			/* Enable the DMA channel */
			if (TIM_DMA_Start_IT(htim->hdma[TIM_DMA_ID_CC2], (uint32_t)BurstBuffer, (uint32_t)&htim->Instance->DMAR, DataLength) != HAL_OK) {
				/* Return error status */
				return HAL_ERROR;
			}
			/* Configure the DMA Burst Source Selection */
		...
		case TIM_DMA_CC3: {
			...
			/* Enable the DMA channel */
			if (TIM_DMA_Start_IT(htim->hdma[TIM_DMA_ID_CC3], (uint32_t)BurstBuffer, (uint32_t)&htim->Instance->DMAR, DataLength) != HAL_OK) {
				/* Return error status */
				return HAL_ERROR;
			}
			/* Configure the DMA Burst Source Selection */
		...
		case TIM_DMA_CC4: {
			...
			/* Enable the DMA channel */
			if (TIM_DMA_Start_IT(htim->hdma[TIM_DMA_ID_CC4], (uint32_t)BurstBuffer, (uint32_t)&htim->Instance->DMAR, DataLength) != HAL_OK) {
				/* Return error status */
				return HAL_ERROR;
			}
			/* Configure the DMA Burst Source Selection */
		...
		case TIM_DMA_COM: {
			...
			/* Enable the DMA channel */
			if (TIM_DMA_Start_IT(htim->hdma[TIM_DMA_ID_COMMUTATION], (uint32_t)BurstBuffer, (uint32_t)&htim->Instance->DMAR, DataLength) != HAL_OK) {
				/* Return error status */
				return HAL_ERROR;
			}
			/* Configure the DMA Burst Source Selection */
		...
		case TIM_DMA_TRIGGER: {
			...
			/* Enable the DMA channel */
			if (TIM_DMA_Start_IT(htim->hdma[TIM_DMA_ID_TRIGGER], (uint32_t)BurstBuffer, (uint32_t)&htim->Instance->DMAR, DataLength) != HAL_OK) {
				/* Return error status */
				return HAL_ERROR;
			}
			/* Configure the DMA Burst Source Selection */
...
HAL_StatusTypeDef HAL_TIM_DMABurst_ReadStart(TIM_HandleTypeDef *htim, uint32_t BurstBaseAddress, uint32_t BurstRequestSrc, uint32_t *BurstBuffer, uint32_t BurstLength)
{
	...
	if (hdma != NULL) {
		...
		if (status == HAL_OK) {
			status = HAL_TIM_DMABurst_MultiReadStart(htim, BurstBaseAddress, BurstRequestSrc, BurstBuffer, BurstLength, BlockDataLength);
		}
	}
...
HAL_StatusTypeDef HAL_TIM_DMABurst_MultiReadStart(TIM_HandleTypeDef *htim, uint32_t BurstBaseAddress, uint32_t BurstRequestSrc, uint32_t *BurstBuffer, uint32_t BurstLength, uint32_t DataLength)
{
	...
	switch (BurstRequestSrc) {
		case TIM_DMA_UPDATE: {
			...
			/* Enable the DMA channel */
			if (TIM_DMA_Start_IT(htim->hdma[TIM_DMA_ID_UPDATE], (uint32_t)&htim->Instance->DMAR, (uint32_t)BurstBuffer, DataLength) != HAL_OK) {
				/* Return error status */
				return HAL_ERROR;
			}
			/* Configure the DMA Burst Source Selection */
		...
		case TIM_DMA_CC1: {
			...
			/* Enable the DMA channel */
			if (TIM_DMA_Start_IT(htim->hdma[TIM_DMA_ID_CC1], (uint32_t)&htim->Instance->DMAR, (uint32_t)BurstBuffer, DataLength) != HAL_OK) {
				/* Return error status */
				return HAL_ERROR;
			}
			/* Configure the DMA Burst Source Selection */
		...
		case TIM_DMA_CC2: {
			...
			/* Enable the DMA channel */
			if (TIM_DMA_Start_IT(htim->hdma[TIM_DMA_ID_CC2], (uint32_t)&htim->Instance->DMAR, (uint32_t)BurstBuffer, DataLength) != HAL_OK) {
				/* Return error status */
				return HAL_ERROR;
			}
			/* Configure the DMA Burst Source Selection */
		...
		case TIM_DMA_CC3: {
			...
			/* Enable the DMA channel */
			if (TIM_DMA_Start_IT(htim->hdma[TIM_DMA_ID_CC3], (uint32_t)&htim->Instance->DMAR, (uint32_t)BurstBuffer, DataLength) != HAL_OK) {
				/* Return error status */
				return HAL_ERROR;
			}
			/* Configure the DMA Burst Source Selection */
		...
		case TIM_DMA_CC4: {
			...
			/* Enable the DMA channel */
			if (TIM_DMA_Start_IT(htim->hdma[TIM_DMA_ID_CC4], (uint32_t)&htim->Instance->DMAR, (uint32_t)BurstBuffer, DataLength) != HAL_OK) {
				/* Return error status */
				return HAL_ERROR;
			}
			/* Configure the DMA Burst Source Selection */
		...
		case TIM_DMA_COM: {
			...
			/* Enable the DMA channel */
			if (TIM_DMA_Start_IT(htim->hdma[TIM_DMA_ID_COMMUTATION], (uint32_t)&htim->Instance->DMAR, (uint32_t)BurstBuffer, DataLength) != HAL_OK) {
				/* Return error status */
				return HAL_ERROR;
			}
			/* Configure the DMA Burst Source Selection */
		...
		case TIM_DMA_TRIGGER: {
			...
			/* Enable the DMA channel */
			if (TIM_DMA_Start_IT(htim->hdma[TIM_DMA_ID_TRIGGER], (uint32_t)&htim->Instance->DMAR, (uint32_t)BurstBuffer, DataLength) != HAL_OK) {
				/* Return error status */
				return HAL_ERROR;
			}
			/* Configure the DMA Burst Source Selection */
...
HAL_StatusTypeDef HAL_TIM_ConfigOCrefClear(TIM_HandleTypeDef *htim, const TIM_ClearInputConfigTypeDef *sClearInputConfig, uint32_t Channel)
{
	...
	switch (sClearInputConfig->ClearInputSource) {
		...
		case TIM_CLEARINPUTSOURCE_ETR: {
			...
			/* When OCRef clear feature is used with ETR source, ETR
		...
		switch (Channel) {
			case TIM_CHANNEL_1: {
				if (sClearInputConfig->ClearInputState != (uint32_t)DISABLE) {
					/* Enable the OCREF clear feature for
					 * Channel 1
					 */
					SET_BIT(htim->Instance->CCMR1, TIM_CCMR1_OC1CE);
				} else {
					/* Disable the OCREF clear feature for
					 * Channel 1
					 */
...
HAL_StatusTypeDef HAL_TIM_ConfigClockSource(TIM_HandleTypeDef *htim, const TIM_ClockConfigTypeDef *sClockSourceConfig)
{
	...
	switch (sClockSourceConfig->ClockSource) {
		...
		case TIM_CLOCKSOURCE_ETRMODE1: {
			/* Check whether or not the timer instance supports
			 * external trigger input mode 1 (ETRF)*/
		...
		case TIM_CLOCKSOURCE_ETRMODE2: {
			/* Check whether or not the timer instance supports
			 * external trigger input mode 2 (ETRF)*/
...
__weak void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_TIM_PeriodElapsedCallback could be implemented in the
	   user file
	 */
}
...
__weak void HAL_TIM_PeriodElapsedHalfCpltCallback(TIM_HandleTypeDef *htim)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_TIM_PeriodElapsedHalfCpltCallback could be
...
__weak void HAL_TIM_OC_DelayElapsedCallback(TIM_HandleTypeDef *htim)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_TIM_OC_DelayElapsedCallback could be implemented in
	   the user file
	 */
}
...
__weak void HAL_TIM_IC_CaptureCallback(TIM_HandleTypeDef *htim)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_TIM_IC_CaptureCallback could be implemented in the
	   user file
	 */
}
...
__weak void HAL_TIM_IC_CaptureHalfCpltCallback(TIM_HandleTypeDef *htim)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_TIM_IC_CaptureHalfCpltCallback could be implemented
	   in the user file
	 */
}
...
__weak void HAL_TIM_PWM_PulseFinishedCallback(TIM_HandleTypeDef *htim)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_TIM_PWM_PulseFinishedCallback could be implemented in
	   the user file
	 */
}
...
__weak void HAL_TIM_PWM_PulseFinishedHalfCpltCallback(TIM_HandleTypeDef *htim)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_TIM_PWM_PulseFinishedHalfCpltCallback could be
	   implemented in the user file
	 */
}
...
__weak void HAL_TIM_TriggerCallback(TIM_HandleTypeDef *htim)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_TIM_TriggerCallback could be implemented in the user
	   file
	 */
}
...
__weak void HAL_TIM_TriggerHalfCpltCallback(TIM_HandleTypeDef *htim)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_TIM_TriggerHalfCpltCallback could be implemented in
	   the user file
	 */
}
...
__weak void HAL_TIM_ErrorCallback(TIM_HandleTypeDef *htim)
{
	...
	/* NOTE : This function should not be modified, when the callback is
	   needed, the HAL_TIM_ErrorCallback could be implemented in the user
	   file
	 */
}
...
HAL_StatusTypeDef HAL_TIM_UnRegisterCallback(TIM_HandleTypeDef *htim, HAL_TIM_CallbackIDTypeDef CallbackID)
{
	...
	if (htim->State == HAL_TIM_STATE_READY) {
		switch (CallbackID) {
			...
			case HAL_TIM_PERIOD_ELAPSED_HALF_CB_ID:
				/* Legacy weak Period Elapsed half complete
				 * Callback */
			...
			case HAL_TIM_PWM_PULSE_FINISHED_HALF_CB_ID:
				/* Legacy weak PWM Pulse Finished half complete
				 * Callback
				 */
			...
			case HAL_TIM_COMMUTATION_HALF_CB_ID:
				/* Legacy weak Commutation half complete
				 * Callback */
...
void TIM_Base_SetConfig(TIM_TypeDef *TIMx, const TIM_Base_InitTypeDef *Structure)
{
	...
	/* Generate an update event to reload the Prescaler
	   and the repetition counter (only for advanced timer) value
	   immediately */
	TIMx->EGR = TIM_EGR_UG;
