...
#define IS_LL_GPIO_ALTERNATE(__VALUE__)                                                                                                                                                                \
	(((__VALUE__) == LL_GPIO_AF_0) || ((__VALUE__) == LL_GPIO_AF_1) || ((__VALUE__) == LL_GPIO_AF_2) || ((__VALUE__) == LL_GPIO_AF_3) || ((__VALUE__) == LL_GPIO_AF_4) ||                          \
	 ((__VALUE__) == LL_GPIO_AF_5) || ((__VALUE__) == LL_GPIO_AF_6) || ((__VALUE__) == LL_GPIO_AF_7) || ((__VALUE__) == LL_GPIO_AF_8) || ((__VALUE__) == LL_GPIO_AF_9) ||                          \
	 ((__VALUE__) == LL_GPIO_AF_10) || ((__VALUE__) == LL_GPIO_AF_11) || ((__VALUE__) == LL_GPIO_AF_12) || ((__VALUE__) == LL_GPIO_AF_13) || ((__VALUE__) == LL_GPIO_AF_14) ||                     \
