...
HAL_StatusTypeDef HAL_TIMEx_OCN_Start(TIM_HandleTypeDef *htim, uint32_t Channel)
{
	...
	if (TIM_CHANNEL_N_STATE_GET(htim, Channel) !=
	    HAL_TIM_CHANNEL_STATE_READY) {
		return HAL_ERROR;
	}
					...
					uint32_t Channel)
{
	...
	if (status == HAL_OK) {
		...
		/* Set the TIM complementary channel state */
		TIM_CHANNEL_N_STATE_SET(htim, Channel,
					HAL_TIM_CHANNEL_STATE_READY);
	}
					      ...
					      uint32_t CommutationSource)
{
	...
	assert_param(IS_TIM_INTERNAL_TRIGGEREVENT_INSTANCE(htim->Instance,
							   InputTrigger));
    ...
    const TIM_BreakDeadTimeConfigTypeDef *sBreakDeadTimeConfig)
{
	...
	MODIFY_REG(tmpbdtr, TIM_BDTR_OSSI,
		   sBreakDeadTimeConfig->OffStateIDLEMode);
	MODIFY_REG(tmpbdtr, TIM_BDTR_OSSR,
		   sBreakDeadTimeConfig->OffStateRunMode);
	MODIFY_REG(tmpbdtr, TIM_BDTR_BKE, sBreakDeadTimeConfig->BreakState);
	MODIFY_REG(tmpbdtr, TIM_BDTR_BKP, sBreakDeadTimeConfig->BreakPolarity);
	MODIFY_REG(tmpbdtr, TIM_BDTR_AOE,
		   sBreakDeadTimeConfig->AutomaticOutput);
	...
	if (IS_TIM_BKIN2_INSTANCE(htim->Instance)) {
		...
		assert_param(IS_TIM_BREAK2_POLARITY(
		...
		MODIFY_REG(tmpbdtr, TIM_BDTR_BK2E,
    ...
    const TIMEx_BreakInputConfigTypeDef *sBreakInputConfig)
{
	...
	switch (sBreakInputConfig->Source) {
		...
		case TIM_BREAKINPUTSOURCE_MDF1: {
			...
			/* No polarity bit for MDF. Variable bkin_polarity_mask
			 * keeps its default value 0 */
 ...
 *            @arg TIM_TIM1_ETR_ADC2_AWD2       TIM1_ETR is connected to ADC2
 * AWD2     (*)
 *            @arg TIM_TIM1_ETR_ADC2_AWD3       TIM1_ETR is connected to ADC2
 * AWD3     (*)
 ...
 * AWD3
 *            @arg TIM_TIM1_ETR_ADC2_AWD1       TIM1_ETR is connected to ADC2
 * AWD1     (*)
 *
 ...
 *            @arg TIM_TIM2_ETR_DCMI_VSYNC      TIM2_ETR is connected to DCMI
 * VSYNC    (*)
 *            @arg TIM_TIM2_ETR_LTDC_VSYNC      TIM2_ETR is connected to
 * LTDC_VSYNC    (*)
 ...
 * (*)
 *            @arg TIM_TIM2_ETR_DCMI_HSYNC      TIM2_ETR is connected to DCMI
 * HSYNC    (*)
 *            @arg TIM_TIM2_ETR_LTDC_HSYNC      TIM2_ETR is connected to LTDC
 * HSYNC    (*)
 *
 ...
 *            @arg TIM_TIM3_ETR_DCMI_VSYNC      TIM3_ETR is connected to DCMI
 * VSYNC    (*)
 *            @arg TIM_TIM3_ETR_LTDC_VSYNC      TIM3_ETR is connected to
 * LTDC_VSYNC    (*)
 ...
 * (*)
 *            @arg TIM_TIM3_ETR_ADC1_AWD1       TIM3 ETR is connected to ADC1
 * AWD1
 *            @arg TIM_TIM3_ETR_ADC1_AWD2       TIM3 ETR is connected to ADC1
 * AWD2
 *            @arg TIM_TIM3_ETR_ADC1_AWD3       TIM3 ETR is connected to ADC1
 * AWD3
 *            @arg TIM_TIM3_ETR_DCMI_HSYNC      TIM3_ETR is connected to DCMI
 * HSYNC    (*)
 *            @arg TIM_TIM3_ETR_LTDC_HSYNC      TIM3_ETR is connected to LTDC
 * HSYNC    (*)
 *
 ...
 *            @arg TIM_TIM4_ETR_DCMI_VSYNC      TIM4_ETR is connected to DCMI
 * VSYNC    (*)
 *            @arg TIM_TIM4_ETR_LTDC_VSYNC      TIM4_ETR is connected to
 * LTDC_VSYNC    (*)
 ...
 * (*)
 *            @arg TIM_TIM4_ETR_ADC2_AWD1       TIM4_ETR is connected to ADC2
 * AWD1     (*)
 *            @arg TIM_TIM4_ETR_ADC2_AWD2       TIM4_ETR is connected to ADC2
 * AWD2     (*)
 *            @arg TIM_TIM4_ETR_ADC2_AWD3       TIM4_ETR is connected to ADC2
 * AWD3     (*)
 *            @arg TIM_TIM4_ETR_DCMI_HSYNC      TIM4_ETR is connected to DCMI
 * HSYNC    (*)
 *            @arg TIM_TIM4_ETR_LTDC_HSYNC      TIM4_ETR is connected to LTDC
 * HSYNC    (*)
 *
 ...
 *            @arg TIM_TIM5_ETR_DCMI_VSYNC      TIM5_ETR is connected to DCMI
 * VSYNC    (*)
 *            @arg TIM_TIM5_ETR_LTDC_VSYNC      TIM5_ETR is connected to
 * LTDC_VSYNC    (*)
 ...
 * (*)
 *            @arg TIM_TIM5_ETR_DCMI_HSYNC      TIM5_ETR is connected to DCMI
 * HSYNC    (*)
 *            @arg TIM_TIM5_ETR_LTDC_HSYNC      TIM5_ETR is connected to LTDC
 * HSYNC    (*)
 *
 ...
 * AWD3     (*)
 *            @arg TIM_TIM8_ETR_ADC1_AWD1       TIM8 ETR is connected to ADC1
 * AWD1
 *            @arg TIM_TIM8_ETR_ADC1_AWD2       TIM8 ETR is connected to ADC1
 * AWD2
 *            @arg TIM_TIM8_ETR_ADC1_AWD3       TIM8 ETR is connected to ADC1
 * AWD3
 *            @arg TIM_TIM8_ETR_ADC4_AWD1       TIM8 ETR is connected to ADC4
 * AWD1
 *            @arg TIM_TIM8_ETR_ADC4_AWD2       TIM8 ETR is connected to ADC4
 * AWD2
 *            @arg TIM_TIM8_ETR_ADC4_AWD3       TIM8 ETR is connected to ADC4
 * AWD3
 ...
 *            @arg TIM_TIM5_TI1_RTC_WKUP:           TIM5 TI1 is connected to RTC
 * wakeup interrupt
 ...
 *            @arg TIM_TIM16_TI1_HSE_DIV32:         TIM16 TI1 is connected to
 * HSE/32
 *            @arg TIM_TIM16_TI1_MSIS_1024:         TIM16 TI1 is connected to
 * MSIS/1024
 *            @arg TIM_TIM16_TI1_MSIS_4:            TIM16 TI1 is connected to
 * MSIS/4
 *            @arg TIM_TIM16_TI1_HSI_256:           TIM16 TI1 is connected to
 * HSI/256
 *
 ...
 * LSE
 *            @arg TIM_TIM17_TI1_RTC_WKUP:          TIM17 TI1 is connected to
 * RTC wakeup interrupt
 *            @arg TIM_TIM17_TI1_HSE_DIV32:         TIM17 TI1 is connected to
 * HSE/32
 *            @arg TIM_TIM17_TI1_MSIS_1024:         TIM17 TI1 is connected to
 * MSIS/024
 *            @arg TIM_TIM17_TI1_MSIS_4:            TIM17 TI1 is connected to
 * MSIS/4
 *            @arg TIM_TIM17_TI1_HSI_256:           TIM17 TI1 is connected to
 * HSI/256
 *
 *         (*)  Value not defined in all devices. \n
 * @retval HAL status
					...
					uint32_t TISelection, uint32_t Channel)
{
	...
	switch (Channel) {
		case TIM_CHANNEL_1:
			MODIFY_REG(htim->Instance->TISEL, TIM_TISEL_TI1SEL,
				   TISelection);
			break;
		case TIM_CHANNEL_2:
			MODIFY_REG(htim->Instance->TISEL, TIM_TISEL_TI2SEL,
				   TISelection);
			break;
		case TIM_CHANNEL_4:
			MODIFY_REG(htim->Instance->TISEL, TIM_TISEL_TI4SEL,
				   TISelection);
			break;
		default:
			status = HAL_ERROR;
					     ...
					     uint32_t BreakInput)
{
	...
	switch (BreakInput) {
		case TIM_BREAKINPUT_BRK: {
			...
			if ((READ_BIT(tmpbdtr, TIM_BDTR_BKBID) ==
			     TIM_BDTR_BKBID) &&
		...
		case TIM_BREAKINPUT_BRK2: {
			/* Check initial conditions */
			tmpbdtr = READ_REG(htim->Instance->BDTR);
			if ((READ_BIT(tmpbdtr, TIM_BDTR_BK2BID) ==
			     TIM_BDTR_BK2BID) &&
			    (READ_BIT(tmpbdtr, TIM_BDTR_MOE) == 0U)) {
				/* Break input BRK is disarmed */
	...
	switch (BreakInput) {
		case TIM_BREAKINPUT_BRK: {
			...
			if (READ_BIT(htim->Instance->BDTR, TIM_BDTR_BKBID) ==
				...
				while (READ_BIT(htim->Instance->BDTR,
						TIM_BDTR_BKDSRM) != 0UL) {
    ...
    TIMEx_EncoderIndexConfigTypeDef *sEncoderIndexConfig)
{
	...
	assert_param(
	    IS_TIM_ENCODERINDEX_POLARITY(sEncoderIndexConfig->Polarity));
	assert_param(
	    IS_TIM_ENCODERINDEX_PRESCALER(sEncoderIndexConfig->Prescaler));
	assert_param(IS_TIM_ENCODERINDEX_FILTER(sEncoderIndexConfig->Filter));
	assert_param(
	    IS_TIM_ENCODERINDEX_BLANKING(sEncoderIndexConfig->Blanking));
	assert_param(
	    IS_FUNCTIONAL_STATE(sEncoderIndexConfig->FirstIndexEnable));
	assert_param(
	    IS_TIM_ENCODERINDEX_POSITION(sEncoderIndexConfig->Position));
	assert_param(
	    IS_TIM_ENCODERINDEX_DIRECTION(sEncoderIndexConfig->Direction));
	...
	if (HAL_GetREVID() >= REV_ID_B) /* supported in cut2 */
	{
		MODIFY_REG(htim->Instance->ECR,
			   TIM_ECR_IDIR_Msk | TIM_ECR_IBLK_Msk |
			       TIM_ECR_FIDX_Msk | TIM_ECR_IPOS_Msk,
		...
		MODIFY_REG(htim->Instance->ECR,
			   TIM_ECR_IDIR_Msk | TIM_ECR_FIDX_Msk |
			       TIM_ECR_IPOS_Msk,
			   (sEncoderIndexConfig->Direction |
			    ((sEncoderIndexConfig->FirstIndexEnable == ENABLE)
				 ? (0x1U << TIM_ECR_FIDX_Pos)
...
/**
 * @brief  Enable HSE/32 .
 * @note  This function should be called to enable the HSE/32 when it is
 * selected as TIM17_TI1 or TIM16_TI1 input source.
 * @param htim TIM handle.
 * @retval  HAL status.
 */
...
#if defined(STM32U575xx) || defined(STM32U585xx)
	/* The Cut1.x contains a limitation when using HSE/32 as input capture
	   for TIM16 Bug ID 56: On TIM16, the HSE/32 input capture requires the
	   set of HSE32EN bit of TIM17 Option Register */
