...
#define IS_LL_COMP_INPUT_PLUS(__COMP_INSTANCE__, __INPUT_PLUS__)                                                                                                                                       \
	(((__INPUT_PLUS__) == LL_COMP_INPUT_PLUS_IO1) || ((__INPUT_PLUS__) == LL_COMP_INPUT_PLUS_IO2) || ((__INPUT_PLUS__) == LL_COMP_INPUT_PLUS_IO3) ||                                               \
	 ((__INPUT_PLUS__) == LL_COMP_INPUT_PLUS_IO4) || ((__INPUT_PLUS__) == LL_COMP_INPUT_PLUS_IO5) || ((__INPUT_PLUS__) == LL_COMP_INPUT_PLUS_IO6))
#else
#define IS_LL_COMP_INPUT_PLUS(__COMP_INSTANCE__, __INPUT_PLUS__)                                                                                                                                       \
	(((__INPUT_PLUS__) == LL_COMP_INPUT_PLUS_IO1) || ((__INPUT_PLUS__) == LL_COMP_INPUT_PLUS_IO2) || ((__INPUT_PLUS__) == LL_COMP_INPUT_PLUS_IO3))
...
#define IS_LL_COMP_OUTPUT_BLANKING_SOURCE(__OUTPUT_BLANKING_SOURCE__)                                                                                                                                  \
	(((__OUTPUT_BLANKING_SOURCE__) == LL_COMP_BLANKINGSRC_NONE) || ((__OUTPUT_BLANKING_SOURCE__) == LL_COMP_BLANKINGSRC_TIM1_OC5) ||                                                               \
	 ...
	 ((__OUTPUT_BLANKING_SOURCE__) == LL_COMP_BLANKINGSRC_TIM3_OC4) || ((__OUTPUT_BLANKING_SOURCE__) == LL_COMP_BLANKINGSRC_TIM8_OC5) ||                                                           \
