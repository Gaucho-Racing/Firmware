...
#define IS_LL_DMA2D_OCMODE(MODE_ARGB)                                                                                                                                                                  \
	(((MODE_ARGB) == LL_DMA2D_OUTPUT_MODE_ARGB8888) || ((MODE_ARGB) == LL_DMA2D_OUTPUT_MODE_RGB888) || ((MODE_ARGB) == LL_DMA2D_OUTPUT_MODE_RGB565) ||                                             \
	 ((MODE_ARGB) == LL_DMA2D_OUTPUT_MODE_ARGB1555) || ((MODE_ARGB) == LL_DMA2D_OUTPUT_MODE_ARGB4444) || ((MODE_ARGB) == LL_DMA2D_OUTPUT_MODE_ARGB2222))
...
void LL_DMA2D_ConfigLayer(DMA2D_TypeDef *DMA2Dx, LL_DMA2D_LayerCfgTypeDef *DMA2D_LayerCfg, uint32_t LayerIdx)
{
	...
	if (LayerIdx == 0U) {
		...
		MODIFY_REG(DMA2Dx->BGPFCCR, (DMA2D_BGPFCCR_ALPHA | DMA2D_BGPFCCR_RBS | DMA2D_BGPFCCR_AI | DMA2D_BGPFCCR_AM | DMA2D_BGPFCCR_CS | DMA2D_BGPFCCR_CM),
		...
		/* Configure the foreground Alpha value, Alpha mode, RB swap, Alpha inversion
		   CLUT size and Color mode */
		MODIFY_REG(DMA2Dx->FGPFCCR, (DMA2D_FGPFCCR_ALPHA | DMA2D_FGPFCCR_RBS | DMA2D_FGPFCCR_AI | DMA2D_FGPFCCR_CSS | DMA2D_FGPFCCR_AM | DMA2D_FGPFCCR_CS | DMA2D_FGPFCCR_CM),
			   ((DMA2D_LayerCfg->Alpha << DMA2D_FGPFCCR_ALPHA_Pos) | DMA2D_LayerCfg->RBSwapMode | DMA2D_LayerCfg->AlphaInversionMode | DMA2D_LayerCfg->ChromaSubSampling |
			    DMA2D_LayerCfg->AlphaMode | (DMA2D_LayerCfg->CLUTSize << DMA2D_FGPFCCR_CS_Pos) | DMA2D_LayerCfg->ColorMode));
