...
#define IS_LL_DMA_ALL_CHANNEL_INSTANCE(INSTANCE, Channel)                                                                                                                                              \
	((((INSTANCE) == GPDMA1) &&                                                                                                                                                                    \
	  (((Channel) == LL_DMA_CHANNEL_0) || ((Channel) == LL_DMA_CHANNEL_1) || ((Channel) == LL_DMA_CHANNEL_2) || ((Channel) == LL_DMA_CHANNEL_3) || ((Channel) == LL_DMA_CHANNEL_4) ||              \
	   ...
	   ((Channel) == LL_DMA_CHANNEL_10) || ((Channel) == LL_DMA_CHANNEL_11) || ((Channel) == LL_DMA_CHANNEL_ALL))) ||                                                                              \
	 (((INSTANCE) == GPDMA2) &&                                                                                                                                                                    \
	  (((Channel) == LL_DMA_CHANNEL_0) || ((Channel) == LL_DMA_CHANNEL_1) || ((Channel) == LL_DMA_CHANNEL_2) || ((Channel) == LL_DMA_CHANNEL_3) || ((Channel) == LL_DMA_CHANNEL_4) ||              \
	   ((Channel) == LL_DMA_CHANNEL_5) || ((Channel) == LL_DMA_CHANNEL_6) || ((Channel) == LL_DMA_CHANNEL_7) || ((Channel) == LL_DMA_CHANNEL_8) || ((Channel) == LL_DMA_CHANNEL_9) ||              \
	   ((Channel) == LL_DMA_CHANNEL_10) || ((Channel) == LL_DMA_CHANNEL_11) || ((Channel) == LL_DMA_CHANNEL_ALL))))
...
#define IS_LL_DMA_ALL_CHANNEL_INSTANCE(INSTANCE, Channel)                                                                                                                                              \
	((((INSTANCE) == GPDMA1) &&                                                                                                                                                                    \
	  (((Channel) == LL_DMA_CHANNEL_0) || ((Channel) == LL_DMA_CHANNEL_1) || ((Channel) == LL_DMA_CHANNEL_2) || ((Channel) == LL_DMA_CHANNEL_3) || ((Channel) == LL_DMA_CHANNEL_4) ||              \
	   ((Channel) == LL_DMA_CHANNEL_5) || ((Channel) == LL_DMA_CHANNEL_6) || ((Channel) == LL_DMA_CHANNEL_7) || ((Channel) == LL_DMA_CHANNEL_ALL))) ||                                             \
	 (((INSTANCE) == GPDMA2) &&                                                                                                                                                                    \
	  (((Channel) == LL_DMA_CHANNEL_0) || ((Channel) == LL_DMA_CHANNEL_1) || ((Channel) == LL_DMA_CHANNEL_2) || ((Channel) == LL_DMA_CHANNEL_3) || ((Channel) == LL_DMA_CHANNEL_4) ||              \
	   ((Channel) == LL_DMA_CHANNEL_5) || ((Channel) == LL_DMA_CHANNEL_6) || ((Channel) == LL_DMA_CHANNEL_7) || ((Channel) == LL_DMA_CHANNEL_ALL))))
...
#define IS_LL_GPDMA_CHANNEL_INSTANCE(INSTANCE, Channel)                                                                                                                                                \
	((((INSTANCE) == GPDMA1) && (((Channel) == LL_DMA_CHANNEL_0) || ((Channel) == LL_DMA_CHANNEL_1) || ((Channel) == LL_DMA_CHANNEL_2) || ((Channel) == LL_DMA_CHANNEL_3) ||                       \
	 ...
	 (((INSTANCE) == GPDMA2) && (((Channel) == LL_DMA_CHANNEL_0) || ((Channel) == LL_DMA_CHANNEL_1) || ((Channel) == LL_DMA_CHANNEL_2) || ((Channel) == LL_DMA_CHANNEL_3) ||                       \
				     ((Channel) == LL_DMA_CHANNEL_4) || ((Channel) == LL_DMA_CHANNEL_5) || ((Channel) == LL_DMA_CHANNEL_6) || ((Channel) == LL_DMA_CHANNEL_7) ||                       \
				     ((Channel) == LL_DMA_CHANNEL_8) || ((Channel) == LL_DMA_CHANNEL_9) || ((Channel) == LL_DMA_CHANNEL_10) || ((Channel) == LL_DMA_CHANNEL_11))))
#else
#define IS_LL_GPDMA_CHANNEL_INSTANCE(INSTANCE, Channel)                                                                                                                                                \
...
#define IS_LL_DMA_2D_CHANNEL_INSTANCE(INSTANCE, Channel)                                                                                                                                               \
	((((INSTANCE) == GPDMA1) && (((Channel) == LL_DMA_CHANNEL_10) || ((Channel) == LL_DMA_CHANNEL_11))) ||                                                                                         \
	 (((INSTANCE) == GPDMA2) && (((Channel) == LL_DMA_CHANNEL_10) || ((Channel) == LL_DMA_CHANNEL_11))))
#else
#define IS_LL_DMA_2D_CHANNEL_INSTANCE(INSTANCE, Channel)                                                                                                                                               \
...
#define IS_LL_DMA_PFREQ_INSTANCE(INSTANCE, Channel)                                                                                                                                                    \
	((((INSTANCE) == GPDMA1) && (((Channel) == LL_DMA_CHANNEL_0) || ((Channel) == LL_DMA_CHANNEL_1) || ((Channel) == LL_DMA_CHANNEL_11))) ||                                                       \
	 (((INSTANCE) == GPDMA2) && (((Channel) == LL_DMA_CHANNEL_0) || ((Channel) == LL_DMA_CHANNEL_1) || ((Channel) == LL_DMA_CHANNEL_11))))
#else
#define IS_LL_DMA_PFREQ_INSTANCE(INSTANCE, Channel)                                                                                                                                                    \
...
#define IS_LL_DMA_LINK_NODETYPE(__VALUE__) (((__VALUE__) == LL_DMA_GPDMA_2D_NODE) || ((__VALUE__) == LL_DMA_GPDMA_LINEAR_NODE))
...
uint32_t LL_DMA_Init(DMA_TypeDef *DMAx, uint32_t Channel, LL_DMA_InitTypeDef *DMA_InitStruct)
{
	...
	LL_DMA_ConfigChannelTransfer(DMAx, Channel,
				     DMA_InitStruct->TransferEventMode | DMA_InitStruct->TriggerPolarity | DMA_InitStruct->BlkHWRequest | DMA_InitStruct->Mode | DMA_InitStruct->Direction);
...
uint32_t LL_DMA_CreateLinkNode(const LL_DMA_InitNodeTypeDef *DMA_InitNodeStruct, LL_DMA_LinkNodeTypeDef *pNode)
{
	...
	if ((DMA_InitNodeStruct->UpdateRegisters & LL_DMA_UPDATE_CTR1) == LL_DMA_UPDATE_CTR1) {
		...
		pNode->LinkRegisters[reg_counter] |= (DMA_InitNodeStruct->DestAllocatedPort | DMA_InitNodeStruct->DestHWordExchange | DMA_InitNodeStruct->DestByteExchange |
						      ((DMA_InitNodeStruct->DestBurstLength - 1U) << DMA_CTR1_DBL_1_Pos) | DMA_InitNodeStruct->SrcAllocatedPort | DMA_InitNodeStruct->SrcByteExchange |
	...
	if ((DMA_InitNodeStruct->UpdateRegisters & LL_DMA_UPDATE_CTR2) == LL_DMA_UPDATE_CTR2) {
		 ...
		 */
		pNode->LinkRegisters[reg_counter] =
		    (DMA_InitNodeStruct->TransferEventMode | DMA_InitNodeStruct->TriggerPolarity | DMA_InitNodeStruct->BlkHWRequest | DMA_InitNodeStruct->Mode | DMA_InitNodeStruct->Direction);
