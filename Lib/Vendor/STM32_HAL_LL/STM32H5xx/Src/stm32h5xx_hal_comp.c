...
HAL_StatusTypeDef HAL_COMP_Init(COMP_HandleTypeDef *hcomp)
{
	...
	if (hcomp == NULL) {
		...
		tmp_csr = (input_minus | hcomp->Init.InputPlus | hcomp->Init.BlankingSrce | hcomp->Init.Hysteresis | hcomp->Init.OutputPol | hcomp->Init.Mode);
#endif /* STM32H503xx */
		...
		MODIFY_REG(hcomp->Instance->CFGR1,
			   COMP_CFGR1_PWRMODE | COMP_CFGR1_INMSEL | COMP_CFGR1_INPSEL1 | COMP_CFGR1_INPSEL2 | COMP_CFGR1_POLARITY | COMP_CFGR1_HYST | COMP_CFGR1_BLANKING | COMP_CFGR1_BRGEN |
			       COMP_CFGR1_SCALEN,
			   tmp_csr);
...
#else
		MODIFY_REG(hcomp->Instance->CFGR1,
			   COMP_CFGR1_PWRMODE | COMP_CFGR1_INMSEL | COMP_CFGR1_INPSEL0 | COMP_CFGR1_INPSEL1 | COMP_CFGR1_POLARITY | COMP_CFGR1_HYST | COMP_CFGR1_BLANKING | COMP_CFGR1_BRGEN |
			       COMP_CFGR1_SCALEN,
			   tmp_csr);
#endif /* STM32H503xx */
