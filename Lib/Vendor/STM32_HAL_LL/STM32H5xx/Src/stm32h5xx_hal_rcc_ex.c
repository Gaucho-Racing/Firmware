...
void HAL_RCCEx_GetPeriphCLKConfig(RCC_PeriphCLKInitTypeDef *pPeriphClkInit)
{
	...
	pPeriphClkInit->PeriphClockSelection = RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_USART2 | RCC_PERIPHCLK_USART3 | RCC_PERIPHCLK_LPUART1 | RCC_PERIPHCLK_I2C1 | RCC_PERIPHCLK_I2C2 |
					       RCC_PERIPHCLK_LPTIM1 | RCC_PERIPHCLK_LPTIM2 | RCC_PERIPHCLK_ADCDAC | RCC_PERIPHCLK_DAC_LP | RCC_PERIPHCLK_RTC | RCC_PERIPHCLK_RNG | RCC_PERIPHCLK_I3C1 |
					       RCC_PERIPHCLK_SPI1 | RCC_PERIPHCLK_SPI2 | RCC_PERIPHCLK_SPI3 | RCC_PERIPHCLK_CKPER;
	...
	if (pll1m != 0U) {
		switch (pll1source) {
			...
			case RCC_PLL1_SOURCE_HSI: /* HSI used as PLL1 clock source */
				...
				pll1vco = ((float_t)hsivalue / (float_t)pll1m) * ((float_t)(uint32_t)pll1n + (fracn1 / (float_t)0x2000) + (float_t)1);
				break;

			case RCC_PLL1_SOURCE_CSI: /* CSI used as PLL1 clock source */
				pll1vco = ((float_t)CSI_VALUE / (float_t)pll1m) * ((float_t)(uint32_t)pll1n + (fracn1 / (float_t)0x2000) + (float_t)1);
				break;

			case RCC_PLL1_SOURCE_HSE: /* HSE used as PLL1 clock source */
				pll1vco = ((float_t)HSE_VALUE / (float_t)pll1m) * ((float_t)(uint32_t)pll1n + (fracn1 / (float_t)0x2000) + (float_t)1);
				break;
		...
		if (HAL_IS_BIT_SET(RCC->CR, RCC_CR_PLL1RDY)) {
			if (__HAL_RCC_GET_PLL1_CLKOUT_CONFIG(RCC_PLL1_DIVP) != 0U) {
				pPLL1_Clocks->PLL1_P_Frequency = (uint32_t)(float_t)(pll1vco / ((float_t)(uint32_t)((RCC->PLL1DIVR & RCC_PLL1DIVR_PLL1P) >> RCC_PLL1DIVR_PLL1P_Pos) + (float_t)1));
			} else {
		...
		if (HAL_IS_BIT_SET(RCC->CR, RCC_CR_PLL1RDY)) {
			if (__HAL_RCC_GET_PLL1_CLKOUT_CONFIG(RCC_PLL1_DIVQ) != 0U) {
				pPLL1_Clocks->PLL1_Q_Frequency = (uint32_t)(float_t)(pll1vco / ((float_t)(uint32_t)((RCC->PLL1DIVR & RCC_PLL1DIVR_PLL1Q) >> RCC_PLL1DIVR_PLL1Q_Pos) + (float_t)1));
			} else {
		...
		if (HAL_IS_BIT_SET(RCC->CR, RCC_CR_PLL1RDY)) {
			if (__HAL_RCC_GET_PLL1_CLKOUT_CONFIG(RCC_PLL1_DIVR) != 0U) {
				pPLL1_Clocks->PLL1_R_Frequency = (uint32_t)(float_t)(pll1vco / ((float_t)(uint32_t)((RCC->PLL1DIVR & RCC_PLL1DIVR_PLL1R) >> RCC_PLL1DIVR_PLL1R_Pos) + (float_t)1));
			} else {
	...
	if (pll2m != 0U) {
		switch (pll2source) {
			case RCC_PLL2_SOURCE_HSI: /* HSI used as PLL clock source */
				hsivalue = (HSI_VALUE >> (__HAL_RCC_GET_HSI_DIVIDER() >> RCC_CR_HSIDIV_Pos));
				pll2vco = ((float_t)hsivalue / (float_t)pll2m) * ((float_t)(uint32_t)pll2n + (fracn2 / (float_t)0x2000) + (float_t)1);
				break;

			case RCC_PLL2_SOURCE_CSI: /* CSI used as PLL clock source */
				pll2vco = ((float_t)CSI_VALUE / (float_t)pll2m) * ((float_t)(uint32_t)pll2n + (fracn2 / (float_t)0x2000) + (float_t)1);
				break;

			case RCC_PLL2_SOURCE_HSE: /* HSE used as PLL clock source */
				pll2vco = ((float_t)HSE_VALUE / (float_t)pll2m) * ((float_t)(uint32_t)pll2n + (fracn2 / (float_t)0x2000) + (float_t)1);
				break;
		...
		if (HAL_IS_BIT_SET(RCC->CR, RCC_CR_PLL2RDY)) {
			if (__HAL_RCC_GET_PLL2_CLKOUT_CONFIG(RCC_PLL2_DIVP) != 0U) {
				pPLL2_Clocks->PLL2_P_Frequency = (uint32_t)(float_t)(pll2vco / ((float_t)(uint32_t)((RCC->PLL2DIVR & RCC_PLL2DIVR_PLL2P) >> RCC_PLL2DIVR_PLL2P_Pos) + (float_t)1));
			} else {
		...
		if (HAL_IS_BIT_SET(RCC->CR, RCC_CR_PLL2RDY)) {
			if (__HAL_RCC_GET_PLL2_CLKOUT_CONFIG(RCC_PLL2_DIVQ) != 0U) {
				pPLL2_Clocks->PLL2_Q_Frequency = (uint32_t)(float_t)(pll2vco / ((float_t)(uint32_t)((RCC->PLL2DIVR & RCC_PLL2DIVR_PLL2Q) >> RCC_PLL2DIVR_PLL2Q_Pos) + (float_t)1));
			} else {
		...
		if (HAL_IS_BIT_SET(RCC->CR, RCC_CR_PLL2RDY)) {
			if (__HAL_RCC_GET_PLL2_CLKOUT_CONFIG(RCC_PLL2_DIVR) != 0U) {
				pPLL2_Clocks->PLL2_R_Frequency = (uint32_t)(float_t)(pll2vco / ((float_t)(uint32_t)((RCC->PLL2DIVR & RCC_PLL2DIVR_PLL2R) >> RCC_PLL2DIVR_PLL2R_Pos) + (float_t)1));
			} else {
	...
	if (pll3m != 0U) {
		switch (pll3source) {
			case RCC_PLL3_SOURCE_HSI: /* HSI used as PLL clock source */
				hsivalue = (HSI_VALUE >> (__HAL_RCC_GET_HSI_DIVIDER() >> RCC_CR_HSIDIV_Pos));
				pll3vco = ((float_t)hsivalue / (float_t)pll3m) * ((float_t)(uint32_t)pll3n + (fracn3 / (float_t)0x2000) + (float_t)1);
				break;

			case RCC_PLL3_SOURCE_CSI: /* CSI used as PLL clock source */
				pll3vco = ((float_t)CSI_VALUE / (float_t)pll3m) * ((float_t)(uint32_t)pll3n + (fracn3 / (float_t)0x2000) + (float_t)1);
				break;

			case RCC_PLL3_SOURCE_HSE: /* HSE used as PLL clock source */
				pll3vco = ((float_t)HSE_VALUE / (float_t)pll3m) * ((float_t)(uint32_t)pll3n + (fracn3 / (float_t)0x2000) + (float_t)1);
				break;
		...
		if (HAL_IS_BIT_SET(RCC->CR, RCC_CR_PLL3RDY)) {
			if (__HAL_RCC_GET_PLL3_CLKOUT_CONFIG(RCC_PLL3_DIVP) != 0U) {
				pPLL3_Clocks->PLL3_P_Frequency = (uint32_t)(float_t)(pll3vco / ((float_t)(uint32_t)((RCC->PLL3DIVR & RCC_PLL3DIVR_PLL3P) >> RCC_PLL3DIVR_PLL3P_Pos) + (float_t)1));
			} else {
		...
		if (HAL_IS_BIT_SET(RCC->CR, RCC_CR_PLL3RDY)) {
			if (__HAL_RCC_GET_PLL3_CLKOUT_CONFIG(RCC_PLL3_DIVQ) != 0U) {
				pPLL3_Clocks->PLL3_Q_Frequency = (uint32_t)(float_t)(pll3vco / ((float_t)(uint32_t)((RCC->PLL3DIVR & RCC_PLL3DIVR_PLL3Q) >> RCC_PLL3DIVR_PLL3Q_Pos) + (float_t)1));
			} else {
		...
		if (HAL_IS_BIT_SET(RCC->CR, RCC_CR_PLL3RDY)) {
			if (__HAL_RCC_GET_PLL3_CLKOUT_CONFIG(RCC_PLL3_DIVR) != 0U) {
				pPLL3_Clocks->PLL3_R_Frequency = (uint32_t)(float_t)(pll3vco / ((float_t)(uint32_t)((RCC->PLL3DIVR & RCC_PLL3DIVR_PLL3R) >> RCC_PLL3DIVR_PLL3R_Pos) + (float_t)1));
			} else {
			...
			case RCC_PERIPHCLK_PLAY1:
				...
				switch (srcclk) {
					...
					case RCC_PLAY1CLKSOURCE_CLKP: {
						...
						if (HAL_IS_BIT_SET(RCC->CR, RCC_CR_HSIRDY) && (ckpclocksource == RCC_CLKPSOURCE_HSI)) {
							/* In Case the CKPER Source is HSI */
							frequency = (HSI_VALUE >> (__HAL_RCC_GET_HSI_DIVIDER() >> RCC_CR_HSIDIV_Pos)) >> (play1_divider >> RCC_CCIPR3_PLAY1DIV_Pos);
						}
...
HAL_StatusTypeDef HAL_RCCEx_EnablePLL2(RCC_PLL2InitTypeDef *pPLL2Init)
{
	...
	if (status == HAL_OK) {
		...
		if (status == HAL_OK) {
			...
			__HAL_RCC_PLL2_CONFIG(pPLL2Init->PLL2Source, pPLL2Init->PLL2M, pPLL2Init->PLL2N, pPLL2Init->PLL2P, pPLL2Init->PLL2Q, pPLL2Init->PLL2R);
...
HAL_StatusTypeDef HAL_RCCEx_EnablePLL3(RCC_PLL3InitTypeDef *pPLL3Init)
{
	...
	if (status == HAL_OK) {
		...
		if (status == HAL_OK) {
			...
			__HAL_RCC_PLL3_CONFIG(pPLL3Init->PLL3Source, pPLL3Init->PLL3M, pPLL3Init->PLL3N, pPLL3Init->PLL3P, pPLL3Init->PLL3Q, pPLL3Init->PLL3R);
