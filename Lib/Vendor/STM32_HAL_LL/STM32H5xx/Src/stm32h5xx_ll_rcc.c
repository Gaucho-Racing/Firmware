...
#define IS_LL_RCC_UART_CLKSOURCE(__VALUE__)                                                                                                                                                            \
	(((__VALUE__) == LL_RCC_UART4_CLKSOURCE) || ((__VALUE__) == LL_RCC_UART5_CLKSOURCE) || ((__VALUE__) == LL_RCC_UART7_CLKSOURCE) || ((__VALUE__) == LL_RCC_UART8_CLKSOURCE) ||                   \
...
#if defined(I3C2)
#define IS_LL_RCC_I3C_CLKSOURCE(__VALUE__) (((__VALUE__) == LL_RCC_I3C1_CLKSOURCE) || ((__VALUE__) == LL_RCC_I3C2_CLKSOURCE))
#else
...
#define IS_LL_RCC_SPI_CLKSOURCE(__VALUE__)                                                                                                                                                             \
	(((__VALUE__) == LL_RCC_SPI1_CLKSOURCE) || ((__VALUE__) == LL_RCC_SPI2_CLKSOURCE) || ((__VALUE__) == LL_RCC_SPI3_CLKSOURCE) || ((__VALUE__) == LL_RCC_SPI4_CLKSOURCE) ||                       \
...
#define IS_LL_RCC_LPTIM_CLKSOURCE(__VALUE__)                                                                                                                                                           \
	(((__VALUE__) == LL_RCC_LPTIM1_CLKSOURCE) || ((__VALUE__) == LL_RCC_LPTIM2_CLKSOURCE) || ((__VALUE__) == LL_RCC_LPTIM3_CLKSOURCE) || ((__VALUE__) == LL_RCC_LPTIM4_CLKSOURCE) ||               \
...
#if defined(SDMMC2)
#define IS_LL_RCC_SDMMC_CLKSOURCE(__VALUE__) (((__VALUE__) == LL_RCC_SDMMC1_CLKSOURCE) || ((__VALUE__) == LL_RCC_SDMMC2_CLKSOURCE))
#elif defined(SDMMC1)
...
ErrorStatus LL_RCC_DeInit(void)
{
	...
	CLEAR_BIT(RCC->CR, RCC_CR_CSION | RCC_CR_CSIKERON | RCC_CR_HSECSSON | RCC_CR_HSIKERON | RCC_CR_HSI48ON | RCC_CR_HSEON | RCC_CR_PLL1ON | RCC_CR_PLL2ON | RCC_CR_PLL3ON);
#else
	/* Reset HSECSSON, HSEON, HSIKERON, CSION, CSIKERON, HSI48ON, PLL1ON, PLL2ON and  PLL3ON bits */
	CLEAR_BIT(RCC->CR, RCC_CR_CSION | RCC_CR_CSIKERON | RCC_CR_HSECSSON | RCC_CR_HSIKERON | RCC_CR_HSI48ON | RCC_CR_HSEON | RCC_CR_PLL1ON | RCC_CR_PLL2ON);
#endif /* PLL3 */
	...
	CLEAR_BIT(RCC->CIER, RCC_CIER_LSIRDYIE | RCC_CIER_LSERDYIE | RCC_CIER_HSIRDYIE | RCC_CIER_HSERDYIE | RCC_CIER_CSIRDYIE | RCC_CIER_HSI48RDYIE | RCC_CIER_PLL1RDYIE | RCC_CIER_PLL2RDYIE |
				 RCC_CIER_PLL3RDYIE);

	/* Clear all interrupt flags */
	SET_BIT(RCC->CICR, RCC_CICR_LSIRDYC | RCC_CICR_LSERDYC | RCC_CICR_HSIRDYC | RCC_CICR_HSERDYC | RCC_CICR_CSIRDYC | RCC_CICR_HSI48RDYC | RCC_CICR_PLL1RDYC | RCC_CICR_PLL2RDYC |
	...
	/* Clear all interrupt flags */
	SET_BIT(RCC->CICR,
		RCC_CICR_LSIRDYC | RCC_CICR_LSERDYC | RCC_CICR_HSIRDYC | RCC_CICR_HSERDYC | RCC_CICR_CSIRDYC | RCC_CICR_HSI48RDYC | RCC_CICR_PLL1RDYC | RCC_CICR_PLL2RDYC | RCC_CICR_HSECSSC);
#endif /* PLL3 */
