...
#define IS_LL_DAC_TRIGGER_SOURCE(__TRIGGER_SOURCE__)                                                                                                                                                   \
	(((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM1_TRGO) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM2_TRGO) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM4_TRGO) ||                          \
	 ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM5_TRGO) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM6_TRGO) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM7_TRGO) ||                          \
	 ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM8_TRGO) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM15_TRGO) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_LPTIM1_CH1) ||                        \
	 ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_LPTIM2_CH1) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_EXTI_LINE9) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_PLAY1_OUT11) ||                      \
	 ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_PLAY1_OUT12) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_SOFTWARE))
#elif defined(TIM8)
...
#define IS_LL_DAC_TRIGGER_SOURCE(__TRIGGER_SOURCE__)                                                                                                                                                   \
	(((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM1_TRGO) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM2_TRGO) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM4_TRGO) ||                          \
	 ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM5_TRGO) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM6_TRGO) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM7_TRGO) ||                          \
	 ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM8_TRGO) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM15_TRGO) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_LPTIM1_CH1) ||                        \
	 ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_LPTIM2_CH1) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_EXTI_LINE9) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_SOFTWARE))
#else
/* Devices STM32H503xx */
#define IS_LL_DAC_TRIGGER_SOURCE(__TRIGGER_SOURCE__)                                                                                                                                                   \
	(((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM1_TRGO) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM2_TRGO) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM3_TRGO) ||                          \
	 ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM6_TRGO) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM7_TRGO) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_LPTIM1_CH1) ||                         \
	 ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_LPTIM2_CH1) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_EXTI_LINE9) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_SOFTWARE))
