...
static HAL_StatusTypeDef I2S_WaitFlagStateUntilTimeout(I2S_HandleTypeDef *hi2s, uint32_t Flag, FlagStatus State, uint32_t Tickstart, uint32_t Timeout);
/**
 * @}
 */
...
HAL_StatusTypeDef HAL_I2S_Init(I2S_HandleTypeDef *hi2s)
{
	...
	if (IS_I2S_MASTER(hi2s->Init.Mode)) {
		...
		MODIFY_REG(hi2s->Instance->I2SCFGR, (SPI_I2SCFGR_I2SDIV | SPI_I2SCFGR_ODD), ((i2sdiv << SPI_I2SCFGR_I2SDIV_Pos) | (i2sodd << SPI_I2SCFGR_ODD_Pos)));
	}
	...
	MODIFY_REG(
	    ...
	    (SPI_I2SCFGR_I2SMOD | SPI_I2SCFGR_I2SCFG | SPI_I2SCFGR_I2SSTD | SPI_I2SCFGR_PCMSYNC | SPI_I2SCFGR_DATLEN | SPI_I2SCFGR_CHLEN | SPI_I2SCFGR_CKPOL | SPI_I2SCFGR_WSINV | SPI_I2SCFGR_DATFMT |
	     SPI_I2SCFGR_MCKOE),
	    (SPI_I2SCFGR_I2SMOD | hi2s->Init.Mode | hi2s->Init.Standard | hi2s->Init.DataFormat | hi2s->Init.CPOL | hi2s->Init.WSInversion | hi2s->Init.Data24BitAlignment | hi2s->Init.MCLKOutput));
