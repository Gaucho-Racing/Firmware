 ...
 * @param handle Specifies the peripheral Handle.
 */
#define PLAY_GET_INSTANCE_ID(handle) (HAL_PLAY1_INSTANCE_ID)
 ...
 */
#define IS_PLAY_TZ_ACCESS_CONTROL(access) (((access) == HAL_PLAY_TZ_REG_UNPROTECTED) || ((access) == HAL_PLAY_TZ_CONFIG_REG_PROTECTED) || ((access) == HAL_PLAY_TZ_ALL_REG_PROTECTED))
...
#define IS_PLAY_EDGE_DETECTION_MODE(mode)                                                                                                                                                              \
	(((mode) == HAL_PLAY_EDGE_DETECTION_BYPASSED) || ((mode) == HAL_PLAY_EDGE_DETECTION_RISING) || ((mode) == HAL_PLAY_EDGE_DETECTION_FALLING) ||                                                  \
...
#define IS_PLAY_IN_ID(mux)                                                                                                                                                                             \
	(((mux) == HAL_PLAY_IN0) || ((mux) == HAL_PLAY_IN1) || ((mux) == HAL_PLAY_IN2) || ((mux) == HAL_PLAY_IN3) || ((mux) == HAL_PLAY_IN4) || ((mux) == HAL_PLAY_IN5) || ((mux) == HAL_PLAY_IN6) ||  \
	 ((mux) == HAL_PLAY_IN7) || ((mux) == HAL_PLAY_IN8) || ((mux) == HAL_PLAY_IN9) || ((mux) == HAL_PLAY_IN10) || ((mux) == HAL_PLAY_IN11) || ((mux) == HAL_PLAY_IN12) ||                          \
	 ((mux) == HAL_PLAY_IN13) || ((mux) == HAL_PLAY_IN14) || ((mux) == HAL_PLAY_IN15))
...
#define IS_PLAY1_IN_SOURCE(source)                                                                                                                                                                     \
	/* IO */                                                                                                                                                                                       \
	(((source) == HAL_PLAY1_IN_IN0_MUX0) || ((source) == HAL_PLAY1_IN_IN1_MUX1) || ((source) == HAL_PLAY1_IN_IN2_MUX2) || ((source) == HAL_PLAY1_IN_IN3_MUX3) ||                                   \
	 ((source) == HAL_PLAY1_IN_IN4_MUX4) || ((source) == HAL_PLAY1_IN_IN5_MUX5) || ((source) == HAL_PLAY1_IN_IN6_MUX6) || ((source) == HAL_PLAY1_IN_IN7_MUX7) ||                                   \
	 ((source) == HAL_PLAY1_IN_IN8_MUX8) || ((source) == HAL_PLAY1_IN_IN9_MUX9) || ((source) == HAL_PLAY1_IN_IN10_MUX10) || ((source) == HAL_PLAY1_IN_IN11_MUX11) ||                               \
	 ((source) == HAL_PLAY1_IN_IN12_MUX12) || ((source) == HAL_PLAY1_IN_IN13_MUX13) || ((source) == HAL_PLAY1_IN_IN14_MUX14) || ((source) == HAL_PLAY1_IN_IN15_MUX15) /* ADC */                    \
	 || ((source) == HAL_PLAY1_IN_ADC1_AWD1_MUX3) || ((source) == HAL_PLAY1_IN_ADC1_AWD1_MUX7) || ((source) == HAL_PLAY1_IN_ADC1_AWD1_MUX9) || ((source) == HAL_PLAY1_IN_ADC1_AWD1_MUX15) ||       \
	 ((source) == HAL_PLAY1_IN_ADC1_AWD2_MUX0) || ((source) == HAL_PLAY1_IN_ADC1_AWD2_MUX4) || ((source) == HAL_PLAY1_IN_ADC1_AWD2_MUX8) || ((source) == HAL_PLAY1_IN_ADC1_AWD2_MUX10) ||          \
	 ((source) == HAL_PLAY1_IN_ADC2_AWD1_MUX3) || ((source) == HAL_PLAY1_IN_ADC2_AWD1_MUX7) || ((source) == HAL_PLAY1_IN_ADC2_AWD1_MUX11) || ((source) == HAL_PLAY1_IN_ADC2_AWD2_MUX4) ||          \
	 ((source) == HAL_PLAY1_IN_ADC2_AWD2_MUX8) || ((source) == HAL_PLAY1_IN_ADC2_AWD2_MUX12) /* COMP */                                                                                            \
	 || ((source) == HAL_PLAY1_IN_COMP1_OUT_MUX1) || ((source) == HAL_PLAY1_IN_COMP1_OUT_MUX5) || ((source) == HAL_PLAY1_IN_COMP1_OUT_MUX7) || ((source) == HAL_PLAY1_IN_COMP1_OUT_MUX13) ||       \
	 ((source) == HAL_PLAY1_IN_COMP2_OUT_MUX1) || ((source) == HAL_PLAY1_IN_COMP2_OUT_MUX5) || ((source) == HAL_PLAY1_IN_COMP2_OUT_MUX9)					   /* EVENT_OUT */     \
	 || ((source) == HAL_PLAY1_IN_EVENTOUT_MUX0) || ((source) == HAL_PLAY1_IN_EVENTOUT_MUX8) || ((source) == HAL_PLAY1_IN_EVENTOUT_MUX12)					   /* LOCKUP */        \
	 || ((source) == HAL_PLAY1_IN_LOCKUP_MUX4) || ((source) == HAL_PLAY1_IN_LOCKUP_MUX8) || ((source) == HAL_PLAY1_IN_LOCKUP_MUX12) || ((source) == HAL_PLAY1_IN_LOCKUP_MUX14) /* LPTIM */         \
	 || ((source) == HAL_PLAY1_IN_LPTIM1_CH1_MUX3) || ((source) == HAL_PLAY1_IN_LPTIM1_CH1_MUX5) || ((source) == HAL_PLAY1_IN_LPTIM1_CH1_MUX11) || ((source) == HAL_PLAY1_IN_LPTIM1_CH1_MUX15) ||  \
	 ((source) == HAL_PLAY1_IN_LPTIM1_CH2_MUX0) || ((source) == HAL_PLAY1_IN_LPTIM1_CH2_MUX4) || ((source) == HAL_PLAY1_IN_LPTIM1_CH2_MUX6) || ((source) == HAL_PLAY1_IN_LPTIM1_CH2_MUX12) ||      \
	 ((source) == HAL_PLAY1_IN_LPTIM2_CH1_MUX3) || ((source) == HAL_PLAY1_IN_LPTIM2_CH1_MUX7) || ((source) == HAL_PLAY1_IN_LPTIM2_CH1_MUX15) || ((source) == HAL_PLAY1_IN_LPTIM2_CH2_MUX0) ||      \
	 ((source) == HAL_PLAY1_IN_LPTIM2_CH2_MUX4) || ((source) == HAL_PLAY1_IN_LPTIM2_CH2_MUX8) /* MCO */                                                                                            \
	 || ((source) == HAL_PLAY1_IN_RCC_MCO1_MUX2) || ((source) == HAL_PLAY1_IN_RCC_MCO1_MUX6) || ((source) == HAL_PLAY1_IN_RCC_MCO1_MUX8) || ((source) == HAL_PLAY1_IN_RCC_MCO1_MUX14) ||           \
	 ((source) == HAL_PLAY1_IN_RCC_MCO2_MUX2) || ((source) == HAL_PLAY1_IN_RCC_MCO2_MUX6) || ((source) == HAL_PLAY1_IN_RCC_MCO2_MUX10)			       /* NMI */                       \
	 || ((source) == HAL_PLAY1_IN_NMI_MUX3) || ((source) == HAL_PLAY1_IN_NMI_MUX7) || ((source) == HAL_PLAY1_IN_NMI_MUX11) || ((source) == HAL_PLAY1_IN_NMI_MUX13) /* SPI */                       \
	 || ((source) == HAL_PLAY1_IN_SPI1_MOSI_MUX0) || ((source) == HAL_PLAY1_IN_SPI1_MOSI_MUX6) || ((source) == HAL_PLAY1_IN_SPI1_MOSI_MUX10) || ((source) == HAL_PLAY1_IN_SPI1_MOSI_MUX14) ||      \
	 ((source) == HAL_PLAY1_IN_SPI1_NSS_MUX5) || ((source) == HAL_PLAY1_IN_SPI1_NSS_MUX9) || ((source) == HAL_PLAY1_IN_SPI1_NSS_MUX13) || ((source) == HAL_PLAY1_IN_SPI1_NSS_MUX15) ||             \
	 ((source) == HAL_PLAY1_IN_SPI1_SCLK_MUX1) || ((source) == HAL_PLAY1_IN_SPI1_SCLK_MUX7) || ((source) == HAL_PLAY1_IN_SPI1_SCLK_MUX11) || ((source) == HAL_PLAY1_IN_SPI1_SCLK_MUX15) ||         \
	 ((source) == HAL_PLAY1_IN_SPI2_MOSI_MUX2) || ((source) == HAL_PLAY1_IN_SPI2_MOSI_MUX10) || ((source) == HAL_PLAY1_IN_SPI2_MOSI_MUX14) || ((source) == HAL_PLAY1_IN_SPI2_NSS_MUX1) ||          \
	 ((source) == HAL_PLAY1_IN_SPI2_NSS_MUX9) || ((source) == HAL_PLAY1_IN_SPI2_NSS_MUX13) || ((source) == HAL_PLAY1_IN_SPI2_SCLK_MUX3) || ((source) == HAL_PLAY1_IN_SPI2_SCLK_MUX11) ||           \
	 ((source) == HAL_PLAY1_IN_SPI2_SCLK_MUX15) /* TIM */                                                                                                                                          \
	 || ((source) == HAL_PLAY1_IN_TIM2_OC3_MUX1) || ((source) == HAL_PLAY1_IN_TIM2_OC3_MUX3) || ((source) == HAL_PLAY1_IN_TIM2_OC3_MUX9) || ((source) == HAL_PLAY1_IN_TIM2_OC3_MUX13) ||           \
	 ((source) == HAL_PLAY1_IN_TIM2_OC4_MUX2) || ((source) == HAL_PLAY1_IN_TIM2_OC4_MUX4) || ((source) == HAL_PLAY1_IN_TIM2_OC4_MUX10) || ((source) == HAL_PLAY1_IN_TIM2_OC4_MUX14) ||             \
	 ((source) == HAL_PLAY1_IN_TIM2_TRGO_MUX0) || ((source) == HAL_PLAY1_IN_TIM2_TRGO_MUX2) || ((source) == HAL_PLAY1_IN_TIM2_TRGO_MUX8) || ((source) == HAL_PLAY1_IN_TIM2_TRGO_MUX12) ||          \
	 ((source) == HAL_PLAY1_IN_TIM3_OC3_MUX1) || ((source) == HAL_PLAY1_IN_TIM3_OC3_MUX5) || ((source) == HAL_PLAY1_IN_TIM3_OC3_MUX13) || ((source) == HAL_PLAY1_IN_TIM3_OC4_MUX2) ||              \
	 ((source) == HAL_PLAY1_IN_TIM3_OC4_MUX6) || ((source) == HAL_PLAY1_IN_TIM3_OC4_MUX14) || ((source) == HAL_PLAY1_IN_TIM3_TRGO_MUX0) || ((source) == HAL_PLAY1_IN_TIM3_TRGO_MUX4) ||            \
	 ((source) == HAL_PLAY1_IN_TIM3_TRGO_MUX12) /* USART */                                                                                                                                        \
	 || ((source) == HAL_PLAY1_IN_USART1_CK_MUX2) || ((source) == HAL_PLAY1_IN_USART1_CK_MUX6) || ((source) == HAL_PLAY1_IN_USART1_CK_MUX10) || ((source) == HAL_PLAY1_IN_USART1_CK_MUX12) ||      \
	 ((source) == HAL_PLAY1_IN_USART1_TX_MUX1) || ((source) == HAL_PLAY1_IN_USART1_TX_MUX5) || ((source) == HAL_PLAY1_IN_USART1_TX_MUX9) || ((source) == HAL_PLAY1_IN_USART1_TX_MUX11) ||          \
	 ((source) == HAL_PLAY1_IN_USART2_CK_MUX6) || ((source) == HAL_PLAY1_IN_USART2_CK_MUX10) || ((source) == HAL_PLAY1_IN_USART2_CK_MUX14) || ((source) == HAL_PLAY1_IN_USART2_TX_MUX5) ||         \
	 ((source) == HAL_PLAY1_IN_USART2_TX_MUX9) || ((source) == HAL_PLAY1_IN_USART2_TX_MUX13))
 ...
 */
#define IS_PLAY_IN_SOURCE(instance, source) ((((instance) == PLAY1_NS) || ((instance) == PLAY1_S)) && IS_PLAY1_IN_SOURCE((source)))
...
#define IS_PLAY1_LUT(lut)                                                                                                                                                                              \
	(((lut) == HAL_PLAY_LUT0) || ((lut) == HAL_PLAY_LUT1) || ((lut) == HAL_PLAY_LUT2) || ((lut) == HAL_PLAY_LUT3) || ((lut) == HAL_PLAY_LUT4) || ((lut) == HAL_PLAY_LUT5) ||                       \
	 ((lut) == HAL_PLAY_LUT6) || ((lut) == HAL_PLAY_LUT7) || ((lut) == HAL_PLAY_LUT8) || ((lut) == HAL_PLAY_LUT9) || ((lut) == HAL_PLAY_LUT10) || ((lut) == HAL_PLAY_LUT11) ||                     \
	 ((lut) == HAL_PLAY_LUT12) || ((lut) == HAL_PLAY_LUT13) || ((lut) == HAL_PLAY_LUT14) || ((lut) == HAL_PLAY_LUT15))
 ...
 *  (*) : available in stm32h5xxxx.h in cmsis device header file.
 */
#define IS_PLAY_LUT(instance, lut) ((((instance) == PLAY1_NS) || ((instance) == PLAY1_S)) && IS_PLAY1_LUT(lut))
 ...
 */
#define IS_PLAY_LUT_INPUT(lut_input) (((lut_input) == HAL_PLAY_LUT_INPUT0) || ((lut_input) == HAL_PLAY_LUT_INPUT1) || ((lut_input) == HAL_PLAY_LUT_INPUT2) || ((lut_input) == HAL_PLAY_LUT_INPUT3))
...
#define IS_PLAY1_LUT_INPUT_SOURCE_LUT_OUT_REGISTERED(input_source)                                                                                                                                     \
	(((input_source) == HAL_PLAY_LUT_INPUT_LUT0_OUT_REGISTERED) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT1_OUT_REGISTERED) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT2_OUT_REGISTERED) ||     \
	 ((input_source) == HAL_PLAY_LUT_INPUT_LUT3_OUT_REGISTERED) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT4_OUT_REGISTERED) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT5_OUT_REGISTERED) ||     \
	 ((input_source) == HAL_PLAY_LUT_INPUT_LUT6_OUT_REGISTERED) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT7_OUT_REGISTERED) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT8_OUT_REGISTERED) ||     \
	 ((input_source) == HAL_PLAY_LUT_INPUT_LUT9_OUT_REGISTERED) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT10_OUT_REGISTERED) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT11_OUT_REGISTERED) ||   \
	 ((input_source) == HAL_PLAY_LUT_INPUT_LUT12_OUT_REGISTERED) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT13_OUT_REGISTERED) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT14_OUT_REGISTERED) ||  \
...
#define IS_PLAY_LUT_INPUT_SOURCE_FILTER(input_source)                                                                                                                                                  \
	(((input_source) == HAL_PLAY_LUT_INPUT_FILTER0) || ((input_source) == HAL_PLAY_LUT_INPUT_FILTER1) || ((input_source) == HAL_PLAY_LUT_INPUT_FILTER2) ||                                         \
	 ((input_source) == HAL_PLAY_LUT_INPUT_FILTER3) || ((input_source) == HAL_PLAY_LUT_INPUT_FILTER4) || ((input_source) == HAL_PLAY_LUT_INPUT_FILTER5) ||                                         \
	 ((input_source) == HAL_PLAY_LUT_INPUT_FILTER6) || ((input_source) == HAL_PLAY_LUT_INPUT_FILTER7) || ((input_source) == HAL_PLAY_LUT_INPUT_FILTER8) ||                                         \
	 ((input_source) == HAL_PLAY_LUT_INPUT_FILTER9) || ((input_source) == HAL_PLAY_LUT_INPUT_FILTER10) || ((input_source) == HAL_PLAY_LUT_INPUT_FILTER11) ||                                       \
	 ((input_source) == HAL_PLAY_LUT_INPUT_FILTER12) || ((input_source) == HAL_PLAY_LUT_INPUT_FILTER13) || ((input_source) == HAL_PLAY_LUT_INPUT_FILTER14) ||                                      \
...
#define IS_PLAY_LUT_INPUT_SOURCE_SWTRIG(input_source)                                                                                                                                                  \
	(((input_source) == HAL_PLAY_LUT_INPUT_SWTRIG0) || ((input_source) == HAL_PLAY_LUT_INPUT_SWTRIG1) || ((input_source) == HAL_PLAY_LUT_INPUT_SWTRIG2) ||                                         \
	 ((input_source) == HAL_PLAY_LUT_INPUT_SWTRIG3) || ((input_source) == HAL_PLAY_LUT_INPUT_SWTRIG4) || ((input_source) == HAL_PLAY_LUT_INPUT_SWTRIG5) ||                                         \
	 ((input_source) == HAL_PLAY_LUT_INPUT_SWTRIG6) || ((input_source) == HAL_PLAY_LUT_INPUT_SWTRIG7) || ((input_source) == HAL_PLAY_LUT_INPUT_SWTRIG8) ||                                         \
	 ((input_source) == HAL_PLAY_LUT_INPUT_SWTRIG9) || ((input_source) == HAL_PLAY_LUT_INPUT_SWTRIG10) || ((input_source) == HAL_PLAY_LUT_INPUT_SWTRIG11) ||                                       \
	 ((input_source) == HAL_PLAY_LUT_INPUT_SWTRIG12) || ((input_source) == HAL_PLAY_LUT_INPUT_SWTRIG13) || ((input_source) == HAL_PLAY_LUT_INPUT_SWTRIG14) ||                                      \
 ...
 * @retval 0            input_source is an invalid value.
 */
#define IS_PLAY1_LUT_INPUT_SOURCE_LUT0(input_source) (((input_source) == HAL_PLAY_LUT_INPUT_LUT0_OUT_DIRECT))
...
#define IS_PLAY1_LUT_INPUT_SOURCE_LUT1(input_source)                                                                                                                                                   \
	(((input_source) == HAL_PLAY_LUT_INPUT_LUT0_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT1_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT4_OUT_DIRECT) ||                 \
	 ((input_source) == HAL_PLAY_LUT_INPUT_LUT8_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT12_OUT_DIRECT))
...
#define IS_PLAY1_LUT_INPUT_SOURCE_LUT2(input_source)                                                                                                                                                   \
	(((input_source) == HAL_PLAY_LUT_INPUT_LUT0_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT1_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT2_OUT_DIRECT) ||                 \
	 ((input_source) == HAL_PLAY_LUT_INPUT_LUT4_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT5_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT8_OUT_DIRECT) ||                 \
	 ((input_source) == HAL_PLAY_LUT_INPUT_LUT9_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT12_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT13_OUT_DIRECT))
...
#define IS_PLAY1_LUT_INPUT_SOURCE_LUT3(input_source)                                                                                                                                                   \
	(((input_source) == HAL_PLAY_LUT_INPUT_LUT0_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT1_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT2_OUT_DIRECT) ||                 \
	 ((input_source) == HAL_PLAY_LUT_INPUT_LUT3_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT4_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT5_OUT_DIRECT) ||                 \
	 ((input_source) == HAL_PLAY_LUT_INPUT_LUT6_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT8_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT9_OUT_DIRECT) ||                 \
	 ((input_source) == HAL_PLAY_LUT_INPUT_LUT10_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT12_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT13_OUT_DIRECT) ||              \
 ...
 * @retval 0            input_source is an invalid value.
 */
#define IS_PLAY1_LUT_INPUT_SOURCE_LUT4(input_source) (((input_source) == HAL_PLAY_LUT_INPUT_LUT4_OUT_DIRECT))
...
#define IS_PLAY1_LUT_INPUT_SOURCE_LUT5(input_source)                                                                                                                                                   \
	(((input_source) == HAL_PLAY_LUT_INPUT_LUT0_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT4_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT5_OUT_DIRECT) ||                 \
	 ((input_source) == HAL_PLAY_LUT_INPUT_LUT8_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT12_OUT_DIRECT))
...
#define IS_PLAY1_LUT_INPUT_SOURCE_LUT6(input_source)                                                                                                                                                   \
	(((input_source) == HAL_PLAY_LUT_INPUT_LUT0_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT1_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT4_OUT_DIRECT) ||                 \
	 ((input_source) == HAL_PLAY_LUT_INPUT_LUT5_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT6_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT8_OUT_DIRECT) ||                 \
	 ((input_source) == HAL_PLAY_LUT_INPUT_LUT9_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT12_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT13_OUT_DIRECT))
...
#define IS_PLAY1_LUT_INPUT_SOURCE_LUT7(input_source)                                                                                                                                                   \
	(((input_source) == HAL_PLAY_LUT_INPUT_LUT0_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT1_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT2_OUT_DIRECT) ||                 \
	 ((input_source) == HAL_PLAY_LUT_INPUT_LUT4_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT5_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT6_OUT_DIRECT) ||                 \
	 ((input_source) == HAL_PLAY_LUT_INPUT_LUT7_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT8_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT9_OUT_DIRECT) ||                 \
	 ((input_source) == HAL_PLAY_LUT_INPUT_LUT10_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT12_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT13_OUT_DIRECT) ||              \
	 ((input_source) == HAL_PLAY_LUT_INPUT_LUT14_OUT_DIRECT))
 ...
 * @retval 0            input_source is an invalid value.
 */
#define IS_PLAY1_LUT_INPUT_SOURCE_LUT8(input_source) (((input_source) == HAL_PLAY_LUT_INPUT_LUT8_OUT_DIRECT))
...
#define IS_PLAY1_LUT_INPUT_SOURCE_LUT9(input_source)                                                                                                                                                   \
	(((input_source) == HAL_PLAY_LUT_INPUT_LUT0_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT4_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT8_OUT_DIRECT) ||                 \
	 ((input_source) == HAL_PLAY_LUT_INPUT_LUT9_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT12_OUT_DIRECT))
...
#define IS_PLAY1_LUT_INPUT_SOURCE_LUT10(input_source)                                                                                                                                                  \
	(((input_source) == HAL_PLAY_LUT_INPUT_LUT0_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT1_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT4_OUT_DIRECT) ||                 \
	 ((input_source) == HAL_PLAY_LUT_INPUT_LUT5_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT8_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT9_OUT_DIRECT) ||                 \
	 ((input_source) == HAL_PLAY_LUT_INPUT_LUT10_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT12_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT13_OUT_DIRECT))
...
#define IS_PLAY1_LUT_INPUT_SOURCE_LUT11(input_source)                                                                                                                                                  \
	(((input_source) == HAL_PLAY_LUT_INPUT_LUT0_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT1_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT2_OUT_DIRECT) ||                 \
	 ...
	 ((input_source) == HAL_PLAY_LUT_INPUT_LUT11_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT12_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT13_OUT_DIRECT) ||              \
	 ((input_source) == HAL_PLAY_LUT_INPUT_LUT14_OUT_DIRECT))
 ...
 * @retval 0            input_source is an invalid value.
 */
#define IS_PLAY1_LUT_INPUT_SOURCE_LUT12(input_source) (((input_source) == HAL_PLAY_LUT_INPUT_LUT12_OUT_DIRECT))
...
#define IS_PLAY1_LUT_INPUT_SOURCE_LUT13(input_source)                                                                                                                                                  \
	(((input_source) == HAL_PLAY_LUT_INPUT_LUT0_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT4_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT8_OUT_DIRECT) ||                 \
	 ((input_source) == HAL_PLAY_LUT_INPUT_LUT12_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT13_OUT_DIRECT))
...
#define IS_PLAY1_LUT_INPUT_SOURCE_LUT14(input_source)                                                                                                                                                  \
	(((input_source) == HAL_PLAY_LUT_INPUT_LUT0_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT1_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT4_OUT_DIRECT) ||                 \
	 ((input_source) == HAL_PLAY_LUT_INPUT_LUT5_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT8_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT9_OUT_DIRECT) ||                 \
	 ((input_source) == HAL_PLAY_LUT_INPUT_LUT12_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT13_OUT_DIRECT) || ((input_source) == HAL_PLAY_LUT_INPUT_LUT14_OUT_DIRECT))
...
#define IS_PLAY1_LUT_INPUT_SOURCE(lut, input_source)                                                                                                                                                   \
	((IS_PLAY1_LUT_INPUT_SOURCE_LUT_OUT_REGISTERED(input_source)) || (IS_PLAY_LUT_INPUT_SOURCE_FILTER(input_source)) || (IS_PLAY_LUT_INPUT_SOURCE_SWTRIG(input_source)) ||                         \
	 (((lut) == HAL_PLAY_LUT0) && IS_PLAY1_LUT_INPUT_SOURCE_LUT0(input_source)) || (((lut) == HAL_PLAY_LUT1) && IS_PLAY1_LUT_INPUT_SOURCE_LUT1(input_source)) ||                                   \
	 (((lut) == HAL_PLAY_LUT2) && IS_PLAY1_LUT_INPUT_SOURCE_LUT2(input_source)) || (((lut) == HAL_PLAY_LUT3) && IS_PLAY1_LUT_INPUT_SOURCE_LUT3(input_source)) ||                                   \
	 (((lut) == HAL_PLAY_LUT4) && IS_PLAY1_LUT_INPUT_SOURCE_LUT4(input_source)) || (((lut) == HAL_PLAY_LUT5) && IS_PLAY1_LUT_INPUT_SOURCE_LUT5(input_source)) ||                                   \
	 (((lut) == HAL_PLAY_LUT6) && IS_PLAY1_LUT_INPUT_SOURCE_LUT6(input_source)) || (((lut) == HAL_PLAY_LUT7) && IS_PLAY1_LUT_INPUT_SOURCE_LUT7(input_source)) ||                                   \
	 (((lut) == HAL_PLAY_LUT8) && IS_PLAY1_LUT_INPUT_SOURCE_LUT8(input_source)) || (((lut) == HAL_PLAY_LUT9) && IS_PLAY1_LUT_INPUT_SOURCE_LUT9(input_source)) ||                                   \
	 (((lut) == HAL_PLAY_LUT10) && IS_PLAY1_LUT_INPUT_SOURCE_LUT10(input_source)) || (((lut) == HAL_PLAY_LUT11) && IS_PLAY1_LUT_INPUT_SOURCE_LUT11(input_source)) ||                               \
	 (((lut) == HAL_PLAY_LUT12) && IS_PLAY1_LUT_INPUT_SOURCE_LUT12(input_source)) || (((lut) == HAL_PLAY_LUT13) && IS_PLAY1_LUT_INPUT_SOURCE_LUT13(input_source)) ||                               \
	 (((lut) == HAL_PLAY_LUT14) && IS_PLAY1_LUT_INPUT_SOURCE_LUT14(input_source)) || (((lut) == HAL_PLAY_LUT15) && IS_PLAY1_LUT_INPUT_SOURCE_LUT15(input_source)))
 ...
 *  (*) : available in stm32h5xxxx.h in cmsis device header file.
 */
#define IS_PLAY_LUT_INPUT_SOURCE(instance, lut, input_source) ((((instance) == PLAY1_NS) || ((instance) == PLAY1_S)) && IS_PLAY1_LUT_INPUT_SOURCE(lut, input_source))
...
#define IS_PLAY1_LUT_CLOCK_GATE_SOURCE(source)                                                                                                                                                         \
	(((source) == HAL_PLAY_LUT_CLK_GATE_OFF) || ((source) == HAL_PLAY_LUT_CLK_GATE_ON) || ((source) == HAL_PLAY_LUT_CLK_GATE_SW_ACK) || ((source) == HAL_PLAY_LUT_CLK_GATE_LUT0_OUT_REGISTERED) || \
	 ((source) == HAL_PLAY_LUT_CLK_GATE_LUT1_OUT_REGISTERED) || ((source) == HAL_PLAY_LUT_CLK_GATE_LUT2_OUT_REGISTERED) || ((source) == HAL_PLAY_LUT_CLK_GATE_LUT3_OUT_REGISTERED) ||              \
	 ((source) == HAL_PLAY_LUT_CLK_GATE_LUT4_OUT_REGISTERED) || ((source) == HAL_PLAY_LUT_CLK_GATE_LUT5_OUT_REGISTERED) || ((source) == HAL_PLAY_LUT_CLK_GATE_LUT6_OUT_REGISTERED) ||              \
	 ((source) == HAL_PLAY_LUT_CLK_GATE_LUT7_OUT_REGISTERED) || ((source) == HAL_PLAY_LUT_CLK_GATE_LUT8_OUT_REGISTERED) || ((source) == HAL_PLAY_LUT_CLK_GATE_LUT9_OUT_REGISTERED) ||              \
	 ((source) == HAL_PLAY_LUT_CLK_GATE_LUT10_OUT_REGISTERED) || ((source) == HAL_PLAY_LUT_CLK_GATE_LUT11_OUT_REGISTERED) || ((source) == HAL_PLAY_LUT_CLK_GATE_LUT12_OUT_REGISTERED) ||           \
	 ((source) == HAL_PLAY_LUT_CLK_GATE_LUT13_OUT_REGISTERED) || ((source) == HAL_PLAY_LUT_CLK_GATE_LUT14_OUT_REGISTERED) || ((source) == HAL_PLAY_LUT_CLK_GATE_LUT15_OUT_REGISTERED) ||           \
	 ((source) == HAL_PLAY_LUT_CLK_GATE_FILTER0) || ((source) == HAL_PLAY_LUT_CLK_GATE_FILTER1) || ((source) == HAL_PLAY_LUT_CLK_GATE_FILTER2) || ((source) == HAL_PLAY_LUT_CLK_GATE_FILTER3) ||   \
	 ((source) == HAL_PLAY_LUT_CLK_GATE_FILTER4) || ((source) == HAL_PLAY_LUT_CLK_GATE_FILTER5) || ((source) == HAL_PLAY_LUT_CLK_GATE_FILTER6) || ((source) == HAL_PLAY_LUT_CLK_GATE_FILTER7) ||   \
	 ((source) == HAL_PLAY_LUT_CLK_GATE_FILTER8) || ((source) == HAL_PLAY_LUT_CLK_GATE_FILTER9) || ((source) == HAL_PLAY_LUT_CLK_GATE_FILTER10) || ((source) == HAL_PLAY_LUT_CLK_GATE_FILTER11) || \
	 ((source) == HAL_PLAY_LUT_CLK_GATE_FILTER12) || ((source) == HAL_PLAY_LUT_CLK_GATE_FILTER13) || ((source) == HAL_PLAY_LUT_CLK_GATE_FILTER14) ||                                               \
	 ((source) == HAL_PLAY_LUT_CLK_GATE_FILTER15) || ((source) == HAL_PLAY_LUT_CLK_GATE_SWTRIG0) || ((source) == HAL_PLAY_LUT_CLK_GATE_SWTRIG1) || ((source) == HAL_PLAY_LUT_CLK_GATE_SWTRIG2) ||  \
	 ((source) == HAL_PLAY_LUT_CLK_GATE_SWTRIG3) || ((source) == HAL_PLAY_LUT_CLK_GATE_SWTRIG4) || ((source) == HAL_PLAY_LUT_CLK_GATE_SWTRIG5) || ((source) == HAL_PLAY_LUT_CLK_GATE_SWTRIG6) ||   \
	 ((source) == HAL_PLAY_LUT_CLK_GATE_SWTRIG7) || ((source) == HAL_PLAY_LUT_CLK_GATE_SWTRIG8) || ((source) == HAL_PLAY_LUT_CLK_GATE_SWTRIG9) || ((source) == HAL_PLAY_LUT_CLK_GATE_SWTRIG10) ||  \
	 ((source) == HAL_PLAY_LUT_CLK_GATE_SWTRIG11) || ((source) == HAL_PLAY_LUT_CLK_GATE_SWTRIG12) || ((source) == HAL_PLAY_LUT_CLK_GATE_SWTRIG13) ||                                               \
	 ((source) == HAL_PLAY_LUT_CLK_GATE_SWTRIG14) || ((source) == HAL_PLAY_LUT_CLK_GATE_SWTRIG15))
 ...
 *  (*): available in stm32h5xxxx.h in cmsis device header file.
 */
#define IS_PLAY_LUT_CLOCK_GATE_SOURCE(instance, source) ((((instance) == PLAY1_NS) || ((instance) == PLAY1_S)) && IS_PLAY1_LUT_CLOCK_GATE_SOURCE(source))
...
#define IS_PLAY_OUT(mux)                                                                                                                                                                               \
	(((mux) == HAL_PLAY_OUT0) || ((mux) == HAL_PLAY_OUT1) || ((mux) == HAL_PLAY_OUT2) || ((mux) == HAL_PLAY_OUT3) || ((mux) == HAL_PLAY_OUT4) || ((mux) == HAL_PLAY_OUT5) ||                       \
	 ((mux) == HAL_PLAY_OUT6) || ((mux) == HAL_PLAY_OUT7) || ((mux) == HAL_PLAY_OUT8) || ((mux) == HAL_PLAY_OUT9) || ((mux) == HAL_PLAY_OUT10) || ((mux) == HAL_PLAY_OUT11) ||                     \
	 ((mux) == HAL_PLAY_OUT12) || ((mux) == HAL_PLAY_OUT13) || ((mux) == HAL_PLAY_OUT14) || ((mux) == HAL_PLAY_OUT15))
...
#define IS_PLAY1_OUT_SOURCE(source)                                                                                                                                                                    \
	(((source) == (uint32_t)HAL_PLAY_LUT0_OUT_DIRECT) || ((source) == (uint32_t)HAL_PLAY_LUT1_OUT_DIRECT) || ((source) == (uint32_t)HAL_PLAY_LUT2_OUT_DIRECT) ||                                   \
	 ((source) == (uint32_t)HAL_PLAY_LUT3_OUT_DIRECT) || ((source) == (uint32_t)HAL_PLAY_LUT4_OUT_DIRECT) || ((source) == (uint32_t)HAL_PLAY_LUT5_OUT_DIRECT) ||                                   \
	 ((source) == (uint32_t)HAL_PLAY_LUT6_OUT_DIRECT) || ((source) == (uint32_t)HAL_PLAY_LUT7_OUT_DIRECT) || ((source) == (uint32_t)HAL_PLAY_LUT8_OUT_DIRECT) ||                                   \
	 ((source) == (uint32_t)HAL_PLAY_LUT9_OUT_DIRECT) || ((source) == (uint32_t)HAL_PLAY_LUT10_OUT_DIRECT) || ((source) == (uint32_t)HAL_PLAY_LUT11_OUT_DIRECT) ||                                 \
	 ((source) == (uint32_t)HAL_PLAY_LUT12_OUT_DIRECT) || ((source) == (uint32_t)HAL_PLAY_LUT13_OUT_DIRECT) || ((source) == (uint32_t)HAL_PLAY_LUT14_OUT_DIRECT) ||                                \
	 ((source) == (uint32_t)HAL_PLAY_LUT15_OUT_DIRECT) || ((source) == (uint32_t)HAL_PLAY_LUT0_OUT_REGISTERED) || ((source) == (uint32_t)HAL_PLAY_LUT1_OUT_REGISTERED) ||                          \
	 ((source) == (uint32_t)HAL_PLAY_LUT2_OUT_REGISTERED) || ((source) == (uint32_t)HAL_PLAY_LUT3_OUT_REGISTERED) || ((source) == (uint32_t)HAL_PLAY_LUT4_OUT_REGISTERED) ||                       \
	 ((source) == (uint32_t)HAL_PLAY_LUT5_OUT_REGISTERED) || ((source) == (uint32_t)HAL_PLAY_LUT6_OUT_REGISTERED) || ((source) == (uint32_t)HAL_PLAY_LUT7_OUT_REGISTERED) ||                       \
	 ((source) == (uint32_t)HAL_PLAY_LUT8_OUT_REGISTERED) || ((source) == (uint32_t)HAL_PLAY_LUT9_OUT_REGISTERED) || ((source) == (uint32_t)HAL_PLAY_LUT10_OUT_REGISTERED) ||                      \
	 ((source) == (uint32_t)HAL_PLAY_LUT11_OUT_REGISTERED) || ((source) == (uint32_t)HAL_PLAY_LUT12_OUT_REGISTERED) || ((source) == (uint32_t)HAL_PLAY_LUT13_OUT_REGISTERED) ||                    \
	 ((source) == (uint32_t)HAL_PLAY_LUT14_OUT_REGISTERED) || ((source) == (uint32_t)HAL_PLAY_LUT15_OUT_REGISTERED))
 ...
 *  (*) : available in stm32h5xxxx.h in cmsis device header file.
 */
#define IS_PLAY_OUT_SOURCE(instance, source) ((((instance) == PLAY1_NS) || ((instance) == PLAY1_S)) && IS_PLAY1_OUT_SOURCE(source))
 ...
 * @retval 0    mode is an invalid value.
 */
#define IS_PLAY_POLL_MODE(mode) (((mode) == HAL_PLAY_POLLING_FOR_ALL_EDGES) || ((mode) == HAL_PLAY_POLLING_FOR_ANY_EDGE))
 ...
 */
#define IS_PLAY_SWTRIGGER_STATE(state) (((state) == HAL_PLAY_SW_TRIGGER_RESET) || ((state) == HAL_PLAY_SW_TRIGGER_SET))
...
#define IS_PLAY_SWTRIGGER(swtrig)                                                                                                                                                                      \
	(((swtrig) == HAL_PLAY_SWTRIG0) || ((swtrig) == HAL_PLAY_SWTRIG1) || ((swtrig) == HAL_PLAY_SWTRIG2) || ((swtrig) == HAL_PLAY_SWTRIG3) || ((swtrig) == HAL_PLAY_SWTRIG4) ||                     \
	 ((swtrig) == HAL_PLAY_SWTRIG5) || ((swtrig) == HAL_PLAY_SWTRIG6) || ((swtrig) == HAL_PLAY_SWTRIG7) || ((swtrig) == HAL_PLAY_SWTRIG8) || ((swtrig) == HAL_PLAY_SWTRIG9) ||                     \
	 ((swtrig) == HAL_PLAY_SWTRIG10) || ((swtrig) == HAL_PLAY_SWTRIG11) || ((swtrig) == HAL_PLAY_SWTRIG12) || ((swtrig) == HAL_PLAY_SWTRIG13) || ((swtrig) == HAL_PLAY_SWTRIG14) ||                \
 ...
 * @retval 0      swtrig is an invalid value.
 */
#define IS_PLAY_SWTRIGGER_MSK(swtrig_msk) ((((uint32_t)(swtrig_msk) & HAL_PLAY_SWTRIG_ALL) != 0x00U) && (((uint32_t)(swtrig_msk) & ~HAL_PLAY_SWTRIG_ALL) == 0x00U))
...
static HAL_StatusTypeDef PLAY_LUT_SetEdgeTrigger(const HAL_PLAY_HandleTypeDef *hplay, const HAL_PLAY_EdgeTriggerConfTypeDef *p_config, uint32_t timeout_ms);
 ...
 */
HAL_StatusTypeDef HAL_PLAY_INPUT_SetConfig(HAL_PLAY_HandleTypeDef *hplay, const HAL_PLAY_IN_ConfTypeDef *p_config, uint32_t array_size)
{
	PLAY_TypeDef *p_playx;
	uint32_t is_locked;
	...
	for (uint32_t idx = 0; idx < array_size; idx++) {
		...
		uint32_t premuxsel_value = ((uint32_t)p_config[idx].source & PLAY_IN_MUX_VALUE_MASK) >> PLAY_IN_MUX_VALUE_POS;
		uint32_t input_mux = ((uint32_t)p_config[idx].source & PLAY_IN_MUX_MASK) >> HAL_PLAY_IN_MUX_POS;

		LL_PLAY_INPUT_Config(p_playx, input_mux, premuxsel_value, (uint32_t)p_config[idx].mode, p_config[idx].min_pulse_width);
	}
 ...
 * @retval HAL_ERROR  Invalid parameter.
 */
HAL_StatusTypeDef HAL_PLAY_INPUT_GetConfig(HAL_PLAY_HandleTypeDef *hplay, HAL_PLAY_IN_ConfTypeDef *p_config, uint32_t array_size)
{
	const PLAY_TypeDef *p_playx;
 ...
 * @retval HAL_ERROR  Invalid parameter.
 */
HAL_StatusTypeDef HAL_PLAY_LUT_SetConfig(HAL_PLAY_HandleTypeDef *hplay, const HAL_PLAY_LUT_ConfTypeDef *p_config, uint32_t array_size)
{
	PLAY_TypeDef *p_playx;
	uint32_t is_locked;
	...
	for (uint32_t idx = 0; idx < array_size; idx++) {
		...
		assert_param(IS_PLAY_LUT_INPUT_SOURCE(p_playx, p_config[idx].lut, p_config[idx].input_source[LL_PLAY_LUT_INPUT0]));
		assert_param(IS_PLAY_LUT_INPUT_SOURCE(p_playx, p_config[idx].lut, p_config[idx].input_source[LL_PLAY_LUT_INPUT1]));
		assert_param(IS_PLAY_LUT_INPUT_SOURCE(p_playx, p_config[idx].lut, p_config[idx].input_source[LL_PLAY_LUT_INPUT2]));
		assert_param(IS_PLAY_LUT_INPUT_SOURCE(p_playx, p_config[idx].lut, p_config[idx].input_source[LL_PLAY_LUT_INPUT3]));
		...
		LL_PLAY_LUT_ConfigInputs(p_playx, (uint32_t)p_config[idx].lut, (uint32_t)p_config[idx].input_source[LL_PLAY_LUT_INPUT0], (uint32_t)p_config[idx].input_source[LL_PLAY_LUT_INPUT1],
					 (uint32_t)p_config[idx].input_source[LL_PLAY_LUT_INPUT2], (uint32_t)p_config[idx].input_source[LL_PLAY_LUT_INPUT3], (uint32_t)p_config[idx].clk_gate_source);
	}
 ...
 * @retval HAL_ERROR  Invalid parameter.
 */
HAL_StatusTypeDef HAL_PLAY_LUT_GetConfig(HAL_PLAY_HandleTypeDef *hplay, HAL_PLAY_LUT_ConfTypeDef *p_config, uint32_t array_size)
{
	const PLAY_TypeDef *p_playx;
	...
	for (uint32_t idx = 0; idx < array_size; idx++) {
		...
		p_config[idx].input_source[LL_PLAY_LUT_INPUT0] = (HAL_PLAY_LUT_InputSourceTypeDef)LL_PLAY_LUT_GetSource(p_playx, idx, LL_PLAY_LUT_INPUT0);
		p_config[idx].input_source[LL_PLAY_LUT_INPUT1] = (HAL_PLAY_LUT_InputSourceTypeDef)LL_PLAY_LUT_GetSource(p_playx, idx, LL_PLAY_LUT_INPUT1);
		p_config[idx].input_source[LL_PLAY_LUT_INPUT2] = (HAL_PLAY_LUT_InputSourceTypeDef)LL_PLAY_LUT_GetSource(p_playx, idx, LL_PLAY_LUT_INPUT2);
		p_config[idx].input_source[LL_PLAY_LUT_INPUT3] = (HAL_PLAY_LUT_InputSourceTypeDef)LL_PLAY_LUT_GetSource(p_playx, idx, LL_PLAY_LUT_INPUT3);
	}
 ...
 * @return HAL status.
 */
HAL_StatusTypeDef HAL_PLAY_OUTPUT_SetConfig(HAL_PLAY_HandleTypeDef *hplay, const HAL_PLAY_OUT_ConfTypeDef *p_config, uint32_t array_size)
{
	PLAY_TypeDef *p_playx;
	uint32_t is_locked;
 ...
 * @retval HAL_ERROR  Invalid parameter.
 */
HAL_StatusTypeDef HAL_PLAY_OUTPUT_GetConfig(HAL_PLAY_HandleTypeDef *hplay, HAL_PLAY_OUT_ConfTypeDef *p_config, uint32_t array_size)
{
	const PLAY_TypeDef *p_playx;
 ...
 * @retval HAL_ERROR Invalid parameter or current state is not @ref HAL_PLAY_STATE_READY.
 */
HAL_StatusTypeDef HAL_PLAY_INPUT_SetMinPulseWidth(HAL_PLAY_HandleTypeDef *hplay, HAL_PLAY_INTypeDef input_mux, uint32_t width)
{
	PLAY_TypeDef *p_playx;
 ...
 * @retval HAL_ERROR Invalid parameter or current state is not @ref HAL_PLAY_STATE_READY.
 */
HAL_StatusTypeDef HAL_PLAY_INPUT_SetEdgeDetectionMode(HAL_PLAY_HandleTypeDef *hplay, HAL_PLAY_INTypeDef input_mux, HAL_PLAY_EdgeDetectionModeTypeDef mode)
{
	PLAY_TypeDef *p_playx;
 ...
 */
HAL_PLAY_EdgeDetectionModeTypeDef HAL_PLAY_INPUT_GetEdgeDetectionMode(const HAL_PLAY_HandleTypeDef *hplay, HAL_PLAY_INTypeDef input_mux)
{
	const PLAY_TypeDef *p_playx;
 ...
 * @retval HAL_ERROR Invalid parameter or current state is not @ref HAL_PLAY_STATE_READY.
 */
HAL_StatusTypeDef HAL_PLAY_LUT_SetTruthTable(HAL_PLAY_HandleTypeDef *hplay, HAL_PLAY_LUTTypeDef lut, uint32_t truth_table_value)
{
	PLAY_TypeDef *p_playx;
 ...
 * @retval HAL_ERROR    Invalid parameter or current state is not @ref HAL_PLAY_STATE_READY.
 */
HAL_StatusTypeDef HAL_PLAY_LUT_SetSource(HAL_PLAY_HandleTypeDef *hplay, HAL_PLAY_LUTTypeDef lut, HAL_PLAY_LUT_InputTypeDef lut_input, HAL_PLAY_LUT_InputSourceTypeDef input_source)
{
	PLAY_TypeDef *p_playx;
 ...
 */
HAL_PLAY_LUT_InputSourceTypeDef HAL_PLAY_LUT_GetSource(const HAL_PLAY_HandleTypeDef *hplay, HAL_PLAY_LUTTypeDef lut, HAL_PLAY_LUT_InputTypeDef lut_input)
{
	const PLAY_TypeDef *p_playx;
 ...
 * @retval HAL_ERROR Invalid parameter or current state is not @ref HAL_PLAY_STATE_READY.
 */
HAL_StatusTypeDef HAL_PLAY_LUT_SetClockGateSource(HAL_PLAY_HandleTypeDef *hplay, HAL_PLAY_LUTTypeDef lut, HAL_PLAY_LUT_ClkGateSourceTypeDef source)
{
	PLAY_TypeDef *p_playx;
 ...
 */
HAL_PLAY_LUT_ClkGateSourceTypeDef HAL_PLAY_LUT_GetClockGateSource(const HAL_PLAY_HandleTypeDef *hplay, HAL_PLAY_LUTTypeDef lut)
{
	const PLAY_TypeDef *p_playx;
 ...
 * @retval HAL_ERROR Invalid parameter or current state is not @ref HAL_PLAY_STATE_READY.
 */
HAL_StatusTypeDef HAL_PLAY_OUTPUT_SetSource(HAL_PLAY_HandleTypeDef *hplay, HAL_PLAY_OUTTypeDef output_mux, uint32_t source)
{
	PLAY_TypeDef *p_playx;
 ...
 */
HAL_StatusTypeDef HAL_PLAY_LUT_SetEdgeTrigger(HAL_PLAY_HandleTypeDef *hplay, const HAL_PLAY_EdgeTriggerConfTypeDef *p_config, uint32_t timeout_ms)
{
	PLAY_TypeDef *p_playx;
 ...
 * @retval HAL_BUSY  A write is pending.
 */
HAL_StatusTypeDef HAL_PLAY_LUT_SetEdgeTrigger_IT(HAL_PLAY_HandleTypeDef *hplay, const HAL_PLAY_EdgeTriggerConfTypeDef *p_config)
{
	PLAY_TypeDef *p_playx;
 ...
 * @retval HAL_ERROR   Invalid parameter.
 */
HAL_StatusTypeDef HAL_PLAY_LUT_PollForEdgeTrigger(HAL_PLAY_HandleTypeDef *hplay, HAL_PLAY_PollingEdgeTriggerTypeDef poll_mode, uint32_t edge_trig_mask, uint32_t *p_edge_trig_mask_status,
						  uint32_t timeout_ms)
{
	PLAY_TypeDef *p_playx;
	uint32_t tickstart;
	...
	*p_edge_trig_mask_status = 0U;
	do {
		...
		if (poll_mode == HAL_PLAY_POLLING_FOR_ANY_EDGE) {
			...
			*p_edge_trig_mask_status = (((current_flag_status & edge_trig_mask) == edge_trig_mask) ? current_flag_status : 0U);
		}
 ...
 */
HAL_StatusTypeDef HAL_PLAY_WriteSWTrigger(HAL_PLAY_HandleTypeDef *hplay, uint32_t sw_triggers, HAL_PLAY_SWTriggerStateTypeDef state, uint32_t timeout_ms)
{
	PLAY_TypeDef *p_playx;
 ...
 * @retval HAL_BUSY    A write is pending.
 */
HAL_StatusTypeDef HAL_PLAY_WriteSWTrigger_IT(HAL_PLAY_HandleTypeDef *hplay, uint32_t sw_triggers, HAL_PLAY_SWTriggerStateTypeDef state)
{
	PLAY_TypeDef *p_playx;
 ...
 * @return HAL status.
 */
HAL_StatusTypeDef HAL_PLAY_RegisterCallback(HAL_PLAY_HandleTypeDef *hplay, HAL_PLAY_CallbackIDTypeDef CallbackID, pPLAY_CallbackTypeDef pCallback)
{
 ...
 * @return HAL status.
 */
HAL_StatusTypeDef HAL_PLAY_RegisterLUTOutputCallback(HAL_PLAY_HandleTypeDef *hplay, HAL_PLAY_CallbackIDTypeDef CallbackID, pPLAY_LUTOutputCallbackTypeDef pCallback)
{
	HAL_StatusTypeDef status = HAL_OK;
 ...
 * @return HAL status.
 */
HAL_StatusTypeDef HAL_PLAY_UnRegisterLUTOutputCallback(HAL_PLAY_HandleTypeDef *hplay, HAL_PLAY_CallbackIDTypeDef CallbackID)
{
	HAL_StatusTypeDef status = HAL_OK;
 ...
 * @return HAL status.
 */
HAL_StatusTypeDef HAL_PLAY_ConfigAttributes(HAL_PLAY_HandleTypeDef *hplay, const HAL_PLAY_AccessControlConfTypeDef *p_config)
{
	PLAY_TypeDef *p_playx;
 ...
 * @return HAL status.
 */
HAL_StatusTypeDef HAL_PLAY_GetConfigAttributes(HAL_PLAY_HandleTypeDef *hplay, HAL_PLAY_AccessControlConfTypeDef *p_config)
{
	const PLAY_TypeDef *p_playx;
	uint32_t reg_value;
	uint32_t sec_value;
