...
#define RCC_RESET_FLAG_ALL (RCC_RESET_FLAG_PIN | RCC_RESET_FLAG_PWR | RCC_RESET_FLAG_SW | RCC_RESET_FLAG_IWDG | RCC_RESET_FLAG_WWDG | RCC_RESET_FLAG_LPWR)
/**
 * @}
 */
...
#if defined(RCC_CR_PLL3ON)
#define RCC_ALL (RCC_HSI | RCC_HSE | RCC_CSI | RCC_LSI | RCC_LSE | RCC_HSI48 | RCC_SYSCLK | RCC_PRESC | RCC_PLL1 | RCC_PLL2 | RCC_PLL3 | RCC_CKPERSEL | RCC_RMVF)
#else
#define RCC_ALL (RCC_HSI | RCC_HSE | RCC_CSI | RCC_LSI | RCC_LSE | RCC_HSI48 | RCC_SYSCLK | RCC_PRESC | RCC_PLL1 | RCC_PLL2 | RCC_CKPERSEL | RCC_RMVF)
#endif /* RCC_CR_PLL3ON */
/**
 * @}
 */
...
#define __HAL_RCC_ETHINTERN_CLK_ENABLE()                                                                                                                                                               \
	do {                                                                                                                                                                                           \
		__IO uint32_t tmpreg;                                                                                                                                                                  \
...
#define __HAL_RCC_OTGPHY_CLK_ENABLE()                                                                                                                                                                  \
	do {                                                                                                                                                                                           \
		__IO uint32_t tmpreg;                                                                                                                                                                  \
...
#if defined(CCB)
#define __HAL_RCC_CCB_CLK_ENABLE()                                                                                                                                                                     \
	do {                                                                                                                                                                                           \
		__IO uint32_t tmpreg;                                                                                                                                                                  \
...
#if defined(PLAY1)
#define __HAL_RCC_PLAY1_CLK_ENABLE()                                                                                                                                                                   \
	do {                                                                                                                                                                                           \
		__IO uint32_t tmpreg;                                                                                                                                                                  \
...
#define __HAL_RCC_PLAY1APB_CLK_ENABLE()                                                                                                                                                                \
	do {                                                                                                                                                                                           \
		__IO uint32_t tmpreg;                                                                                                                                                                  \
...
#define __HAL_RCC_RTC_CLKPRESCALER(__RTCCLKSource__)                                                                                                                                                   \
	(((__RTCCLKSource__) & RCC_BDCR_RTCSEL) == RCC_BDCR_RTCSEL) ? MODIFY_REG(RCC->CFGR1, RCC_CFGR1_RTCPRE, (((__RTCCLKSource__) & 0xFFFFCFFU) >> 4)) : CLEAR_BIT(RCC->CFGR1, RCC_CFGR1_RTCPRE)
...
#define __HAL_RCC_PLL1_CONFIG(__PLL1SOURCE__, __PLL1M__, __PLL1N__, __PLL1P__, __PLL1Q__, __PLL1R__)                                                                                                   \
	do {                                                                                                                                                                                           \
		MODIFY_REG(RCC->PLL1CFGR, (RCC_PLL1CFGR_PLL1SRC | RCC_PLL1CFGR_PLL1M), ((__PLL1SOURCE__) << RCC_PLL1CFGR_PLL1SRC_Pos) | ((__PLL1M__) << RCC_PLL1CFGR_PLL1M_Pos));                      \
 ...
 *
 */
#define __HAL_RCC_PLL1_PLLSOURCE_CONFIG(__PLL1SOURCE__) MODIFY_REG(RCC->PLL1CFGR, RCC_PLL1CFGR_PLL1SRC, (__PLL1SOURCE__))
 ...
 * @retval None
 */
#define __HAL_RCC_PLL1_DIVM_CONFIG(__PLL1M__) MODIFY_REG(RCC->PLL1CFGR, RCC_PLL1CFGR_PLL1M, (__PLL1M__) << RCC_PLL1CFGR_PLL1M_Pos)
 ...
 * @retval None
 */
#define __HAL_RCC_PLL1_FRACN_CONFIG(__PLL1FRACN__) WRITE_REG(RCC->PLL1FRACR, (uint32_t)(__PLL1FRACN__) << RCC_PLL1FRACR_PLL1FRACN_Pos)
 ...
 * @retval None
 */
#define __HAL_RCC_PLL1_VCORANGE(__RCC_PLL1VCORange__) MODIFY_REG(RCC->PLL1CFGR, RCC_PLL1CFGR_PLL1VCOSEL, (__RCC_PLL1VCORange__))
 ...
 */
#define __HAL_RCC_MCO1_CONFIG(__MCOCLKSOURCE__, __MCODIV__) MODIFY_REG(RCC->CFGR1, (RCC_CFGR1_MCO1SEL | RCC_CFGR1_MCO1PRE), ((__MCOCLKSOURCE__) | (__MCODIV__)))
 ...
 */
#define __HAL_RCC_MCO2_CONFIG(__MCOCLKSOURCE__, __MCODIV__) MODIFY_REG(RCC->CFGR1, (RCC_CFGR1_MCO2SEL | RCC_CFGR1_MCO2PRE), ((__MCOCLKSOURCE__) | ((__MCODIV__) << 7)));
...
#define __HAL_RCC_GET_FLAG(__FLAG__)                                                                                                                                                                   \
	(((((((__FLAG__) >> 5U) == 1U) ? RCC->CR : ((((__FLAG__) >> 5U) == 2U) ? RCC->BDCR : ((((__FLAG__) >> 5U) == 3U) ? RCC->RSR : RCC->CIFR))) & (1UL << ((__FLAG__) & RCC_FLAG_MASK))) != 0U)     \
	     ? 1U                                                                                                                                                                                      \
	     : 0U)
/**
 * @}
...
#define RCC_OSCILLATORTYPE_ALL (RCC_OSCILLATORTYPE_HSE | RCC_OSCILLATORTYPE_HSI | RCC_OSCILLATORTYPE_HSI48 | RCC_OSCILLATORTYPE_CSI | RCC_OSCILLATORTYPE_LSI | RCC_OSCILLATORTYPE_LSE)
...
#define IS_RCC_HSE(__HSE__) (((__HSE__) == RCC_HSE_OFF) || ((__HSE__) == RCC_HSE_ON) || ((__HSE__) == RCC_HSE_BYPASS) || ((__HSE__) == RCC_HSE_BYPASS_DIGITAL))

#define IS_RCC_LSE(__LSE__) (((__LSE__) == RCC_LSE_OFF) || ((__LSE__) == RCC_LSE_ON) || ((__LSE__) == RCC_LSE_BYPASS) || ((__LSE__) == RCC_LSE_BYPASS_DIGITAL))

#define IS_RCC_HSI(__HSI__) (((__HSI__) == RCC_HSI_OFF) || ((__HSI__) == RCC_HSI_ON))

#define IS_RCC_HSIDIV(__DIV__) (((__DIV__) == RCC_HSI_DIV1) || ((__DIV__) == RCC_HSI_DIV2) || ((__DIV__) == RCC_HSI_DIV4) || ((__DIV__) == RCC_HSI_DIV8))

#define IS_RCC_HSI_CALIBRATION_VALUE(__VALUE__) ((__VALUE__) <= (uint32_t)(RCC_HSICFGR_HSITRIM >> RCC_HSICFGR_HSITRIM_Pos))

#define IS_RCC_LSI(__LSI__) (((__LSI__) == RCC_LSI_OFF) || ((__LSI__) == RCC_LSI_ON))

#define IS_RCC_CSI(__CSI__) (((__CSI__) == RCC_CSI_OFF) || ((__CSI__) == RCC_CSI_ON))

#define IS_RCC_CSICALIBRATION_VALUE(__VALUE__) ((__VALUE__) <= (uint32_t)(RCC_CSICFGR_CSITRIM >> RCC_CSICFGR_CSITRIM_Pos))

#define IS_RCC_HSI48(__HSI48__) (((__HSI48__) == RCC_HSI48_OFF) || ((__HSI48__) == RCC_HSI48_ON))

#define IS_RCC_PLL(PLL) (((PLL) == RCC_PLL_NONE) || ((PLL) == RCC_PLL_OFF) || ((PLL) == RCC_PLL_ON))

#define IS_RCC_PLL1_SOURCE(SOURCE) (((SOURCE) == RCC_PLL1_SOURCE_CSI) || ((SOURCE) == RCC_PLL1_SOURCE_HSI) || ((SOURCE) == RCC_PLL1_SOURCE_HSE))
...
#define IS_RCC_PLL1_CLOCKOUT_VALUE(VALUE) (((VALUE) == RCC_PLL1_DIVP) || ((VALUE) == RCC_PLL1_DIVQ) || ((VALUE) == RCC_PLL1_DIVR))

#define IS_RCC_PLL1_VCIRGE_VALUE(VALUE) (((VALUE) == RCC_PLL1_VCIRANGE_0) || ((VALUE) == RCC_PLL1_VCIRANGE_1) || ((VALUE) == RCC_PLL1_VCIRANGE_2) || ((VALUE) == RCC_PLL1_VCIRANGE_3))
...
#define IS_RCC_SYSCLKSOURCE(__SOURCE__)                                                                                                                                                                \
	(((__SOURCE__) == RCC_SYSCLKSOURCE_CSI) || ((__SOURCE__) == RCC_SYSCLKSOURCE_HSI) || ((__SOURCE__) == RCC_SYSCLKSOURCE_HSE) || ((__SOURCE__) == RCC_SYSCLKSOURCE_PLLCLK))
...
#define IS_RCC_RTCCLKSOURCE(SOURCE)                                                                                                                                                                    \
	(((SOURCE) == RCC_RTCCLKSOURCE_LSE) || ((SOURCE) == RCC_RTCCLKSOURCE_LSI) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV2) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV3) ||                             \
	 ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV4) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV5) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV6) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV7) ||                   \
	 ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV8) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV9) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV10) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV11) ||                 \
	 ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV12) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV13) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV14) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV15) ||               \
	 ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV16) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV17) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV18) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV19) ||               \
	 ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV20) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV21) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV22) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV23) ||               \
	 ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV24) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV25) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV26) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV27) ||               \
	 ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV28) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV29) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV30) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV31) ||               \
	 ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV32) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV33) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV34) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV35) ||               \
	 ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV36) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV37) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV38) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV39) ||               \
	 ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV40) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV41) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV42) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV43) ||               \
	 ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV44) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV45) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV46) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV47) ||               \
	 ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV48) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV49) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV50) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV51) ||               \
	 ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV52) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV53) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV54) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV55) ||               \
	 ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV56) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV57) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV58) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV59) ||               \
	 ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV60) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV61) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV62) || ((SOURCE) == RCC_RTCCLKSOURCE_HSE_DIV63) ||               \
	 ((SOURCE) == RCC_RTCCLKSOURCE_NO_CLK))

#define IS_RCC_MCO(MCOx) (((MCOx) == RCC_MCO1) || ((MCOx) == RCC_MCO2))

#define IS_RCC_MCO1SOURCE(SOURCE)                                                                                                                                                                      \
	(((SOURCE) == RCC_MCO1SOURCE_HSI) || ((SOURCE) == RCC_MCO1SOURCE_LSE) || ((SOURCE) == RCC_MCO1SOURCE_HSE) || ((SOURCE) == RCC_MCO1SOURCE_PLL1Q) || ((SOURCE) == RCC_MCO1SOURCE_HSI48))

#define IS_RCC_MCO2SOURCE(SOURCE)                                                                                                                                                                      \
	(((SOURCE) == RCC_MCO2SOURCE_SYSCLK) || ((SOURCE) == RCC_MCO2SOURCE_PLL2P) || ((SOURCE) == RCC_MCO2SOURCE_HSE) || ((SOURCE) == RCC_MCO2SOURCE_PLL1P) || ((SOURCE) == RCC_MCO2SOURCE_CSI) ||    \
	 ((SOURCE) == RCC_MCO2SOURCE_LSI))

#define IS_RCC_MCODIV(DIV)                                                                                                                                                                             \
	(((DIV) == RCC_MCODIV_1) || ((DIV) == RCC_MCODIV_2) || ((DIV) == RCC_MCODIV_3) || ((DIV) == RCC_MCODIV_4) || ((DIV) == RCC_MCODIV_5) || ((DIV) == RCC_MCODIV_6) || ((DIV) == RCC_MCODIV_7) ||  \
	 ((DIV) == RCC_MCODIV_8) || ((DIV) == RCC_MCODIV_9) || ((DIV) == RCC_MCODIV_10) || ((DIV) == RCC_MCODIV_11) || ((DIV) == RCC_MCODIV_12) || ((DIV) == RCC_MCODIV_13) ||                         \
	 ((DIV) == RCC_MCODIV_14) || ((DIV) == RCC_MCODIV_15))

#if defined(STM32H5E5xx) || defined(STM32H5E4xx) || defined(STM32H5F5xx) || defined(STM32H5F4xx)
#define IS_RCC_LSE_DRIVE(__DRIVE__) (((__DRIVE__) == RCC_LSEDRIVE_MEDIUMLOW) || ((__DRIVE__) == RCC_LSEDRIVE_MEDIUMHIGH) || ((__DRIVE__) == RCC_LSEDRIVE_HIGH))
#else
#define IS_RCC_LSE_DRIVE(__DRIVE__) (((__DRIVE__) == RCC_LSEDRIVE_MEDIUMLOW) || ((__DRIVE__) == RCC_LSEDRIVE_LOW) || ((__DRIVE__) == RCC_LSEDRIVE_MEDIUMHIGH) || ((__DRIVE__) == RCC_LSEDRIVE_HIGH))
#endif /* STM32H5E5xx || STM32H5E4xx || !STM32H5F5xx || STM32H5F4xx */

#define IS_RCC_STOP_WAKEUPCLOCK(__SOURCE__) (((__SOURCE__) == RCC_STOP_WAKEUPCLOCK_CSI) || ((__SOURCE__) == RCC_STOP_WAKEUPCLOCK_HSI))

#define IS_RCC_STOP_KERWAKEUPCLOCK(SOURCE) (((SOURCE) == RCC_STOP_KERWAKEUPCLOCK_CSI) || ((SOURCE) == RCC_STOP_KERWAKEUPCLOCK_HSI))
...
#define IS_RCC_SINGLE_ITEM_ATTRIBUTES(ITEM)                                                                                                                                                            \
	(((ITEM) == RCC_HSI) || ((ITEM) == RCC_HSE) || ((ITEM) == RCC_CSI) || ((ITEM) == RCC_LSI) || ((ITEM) == RCC_LSE) || ((ITEM) == RCC_SYSCLK) || ((ITEM) == RCC_PRESC) || ((ITEM) == RCC_PLL1) || \
	 ((ITEM) == RCC_PLL2) || ((ITEM) == RCC_PLL3) || ((ITEM) == RCC_HSI48) || ((ITEM) == RCC_RMVF) || ((ITEM) == RCC_CKPERSEL))
#else
#define IS_RCC_SINGLE_ITEM_ATTRIBUTES(ITEM)                                                                                                                                                            \
	(((ITEM) == RCC_HSI) || ((ITEM) == RCC_HSE) || ((ITEM) == RCC_CSI) || ((ITEM) == RCC_LSI) || ((ITEM) == RCC_LSE) || ((ITEM) == RCC_SYSCLK) || ((ITEM) == RCC_PRESC) || ((ITEM) == RCC_PLL1) || \
	 ((ITEM) == RCC_PLL2) || ((ITEM) == RCC_HSI48) || ((ITEM) == RCC_RMVF) || ((ITEM) == RCC_CKPERSEL))
#endif /* RCC_CR_PLL3ON */
#endif /* RCC_SECCFGR_HSISEC */

#if defined(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)
#define IS_RCC_ATTRIBUTES(ATTRIBUTES) (((ATTRIBUTES) == RCC_SEC_PRIV) || ((ATTRIBUTES) == RCC_SEC_NPRIV) || ((ATTRIBUTES) == RCC_NSEC_PRIV) || ((ATTRIBUTES) == RCC_NSEC_NPRIV))
