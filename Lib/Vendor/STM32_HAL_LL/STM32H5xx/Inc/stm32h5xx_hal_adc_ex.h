...
#define ADC_EXTERNALTRIGINJEC_PLAY_OUT9                                                                                                                                                                \
	(LL_ADC_INJ_TRIG_EXT_PLAY_OUT9) /*!< ADC group regular conversion                                                                                                                              \
...
#elif defined(ADC3)
#define ADC_BATTERY_VOLTAGE_INSTANCE(__HANDLE__) ((((__HANDLE__)->Instance) == ADC2) || (((__HANDLE__)->Instance) == ADC3))
#else
 ...
 */
#if defined(ADC3)
#define ADC_VREFINT_INSTANCE(__HANDLE__) ((((__HANDLE__)->Instance) == ADC1) || (((__HANDLE__)->Instance) == ADC3))
#else
...
#if defined(ADC3)
#define ADC_VDDCORE_INSTANCE(__HANDLE__) ((((__HANDLE__)->Instance) != ADC1) && (((__HANDLE__)->Instance) != ADC3))
#else
...
#define IS_ADC_CHANNEL(__HANDLE__, __CHANNEL__)                                                                                                                                                        \
	(((__CHANNEL__) == ADC_CHANNEL_0) || ((__CHANNEL__) == ADC_CHANNEL_1) || ((__CHANNEL__) == ADC_CHANNEL_2) || ((__CHANNEL__) == ADC_CHANNEL_3) || ((__CHANNEL__) == ADC_CHANNEL_4) ||           \
	 ...
	 (((((__HANDLE__)->Instance) == ADC1) || (((__HANDLE__)->Instance) == ADC2)) && ((__CHANNEL__) == ADC_CHANNEL_12)) ||                                                                          \
	 (((((__HANDLE__)->Instance) == ADC1) || (((__HANDLE__)->Instance) == ADC2)) && ((__CHANNEL__) == ADC_CHANNEL_13)) || ((__CHANNEL__) == ADC_CHANNEL_14) ||                                     \
	 ...
	 (((((__HANDLE__)->Instance) == ADC1) || (((__HANDLE__)->Instance) == ADC3)) && (((__CHANNEL__) == ADC_CHANNEL_VREFINT) || ((__CHANNEL__) == ADC_CHANNEL_TEMPSENSOR))) ||                      \
	 ((((__HANDLE__)->Instance) == ADC2) && ((__CHANNEL__) == ADC_CHANNEL_VBAT) || ((__CHANNEL__) == ADC_CHANNEL_VDDCORE)) ||                                                                      \
	 ((((__HANDLE__)->Instance) == ADC3) && ((__CHANNEL__) == ADC_CHANNEL_VBAT_ADC3) || ((__CHANNEL__) == ADC_CHANNEL_VDDCORE_ADC3) || ((__CHANNEL__) == ADC_CHANNEL_DAC1_CH1) ||                  \
...
#define IS_ADC_CHANNEL(__HANDLE__, __CHANNEL__)                                                                                                                                                        \
	(((__CHANNEL__) == ADC_CHANNEL_0) || ((__CHANNEL__) == ADC_CHANNEL_1) || ((__CHANNEL__) == ADC_CHANNEL_2) || ((__CHANNEL__) == ADC_CHANNEL_3) || ((__CHANNEL__) == ADC_CHANNEL_4) ||           \
	 ...
	 ((__CHANNEL__) == ADC_CHANNEL_15) || ((__CHANNEL__) == ADC_CHANNEL_16) || ((__CHANNEL__) == ADC_CHANNEL_17) || ((__CHANNEL__) == ADC_CHANNEL_18) || ((__CHANNEL__) == ADC_CHANNEL_19) ||      \
	 ((__CHANNEL__) == ADC_CHANNEL_VREFINT) || ((__CHANNEL__) == ADC_CHANNEL_TEMPSENSOR) || ((__CHANNEL__) == ADC_CHANNEL_VBAT) || ((__CHANNEL__) == ADC_CHANNEL_VDDCORE))
#endif /* ADC3 */
...
#define IS_ADC_DIFF_CHANNEL(__HANDLE__, __CHANNEL__)                                                                                                                                                   \
	((((__HANDLE__)->Instance == ADC1) || ((__HANDLE__)->Instance == ADC2)) &&                                                                                                                     \
	 (((__CHANNEL__) == ADC_CHANNEL_1) || ((__CHANNEL__) == ADC_CHANNEL_2) || ((__CHANNEL__) == ADC_CHANNEL_3) || ((__CHANNEL__) == ADC_CHANNEL_4) || ((__CHANNEL__) == ADC_CHANNEL_5) ||          \
	  ((__CHANNEL__) == ADC_CHANNEL_10) || ((__CHANNEL__) == ADC_CHANNEL_11) || ((__CHANNEL__) == ADC_CHANNEL_12) || ((__CHANNEL__) == ADC_CHANNEL_18)))
#else
/**
 * @brief Verify the ADC channel setting in differential mode for ADCx.
 * @param __HANDLE__ ADC instance
...
#define IS_ADC_EXTTRIGINJEC(__INJTRIG__)                                                                                                                                                               \
	(((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T1_TRGO) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T1_CC4) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T2_TRGO) ||                                    \
	 ...
	 ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T15_TRGO) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_LPTIM1_CH1) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_LPTIM2_CH1) ||                            \
...
#define IS_ADC_EXTTRIGINJEC(__INJTRIG__)                                                                                                                                                               \
	(((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T1_TRGO) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T1_CC4) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T2_TRGO) ||                                    \
	 ...
	 ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T3_TRGO) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T3_CC1) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T6_TRGO) ||                                    \
	 ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T15_TRGO) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_LPTIM1_CH1) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_LPTIM2_CH1) ||                            \
	 ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_PLAY_OUT9) || ((__INJTRIG__) == ADC_INJECTED_SOFTWARE_START))
#else
/* Devices STM32H503xx */
#define IS_ADC_EXTTRIGINJEC(__INJTRIG__)                                                                                                                                                               \
	(((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T1_TRGO) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T1_CC4) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T2_TRGO) ||                                    \
	 ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T2_CC1) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T3_CC4) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_EXT_IT15) ||                                    \
	 ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T1_TRGO2) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T3_CC3) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T3_TRGO) ||                                   \
	 ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T3_CC1) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T6_TRGO) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T7_TRGO) ||                                    \
	 ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_LPTIM1_CH1) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_LPTIM2_CH1) || ((__INJTRIG__) == ADC_INJECTED_SOFTWARE_START))
