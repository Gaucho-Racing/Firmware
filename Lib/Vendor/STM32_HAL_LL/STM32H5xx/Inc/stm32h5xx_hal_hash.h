...
#define __HAL_HASH_GET_FLAG(__HANDLE__, __FLAG__)                                                                                                                                                      \
	(((__FLAG__) > 8U) ? ((((__HANDLE__)->Instance->CR & (__FLAG__)) == (__FLAG__)) ? SET : RESET) : ((((__HANDLE__)->Instance->SR & (__FLAG__)) == (__FLAG__)) ? SET : RESET))
 ...
 */
#define __HAL_HASH_GET_IT_SOURCE(__HANDLE__, __INTERRUPT__) (((__HANDLE__)->Instance->IMR & (__INTERRUPT__)) == (__INTERRUPT__))
...
HAL_StatusTypeDef HAL_HASH_Start(HASH_HandleTypeDef *hhash, const uint8_t *const pInBuffer, uint32_t Size, uint8_t *const pOutBuffer, uint32_t Timeout);
HAL_StatusTypeDef HAL_HASH_Start_IT(HASH_HandleTypeDef *hhash, const uint8_t *const pInBuffer, uint32_t Size, uint8_t *const pOutBuffer);
HAL_StatusTypeDef HAL_HASH_Start_DMA(HASH_HandleTypeDef *hhash, const uint8_t *const pInBuffer, uint32_t Size, uint8_t *const pOutBuffer);

HAL_StatusTypeDef HAL_HASH_Accumulate(HASH_HandleTypeDef *hhash, const uint8_t *const pInBuffer, uint32_t Size, uint32_t Timeout);
HAL_StatusTypeDef HAL_HASH_AccumulateLast(HASH_HandleTypeDef *hhash, const uint8_t *const pInBuffer, uint32_t Size, uint8_t *const pOutBuffer, uint32_t Timeout);
HAL_StatusTypeDef HAL_HASH_AccumulateLast_IT(HASH_HandleTypeDef *hhash, const uint8_t *const pInBuffer, uint32_t Size, uint8_t *const pOutBuffer);
 ...
 * @{
 */
HAL_StatusTypeDef HAL_HASH_HMAC_Start(HASH_HandleTypeDef *hhash, const uint8_t *const pInBuffer, uint32_t Size, uint8_t *const pOutBuffer, uint32_t Timeout);
HAL_StatusTypeDef HAL_HASH_HMAC_Start_DMA(HASH_HandleTypeDef *hhash, const uint8_t *const pInBuffer, uint32_t Size, uint8_t *const pOutBuffer);
HAL_StatusTypeDef HAL_HASH_HMAC_Start_IT(HASH_HandleTypeDef *hhash, const uint8_t *const pInBuffer, uint32_t Size, uint8_t *const pOutBuffer);

HAL_StatusTypeDef HAL_HASH_HMAC_Accumulate(HASH_HandleTypeDef *hhash, const uint8_t *const pInBuffer, uint32_t Size, uint32_t Timeout);
HAL_StatusTypeDef HAL_HASH_HMAC_AccumulateLast(HASH_HandleTypeDef *hhash, const uint8_t *const pInBuffer, uint32_t Size, uint8_t *const pOutBuffer, uint32_t Timeout);
HAL_StatusTypeDef HAL_HASH_HMAC_Accumulate_IT(HASH_HandleTypeDef *hhash, const uint8_t *const pInBuffer, uint32_t Size);
HAL_StatusTypeDef HAL_HASH_HMAC_AccumulateLast_IT(HASH_HandleTypeDef *hhash, const uint8_t *const pInBuffer, uint32_t Size, uint8_t *const pOutBuffer);
	      ...
	      : ((READ_BIT((__HANDLE__)->Instance->CR, HASH_CR_ALGO) == HASH_ALGOSELECTION_SHA224)                                                                                                     \
		     ...
		     : ((READ_BIT((__HANDLE__)->Instance->CR, HASH_CR_ALGO) == HASH_ALGOSELECTION_SHA256)                                                                                              \
			    ...
			    : ((READ_BIT((__HANDLE__)->Instance->CR, HASH_CR_ALGO) == HASH_ALGOSELECTION_SHA384)                                                                                       \
				   ? 48U                                                                                                                                                               \
				   : ((READ_BIT((__HANDLE__)->Instance->CR, HASH_CR_ALGO) == HASH_ALGOSELECTION_SHA512_224)                                                                            \
					  ? 28U                                                                                                                                                        \
					  : ((READ_BIT((__HANDLE__)->Instance->CR, HASH_CR_ALGO) == HASH_ALGOSELECTION_SHA512_256)                                                                     \
						 ? 32U                                                                                                                                                 \
						 : ((READ_BIT((__HANDLE__)->Instance->CR, HASH_CR_ALGO) == HASH_ALGOSELECTION_SHA512) ? 64U : 20U))))))))
#else
#define HASH_DIGEST_LENGTH(__HANDLE__)                                                                                                                                                                 \
	(((READ_BIT((__HANDLE__)->Instance->CR, HASH_CR_ALGO) == HASH_ALGOSELECTION_SHA1) ? 20U                                                                                                        \
											  : ((READ_BIT((__HANDLE__)->Instance->CR, HASH_CR_ALGO) == HASH_ALGOSELECTION_SHA224)                         \
												 ? 28U                                                                                                 \
 ...
 */
#define IS_HASH_DATATYPE(__DATATYPE__) (((__DATATYPE__) == HASH_NO_SWAP) || ((__DATATYPE__) == HASH_HALFWORD_SWAP) || ((__DATATYPE__) == HASH_BYTE_SWAP) || ((__DATATYPE__) == HASH_BIT_SWAP))
...
#define IS_HASH_ALGORITHM(__ALGORITHM__)                                                                                                                                                               \
	(((__ALGORITHM__) == HASH_ALGOSELECTION_SHA1) || ((__ALGORITHM__) == HASH_ALGOSELECTION_SHA224) || ((__ALGORITHM__) == HASH_ALGOSELECTION_SHA256) ||                                           \
	 ((__ALGORITHM__) == HASH_ALGOSELECTION_SHA384) || ((__ALGORITHM__) == HASH_ALGOSELECTION_SHA512_224) || ((__ALGORITHM__) == HASH_ALGOSELECTION_SHA512_256) ||                                 \
	 ((__ALGORITHM__) == HASH_ALGOSELECTION_SHA512))
#else
#define IS_HASH_ALGORITHM(__ALGORITHM__) (((__ALGORITHM__) == HASH_ALGOSELECTION_SHA1) || ((__ALGORITHM__) == HASH_ALGOSELECTION_SHA224) || ((__ALGORITHM__) == HASH_ALGOSELECTION_SHA256))
#endif /* HASH_ALGOSELECTION_SHA512 */
