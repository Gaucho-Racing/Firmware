...
typedef struct __I3C_HandleTypeDef {
	...
	HAL_StatusTypeDef (*XferISR)(struct __I3C_HandleTypeDef *hi3c, uint32_t itMasks); /*!< I3C transfer IRQ handler function pointer */
...
#define HAL_I3C_ERROR_CE2                                                                                                                                                                              \
	(I3C_SER_PERR | LL_I3C_CONTROLLER_ERROR_CE2) /*!< Controller detected that broadcast address                                                                                                   \
...
#define HAL_I3C_ERROR_TE4                                                                                                                                                                              \
	(I3C_SER_PERR | LL_I3C_TARGET_ERROR_TE4) /*!< Target detected 7'h7E missing after Restart                                                                                                      \
...
#define HAL_I3C_ALL_TGT_ITS                                                                                                                                                                            \
	(uint32_t)(LL_I3C_IER_IBIENDIE | LL_I3C_IER_CRUPDIE | LL_I3C_IER_WKPIE | LL_I3C_IER_GETIE | LL_I3C_IER_STAIE | LL_I3C_IER_DAUPDIE | LL_I3C_IER_MWLUPDIE | LL_I3C_IER_MRLUPDIE |                \
		   LL_I3C_IER_RSTIE | LL_I3C_IER_ASUPDIE | LL_I3C_IER_INTUPDIE | LL_I3C_IER_DEFIE | LL_I3C_IER_GRPIE)
/**
 * @}
 */
...
#define HAL_I3C_ALL_CTRL_ITS (uint32_t)(LL_I3C_IER_CFNFIE | LL_I3C_IER_SFNEIE | LL_I3C_IER_HJIE | LL_I3C_IER_CRIE | LL_I3C_IER_IBIIE | LL_I3C_IER_RXTGTENDIE)
/**
 * @}
 */
 ...
 */
#define __HAL_I3C_GET_FLAG(__HANDLE__, __FLAG__) (((((__HANDLE__)->Instance->EVR) & (__FLAG__)) == (__FLAG__)) ? SET : RESET)
 ...
 */
#define __HAL_I3C_GET_BCR(__PAYLOAD__) (((uint32_t)((uint64_t)(__PAYLOAD__) >> HAL_I3C_BCR_IN_PAYLOAD_SHIFT)) & I3C_BCR_BCR)
 ...
 */
#define __HAL_I3C_GET_IBI_CAPABLE(__BCR__) (((((__BCR__) & I3C_BCR_BCR1_Msk) >> I3C_BCR_BCR1_Pos) == 1U) ? ENABLE : DISABLE)
 ...
 */
#define __HAL_I3C_GET_IBI_PAYLOAD(__BCR__) (((((__BCR__) & I3C_BCR_BCR2_Msk) >> I3C_BCR_BCR2_Pos) == 1U) ? ENABLE : DISABLE)
 ...
 */
#define __HAL_I3C_GET_CR_CAPABLE(__BCR__) (((((__BCR__) & I3C_BCR_BCR6_Msk) >> I3C_BCR_BCR6_Pos) == 1U) ? ENABLE : DISABLE)
 ...
 * @{
 */
#define IS_I3C_MODE(__MODE__) (((__MODE__) == HAL_I3C_MODE_NONE) || ((__MODE__) == HAL_I3C_MODE_CONTROLLER) || ((__MODE__) == HAL_I3C_MODE_TARGET))

#define IS_I3C_INTERRUPTMASK(__MODE__, __ITMASK__)                                                                                                                                                     \
	(((__MODE__) == HAL_I3C_MODE_CONTROLLER) ? ((((__ITMASK__) & HAL_I3C_ALL_CTRL_ITS) != 0x0U) || (((__ITMASK__) & HAL_I3C_ALL_COMMON_ITS) != 0x0U))                                              \
...
#define IS_I3C_WAITTIME_VALUE(__VALUE__)                                                                                                                                                               \
	(((__VALUE__) == HAL_I3C_OWN_ACTIVITY_STATE_0) || ((__VALUE__) == HAL_I3C_OWN_ACTIVITY_STATE_1) || ((__VALUE__) == HAL_I3C_OWN_ACTIVITY_STATE_2) ||                                            \
	 ((__VALUE__) == HAL_I3C_OWN_ACTIVITY_STATE_3))

#define IS_I3C_TXFIFOTHRESHOLD_VALUE(__VALUE__) (((__VALUE__) == HAL_I3C_TXFIFO_THRESHOLD_1_4) || ((__VALUE__) == HAL_I3C_TXFIFO_THRESHOLD_4_4))

#define IS_I3C_RXFIFOTHRESHOLD_VALUE(__VALUE__) (((__VALUE__) == HAL_I3C_RXFIFO_THRESHOLD_1_4) || ((__VALUE__) == HAL_I3C_RXFIFO_THRESHOLD_4_4))

#define IS_I3C_CONTROLFIFOSTATE_VALUE(__VALUE__) (((__VALUE__) == HAL_I3C_CONTROLFIFO_DISABLE) || ((__VALUE__) == HAL_I3C_CONTROLFIFO_ENABLE))

#define IS_I3C_STATUSFIFOSTATE_VALUE(__VALUE__) (((__VALUE__) == HAL_I3C_STATUSFIFO_DISABLE) || ((__VALUE__) == HAL_I3C_STATUSFIFO_ENABLE))
...
#define IS_I3C_HANDOFFACTIVITYSTATE_VALUE(__VALUE__)                                                                                                                                                   \
	(((__VALUE__) == HAL_I3C_HANDOFF_ACTIVITY_STATE_0) || ((__VALUE__) == HAL_I3C_HANDOFF_ACTIVITY_STATE_1) || ((__VALUE__) == HAL_I3C_HANDOFF_ACTIVITY_STATE_2) ||                                \
	 ((__VALUE__) == HAL_I3C_HANDOFF_ACTIVITY_STATE_3))

#define IS_I3C_TSCOTIME_VALUE(__VALUE__) (((__VALUE__) == HAL_I3C_TURNAROUND_TIME_TSCO_LESS_12NS) || ((__VALUE__) == HAL_I3C_TURNAROUND_TIME_TSCO_GREATER_12NS))

#define IS_I3C_MAXSPEEDDATA_VALUE(__VALUE__)                                                                                                                                                           \
	(((__VALUE__) == HAL_I3C_GETMXDS_FORMAT_1) || ((__VALUE__) == HAL_I3C_GETMXDS_FORMAT_2_LSB) || ((__VALUE__) == HAL_I3C_GETMXDS_FORMAT_2_MID) || ((__VALUE__) == HAL_I3C_GETMXDS_FORMAT_2_MSB))

#define IS_I3C_IBIPAYLOADSIZE_VALUE(__VALUE__)                                                                                                                                                         \
	(((__VALUE__) == HAL_I3C_PAYLOAD_EMPTY) || ((__VALUE__) == HAL_I3C_PAYLOAD_1_BYTE) || ((__VALUE__) == HAL_I3C_PAYLOAD_2_BYTES) || ((__VALUE__) == HAL_I3C_PAYLOAD_3_BYTES) ||                  \
...
#define IS_I3C_RESET_PATTERN(__RSTPTRN__) (((__RSTPTRN__) == HAL_I3C_RESET_PATTERN_ENABLE) || ((__RSTPTRN__) == HAL_I3C_RESET_PATTERN_DISABLE))
/**
 * @}
 */
