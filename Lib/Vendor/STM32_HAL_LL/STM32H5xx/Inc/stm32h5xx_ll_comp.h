...
#define LL_COMP_WINDOWMODE_COMP_ODD_REGOFFSET_MASK                                                                                                                                                     \
	(0x00000000UL) /* Register of COMP instance odd (COMP1_CSR, ...)                                                                                                                               \
			  defined as reference register */
#define LL_COMP_WINDOWMODE_COMP_EVEN_REGOFFSET_MASK                                                                                                                                                    \
	(0x00000001UL) /* Register of COMP instance even (COMP2_CSR, ...)                                                                                                                              \
 ...
 */
#define __COMP_PTR_REG_OFFSET(__REG__, __REG_OFFFSET__) ((__IO uint32_t *)((uint32_t)((uint32_t)(&(__REG__)) + ((__REG_OFFFSET__) << 2UL))))
...
#define LL_COMP_WINDOWMODE_COMP1_INPUT_PLUS_COMMON                                                                                                                                                     \
	(COMP_CFGR1_WINMODE | LL_COMP_WINDOWMODE_COMP_EVEN_REGOFFSET_MASK) /*!< Window mode                                                                                                            \
...
#define LL_COMP_WINDOWMODE_COMP2_INPUT_PLUS_COMMON                                                                                                                                                     \
	(COMP_CFGR1_WINMODE | LL_COMP_WINDOWMODE_COMP_ODD_REGOFFSET_MASK) /*!< Window mode                                                                                                             \
			  enable: Comparators instances pair COMP1 and COMP2 have their input                                                                                                          \
 ...
 * @{
 */
#define LL_COMP_WINDOWOUTPUT_EACH_COMP                                                                                                                                                                 \
	(0x00000000UL) /*!< Window output default mode: Comparators output                                                                                                                             \
...
#define LL_COMP_WINDOWOUTPUT_COMP1                                                                                                                                                                     \
	(COMP_CFGR1_WINOUT | LL_COMP_WINDOWMODE_COMP_ODD_REGOFFSET_MASK) /*!< Window output                                                                                                            \
...
#define LL_COMP_WINDOWOUTPUT_COMP2                                                                                                                                                                     \
	(COMP_CFGR1_WINOUT | LL_COMP_WINDOWMODE_COMP_EVEN_REGOFFSET_MASK) /*!< Window output                                                                                                           \
			  ...
			  timers, ...), does not impact output digital state of comparator                                                                                                             \
			  (COMPx_VALUE) always reflecting each comparator output state.*/
#define LL_COMP_WINDOWOUTPUT_BOTH                                                                                                                                                                      \
	(COMP_CFGR1_WINOUT | LL_COMP_WINDOWMODE_COMP_EVEN_REGOFFSET_MASK | LL_COMP_WINDOWOUTPUT_BOTH_SETTING_MASK) /*!< Window output                                                                  \
...
#define LL_COMP_POWERMODE_ULTRALOWPOWER (COMP_CFGR1_PWRMODE_1 | COMP_CFGR1_PWRMODE_0) /*!< COMP power mode to ultra-low power */
/**
 * @}
 */
...
#define LL_COMP_INPUT_PLUS_DAC1_CH2                                                                                                                                                                    \
 ...
 * @{
 */
#define LL_COMP_INPUT_MINUS_1_4VREFINT (COMP_CFGR1_SCALEN | COMP_CFGR1_BRGEN)			    /*!< Comparator input minus connected to 1/4 VrefInt */
#define LL_COMP_INPUT_MINUS_1_2VREFINT (COMP_CFGR1_INMSEL_0 | COMP_CFGR1_SCALEN | COMP_CFGR1_BRGEN) /*!< Comparator input minus connected to 1/2 VrefInt */
#define LL_COMP_INPUT_MINUS_3_4VREFINT (COMP_CFGR1_INMSEL_1 | COMP_CFGR1_SCALEN | COMP_CFGR1_BRGEN) /*!< Comparator input minus connected to 3/4 VrefInt */
#define LL_COMP_INPUT_MINUS_VREFINT (COMP_CFGR1_INMSEL_1 | COMP_CFGR1_INMSEL_0 | COMP_CFGR1_SCALEN) /*!< Comparator input minus connected to VrefInt */
#if defined(STM32H503xx)
#define LL_COMP_INPUT_MINUS_DAC1_CH1                                                                                                                                                                   \
	(COMP_CFGR1_INMSEL_2)									  /*!< Comparator input minus connected to DAC1                                                        \
									  channel 1 (DAC_OUT1) */
#define LL_COMP_INPUT_MINUS_IO1 (COMP_CFGR1_INMSEL_2 | COMP_CFGR1_INMSEL_0)			  /*!< Comparator input minus connected to pin PC4 */
#define LL_COMP_INPUT_MINUS_IO2 (COMP_CFGR1_INMSEL_2 | COMP_CFGR1_INMSEL_1)			  /*!< Comparator input minus connected to pin PB1 */
#define LL_COMP_INPUT_MINUS_IO3 (COMP_CFGR1_INMSEL_2 | COMP_CFGR1_INMSEL_1 | COMP_CFGR1_INMSEL_0) /*!< Comparator input minus connected to pin PA5 */
...
#define LL_COMP_INPUT_MINUS_VBAT                                                                                                                                                                       \
	(COMP_CFGR1_INMSEL_3 | COMP_CFGR1_INMSEL_0) /*!< Comparator input minus connected to Vbat/4:                                                                                                   \
			    ...
			    always below Vdda.                                                                                                                                                         \
			    (specific to instance: COMP1) */
#define LL_COMP_INPUT_MINUS_VDDCORE                                                                                                                                                                    \
...
#define LL_COMP_BLANKINGSRC_TIM3_OC3 (COMP_CFGR1_BLANKING_0 | COMP_CFGR1_BLANKING_1)   /*!< Comparator output blanking source TIM3 OC3 */
#define LL_COMP_BLANKINGSRC_TIM3_OC4 (COMP_CFGR1_BLANKING_2)			       /*!< Comparator output blanking source TIM3 OC4 */
#define LL_COMP_BLANKINGSRC_LPTIM1_OC2 (COMP_CFGR1_BLANKING_2 | COMP_CFGR1_BLANKING_0) /*!< Comparator output blanking source LPTIM1 OC2 */
#define LL_COMP_BLANKINGSRC_LPTIM2_OC2 (COMP_CFGR1_BLANKING_2 | COMP_CFGR1_BLANKING_1) /*!< Comparator output blanking source LPTIM2 OC2 */
#else
#define LL_COMP_BLANKINGSRC_TIM1_OC5                                                                                                                                                                   \
	(COMP_CFGR1_BLANKING_0) /*!< Comparator output blanking source TIM1 OC5                                                                                                                        \
				     (specific to instance: COMP1) */
#define LL_COMP_BLANKINGSRC_TIM1_OC6                                                                                                                                                                   \
...
__STATIC_INLINE void LL_COMP_SetCommonWindowMode(COMP_Common_TypeDef *COMPxy_COMMON, uint32_t WindowMode)
{
	...
	__IO uint32_t *preg = __COMP_PTR_REG_OFFSET(COMPxy_COMMON->CFGR1_ODD, (WindowMode & LL_COMP_WINDOWMODE_COMPX_REGOFFSET_MASK));

	/* Clear the potential previous setting of window mode */
	__IO uint32_t *preg_clear = __COMP_PTR_REG_OFFSET(COMPxy_COMMON->CFGR1_ODD, (~(WindowMode & LL_COMP_WINDOWMODE_COMPX_REGOFFSET_MASK) & 0x1UL));
...
__STATIC_INLINE uint32_t LL_COMP_GetCommonWindowMode(const COMP_Common_TypeDef *COMPxy_COMMON)
{
	...
	return (uint32_t)(window_mode_comp_odd | window_mode_comp_even | ((window_mode_comp_even >> COMP_CFGR1_WINMODE_Pos) * LL_COMP_WINDOWMODE_COMP_EVEN_REGOFFSET_MASK));
}
...
{
	__IO uint32_t *preg = __COMP_PTR_REG_OFFSET(COMPxy_COMMON->CFGR1_ODD, (WindowOutput & LL_COMP_WINDOWMODE_COMPX_REGOFFSET_MASK));
	...
	__IO uint32_t *preg_clear = __COMP_PTR_REG_OFFSET(COMPxy_COMMON->CFGR1_ODD, (~(WindowOutput & LL_COMP_WINDOWMODE_COMPX_REGOFFSET_MASK) & 0x1UL));
	MODIFY_REG(*preg_clear, COMP_CFGR1_WINOUT, ((WindowOutput & LL_COMP_WINDOWOUTPUT_BOTH_SETTING_MASK) >> LL_COMP_WINDOWOUTPUT_BOTH_POS_VS_WINDOW));

	/* Set window output */
	MODIFY_REG(*preg, COMP_CFGR1_WINOUT, (WindowOutput & LL_COMP_WINDOWOUTPUT_COMPX_SETTING_MASK));
}
...
__STATIC_INLINE uint32_t LL_COMP_GetCommonWindowOutput(const COMP_Common_TypeDef *COMPxy_COMMON)
{
	...
	return (uint32_t)(window_output_comp_odd | window_output_comp_even | ((window_output_comp_even >> COMP_CFGR1_WINOUT_Pos) * LL_COMP_WINDOWMODE_COMP_EVEN_REGOFFSET_MASK) |
...
__STATIC_INLINE void LL_COMP_ConfigInputs(COMP_TypeDef *COMPx, uint32_t InputMinus, uint32_t InputPlus)
{
	...
	MODIFY_REG(COMPx->CFGR1, COMP_CFGR1_INMSEL | COMP_CFGR1_INPSEL1 | COMP_CFGR1_INPSEL2 | COMP_CFGR1_SCALEN | COMP_CFGR1_BRGEN, InputMinus | InputPlus);
#else
	if (COMPx == COMP2) {
	...
	MODIFY_REG(COMPx->CFGR1, COMP_CFGR1_INMSEL | COMP_CFGR1_INPSEL0 | COMP_CFGR1_INPSEL1 | COMP_CFGR1_SCALEN | COMP_CFGR1_BRGEN, InputMinus | InputPlus);
#endif /* STM32H503xx */
}
