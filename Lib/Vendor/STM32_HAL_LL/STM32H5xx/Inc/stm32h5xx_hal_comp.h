...
#define COMP_WINDOWMODE_COMP1_INPUT_PLUS_COMMON                                                                                                                                                        \
	(COMP_CFGR1_WINMODE) /*!< Window mode enable: Comparators instances                                                                                                                            \
...
#define COMP_WINDOWMODE_COMP2_INPUT_PLUS_COMMON                                                                                                                                                        \
	(COMP_CFGR1_WINMODE | COMP_WINDOWMODE_COMP2) /*!< Window mode enable: Comparators instances                                                                                                    \
							  pair COMP1 and COMP2 have their input                                                                                                        \
							  plus connected together.                                                                                                                     \
...
#define COMP_WINDOWOUTPUT_EACH_COMP                                                                                                                                                                    \
	(0x00000000UL) /*!< Window output default mode: Comparators output are                                                                                                                         \
...
#define COMP_WINDOWOUTPUT_COMP1                                                                                                                                                                        \
	(COMP_CFGR1_WINOUT) /*!< Window output synthesized on COMP1 output:                                                                                                                            \
...
#define COMP_WINDOWOUTPUT_COMP2                                                                                                                                                                        \
	(COMP_CFGR1_WINOUT | COMP_WINDOWMODE_COMP2) /*!< Window output synthesized on COMP2 output:                                                                                                    \
...
#define COMP_WINDOWOUTPUT_BOTH                                                                                                                                                                         \
	(0x00000001UL) /*!< Window output synthesized on both comparators output                                                                                                                       \
...
#define COMP_INPUT_PLUS_IO1                                                                                                                                                                            \
	(0x00000000UL) /*!< Comparator input plus connected to IO1                                                                                                                                     \
			    (COMP1 pin PA7, COMP2 pin PB0) */
#define COMP_INPUT_PLUS_IO2                                                                                                                                                                            \
	(COMP_CFGR1_INPSEL0) /*!< Comparator input plus connected to IO2                                                                                                                               \
				  (COMP1 pin PB2, COMP2 pin PE7) */
#define COMP_INPUT_PLUS_DAC1_CH1                                                                                                                                                                       \
	(COMP_CFGR1_INPSEL1) /*!< Comparator input plus connected to DAC1 channel 1                                                                                                                    \
				  (specific to instance: COMP1) */
#define COMP_INPUT_PLUS_DAC1_CH2                                                                                                                                                                       \
	(COMP_CFGR1_INPSEL1) /*!< Comparator input plus connected to DAC1 channel 2                                                                                                                    \
 ...
 * @{
 */
#define COMP_INPUT_MINUS_1_4VREFINT (COMP_CFGR1_SCALEN | COMP_CFGR1_BRGEN)			 /*!< Comparator input minus connected to 1/4 VrefInt    */
#define COMP_INPUT_MINUS_1_2VREFINT (COMP_CFGR1_INMSEL_0 | COMP_CFGR1_SCALEN | COMP_CFGR1_BRGEN) /*!< Comparator input minus connected to 1/2 VrefInt    */
#define COMP_INPUT_MINUS_3_4VREFINT (COMP_CFGR1_INMSEL_1 | COMP_CFGR1_SCALEN | COMP_CFGR1_BRGEN) /*!< Comparator input minus connected to 3/4 VrefInt    */
#define COMP_INPUT_MINUS_VREFINT (COMP_CFGR1_INMSEL_1 | COMP_CFGR1_INMSEL_0 | COMP_CFGR1_SCALEN) /*!< Comparator input minus connected to VrefInt        */
#if defined(STM32H503xx)
#define COMP_INPUT_MINUS_DAC1_CH1                                                                                                                                                                      \
	(COMP_CFGR1_INMSEL_2)								       /*!< Comparator input minus connected to DAC1                                                           \
								       channel 1 (DAC_OUT1) */
#define COMP_INPUT_MINUS_IO1 (COMP_CFGR1_INMSEL_2 | COMP_CFGR1_INMSEL_0)		       /*!< Comparator input minus connected to pin PC4 */
#define COMP_INPUT_MINUS_IO2 (COMP_CFGR1_INMSEL_2 | COMP_CFGR1_INMSEL_1)		       /*!< Comparator input minus connected to pin PB1 */
#define COMP_INPUT_MINUS_IO3 (COMP_CFGR1_INMSEL_2 | COMP_CFGR1_INMSEL_1 | COMP_CFGR1_INMSEL_0) /*!< Comparator input minus connected to pin PA5 */
...
#else
#define COMP_INPUT_MINUS_DAC1_CH1                                                                                                                                                                      \
	(COMP_CFGR1_INMSEL_2 | COMP_CFGR1_INMSEL_0) /*!< Comparator input minus connected to DAC1                                                                                                      \
			    channel 1 (DAC_OUT1) */
#define COMP_INPUT_MINUS_DAC1_CH2                                                                                                                                                                      \
	(COMP_CFGR1_INMSEL_2) /*!< Comparator input minus connected to DAC1                                                                                                                            \
      channel 2 (DAC_OUT2) */
#define COMP_INPUT_MINUS_IO1                                                                                                                                                                           \
	(COMP_CFGR1_INMSEL_2 | COMP_CFGR1_INMSEL_1) /*!< Comparator input minus connected to IO1                                                                                                       \
...
#define COMP_INPUT_MINUS_IO2                                                                                                                                                                           \
	(COMP_CFGR1_INMSEL_2 | COMP_CFGR1_INMSEL_1 | COMP_CFGR1_INMSEL_0) /*!< Comparator input minus connected to IO2                                                                                 \
						  (COMP1 pin PE10, COMP2 pin PE9).                                                                                                                     \
						  Note: value for COMP2 different, updated in function using this define. */
#define COMP_INPUT_MINUS_IO3                                                                                                                                                                           \
	(COMP_CFGR1_INMSEL_3) /*!< Comparator input minus connected to IO3                                                                                                                             \
...
#define COMP_INPUT_MINUS_VBAT                                                                                                                                                                          \
	(COMP_CFGR1_INMSEL_3 | COMP_CFGR1_INMSEL_0) /*!< Comparator input minus connected to Vbat/4:                                                                                                   \
			    ...
			    always below Vdda.                                                                                                                                                         \
			    (specific to instance: COMP1) */
#define COMP_INPUT_MINUS_VDDCORE                                                                                                                                                                       \
	(COMP_CFGR1_INMSEL_2 | COMP_CFGR1_INMSEL_1) /*!< Comparator input minus connected to VddCore.                                                                                                  \
			    (specific to instance: COMP2) */
#endif						    /* STM32H503xx */
/**
 * @}
...
#define COMP_BLANKINGSRC_TIM3_OC3 (COMP_CFGR1_BLANKING_0 | COMP_CFGR1_BLANKING_1)   /*!< Comparator output blanking source TIM3 OC3 */
#define COMP_BLANKINGSRC_TIM3_OC4 (COMP_CFGR1_BLANKING_2)			    /*!< Comparator output blanking source TIM3 OC4 */
#define COMP_BLANKINGSRC_LPTIM1_OC2 (COMP_CFGR1_BLANKING_2 | COMP_CFGR1_BLANKING_0) /*!< Comparator output blanking source LPTIM1 OC2 */
#define COMP_BLANKINGSRC_LPTIM2_OC2 (COMP_CFGR1_BLANKING_2 | COMP_CFGR1_BLANKING_1) /*!< Comparator output blanking source LPTIM2 OC2 */
#else
#define COMP_BLANKINGSRC_TIM1_OC5                                                                                                                                                                      \
	(COMP_CFGR1_BLANKING_0) /*!< Comparator output blanking source TIM1 OC5                                                                                                                        \
				     (specific to instance: COMP1) */
#define COMP_BLANKINGSRC_TIM1_OC6                                                                                                                                                                      \
	(COMP_CFGR1_BLANKING_0)							  /*!< Comparator output blanking source TIM1 OC6                                                                      \
										       (specific to instance: COMP2) */
#define COMP_BLANKINGSRC_TIM2_OC3 (COMP_CFGR1_BLANKING_1)			  /*!< Comparator output blanking source TIM2 OC3 */
#define COMP_BLANKINGSRC_TIM3_OC3 (COMP_CFGR1_BLANKING_0 | COMP_CFGR1_BLANKING_1) /*!< Comparator output blanking source TIM3 OC3 */
#define COMP_BLANKINGSRC_TIM3_OC4 (COMP_CFGR1_BLANKING_2)			  /*!< Comparator output blanking source TIM3 OC4 */
...
#define COMP_BLANKINGSRC_TIM8_OC5                                                                                                                                                                      \
	(COMP_CFGR1_BLANKING_2 | COMP_CFGR1_BLANKING_0) /*!< Comparator output blanking source TIM8 OC5                                                                                                \
							     (specific to instance: COMP2) */
#define COMP_BLANKINGSRC_TIM15_OC2                                                                                                                                                                     \
	(COMP_CFGR1_BLANKING_2 | COMP_CFGR1_BLANKING_1) /*!< Comparator output blanking source TIM15 OC2                                                                                               \
							     (specific to instance: COMP2) */
#endif							/* STM32H503xx */
/**
 * @}
...
#define COMP_TRIGGERMODE_EVENT_RISING                                                                                                                                                                  \
	(COMP_EXTI_EVENT | COMP_EXTI_RISING) /*!< Comparator output triggering                                                                                                                         \
      interrupt on rising edge */
#define COMP_TRIGGERMODE_EVENT_FALLING                                                                                                                                                                 \
	(COMP_EXTI_EVENT | COMP_EXTI_FALLING) /*!< Comparator output triggering                                                                                                                        \
       interrupt on falling edge */
 ...
 */
#define __HAL_COMP_GET_IT_SOURCE(__HANDLE__, __INTERRUPT__) ((((__HANDLE__)->Instance->CFGR1 & (__INTERRUPT__)) == (__INTERRUPT__)) ? SET : RESET)
...
#define IS_COMP_WINDOWMODE(__WINDOWMODE__)                                                                                                                                                             \
	(((__WINDOWMODE__) == COMP_WINDOWMODE_DISABLE) || ((__WINDOWMODE__) == COMP_WINDOWMODE_COMP1_INPUT_PLUS_COMMON) || ((__WINDOWMODE__) == COMP_WINDOWMODE_COMP2_INPUT_PLUS_COMMON))

#define IS_COMP_WINDOWOUTPUT(__WINDOWOUTPUT__)                                                                                                                                                         \
	(((__WINDOWOUTPUT__) == COMP_WINDOWOUTPUT_EACH_COMP) || ((__WINDOWOUTPUT__) == COMP_WINDOWOUTPUT_COMP1) || ((__WINDOWOUTPUT__) == COMP_WINDOWOUTPUT_COMP2) ||                                  \
	 ((__WINDOWOUTPUT__) == COMP_WINDOWOUTPUT_BOTH))
#endif /* COMP_WINDOW_MODE_SUPPORT */

#define IS_COMP_POWERMODE(__POWERMODE__) (((__POWERMODE__) == COMP_POWERMODE_HIGHSPEED) || ((__POWERMODE__) == COMP_POWERMODE_MEDIUMSPEED) || ((__POWERMODE__) == COMP_POWERMODE_ULTRALOWPOWER))

#if defined(STM32H503xx)
#define IS_COMP_INPUT_PLUS(__COMP_INSTANCE__, __INPUT_PLUS__)                                                                                                                                          \
	(((__INPUT_PLUS__) == COMP_INPUT_PLUS_IO1) || ((__INPUT_PLUS__) == COMP_INPUT_PLUS_IO2) || ((__INPUT_PLUS__) == COMP_INPUT_PLUS_IO3) || ((__INPUT_PLUS__) == COMP_INPUT_PLUS_DAC1_CH1))
#else
/* Note: check of COMP_INPUT_PLUS_DAC1_CH2 done through other literals with same value */
#define IS_COMP_INPUT_PLUS(__COMP_INSTANCE__, __INPUT_PLUS__) (((__INPUT_PLUS__) == COMP_INPUT_PLUS_IO1) || ((__INPUT_PLUS__) == COMP_INPUT_PLUS_IO2) || ((__INPUT_PLUS__) == COMP_INPUT_PLUS_DAC1_CH1))
#endif /* STM32H503xx */
...
#define IS_COMP_INPUT_MINUS(__COMP_INSTANCE__, __INPUT_MINUS__)                                                                                                                                        \
	(((__INPUT_MINUS__) == COMP_INPUT_MINUS_1_4VREFINT) || ((__INPUT_MINUS__) == COMP_INPUT_MINUS_1_2VREFINT) || ((__INPUT_MINUS__) == COMP_INPUT_MINUS_3_4VREFINT) ||                             \
	 ((__INPUT_MINUS__) == COMP_INPUT_MINUS_VREFINT) || ((__INPUT_MINUS__) == COMP_INPUT_MINUS_DAC1_CH1) || ((__INPUT_MINUS__) == COMP_INPUT_MINUS_IO1) ||                                         \
	 ((__INPUT_MINUS__) == COMP_INPUT_MINUS_IO2) || ((__INPUT_MINUS__) == COMP_INPUT_MINUS_IO3) || ((__INPUT_MINUS__) == COMP_INPUT_MINUS_TEMPSENSOR) ||                                           \
...
#define IS_COMP_INPUT_MINUS(__COMP_INSTANCE__, __INPUT_MINUS__)                                                                                                                                        \
	(((__INPUT_MINUS__) == COMP_INPUT_MINUS_1_4VREFINT) || ((__INPUT_MINUS__) == COMP_INPUT_MINUS_1_2VREFINT) || ((__INPUT_MINUS__) == COMP_INPUT_MINUS_3_4VREFINT) ||                             \
	 ((__INPUT_MINUS__) == COMP_INPUT_MINUS_VREFINT) || ((__INPUT_MINUS__) == COMP_INPUT_MINUS_DAC1_CH1) || ((__INPUT_MINUS__) == COMP_INPUT_MINUS_DAC1_CH2) ||                                    \
	 ((__INPUT_MINUS__) == COMP_INPUT_MINUS_IO1) || ((__INPUT_MINUS__) == COMP_INPUT_MINUS_IO2) || ((__INPUT_MINUS__) == COMP_INPUT_MINUS_TEMPSENSOR) ||                                           \
	 ((__INPUT_MINUS__) == COMP_INPUT_MINUS_VBAT))
#endif /* STM32H503xx */

#define IS_COMP_HYSTERESIS(__HYSTERESIS__)                                                                                                                                                             \
	(((__HYSTERESIS__) == COMP_HYSTERESIS_NONE) || ((__HYSTERESIS__) == COMP_HYSTERESIS_LOW) || ((__HYSTERESIS__) == COMP_HYSTERESIS_MEDIUM) || ((__HYSTERESIS__) == COMP_HYSTERESIS_HIGH))
...
#define IS_COMP_BLANKINGSRCE(__SOURCE__)                                                                                                                                                               \
	(((__SOURCE__) == COMP_BLANKINGSRC_NONE) || ((__SOURCE__) == COMP_BLANKINGSRC_TIM1_OC5) || ((__SOURCE__) == COMP_BLANKINGSRC_TIM2_OC3) || ((__SOURCE__) == COMP_BLANKINGSRC_TIM3_OC3) ||       \
	 ((__SOURCE__) == COMP_BLANKINGSRC_TIM3_OC4) || ((__SOURCE__) == COMP_BLANKINGSRC_LPTIM1_OC2) || ((__SOURCE__) == COMP_BLANKINGSRC_LPTIM2_OC2))

#if defined(STM32H503xx)
#define IS_COMP_TRIGGERMODE(__MODE__) (((__MODE__) == COMP_TRIGGERMODE_NONE) || ((__MODE__) == COMP_TRIGGERMODE_IT_RISING_FALLING))
#else
