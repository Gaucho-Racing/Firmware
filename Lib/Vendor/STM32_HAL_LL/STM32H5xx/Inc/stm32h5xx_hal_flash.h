...
#if defined(FLASH_SR_OBKERR)
#define FLASH_FLAG_SR_ERRORS (FLASH_SR_WRPERR | FLASH_SR_PGSERR | FLASH_SR_STRBERR | FLASH_SR_INCERR | FLASH_SR_OBKERR | FLASH_SR_OBKWERR | FLASH_SR_OPTCHANGEERR)
#else
#define FLASH_FLAG_SR_ERRORS (FLASH_SR_WRPERR | FLASH_SR_PGSERR | FLASH_SR_STRBERR | FLASH_SR_INCERR | FLASH_SR_OPTCHANGEERR)
#endif /* FLASH_SR_OBKERR */
...
#if defined(FLASH_SR_OBKERR)
#define FLASH_IT_ALL                                                                                                                                                                                   \
	(FLASH_IT_EOP | FLASH_IT_WRPERR | FLASH_IT_PGSERR | FLASH_IT_STRBERR | FLASH_IT_INCERR | FLASH_IT_OBKERR | FLASH_IT_OBKWERR | FLASH_IT_OPTCHANGEERR |                                          \
	 FLASH_IT_ECCC) /*!< All Flash interrupt sources */
#else
#define FLASH_IT_ALL (FLASH_IT_EOP | FLASH_IT_WRPERR | FLASH_IT_PGSERR | FLASH_IT_STRBERR | FLASH_IT_INCERR | FLASH_IT_OPTCHANGEERR | FLASH_IT_ECCC) /*!< All Flash interrupt sources */
#endif																		     /* FLASH_SR_OBKERR */
...
#define __HAL_FLASH_GET_FLAG(__FLAG__)                                                                                                                                                                 \
	((((__FLAG__) & (FLASH_FLAG_ECCC)) != 0U) ? (READ_BIT(FLASH->ECCCORR, (__FLAG__)) == (__FLAG__))                                                                                               \
	 : (((__FLAG__) & (FLASH_FLAG_ECCD)) != 0U)                                                                                                                                                    \
	     ...
	     : ((((__FLAG__) & (FLASH_FLAG_OPTCHANGEERR)) != 0U) ? (READ_BIT(FLASH->NSSR, (__FLAG__)) == (__FLAG__)) : (READ_BIT(FLASH->SECSR, (__FLAG__)) == (__FLAG__))))
...
#define IS_FLASH_TYPEPROGRAM(VALUE)                                                                                                                                                                    \
	(((VALUE) == FLASH_TYPEPROGRAM_QUADWORD) || ((VALUE) == FLASH_TYPEPROGRAM_QUADWORD_NS) || ((VALUE) == FLASH_TYPEPROGRAM_HALFWORD_OTP) || ((VALUE) == FLASH_TYPEPROGRAM_HALFWORD_EDATA) ||      \
	 ((VALUE) == FLASH_TYPEPROGRAM_HALFWORD_EDATA_NS) || ((VALUE) == FLASH_TYPEPROGRAM_WORD_EDATA) || ((VALUE) == FLASH_TYPEPROGRAM_WORD_EDATA_NS) ||                                              \
	 ((VALUE) == FLASH_TYPEPROGRAM_QUADWORD_OBK) || ((VALUE) == FLASH_TYPEPROGRAM_QUADWORD_OBK_ALT))
#else
#define IS_FLASH_TYPEPROGRAM(VALUE) (((VALUE) == FLASH_TYPEPROGRAM_QUADWORD) || ((VALUE) == FLASH_TYPEPROGRAM_QUADWORD_NS) || ((VALUE) == FLASH_TYPEPROGRAM_HALFWORD_OTP))
#endif /* FLASH_SR_OBKERR && FLASH_EDATAR_EDATA_EN */
#else
#if defined(FLASH_SR_OBKERR) && defined(FLASH_EDATAR_EDATA_EN)
#define IS_FLASH_TYPEPROGRAM(VALUE)                                                                                                                                                                    \
	(((VALUE) == FLASH_TYPEPROGRAM_QUADWORD) || ((VALUE) == FLASH_TYPEPROGRAM_HALFWORD_OTP) || ((VALUE) == FLASH_TYPEPROGRAM_HALFWORD_EDATA) || ((VALUE) == FLASH_TYPEPROGRAM_WORD_EDATA) ||       \
	 ((VALUE) == FLASH_TYPEPROGRAM_QUADWORD_OBK) || ((VALUE) == FLASH_TYPEPROGRAM_QUADWORD_OBK_ALT))
#else
#define IS_FLASH_TYPEPROGRAM(VALUE) (((VALUE) == FLASH_TYPEPROGRAM_QUADWORD) || ((VALUE) == FLASH_TYPEPROGRAM_HALFWORD_OTP))
#endif /* FLASH_SR_OBKERR && FLASH_EDATAR_EDATA_EN */
#endif /* __ARM_FEATURE_CMSE */

#if defined(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)
#define IS_FLASH_USER_MEM_ADDRESS(ADDRESS) ((((ADDRESS) >= FLASH_BASE) && ((ADDRESS) < (FLASH_BASE + FLASH_SIZE))) || (((ADDRESS) >= FLASH_BASE_NS) && ((ADDRESS) < (FLASH_BASE_NS + FLASH_SIZE))))
#if defined(FLASH_SR_OBKERR)
#define IS_FLASH_OBK_ADDRESS(ADDRESS)                                                                                                                                                                  \
	((((ADDRESS) >= FLASH_OBK_BASE) && ((ADDRESS) < (FLASH_OBK_BASE + FLASH_OBK_SIZE))) || (((ADDRESS) >= FLASH_OBK_BASE_NS) && ((ADDRESS) < (FLASH_OBK_BASE_NS + FLASH_OBK_SIZE))))
#endif /* FLASH_SR_OBKERR */
#if defined(FLASH_EDATAR_EDATA_EN)
#define IS_FLASH_EDATA_ADDRESS(ADDRESS)                                                                                                                                                                \
	((((ADDRESS) >= FLASH_EDATA_BASE_S) && ((ADDRESS) < (FLASH_EDATA_BASE_S + FLASH_EDATA_SIZE))) || (((ADDRESS) >= FLASH_EDATA_BASE_NS) && ((ADDRESS) < (FLASH_EDATA_BASE_NS + FLASH_EDATA_SIZE))))
#endif /* FLASH_EDATAR_EDATA_EN */
#else
...
#endif /* FLASH_SR_OBKERR */
#if defined(FLASH_EDATAR_EDATA_EN)
#define IS_FLASH_EDATA_ADDRESS(ADDRESS) (((ADDRESS) >= FLASH_EDATA_BASE_NS) && ((ADDRESS) < (FLASH_EDATA_BASE_NS + FLASH_EDATA_SIZE)))
#endif /* FLASH_EDATAR_EDATA_EN */
#endif /* __ARM_FEATURE_CMSE */
