...
#define LL_PLAY_LUT_ALL_OUT_DIRECT                                                                                                                                                                     \
	(LL_PLAY_LUT0_OUT_DIRECT | LL_PLAY_LUT1_OUT_DIRECT | LL_PLAY_LUT2_OUT_DIRECT | LL_PLAY_LUT3_OUT_DIRECT | LL_PLAY_LUT4_OUT_DIRECT | LL_PLAY_LUT5_OUT_DIRECT | LL_PLAY_LUT6_OUT_DIRECT |         \
	 LL_PLAY_LUT7_OUT_DIRECT | LL_PLAY_LUT8_OUT_DIRECT | LL_PLAY_LUT9_OUT_DIRECT | LL_PLAY_LUT10_OUT_DIRECT | LL_PLAY_LUT11_OUT_DIRECT | LL_PLAY_LUT12_OUT_DIRECT | LL_PLAY_LUT13_OUT_DIRECT |     \
	 LL_PLAY_LUT14_OUT_DIRECT | LL_PLAY_LUT15_OUT_DIRECT)
...
#define LL_PLAY_LUT_ALL_OUT_REGISTERED                                                                                                                                                                 \
	(LL_PLAY_LUT0_OUT_REGISTERED | LL_PLAY_LUT1_OUT_REGISTERED | LL_PLAY_LUT2_OUT_REGISTERED | LL_PLAY_LUT3_OUT_REGISTERED | LL_PLAY_LUT4_OUT_REGISTERED | LL_PLAY_LUT5_OUT_REGISTERED |           \
	 LL_PLAY_LUT6_OUT_REGISTERED | LL_PLAY_LUT7_OUT_REGISTERED | LL_PLAY_LUT8_OUT_REGISTERED | LL_PLAY_LUT9_OUT_REGISTERED | LL_PLAY_LUT10_OUT_REGISTERED | LL_PLAY_LUT11_OUT_REGISTERED |         \
	 LL_PLAY_LUT12_OUT_REGISTERED | LL_PLAY_LUT13_OUT_REGISTERED | LL_PLAY_LUT14_OUT_REGISTERED | LL_PLAY_LUT15_OUT_REGISTERED)
...
#define LL_PLAY_SWTRIG_ALL                                                                                                                                                                             \
	(LL_PLAY_SWTRIG0 | LL_PLAY_SWTRIG1 | LL_PLAY_SWTRIG2 | LL_PLAY_SWTRIG3 | LL_PLAY_SWTRIG4 | LL_PLAY_SWTRIG5 | LL_PLAY_SWTRIG6 | LL_PLAY_SWTRIG7 | LL_PLAY_SWTRIG8 | LL_PLAY_SWTRIG9 |           \
	 LL_PLAY_SWTRIG10 | LL_PLAY_SWTRIG11 | LL_PLAY_SWTRIG12 | LL_PLAY_SWTRIG13 | LL_PLAY_SWTRIG14 | LL_PLAY_SWTRIG15)
...
#define LL_PLAY_EDGE_DETECTION_MODE_RISING_FALLING (PLAY_FILTxCFG_EDGEDET_0 | PLAY_FILTxCFG_EDGEDET_1) /*!< Both rising and falling edge detection mode */
 ...
 */
__STATIC_INLINE void LL_PLAY_INPUT_Config(PLAY_TypeDef *playx, uint32_t input_mux, uint32_t premuxsel_value, uint32_t edge_detection_mode, uint32_t min_pulse_width)
{
	MODIFY_REG(playx->FILTCFG[input_mux & 0x0FU], (PLAY_FILTxCFG_WIDTH | PLAY_FILTxCFG_EDGEDET | PLAY_FILTxCFG_PREMUXSEL),
		   ((min_pulse_width << PLAY_FILTxCFG_WIDTH_Pos) | edge_detection_mode | (premuxsel_value << PLAY_FILTxCFG_PREMUXSEL_Pos)));
}
 ...
 */
__STATIC_INLINE void LL_PLAY_LUT_ConfigInputs(PLAY_TypeDef *playx, uint32_t lut, uint32_t source_sel0, uint32_t source_sel1, uint32_t source_sel2, uint32_t source_sel3, uint32_t clk_enable)
{
	MODIFY_REG(playx->LECFG2[lut], (PLAY_LExCFG2_IN0_SEL | PLAY_LExCFG2_IN1_SEL | PLAY_LExCFG2_IN2_SEL | PLAY_LExCFG2_IN3_SEL | PLAY_LExCFG2_CK_SEL),
		   ((source_sel0 << PLAY_LExCFG2_IN0_SEL_Pos) | (source_sel1 << PLAY_LExCFG2_IN1_SEL_Pos) | (source_sel2 << PLAY_LExCFG2_IN2_SEL_Pos) | (source_sel3 << PLAY_LExCFG2_IN3_SEL_Pos) |
 ...
 * @param  min_pulse_width Value in range 0x0000 to 0x00FF.
 */
__STATIC_INLINE void LL_PLAY_INPUT_SetMinimumPulseWidth(PLAY_TypeDef *playx, uint32_t input_mux, uint32_t min_pulse_width)
{
 ...
 *         @arg @ref LL_PLAY_EDGE_DETECTION_MODE_RISING_FALLING
 */
__STATIC_INLINE void LL_PLAY_INPUT_SetEdgeDetectionMode(PLAY_TypeDef *playx, uint32_t input_mux, uint32_t edge_detection_mode)
{
...
{
	MODIFY_REG(playx->FILTCFG[input_mux & (LL_PLAY_IN_MAX - 1U)], PLAY_FILTxCFG_PREMUXSEL, ((uint32_t)source) << PLAY_FILTxCFG_PREMUXSEL_Pos);
}
...
{
	return (READ_BIT(playx->FILTCFG[input_mux & (LL_PLAY_IN_MAX - 1U)], PLAY_FILTxCFG_PREMUXSEL) >> PLAY_FILTxCFG_PREMUXSEL_Pos);
}
...
{
	MODIFY_REG(playx->LECFG2[lut], (PLAY_LExCFG2_IN0_SEL << (input_idx * PLAY_LExCFG2_IN1_SEL_Pos)), (source_sel << (input_idx * PLAY_LExCFG2_IN1_SEL_Pos)));
}
...
{
	return (uint32_t)((READ_BIT(playx->LECFG2[lut], (PLAY_LExCFG2_IN0_SEL << (input_idx * PLAY_LExCFG2_IN1_SEL_Pos)))) >> (input_idx * PLAY_LExCFG2_IN1_SEL_Pos));
}
 ...
 */
__STATIC_INLINE void LL_PLAY_LUT_SetEdgeTrigger(PLAY_TypeDef *playx, uint32_t msk_out_falling, uint32_t msk_out_rising)
{
