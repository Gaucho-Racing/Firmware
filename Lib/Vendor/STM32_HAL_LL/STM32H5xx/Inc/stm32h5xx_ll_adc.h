...
#define LL_ADC_CHANNEL_19 (ADC_CHANNEL_19_NUMBER | ADC_CHANNEL_19_SMP | ADC_CHANNEL_19_BITFIELD) /*!< ADC channel ADCx_IN19 */
...
#if defined(ADC3)
#define LL_ADC_REG_TRIG_EXT_PLAY_OUT7                                                                                                                                                                  \
 ...
 * @{
 */
#define LL_ADC_REG_MDF_TRANSFER_NONE                                                                                                                                                                   \
	(0x00000000UL) /*!< ADC conversions data are not transferred to MDF                                                                                                                            \
    peripheral */
#define LL_ADC_REG_MDF_TRANSFER_ENABLE                                                                                                                                                                 \
	(ADC_CFGR_ADFCFG) /*!< ADC conversion data are transferred to MDF                                                                                                                              \
...
#define LL_ADC_INJ_TRIG_EXT_LPTIM2_CH1                                                                                                                                                                 \
	(ADC_JSQR_JEXTSEL_4 | ADC_JSQR_JEXTSEL_1 | ADC_JSQR_JEXTSEL_0 | ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected                                                                         \
						 conversion trigger from external peripheral: LPTIM2 channel 1 event. Trigger                                                                          \
						 edge set to rising edge (default setting). */

/* Triggers specific to some devices of STM32H5 series */
#if defined(ADC3)
#define LL_ADC_INJ_TRIG_EXT_PLAY_OUT9                                                                                                                                                                  \
	(ADC_JSQR_JEXTSEL_4 | ADC_JSQR_JEXTSEL_2 | ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected                                                                                              \
...
#define LL_ADC_INJ_TRIG_EXT_TIM15_TRGO                                                                                                                                                                 \
	(ADC_JSQR_JEXTSEL_3 | ADC_JSQR_JEXTSEL_2 | ADC_JSQR_JEXTSEL_1 | ADC_JSQR_JEXTSEL_0 | ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected                                                    \
...
#define LL_ADC_AWD_CHANNEL_19_REG                                                                                                                                                                      \
	((LL_ADC_CHANNEL_19 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring                                                                           \
					       of ADC channel ADCx_IN19, converted by group regular only */
#define LL_ADC_AWD_CHANNEL_19_INJ                                                                                                                                                                      \
	((LL_ADC_CHANNEL_19 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring                                                                          \
						of ADC channel ADCx_IN19, converted by group injected only */
#define LL_ADC_AWD_CHANNEL_19_REG_INJ                                                                                                                                                                  \
	((LL_ADC_CHANNEL_19 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring                                                        \
...
#define LL_ADC_AWD_CH_TEMPSENSOR_INJ                                                                                                                                                                   \
	((LL_ADC_CHANNEL_TEMPSENSOR & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring                                                                  \
							of ADC internal channel connected to internal temperature sensor,                                                                              \
							converted by group injected only.                                                                                                              \
							On STM32H563xx/573xx, ADC channel available only on ADC instance: ADC1. */
...
#define LL_ADC_AWD_CH_VDDCORE_REG                                                                                                                                                                      \
	((LL_ADC_CHANNEL_VDDCORE & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring                                                                      \
						    of ADC internal channel connected to Vddcore, converted by group regular only                                                                      \
						    On STM32H563xx/573xx, ADC channel available only on ADC instance: ADC2. */
#define LL_ADC_AWD_CH_VDDCORE_INJ                                                                                                                                                                      \
	((LL_ADC_CHANNEL_VDDCORE & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring                                                                     \
						     of ADC internal channel connected to Vddcore,                                                                                                     \
						     converted by group injected only.                                                                                                                 \
						     On STM32H563xx/573xx, ADC channel available only on ADC instance: ADC2. */
#define LL_ADC_AWD_CH_VDDCORE_REG_INJ                                                                                                                                                                  \
	((LL_ADC_CHANNEL_VDDCORE & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring                                                   \
								       of ADC internal channel connected to Vddcore,                                                                                   \
								       converted by either group regular or injected.                                                                                  \
								       On STM32H563xx/573xx, ADC channel available only on ADC instance: ADC2. */
#if defined(ADC3)
#define LL_ADC_AWD_CH_VBAT_ADC3_REG                                                                                                                                                                    \
	((LL_ADC_CHANNEL_VBAT_ADC3 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring                                                                    \
						      of ADC internal channel connected to Vbat/4: Vbat voltage through                                                                                \
						      a divider ladder of factor 1/4 to have channel voltage always below Vdda,                                                                        \
						      converted by group regular only.                                                                                                                 \
						      On STM32H563xx/573xx, ADC channel available only on ADC instance: ADC3. */
#define LL_ADC_AWD_CH_VBAT_ADC3_INJ                                                                                                                                                                    \
	((LL_ADC_CHANNEL_VBAT_ADC3 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring                                                                   \
						       of ADC internal channel connected to Vbat/4: Vbat voltage through                                                                               \
						       a divider ladder of factor 1/4 to have channel voltage always below Vdda,                                                                       \
						       converted by group injected only.                                                                                                               \
						       On STM32H563xx/573xx, ADC channel available only on ADC instance: ADC3. */
#define LL_ADC_AWD_CH_VBAT_ADC3_REG_INJ                                                                                                                                                                \
	((LL_ADC_CHANNEL_VBAT_ADC3 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring                                                 \
									 of ADC internal channel connected to Vbat/4: Vbat voltage through                                                             \
									 a divider ladder of factor 1/4 to have channel voltage always below Vdda.                                                     \
									 On STM32H563xx/573xx, ADC channel available only on ADC instance: ADC3. */
#define LL_ADC_AWD_CH_VDDCORE_ADC3_REG                                                                                                                                                                 \
	((LL_ADC_CHANNEL_VDDCORE_ADC3 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring                                                                 \
							 of ADC internal channel connected to Vddcore, converted by group regular only                                                                 \
							 On STM32H563xx/573xx, ADC channel available only on ADC instance: ADC3. */
#define LL_ADC_AWD_CH_VDDCORE_ADC3_INJ                                                                                                                                                                 \
	((LL_ADC_CHANNEL_VDDCORE_ADC3 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring                                                                \
							  of ADC internal channel connected to Vddcore,                                                                                                \
							  converted by group injected only.                                                                                                            \
							  On STM32H563xx/573xx, ADC channel available only on ADC instance: ADC3. */
#define LL_ADC_AWD_CH_VDDCORE_ADC3_REG_INJ                                                                                                                                                             \
	((LL_ADC_CHANNEL_VDDCORE_ADC3 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring                                              \
									    of ADC internal channel connected to Vddcore,                                                                              \
									    converted by either group regular or injected.                                                                             \
									    On STM32H563xx/573xx, ADC channel available only on ADC instance: ADC3. */
...
#define __LL_ADC_IS_CHANNEL_INTERNAL_AVAILABLE(__ADC_INSTANCE__, __CHANNEL__)                                                                                                                          \
	((((__ADC_INSTANCE__) == ADC1) && (((__CHANNEL__) == LL_ADC_CHANNEL_TEMPSENSOR) || ((__CHANNEL__) == LL_ADC_CHANNEL_VREFINT))) ||                                                              \
	 (((__ADC_INSTANCE__) == ADC2) && (((__CHANNEL__) == LL_ADC_CHANNEL_VBAT) || ((__CHANNEL__) == LL_ADC_CHANNEL_VDDCORE))))
#else
#define __LL_ADC_IS_CHANNEL_INTERNAL_AVAILABLE(__ADC_INSTANCE__, __CHANNEL__)                                                                                                                          \
	(((__CHANNEL__) == LL_ADC_CHANNEL_VREFINT) || ((__CHANNEL__) == LL_ADC_CHANNEL_TEMPSENSOR) || ((__CHANNEL__) == LL_ADC_CHANNEL_VDDCORE) || ((__CHANNEL__) == LL_ADC_CHANNEL_VBAT))
#endif /* ADC2 */
...
#define __LL_ADC_COMMON_INSTANCE(__ADCx__) ((((__ADCx__) == ADC1) || ((__ADCx__) == ADC2)) ? (ADC12_COMMON) : (ADC3_COMMON))
#else
