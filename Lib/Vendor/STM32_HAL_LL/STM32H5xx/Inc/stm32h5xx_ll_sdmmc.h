...
#define SDMMC_SDIO_R5_ERRORBITS (SDMMC_SDIO_R5_COM_CRC_FAILED | SDMMC_SDIO_R5_ILLEGAL_CMD | SDMMC_SDIO_R5_GENERAL_UNKNOWN_ERROR | SDMMC_SDIO_R5_INVALID_FUNCTION_NUMBER | SDMMC_SDIO_R5_OUT_OF_RANGE)
/**
...
#define SDMMC_CMD_SDMMC_SEN_OP_COND                                                                                                                                                                    \
	5U		       /*!< Sends host capacity support information (HCS) and asks the accessed card to send its operating condition register (OCR) content in the response on the CMD line.*/
...
#define SDMMC_CMD_HS_SEND_EXT_CSD                                                                                                                                                                      \
	8U		       /*!< Sends SD Memory Card interface condition, which includes host supply voltage information  and asks the card whether card supports voltage.                      */
...
#define SDMMC_CMD_SET_BLOCKLEN                                                                                                                                                                         \
	16U /*!< Sets the block length (in bytes for SDSC) for all following block commands (read, write, lock). Default block length is fixed to 512 Bytes. Not effective        */
/*!< for SDHS and SDXC.                                                                       */
#define SDMMC_CMD_READ_SINGLE_BLOCK                                                                                                                                                                    \
	17U /*!< Reads single block of size selected by SET_BLOCKLEN in case of SDSC, and a block of fixed 512 bytes in case of SDHC and SDXC.                                    */
#define SDMMC_CMD_READ_MULT_BLOCK                                                                                                                                                                      \
	18U /*!< Continuously transfers data blocks from card to host until interrupted by  STOP_TRANSMISSION command.                                                            */
...
#define SDMMC_CMD_WRITE_SINGLE_BLOCK                                                                                                                                                                   \
	24U /*!< Writes single block of size selected by SET_BLOCKLEN in case of SDSC, and a block of fixed 512 bytes in case of SDHC and SDXC.                                   */
...
#define SDMMC_CMD_ERASE_GRP_START                                                                                                                                                                      \
	35U /*!< Sets the address of the first write block to be erased. Reserved for each command system set by switch function command (CMD6).                                  */
#define SDMMC_CMD_ERASE_GRP_END                                                                                                                                                                        \
	36U		      /*!< Sets the address of the last write block of the continuous range to be erased. Reserved for each command system set by switch function command (CMD6).           */
...
#define SDMMC_CMD_LOCK_UNLOCK                                                                                                                                                                          \
	42U		      /*!< Sets/resets the password or lock/unlock the card. The size of the data block is set by the SET_BLOCK_LEN command.                                                */
...
#define SDMMC_CMD_APP_SD_SET_BUSWIDTH                                                                                                                                                                  \
	6U /*!< (ACMD6) Defines the data bus width to be used for data transfer. The allowed data bus widths are given in SCR register.                                                   */
#define SDMMC_CMD_SD_APP_STATUS 13U /*!< (ACMD13) Sends the SD status.                                                            */
#define SDMMC_CMD_SD_APP_SEND_NUM_WRITE_BLOCKS                                                                                                                                                         \
	22U /*!< (ACMD22) Sends the number of the written (without errors) write blocks. Responds with 32bit+CRC data block.                                                               */
#define SDMMC_CMD_SD_APP_OP_COND                                                                                                                                                                       \
	41U /*!< (ACMD41) Sends host capacity support information (HCS) and asks the accessed card to send its operating condition register (OCR) content in the response on the CMD line. */
...
#define IS_SDMMC_SPEED_MODE(MODE)                                                                                                                                                                      \
	(((MODE) == SDMMC_SPEED_MODE_AUTO) || ((MODE) == SDMMC_SPEED_MODE_DEFAULT) || ((MODE) == SDMMC_SPEED_MODE_HIGH) || ((MODE) == SDMMC_SPEED_MODE_ULTRA) ||                                       \
...
#define IS_SDMMC_TRANSFER_MODE(MODE) (((MODE) == SDMMC_TRANSFER_MODE_BLOCK) || ((MODE) == SDMMC_TRANSFER_MODE_SDIO) || ((MODE) == SDMMC_TRANSFER_MODE_STREAM))
/**
 * @}
 */
