...
#define IS_OPAMP_NONINVERTING_INPUT(INPUT) (((INPUT) == OPAMP_NONINVERTINGINPUT_IO0) || ((INPUT) == OPAMP_NONINVERTINGINPUT_IO1) || ((INPUT) == OPAMP_NONINVERTINGINPUT_DAC_CH))
...
#define IS_OPAMP_POWERMODE(TRIMMING) (((TRIMMING) == OPAMP_POWERMODE_NORMAL) || ((TRIMMING) == OPAMP_POWERMODE_HIGHSPEED))
