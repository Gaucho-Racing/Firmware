...
#define LPTIM_ICFLT_CLOCK_DIV8                                                                                                                                                                         \
	(LPTIM_CCMR1_IC1F_0 | LPTIM_CCMR1_IC1F_1) /*!< external input capture signal level change must be stable for at least 8 clock periods before it is considered as valid transition */
/**
 * @}
 */
...
#define __HAL_LPTIM_COMPARE_SET(__HANDLE__, __CHANNEL__, __VALUE__)                                                                                                                                    \
	(((__CHANNEL__) == LPTIM_CHANNEL_1) ? ((__HANDLE__)->Instance->CCR1 = (__VALUE__)) : ((__CHANNEL__) == LPTIM_CHANNEL_2) ? ((__HANDLE__)->Instance->CCR2 = (__VALUE__)) : 0U)
...
#define __HAL_LPTIM_GET_IT_SOURCE(__HANDLE__, __INTERRUPT__) ((((__HANDLE__)->Instance->DIER & (__INTERRUPT__)) == (__INTERRUPT__)) ? SET : RESET)
 ...
 */
/* Config functions  **********************************************************/
HAL_StatusTypeDef HAL_LPTIM_OC_ConfigChannel(LPTIM_HandleTypeDef *hlptim, const LPTIM_OC_ConfigTypeDef *sConfig, uint32_t Channel);
...
HAL_StatusTypeDef HAL_LPTIM_PWM_Start_DMA(LPTIM_HandleTypeDef *hlptim, uint32_t Channel, const uint32_t *pData, uint32_t Length);
...
/* ############################## Input Capture Mode ###############################*/
/* Blocking mode: Polling */
HAL_StatusTypeDef HAL_LPTIM_IC_ConfigChannel(LPTIM_HandleTypeDef *hlptim, const LPTIM_IC_ConfigTypeDef *sConfig, uint32_t Channel);
...
HAL_StatusTypeDef HAL_LPTIM_IC_Start_DMA(LPTIM_HandleTypeDef *hlptim, uint32_t Channel, uint32_t *pData, uint32_t Length);
...
#define IS_LPTIM_OC_POLARITY(__OCPOLARITY__) (((__OCPOLARITY__) == LPTIM_OCPOLARITY_LOW) || ((__OCPOLARITY__) == LPTIM_OCPOLARITY_HIGH))
#define IS_LPTIM_IC_PRESCALER(__PRESCALER__)                                                                                                                                                           \
	(((__PRESCALER__) == LPTIM_ICPSC_DIV1) || ((__PRESCALER__) == LPTIM_ICPSC_DIV2) || ((__PRESCALER__) == LPTIM_ICPSC_DIV4) || ((__PRESCALER__) == LPTIM_ICPSC_DIV8))

#define IS_LPTIM_IC_POLARITY(__POLARITY__) (((__POLARITY__) == LPTIM_ICPOLARITY_RISING) || ((__POLARITY__) == LPTIM_ICPOLARITY_FALLING) || ((__POLARITY__) == LPTIM_ICPOLARITY_RISING_FALLING))

#define IS_LPTIM_IC_FILTER(__FILTER__)                                                                                                                                                                 \
	(((__FILTER__) == LPTIM_ICFLT_CLOCK_DIV1) || ((__FILTER__) == LPTIM_ICFLT_CLOCK_DIV2) || ((__FILTER__) == LPTIM_ICFLT_CLOCK_DIV4) || ((__FILTER__) == LPTIM_ICFLT_CLOCK_DIV8))

#define IS_LPTIM_REPETITION(__REPETITION__) ((__REPETITION__) <= 0x000000FFUL)

#if defined(STM32H503xx)
#define IS_LPTIM_INPUT1_SOURCE(__INSTANCE__, __SOURCE__)                                                                                                                                               \
	((((__INSTANCE__) == LPTIM1) && (((__SOURCE__) == LPTIM_INPUT1SOURCE_GPIO) || ((__SOURCE__) == LPTIM_INPUT1SOURCE_COMP1) || ((__SOURCE__) == LPTIM_INPUT1SOURCE_LPTIM2_CH1))) ||               \
	 (((__INSTANCE__) == LPTIM2) && (((__SOURCE__) == LPTIM_INPUT1SOURCE_GPIO) || ((__SOURCE__) == LPTIM_INPUT1SOURCE_COMP1) || ((__SOURCE__) == LPTIM_INPUT1SOURCE_LPTIM1_CH2))))
#elif defined(STM32H5E5xx) || defined(STM32H5E4xx) || defined(STM32H5F5xx) || defined(STM32H5F4xx)
#define IS_LPTIM_INPUT1_SOURCE(__INSTANCE__, __SOURCE__)                                                                                                                                               \
	((((__INSTANCE__) == LPTIM1) || ((__INSTANCE__) == LPTIM2) || ((__INSTANCE__) == LPTIM3) || ((__INSTANCE__) == LPTIM4) || ((__INSTANCE__) == LPTIM5) || ((__INSTANCE__) == LPTIM6)) &&         \
	 (((__SOURCE__) == LPTIM_INPUT1SOURCE_GPIO) || ((__SOURCE__) == LPTIM_INPUT1SOURCE_COMP1) || ((__SOURCE__) == LPTIM_INPUT1SOURCE_PLAY1_OUT3)))
#elif defined(LPTIM3) && defined(LPTIM4) && defined(LPTIM5) && defined(LPTIM6)
#define IS_LPTIM_INPUT1_SOURCE(__INSTANCE__, __SOURCE__)                                                                                                                                               \
	((((__INSTANCE__) == LPTIM1) || ((__INSTANCE__) == LPTIM2) || ((__INSTANCE__) == LPTIM3) || ((__INSTANCE__) == LPTIM4) || ((__INSTANCE__) == LPTIM5) || ((__INSTANCE__) == LPTIM6)) &&         \
	 (((__SOURCE__) == LPTIM_INPUT1SOURCE_GPIO)))
#else
#define IS_LPTIM_INPUT1_SOURCE(__INSTANCE__, __SOURCE__) ((((__INSTANCE__) == LPTIM1) || ((__INSTANCE__) == LPTIM2)) && (((__SOURCE__) == LPTIM_INPUT1SOURCE_GPIO)))
#endif /* STM32H503xx */

#if defined(STM32H503xx)
#define IS_LPTIM_INPUT2_SOURCE(__INSTANCE__, __SOURCE__) ((((__INSTANCE__) == LPTIM1) || ((__INSTANCE__) == LPTIM2)) && (((__SOURCE__) == LPTIM_INPUT2SOURCE_GPIO)))
#elif defined(STM32H5E5xx) || defined(STM32H5E4xx) || defined(STM32H5F5xx) || defined(STM32H5F4xx)
#define IS_LPTIM_INPUT2_SOURCE(__INSTANCE__, __SOURCE__)                                                                                                                                               \
	(((((__INSTANCE__) == LPTIM1) || ((__INSTANCE__) == LPTIM2) || ((__INSTANCE__) == LPTIM3) || ((__INSTANCE__) == LPTIM5) || ((__INSTANCE__) == LPTIM6)) &&                                      \
	  (((__SOURCE__) == LPTIM_INPUT2SOURCE_GPIO) || ((__SOURCE__) == LPTIM_INPUT2SOURCE_COMP2) || ((__SOURCE__) == LPTIM_INPUT2SOURCE_PLAY1_OUT4))) ||                                             \
	 (((__INSTANCE__) == LPTIM4) && ((__SOURCE__) == LPTIM_INPUT2SOURCE_GPIO)))
...
#define IS_LPTIM_IC1_SOURCE(__INSTANCE__, __SOURCE__)                                                                                                                                                  \
	((((__INSTANCE__) == LPTIM1) &&                                                                                                                                                                \
	  (((__SOURCE__) == LPTIM_IC1SOURCE_GPIO) || ((__SOURCE__) == LPTIM_IC1SOURCE_COMP1) || ((__SOURCE__) == LPTIM_IC1SOURCE_EVENTOUT) || ((__SOURCE__) == LPTIM_IC1SOURCE_MCO1))) ||              \
	 (((__INSTANCE__) == LPTIM2) &&                                                                                                                                                                \
	  (((__SOURCE__) == LPTIM_IC1SOURCE_GPIO) || ((__SOURCE__) == LPTIM_IC1SOURCE_COMP1) || ((__SOURCE__) == LPTIM_IC1SOURCE_EVENTOUT) || ((__SOURCE__) == LPTIM_IC1SOURCE_MCO2))))

#define IS_LPTIM_IC2_SOURCE(__INSTANCE__, __SOURCE__)                                                                                                                                                  \
	((((__INSTANCE__) == LPTIM1) &&                                                                                                                                                                \
	  (((__SOURCE__) == LPTIM_IC2SOURCE_GPIO) || ((__SOURCE__) == LPTIM_IC2SOURCE_LSI) || ((__SOURCE__) == LPTIM_IC2SOURCE_LSE) || ((__SOURCE__) == LPTIM_IC2SOURCE_HSE_1M))) ||                   \
	 (((__INSTANCE__) == LPTIM2) &&                                                                                                                                                                \
	  (((__SOURCE__) == LPTIM_IC2SOURCE_GPIO) || ((__SOURCE__) == LPTIM_IC2SOURCE_HSI_1024) || ((__SOURCE__) == LPTIM_IC2SOURCE_CSI_128) || ((__SOURCE__) == LPTIM_IC2SOURCE_HSI_8))))
#elif defined(STM32H5E5xx) || defined(STM32H5E4xx) || defined(STM32H5F5xx) || defined(STM32H5F4xx)
#define IS_LPTIM_IC1_SOURCE(__INSTANCE__, __SOURCE__)                                                                                                                                                  \
	(((((__INSTANCE__) == LPTIM1) || ((__INSTANCE__) == LPTIM2)) &&                                                                                                                                \
	  (((__SOURCE__) == LPTIM_IC1SOURCE_GPIO) || ((__SOURCE__) == LPTIM_IC1SOURCE_COMP1) || ((__SOURCE__) == LPTIM_IC1SOURCE_COMP2) || ((__SOURCE__) == LPTIM_IC1SOURCE_PLAY1_OUT5))) ||           \
	 (((__INSTANCE__) == LPTIM3) && (((__SOURCE__) == LPTIM_IC1SOURCE_GPIO) || ((__SOURCE__) == LPTIM_IC1SOURCE_COMP1) || ((__SOURCE__) == LPTIM_IC1SOURCE_COMP2))) ||                             \
	 (((__INSTANCE__) == LPTIM5) &&                                                                                                                                                                \
	  (((__SOURCE__) == LPTIM_IC1SOURCE_GPIO) || ((__SOURCE__) == LPTIM_IC1SOURCE_COMP1) || ((__SOURCE__) == LPTIM_IC1SOURCE_COMP2) || ((__SOURCE__) == LPTIM_IC1SOURCE_I3C1_IBIACK))) ||          \
	 (((__INSTANCE__) == LPTIM6) &&                                                                                                                                                                \
	  (((__SOURCE__) == LPTIM_IC1SOURCE_GPIO) || ((__SOURCE__) == LPTIM_IC1SOURCE_COMP1) || ((__SOURCE__) == LPTIM_IC1SOURCE_COMP2) || ((__SOURCE__) == LPTIM_IC1SOURCE_I3C2_IBIACK))))
...
#define IS_LPTIM_IC2_SOURCE(__INSTANCE__, __SOURCE__)                                                                                                                                                  \
	((((__INSTANCE__) == LPTIM1) &&                                                                                                                                                                \
	 ...
	 (((__INSTANCE__) == LPTIM2) &&                                                                                                                                                                \
	  (((__SOURCE__) == LPTIM_IC2SOURCE_GPIO) || ((__SOURCE__) == LPTIM_IC2SOURCE_HSI_1024) || ((__SOURCE__) == LPTIM_IC2SOURCE_CSI_128) || ((__SOURCE__) == LPTIM_IC2SOURCE_HSI_8))) ||           \
	 (((__INSTANCE__) == LPTIM3) && (((__SOURCE__) == LPTIM_IC2SOURCE_GPIO) || ((__SOURCE__) == LPTIM_IC2SOURCE_COMP1) || ((__SOURCE__) == LPTIM_IC2SOURCE_COMP2))) ||                             \
	 (((__INSTANCE__) == LPTIM4) && ((__SOURCE__) == LPTIM_IC2SOURCE_GPIO)) ||                                                                                                                     \
	 ((((__INSTANCE__) == LPTIM5) || ((__INSTANCE__) == LPTIM6)) &&                                                                                                                                \
	  (((__SOURCE__) == LPTIM_IC2SOURCE_GPIO) || ((__SOURCE__) == LPTIM_IC2SOURCE_COMP1) || ((__SOURCE__) == LPTIM_IC2SOURCE_EVENTOUT))))
#elif defined(LPTIM3) && defined(LPTIM5) && defined(LPTIM6)
#define IS_LPTIM_IC1_SOURCE(__INSTANCE__, __SOURCE__)                                                                                                                                                  \
	((((__INSTANCE__) == LPTIM1) || ((__INSTANCE__) == LPTIM2) || ((__INSTANCE__) == LPTIM3) || ((__INSTANCE__) == LPTIM5) || ((__INSTANCE__) == LPTIM6)) &&                                       \
...
#define IS_LPTIM_IC2_SOURCE(__INSTANCE__, __SOURCE__)                                                                                                                                                  \
	((((__INSTANCE__) == LPTIM1) && (((__SOURCE__) == LPTIM_IC2SOURCE_GPIO) || ((__SOURCE__) == LPTIM_IC2SOURCE_LSI) || ((__SOURCE__) == LPTIM_IC2SOURCE_LSE))) ||                                 \
	 (((__INSTANCE__) == LPTIM2) &&                                                                                                                                                                \
	  (((__SOURCE__) == LPTIM_IC2SOURCE_GPIO) || ((__SOURCE__) == LPTIM_IC2SOURCE_HSI_1024) || ((__SOURCE__) == LPTIM_IC2SOURCE_CSI_128) || ((__SOURCE__) == LPTIM_IC2SOURCE_HSI_8))) ||           \
	 (((__INSTANCE__) == LPTIM3) && ((__SOURCE__) == LPTIM_IC2SOURCE_GPIO)) || (((__INSTANCE__) == LPTIM5) && ((__SOURCE__) == LPTIM_IC2SOURCE_GPIO)) ||                                           \
	 (((__INSTANCE__) == LPTIM6) && ((__SOURCE__) == LPTIM_IC2SOURCE_GPIO)))
#else
#define IS_LPTIM_IC1_SOURCE(__INSTANCE__, __SOURCE__) ((((__INSTANCE__) == LPTIM1) || ((__INSTANCE__) == LPTIM2)) && (((__SOURCE__) == LPTIM_IC1SOURCE_GPIO)))
...
#define LPTIM_CHANNEL_STATE_GET(__INSTANCE__, __CHANNEL__) (((__CHANNEL__) == LPTIM_CHANNEL_1) ? (__INSTANCE__)->ChannelState[0] : (__INSTANCE__)->ChannelState[1])

#define LPTIM_CHANNEL_STATE_SET(__INSTANCE__, __CHANNEL__, __CHANNEL_STATE__)                                                                                                                          \
	(((__CHANNEL__) == LPTIM_CHANNEL_1) ? ((__INSTANCE__)->ChannelState[0] = (__CHANNEL_STATE__)) : ((__INSTANCE__)->ChannelState[1] = (__CHANNEL_STATE__)))
...
#elif defined(LPTIM3) && defined(LPTIM4) && defined(LPTIM5) && defined(LPTIM6)
#define IS_LPTIM_CCX_INSTANCE(__INSTANCE__, __CHANNEL__)                                                                                                                                               \
	(((((__INSTANCE__) == LPTIM1_NS) || ((__INSTANCE__) == LPTIM1_S)) && (((__CHANNEL__) == LPTIM_CHANNEL_1) || ((__CHANNEL__) == LPTIM_CHANNEL_2))) ||                                            \
	 ((((__INSTANCE__) == LPTIM2_NS) || ((__INSTANCE__) == LPTIM2_S)) && (((__CHANNEL__) == LPTIM_CHANNEL_1) || ((__CHANNEL__) == LPTIM_CHANNEL_2))) ||                                            \
	 ((((__INSTANCE__) == LPTIM3_NS) || ((__INSTANCE__) == LPTIM3_S)) && (((__CHANNEL__) == LPTIM_CHANNEL_1) || ((__CHANNEL__) == LPTIM_CHANNEL_2))) ||                                            \
	 ((((__INSTANCE__) == LPTIM4_NS) || ((__INSTANCE__) == LPTIM4_S)) && ((__CHANNEL__) == LPTIM_CHANNEL_1)) ||                                                                                    \
	 ((((__INSTANCE__) == LPTIM5_NS) || ((__INSTANCE__) == LPTIM5_S)) && (((__CHANNEL__) == LPTIM_CHANNEL_1) || ((__CHANNEL__) == LPTIM_CHANNEL_2))) ||                                            \
	 ((((__INSTANCE__) == LPTIM6_NS) || ((__INSTANCE__) == LPTIM6_S)) && (((__CHANNEL__) == LPTIM_CHANNEL_1) || ((__CHANNEL__) == LPTIM_CHANNEL_2))))
#else
#define IS_LPTIM_CCX_INSTANCE(__INSTANCE__, __CHANNEL__)                                                                                                                                               \
	(((((__INSTANCE__) == LPTIM1_NS) || ((__INSTANCE__) == LPTIM1_S)) && (((__CHANNEL__) == LPTIM_CHANNEL_1) || ((__CHANNEL__) == LPTIM_CHANNEL_2))) ||                                            \
	 ((((__INSTANCE__) == LPTIM2_NS) || ((__INSTANCE__) == LPTIM2_S)) && (((__CHANNEL__) == LPTIM_CHANNEL_1) || ((__CHANNEL__) == LPTIM_CHANNEL_2))))
