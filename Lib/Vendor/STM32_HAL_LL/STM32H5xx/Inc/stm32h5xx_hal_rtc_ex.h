...
#define RTC_INT_TAMPER_ALL                                                                                                                                                                             \
	(RTC_INT_TAMPER_1 | RTC_INT_TAMPER_2 | RTC_INT_TAMPER_3 | RTC_INT_TAMPER_4 | RTC_INT_TAMPER_5 | RTC_INT_TAMPER_6 | RTC_INT_TAMPER_7 | RTC_INT_TAMPER_8 | RTC_INT_TAMPER_9 |                    \
	 RTC_INT_TAMPER_11 | RTC_INT_TAMPER_12 | RTC_INT_TAMPER_13 | RTC_INT_TAMPER_15)
/**
 * @}
 */
...
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV256 (TAMP_FLTCR_TAMPFREQ_0 | TAMP_FLTCR_TAMPFREQ_1 | TAMP_FLTCR_TAMPFREQ_2) /*!< Each of the tamper inputs are sampled with a frequency =  RTCCLK / 256   */
/**
 * @}
 */
...
#define RTC_IT_INT_TAMP_ALL                                                                                                                                                                            \
	(RTC_IT_INT_TAMP_1 | RTC_IT_INT_TAMP_2 | RTC_IT_INT_TAMP_3 | RTC_IT_INT_TAMP_4 | RTC_IT_INT_TAMP_5 | RTC_IT_INT_TAMP_6 | RTC_IT_INT_TAMP_7 | RTC_IT_INT_TAMP_8 | RTC_IT_INT_TAMP_9 |           \
	 RTC_IT_INT_TAMP_11 | RTC_IT_INT_TAMP_12 | RTC_IT_INT_TAMP_13 | RTC_IT_INT_TAMP_15)
/**
 * @}
 */
...
#define RTC_FLAG_INT_TAMP_ALL                                                                                                                                                                          \
	(RTC_FLAG_INT_TAMP_1 | RTC_FLAG_INT_TAMP_2 | RTC_FLAG_INT_TAMP_3 | RTC_FLAG_INT_TAMP_4 | RTC_FLAG_INT_TAMP_5 | RTC_FLAG_INT_TAMP_6 | RTC_FLAG_INT_TAMP_7 | RTC_FLAG_INT_TAMP_8 |               \
	 RTC_FLAG_INT_TAMP_9 | RTC_FLAG_INT_TAMP_11 | RTC_FLAG_INT_TAMP_12 | RTC_FLAG_INT_TAMP_13 | RTC_FLAG_INT_TAMP_15)
/**
 * @}
 */
...
#define RTC_NONSECURE_FEATURE_ALL (RTC_SECCFGR_INITSEC | RTC_SECCFGR_CALSEC | RTC_SECCFGR_TSSEC | RTC_SECCFGR_WUTSEC | RTC_SECCFGR_ALRASEC | RTC_SECCFGR_ALRBSEC)
/**
 * @}
 */
...
HAL_StatusTypeDef HAL_RTCEx_GetTimeStamp(const RTC_HandleTypeDef *hrtc, RTC_TimeTypeDef *sTimeStamp, RTC_DateTypeDef *sTimeStampDate, uint32_t Format);
...
HAL_StatusTypeDef HAL_RTCEx_SetInternalTamper(const RTC_HandleTypeDef *hrtc, const RTC_InternalTamperTypeDef *sIntTamper);
HAL_StatusTypeDef HAL_RTCEx_SetInternalTamper_IT(const RTC_HandleTypeDef *hrtc, const RTC_InternalTamperTypeDef *sIntTamper);
HAL_StatusTypeDef HAL_RTCEx_DeactivateInternalTamper(const RTC_HandleTypeDef *hrtc, uint32_t IntTamper);
HAL_StatusTypeDef HAL_RTCEx_PollForInternalTamperEvent(const RTC_HandleTypeDef *hrtc, uint32_t IntTamper, uint32_t Timeout);
 ...
 * @{
 */
HAL_StatusTypeDef HAL_RTCEx_PrivilegeModeSet(const RTC_HandleTypeDef *hrtc, const RTC_PrivilegeStateTypeDef *privilegeState);
...
#define IS_RTC_ATAMPER_FILTER(__FILTER__) (((__FILTER__) == RTC_ATAMP_FILTER_ENABLE) || ((__FILTER__) == RTC_ATAMP_FILTER_DISABLE))

#define IS_RTC_ATAMPER_OUTPUT_CHANGE_PERIOD(__PERIOD__) ((__PERIOD__) <= 7U)

#define IS_RTC_ATAMPER_ASYNCPRES_RTCCLK(__PRESCALER__)                                                                                                                                                 \
	(((__PRESCALER__) == RTC_ATAMP_ASYNCPRES_RTCCLK) || ((__PRESCALER__) == RTC_ATAMP_ASYNCPRES_RTCCLK_2) || ((__PRESCALER__) == RTC_ATAMP_ASYNCPRES_RTCCLK_4) ||                                  \
	 ((__PRESCALER__) == RTC_ATAMP_ASYNCPRES_RTCCLK_8) || ((__PRESCALER__) == RTC_ATAMP_ASYNCPRES_RTCCLK_16) || ((__PRESCALER__) == RTC_ATAMP_ASYNCPRES_RTCCLK_32) ||                              \
	 ((__PRESCALER__) == RTC_ATAMP_ASYNCPRES_RTCCLK_64) || ((__PRESCALER__) == RTC_ATAMP_ASYNCPRES_RTCCLK_128) || ((__PRESCALER__) == RTC_ATAMP_ASYNCPRES_RTCCLK_2048))
