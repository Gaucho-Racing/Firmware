...
{
	MODIFY_REG(PWR->WUCR, (PWR_WUCR_WUPPUPD1 << ((LL_PWR_WAKEUP_PINS_PULL_SHIFT_OFFSET * (POSITION_VAL(WakeUpPin) & 0xFU)) & LL_PWR_WAKEUP_PINS_MAX_SHIFT_MASK)),
		   (LL_PWR_WAKEUP_PIN_NOPULL << ((PWR_WUCR_WUPPUPD1_Pos + ((LL_PWR_WAKEUP_PINS_PULL_SHIFT_OFFSET * POSITION_VAL(WakeUpPin)) & 0xFU)) & LL_PWR_WAKEUP_PINS_MAX_SHIFT_MASK)));
}
...
{
	MODIFY_REG(PWR->WUCR, (PWR_WUCR_WUPPUPD1 << ((LL_PWR_WAKEUP_PINS_PULL_SHIFT_OFFSET * (POSITION_VAL(WakeUpPin) & 0xFU)) & LL_PWR_WAKEUP_PINS_MAX_SHIFT_MASK)),
		   (LL_PWR_WAKEUP_PIN_PULLUP << ((PWR_WUCR_WUPPUPD1_Pos + ((LL_PWR_WAKEUP_PINS_PULL_SHIFT_OFFSET * POSITION_VAL(WakeUpPin)) & 0xFU)) & LL_PWR_WAKEUP_PINS_MAX_SHIFT_MASK)));
}
...
{
	MODIFY_REG(PWR->WUCR, (PWR_WUCR_WUPPUPD1 << ((LL_PWR_WAKEUP_PINS_PULL_SHIFT_OFFSET * (POSITION_VAL(WakeUpPin) & 0xFU)) & LL_PWR_WAKEUP_PINS_MAX_SHIFT_MASK)),
		   (LL_PWR_WAKEUP_PIN_PULLDOWN << ((PWR_WUCR_WUPPUPD1_Pos + ((LL_PWR_WAKEUP_PINS_PULL_SHIFT_OFFSET * POSITION_VAL(WakeUpPin)) & 0xFU)) & LL_PWR_WAKEUP_PINS_MAX_SHIFT_MASK)));
}
...
{
	uint32_t regValue = READ_BIT(PWR->WUCR, (PWR_WUCR_WUPPUPD1 << ((LL_PWR_WAKEUP_PINS_PULL_SHIFT_OFFSET * (POSITION_VAL(WakeUpPin) & 0xFU)) & LL_PWR_WAKEUP_PINS_MAX_SHIFT_MASK)));

	return (uint32_t)(regValue >> ((PWR_WUCR_WUPPUPD1_Pos + ((LL_PWR_WAKEUP_PINS_PULL_SHIFT_OFFSET * POSITION_VAL(WakeUpPin)) & 0xFU)) & LL_PWR_WAKEUP_PINS_MAX_SHIFT_MASK));
}
