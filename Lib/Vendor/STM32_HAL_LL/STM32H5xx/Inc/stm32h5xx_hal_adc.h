...
#define ADC_EXTERNALTRIG_PLAY_OUT7                                                                                                                                                                     \
	(LL_ADC_REG_TRIG_EXT_PLAY_OUT7) /*!< ADC group regular conversion                                                                                                                              \
...
#define ADC_CHANNEL_VDDCORE                                                                                                                                                                            \
 ...
 specific to ADC2. */
#if defined(ADC3)
#define ADC_CHANNEL_VBAT_ADC3                                                                                                                                                                          \
	(LL_ADC_CHANNEL_VBAT_ADC3) /*!< Internal channel Vbat/4: Vbat voltage                                                                                                                          \
   through a divider ladder of factor 1/4 to have channel voltage always below                                                                                                                         \
   Vdda, channel specific to ADC3. */
#define ADC_CHANNEL_VDDCORE_ADC3                                                                                                                                                                       \
	(LL_ADC_CHANNEL_VDDCORE_ADC3) /*!< Internal channel Vddcore, channel                                                                                                                           \
      specific to ADC3. */
#define ADC_CHANNEL_DAC1_CH1                                                                                                                                                                           \
	(LL_ADC_CHANNEL_DAC1_CH1) /*!< Internal channel DAC1 channel 1,                                                                                                                                \
  channel specific to ADC3 */
#define ADC_CHANNEL_DAC1_CH2                                                                                                                                                                           \
	(LL_ADC_CHANNEL_DAC1_CH2) /*!< Internal channel DAC1 channel 2,                                                                                                                                \
  channel specific to ADC3 */
#endif				  /* ADC3 */
/**
 * @}
 ...
 */
#if defined(ADC_CFGR_ADFCFG)
#define IS_ADC_CONVERSIONDATAMGT(DATA) ((((DATA) == ADC_CONVERSIONDATA_DR)) || (((DATA) == ADC_CONVERSIONDATA_MDF)))
#else
#define IS_ADC_CONVERSIONDATAMGT(DATA) (((DATA) == ADC_CONVERSIONDATA_DR))
...
#define IS_ADC_EXTTRIG(__REGTRIG__)                                                                                                                                                                    \
	(((__REGTRIG__) == ADC_EXTERNALTRIG_T1_CC1) || ((__REGTRIG__) == ADC_EXTERNALTRIG_T1_CC2) || ((__REGTRIG__) == ADC_EXTERNALTRIG_T1_CC3) || ((__REGTRIG__) == ADC_EXTERNALTRIG_T2_CC2) ||       \
	 ...
	 ((__REGTRIG__) == ADC_EXTERNALTRIG_EXT_IT15) || ((__REGTRIG__) == ADC_EXTERNALTRIG_LPTIM1_CH1) || ((__REGTRIG__) == ADC_EXTERNALTRIG_LPTIM2_CH1) || ((__REGTRIG__) == ADC_SOFTWARE_START))
#elif defined(ADC3)
/* Devices STM32H5Ex/H5Fxxx */
#define IS_ADC_EXTTRIG(__REGTRIG__)                                                                                                                                                                    \
	(((__REGTRIG__) == ADC_EXTERNALTRIG_T1_CC1) || ((__REGTRIG__) == ADC_EXTERNALTRIG_T1_CC2) || ((__REGTRIG__) == ADC_EXTERNALTRIG_T1_CC3) || ((__REGTRIG__) == ADC_EXTERNALTRIG_T2_CC2) ||       \
	 ...
	 ((__REGTRIG__) == ADC_EXTERNALTRIG_PLAY_OUT7) || ((__REGTRIG__) == ADC_SOFTWARE_START))
#else
/* Devices STM32H503xx */
#define IS_ADC_EXTTRIG(__REGTRIG__)                                                                                                                                                                    \
	(((__REGTRIG__) == ADC_EXTERNALTRIG_T1_CC1) || ((__REGTRIG__) == ADC_EXTERNALTRIG_T1_CC2) || ((__REGTRIG__) == ADC_EXTERNALTRIG_T1_CC3) || ((__REGTRIG__) == ADC_EXTERNALTRIG_T2_CC2) ||       \
	 ((__REGTRIG__) == ADC_EXTERNALTRIG_T3_TRGO) || ((__REGTRIG__) == ADC_EXTERNALTRIG_EXT_IT11) || ((__REGTRIG__) == ADC_EXTERNALTRIG_T1_TRGO) || ((__REGTRIG__) == ADC_EXTERNALTRIG_T1_TRGO2) || \
	 ((__REGTRIG__) == ADC_EXTERNALTRIG_T2_TRGO) || ((__REGTRIG__) == ADC_EXTERNALTRIG_T6_TRGO) || ((__REGTRIG__) == ADC_EXTERNALTRIG_T3_CC4) || ((__REGTRIG__) == ADC_EXTERNALTRIG_T7_TRGO) ||    \
	 ((__REGTRIG__) == ADC_EXTERNALTRIG_LPTIM1_CH1) || ((__REGTRIG__) == ADC_EXTERNALTRIG_LPTIM2_CH1) || ((__REGTRIG__) == ADC_SOFTWARE_START))
#endif /* Devices STM32H563/H573xx or STM32H503xx */
