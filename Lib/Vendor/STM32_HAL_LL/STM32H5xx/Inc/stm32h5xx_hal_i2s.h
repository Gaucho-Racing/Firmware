...
#define IS_I2S_MODE(__MODE__)                                                                                                                                                                          \
	(((__MODE__) == I2S_MODE_SLAVE_TX) || ((__MODE__) == I2S_MODE_SLAVE_RX) || ((__MODE__) == I2S_MODE_MASTER_TX) || ((__MODE__) == I2S_MODE_MASTER_RX) ||                                         \
	 ((__MODE__) == I2S_MODE_SLAVE_FULLDUPLEX) || ((__MODE__) == I2S_MODE_MASTER_FULLDUPLEX))

#define IS_I2S_MASTER(__MODE__) (((__MODE__) == I2S_MODE_MASTER_TX) || ((__MODE__) == I2S_MODE_MASTER_RX) || ((__MODE__) == I2S_MODE_MASTER_FULLDUPLEX))

#define IS_I2S_SLAVE(__MODE__) (((__MODE__) == I2S_MODE_SLAVE_TX) || ((__MODE__) == I2S_MODE_SLAVE_RX) || ((__MODE__) == I2S_MODE_SLAVE_FULLDUPLEX))

#define IS_I2S_FULLDUPLEX(__MODE__) (((__MODE__) == I2S_MODE_MASTER_FULLDUPLEX) || ((__MODE__) == I2S_MODE_SLAVE_FULLDUPLEX))

#define IS_I2S_STANDARD(__STANDARD__)                                                                                                                                                                  \
	(((__STANDARD__) == I2S_STANDARD_PHILIPS) || ((__STANDARD__) == I2S_STANDARD_MSB) || ((__STANDARD__) == I2S_STANDARD_LSB) || ((__STANDARD__) == I2S_STANDARD_PCM_SHORT) ||                     \
...
#define IS_I2S_WS_INVERSION(__WSINV__) (((__WSINV__) == I2S_WS_INVERSION_DISABLE) || ((__WSINV__) == I2S_WS_INVERSION_ENABLE))

#define IS_I2S_DATA_24BIT_ALIGNMENT(__ALIGNMENT__) (((__ALIGNMENT__) == I2S_DATA_24BIT_ALIGNMENT_RIGHT) || ((__ALIGNMENT__) == I2S_DATA_24BIT_ALIGNMENT_LEFT))

#define IS_I2S_MASTER_KEEP_IO_STATE(__AFCNTR__) (((__AFCNTR__) == I2S_MASTER_KEEP_IO_STATE_DISABLE) || ((__AFCNTR__) == I2S_MASTER_KEEP_IO_STATE_ENABLE))
