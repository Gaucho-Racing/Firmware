 ...
 */
#define __HAL_DTS_GET_FLAG(__HANDLE__, __FLAG__) (((((__HANDLE__)->Instance->SR & (__FLAG__)) == (__FLAG__))) ? SET : RESET)
 ...
 */
#define __HAL_DTS_GET_IT_SOURCE(__HANDLE__, __INTERRUPT__) ((((__HANDLE__)->Instance->ITENR & (__INTERRUPT__)) == (__INTERRUPT__)) ? SET : RESET)
...
#define IS_DTS_TRIGGERINPUT(__INPUT__)                                                                                                                                                                 \
	(((__INPUT__) == DTS_TRIGGER_HW_NONE) || ((__INPUT__) == DTS_TRIGGER_LPTIMER1) || ((__INPUT__) == DTS_TRIGGER_LPTIMER2) || ((__INPUT__) == DTS_TRIGGER_LPTIMER3) ||                            \
	 ((__INPUT__) == DTS_TRIGGER_EXTI13) || ((__INPUT__) == DTS_TRIGGER_PLAY_OUT13))
#elif defined(LPTIM3)
#define IS_DTS_TRIGGERINPUT(__INPUT__)                                                                                                                                                                 \
	(((__INPUT__) == DTS_TRIGGER_HW_NONE) || ((__INPUT__) == DTS_TRIGGER_LPTIMER1) || ((__INPUT__) == DTS_TRIGGER_LPTIMER2) || ((__INPUT__) == DTS_TRIGGER_LPTIMER3) ||                            \
...
#elif defined(PLAY1)
#define IS_DTS_TRIGGERINPUT(__INPUT__)                                                                                                                                                                 \
	(((__INPUT__) == DTS_TRIGGER_HW_NONE) || ((__INPUT__) == DTS_TRIGGER_LPTIMER1) || ((__INPUT__) == DTS_TRIGGER_LPTIMER2) || ((__INPUT__) == DTS_TRIGGER_EXTI13) ||                              \
	 ((__INPUT__) == DTS_TRIGGER_PLAY_OUT13))
#else
#define IS_DTS_TRIGGERINPUT(__INPUT__) (((__INPUT__) == DTS_TRIGGER_HW_NONE) || ((__INPUT__) == DTS_TRIGGER_LPTIMER1) || ((__INPUT__) == DTS_TRIGGER_LPTIMER2) || ((__INPUT__) == DTS_TRIGGER_EXTI13))
...
#define IS_DTS_SAMPLINGTIME(__CYCLE__)                                                                                                                                                                 \
	(((__CYCLE__) == DTS_SMP_TIME_1_CYCLE) || ((__CYCLE__) == DTS_SMP_TIME_2_CYCLE) || ((__CYCLE__) == DTS_SMP_TIME_3_CYCLE) || ((__CYCLE__) == DTS_SMP_TIME_4_CYCLE) ||                           \
	 ((__CYCLE__) == DTS_SMP_TIME_5_CYCLE) || ((__CYCLE__) == DTS_SMP_TIME_6_CYCLE) || ((__CYCLE__) == DTS_SMP_TIME_7_CYCLE) || ((__CYCLE__) == DTS_SMP_TIME_8_CYCLE) ||                           \
	 ((__CYCLE__) == DTS_SMP_TIME_9_CYCLE) || ((__CYCLE__) == DTS_SMP_TIME_10_CYCLE) || ((__CYCLE__) == DTS_SMP_TIME_11_CYCLE) || ((__CYCLE__) == DTS_SMP_TIME_12_CYCLE) ||                        \
	 ((__CYCLE__) == DTS_SMP_TIME_13_CYCLE) || ((__CYCLE__) == DTS_SMP_TIME_14_CYCLE) || ((__CYCLE__) == DTS_SMP_TIME_15_CYCLE))
