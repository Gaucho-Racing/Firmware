...
#define IS_SBS_MEMORIES_ERASE_FLAG(FLAG) (((FLAG) == SBS_MEMORIES_ERASE_FLAG_IPMEE) || ((FLAG) == SBS_MEMORIES_ERASE_FLAG_MCLR))
...
#define IS_SBS_EPOCH_SELECTION(SELECT) (((SELECT) == SBS_EPOCH_SEL_SECURE) || ((SELECT) == SBS_EPOCH_SEL_NONSECURE) || ((SELECT) == SBS_EPOCH_SEL_PUFCHECK))
/**
 * @}
 */
...
#define IS_SBS_FPU_INTERRUPT(__INTERRUPT__)                                                                                                                                                            \
	((((__INTERRUPT__) & SBS_IT_FPU_IOC) == SBS_IT_FPU_IOC) || (((__INTERRUPT__) & SBS_IT_FPU_DZC) == SBS_IT_FPU_DZC) || (((__INTERRUPT__) & SBS_IT_FPU_UFC) == SBS_IT_FPU_UFC) ||                 \
	 (((__INTERRUPT__) & SBS_IT_FPU_OFC) == SBS_IT_FPU_OFC) || (((__INTERRUPT__) & SBS_IT_FPU_IDC) == SBS_IT_FPU_IDC) || (((__INTERRUPT__) & SBS_IT_FPU_IXC) == SBS_IT_FPU_IXC))

#define IS_SBS_BREAK_CONFIG(__CONFIG__) (((__CONFIG__) == SBS_BREAK_FLASH_ECC) || ((__CONFIG__) == SBS_BREAK_PVD) || ((__CONFIG__) == SBS_BREAK_SRAM_ECC) || ((__CONFIG__) == SBS_BREAK_LOCKUP))

#if defined(VREFBUF)
#define IS_VREFBUF_VOLTAGE_SCALE(__SCALE__)                                                                                                                                                            \
	(((__SCALE__) == VREFBUF_VOLTAGE_SCALE0) || ((__SCALE__) == VREFBUF_VOLTAGE_SCALE1) || ((__SCALE__) == VREFBUF_VOLTAGE_SCALE2) || ((__SCALE__) == VREFBUF_VOLTAGE_SCALE3))

#define IS_VREFBUF_HIGH_IMPEDANCE(__VALUE__) (((__VALUE__) == VREFBUF_HIGH_IMPEDANCE_DISABLE) || ((__VALUE__) == VREFBUF_HIGH_IMPEDANCE_ENABLE))
...
#define IS_SBS_FASTMODEPLUS(__PIN__)                                                                                                                                                                   \
	((((__PIN__) & SBS_FASTMODEPLUS_PB6) == SBS_FASTMODEPLUS_PB6) || (((__PIN__) & SBS_FASTMODEPLUS_PB7) == SBS_FASTMODEPLUS_PB7) ||                                                               \
	 (((__PIN__) & SBS_FASTMODEPLUS_PB8) == SBS_FASTMODEPLUS_PB8) || (((__PIN__) & SBS_FASTMODEPLUS_PB9) == SBS_FASTMODEPLUS_PB9))
#else
#define IS_SBS_FASTMODEPLUS(__PIN__)                                                                                                                                                                   \
	((((__PIN__) & SBS_FASTMODEPLUS_PB6) == SBS_FASTMODEPLUS_PB6) || (((__PIN__) & SBS_FASTMODEPLUS_PB7) == SBS_FASTMODEPLUS_PB7) || (((__PIN__) & SBS_FASTMODEPLUS_PB8) == SBS_FASTMODEPLUS_PB8))
#endif /* SBS_FASTMODEPLUS_PB9 */

#define IS_SBS_HDPL(__LEVEL__) (((__LEVEL__) == SBS_HDPL_VALUE_0) || ((__LEVEL__) == SBS_HDPL_VALUE_1) || ((__LEVEL__) == SBS_HDPL_VALUE_2) || ((__LEVEL__) == SBS_HDPL_VALUE_3))

#define IS_SBS_OBKHDPL_SELECTION(__SELECT__)                                                                                                                                                           \
	(((__SELECT__) == SBS_OBKHDPL_INCR_0) || ((__SELECT__) == SBS_OBKHDPL_INCR_1) || ((__SELECT__) == SBS_OBKHDPL_INCR_2) || ((__SELECT__) == SBS_OBKHDPL_INCR_3))

#define IS_SBS_ITEMS_ATTRIBUTES(__ITEM__) ((((__ITEM__) & SBS_CLK) == SBS_CLK) || (((__ITEM__) & SBS_CLASSB) == SBS_CLASSB) || (((__ITEM__) & SBS_FPU) == SBS_FPU) || (((__ITEM__) & ~(SBS_ALL)) == 0U))

#define IS_SBS_ATTRIBUTES(__ATTRIBUTES__) (((__ATTRIBUTES__) == SBS_SEC) || ((__ATTRIBUTES__) == SBS_NSEC))

#if defined(SBS_OTGHSPHYTUNER2_COMPDISTUNE)
#define IS_SBS_OTGPHY_DISCONNECT(__VALUE__) (((__VALUE__) == SBS_OTG_HS_PHY_DISCONNECT_5_9PERCENT) || ((__VALUE__) == SBS_OTG_HS_PHY_DISCONNECT_0PERCENT))
#endif /* SBS_OTGHSPHYTUNER2_COMPDISTUNE*/
#if defined(SBS_OTGHSPHYTUNER2_SQRXTUNE)
#define IS_SBS_OTGPHY_SQUELCH(__VALUE__) (((__VALUE__) == SBS_OTG_HS_PHY_SQUELCH_0PERCENT) || ((__VALUE__) == SBS_OTG_HS_PHY_SQUELCH_15PERCENT))
#endif /* SBS_OTGHSPHYTUNER2_SQRXTUNE */

#if defined(SBS_OTGHSPHYTUNER2_TXPREEMPAMPTUNE)
#define IS_SBS_OTGPHY_PREEMPHASIS(__VALUE__)                                                                                                                                                           \
	(((__VALUE__) == SBS_OTG_HS_PHY_PREEMP_DISABLED) || ((__VALUE__) == SBS_OTG_HS_PHY_PREEMP_1X) || ((__VALUE__) == SBS_OTG_HS_PHY_PREEMP_2X) || ((__VALUE__) == SBS_OTG_HS_PHY_PREEMP_3X))
#endif /* SBS_OTGHSPHYTUNER2_TXPREEMPAMPTUNE */

#if defined(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)

#define IS_SBS_LOCK_ITEMS(__ITEM__)                                                                                                                                                                    \
	((((__ITEM__) & SBS_MPU_NSEC) == SBS_MPU_NSEC) || (((__ITEM__) & SBS_VTOR_NSEC) == SBS_VTOR_NSEC) || (((__ITEM__) & SBS_SAU) == SBS_SAU) || (((__ITEM__) & SBS_MPU_SEC) == SBS_MPU_SEC) ||     \
	 (((__ITEM__) & SBS_VTOR_AIRCR_SEC) == SBS_VTOR_AIRCR_SEC) || (((__ITEM__) & ~(SBS_LOCK_ALL)) == 0U))

#else

#define IS_SBS_LOCK_ITEMS(__ITEM__) ((((__ITEM__) & SBS_MPU_NSEC) == SBS_MPU_NSEC) || (((__ITEM__) & SBS_VTOR_NSEC) == SBS_VTOR_NSEC) || (((__ITEM__) & ~(SBS_LOCK_ALL)) == 0U))
