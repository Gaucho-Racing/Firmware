...
#else
#define IS_TIM_CLEARINPUT_SOURCE(__MODE__) (((__MODE__) == TIM_CLEARINPUTSOURCE_ETR) || ((__MODE__) == TIM_CLEARINPUTSOURCE_NONE))
#endif /* COMP1 && COMP2 */
...
#define IS_TIM_DMA_LENGTH(__LENGTH__)                                                                                                                                                                  \
	(((__LENGTH__) == TIM_DMABURSTLENGTH_1TRANSFER) || ((__LENGTH__) == TIM_DMABURSTLENGTH_2TRANSFERS) || ((__LENGTH__) == TIM_DMABURSTLENGTH_3TRANSFERS) ||                                       \
	 ...
	 ((__LENGTH__) == TIM_DMABURSTLENGTH_25TRANSFERS) || ((__LENGTH__) == TIM_DMABURSTLENGTH_26TRANSFERS) || ((__LENGTH__) == TIM_DMABURSTLENGTH_27TRANSFERS))
