...
#define DMA2D_GPFLAG_RISING_FALLING                                                                                                                                                                    \
	3 /*!< General purpose flag interrupt is set on a rising or a falling edge                                                                                                                     \
	       of the GPF */
/**
 * @}
 */
...
#define DMA2D_IT_ALL                                                                                                                                                                                   \
	(DMA2D_IT_CE | DMA2D_IT_CTC | DMA2D_IT_CAE | DMA2D_IT_TW | DMA2D_IT_TC | DMA2D_IT_TE | DMA2D_IT_GPF3 | DMA2D_IT_GPF2 | DMA2D_IT_GPF1 | DMA2D_IT_GPF0 | DMA2D_IT_CLE | DMA2D_IT_CLS |           \
	 DMA2D_IT_RBE | DMA2D_IT_RBC) /*!< All Interrupt */
...
HAL_StatusTypeDef HAL_DMA2D_CLUTStartLoad_IT(DMA2D_HandleTypeDef *hdma2d, const DMA2D_CLUTCfgTypeDef *CLUTCfg, uint32_t LayerIdx);
...
HAL_StatusTypeDef HAL_DMA2D_ConfigStencil(DMA2D_HandleTypeDef *hdma2d, uint32_t source, DMA2D_StencilCfgTypeDef *pStencilCfg);
HAL_StatusTypeDef HAL_DMA2D_ConfigDownscaling(DMA2D_HandleTypeDef *hdma2d, uint32_t source, DMA2D_DownscalingCfgTypeDef *pDownscalingCfg);
...
/* Callbacks Register/UnRegister functions  ***********************************/
#if (USE_HAL_DMA2D_REGISTER_CALLBACKS == 1)
HAL_StatusTypeDef HAL_DMA2D_CL_RegisterCallback(DMA2D_CL_HandleTypeDef *hdma2d, HAL_DMA2D_CL_CallbackIDTypeDef CallbackID, pDMA2D_CL_CallbackTypeDef pCallback);
HAL_StatusTypeDef HAL_DMA2D_CL_UnRegisterCallback(DMA2D_CL_HandleTypeDef *hdma2d, HAL_DMA2D_CL_CallbackIDTypeDef CallbackID);
HAL_StatusTypeDef HAL_DMA2D_CL_Register_GeneralPurposeEvent_Callback(DMA2D_CL_HandleTypeDef *hdma2d, HAL_DMA2D_CL_CallbackIDTypeDef CallbackID, pDMA2D_CL_GeneralPurposeEventCallbackTypeDef pCallback);
...
HAL_StatusTypeDef HAL_DMA2D_CL_AddConfigLayerCMD(DMA2D_CL_HandleTypeDef *hdma2d, uint32_t LayerIdx, DMA2D_LayerCfgTypeDef *pLayerCfg);
HAL_StatusTypeDef HAL_DMA2D_CL_AddConfigRotationCMD(DMA2D_CL_HandleTypeDef *hdma2d, uint32_t Source, uint32_t Mirroring_Type);
HAL_StatusTypeDef HAL_DMA2D_CL_AddConfigStencilCMD(DMA2D_CL_HandleTypeDef *hdma2d, uint32_t Source, DMA2D_StencilCfgTypeDef *pStencilCfg);
HAL_StatusTypeDef HAL_DMA2D_CL_AddConfigDownscalingCMD(DMA2D_CL_HandleTypeDef *hdma2d, uint32_t Source, DMA2D_DownscalingCfgTypeDef *pDownscalingCfg);
HAL_StatusTypeDef HAL_DMA2D_CL_AddProgramLineEventCMD(DMA2D_CL_HandleTypeDef *hdma2d, uint32_t Line);
HAL_StatusTypeDef HAL_DMA2D_CL_AddCLUTStartLoadCMD(DMA2D_CL_HandleTypeDef *hdma2d, uint32_t LayerIdx, const DMA2D_CLUTCfgTypeDef *CLUTCfg, DMA2D_CL_CommandListTypeDef *pCommandList);
HAL_StatusTypeDef HAL_DMA2D_CL_AddCopyCMD(DMA2D_CL_HandleTypeDef *hdma2d, uint32_t pdata, uint32_t DstAddress, uint32_t Width, uint32_t Height, DMA2D_CL_CommandListTypeDef *pCommandList);
HAL_StatusTypeDef HAL_DMA2D_CL_AddBlendingCMD(DMA2D_CL_HandleTypeDef *hdma2d, uint32_t SrcAddress1, uint32_t SrcAddress2, uint32_t DstAddress, uint32_t Width, uint32_t Height,
					      DMA2D_CL_CommandListTypeDef *pCommandList);
HAL_StatusTypeDef HAL_DMA2D_CL_Init_CommandList(uint32_t *Address, uint32_t Size, DMA2D_CL_CommandListTypeDef *pCommandList);
HAL_StatusTypeDef HAL_DMA2D_CL_ResetIndex(DMA2D_CL_CommandListTypeDef *pCommandList);
HAL_StatusTypeDef HAL_DMA2D_CL_InsertCommandList(DMA2D_CL_HandleTypeDef *hdma2d, DMA2D_CL_CommandListTypeDef *pCommandList, uint32_t gpflag, uint32_t post_flag_config, uint32_t pre_flag_config);
...
#define IS_DMA2D_MODE(MODE)                                                                                                                                                                            \
	(((MODE) == DMA2D_M2M) || ((MODE) == DMA2D_M2M_PFC) || ((MODE) == DMA2D_M2M_BLEND) || ((MODE) == DMA2D_R2M) || ((MODE) == DMA2D_M2M_BLEND_FG) || ((MODE) == DMA2D_M2M_BLEND_BG))

#define IS_DMA2D_CMODE(MODE_ARGB)                                                                                                                                                                      \
	(((MODE_ARGB) == DMA2D_OUTPUT_ARGB8888) || ((MODE_ARGB) == DMA2D_OUTPUT_RGB888) || ((MODE_ARGB) == DMA2D_OUTPUT_RGB565) || ((MODE_ARGB) == DMA2D_OUTPUT_ARGB1555) ||                           \
...
#define IS_DMA2D_INPUT_COLOR_MODE(INPUT_CM)                                                                                                                                                            \
	(((INPUT_CM) == DMA2D_INPUT_ARGB8888) || ((INPUT_CM) == DMA2D_INPUT_RGB888) || ((INPUT_CM) == DMA2D_INPUT_RGB565) || ((INPUT_CM) == DMA2D_INPUT_ARGB1555) ||                                   \
	 ((INPUT_CM) == DMA2D_INPUT_ARGB4444) || ((INPUT_CM) == DMA2D_INPUT_L8) || ((INPUT_CM) == DMA2D_INPUT_AL44) || ((INPUT_CM) == DMA2D_INPUT_AL88) || ((INPUT_CM) == DMA2D_INPUT_L4) ||           \
	 ((INPUT_CM) == DMA2D_INPUT_A8) || ((INPUT_CM) == DMA2D_INPUT_A4) || ((INPUT_CM) == DMA2D_INPUT_YCBCR) || ((INPUT_CM) == DMA2D_INPUT_A2) || ((INPUT_CM) == DMA2D_INPUT_A1) ||                  \
	 ((INPUT_CM) == DMA2D_INPUT_ARGB2222))

#define IS_DMA2D_ALPHA_MODE(AlphaMode) (((AlphaMode) == DMA2D_NO_MODIF_ALPHA) || ((AlphaMode) == DMA2D_REPLACE_ALPHA) || ((AlphaMode) == DMA2D_COMBINE_ALPHA))

#define IS_DMA2D_ALPHA_INVERTED(Alpha_Inverted) (((Alpha_Inverted) == DMA2D_REGULAR_ALPHA) || ((Alpha_Inverted) == DMA2D_INVERTED_ALPHA))
...
#define IS_DMA2D_ALPHA_POSITION(AlphaPosition) (((AlphaPosition) == DMA2D_REGULAR_ALPHA_POS) || ((AlphaPosition) == DMA2D_SWAP_ALPHA_POS))

#define IS_DMA2D_ROT_SRC(ROT_SRC) (((ROT_SRC) == DMA2D_SOURCE_NONE) || ((ROT_SRC) == DMA2D_SOURCE_FOREGROUND) || ((ROT_SRC) == DMA2D_SOURCE_BACKGROUND) || ((ROT_SRC) == DMA2D_SOURCE_BLENDER_OUTPUT))
#define IS_DMA2D_ROT_TYPE(ROT_TYPE)                                                                                                                                                                    \
	(((ROT_TYPE) == DMA2D_NO_ROTATION) || ((ROT_TYPE) == DMA2D_NO_ROTATION_FLIP) || ((ROT_TYPE) == DMA2D_ROTATE_90) || ((ROT_TYPE) == DMA2D_ROTATE_90_FLIP) || ((ROT_TYPE) == DMA2D_ROTATE_180) || \
	 ((ROT_TYPE) == DMA2D_ROTATE_180_FLIP) || ((ROT_TYPE) == DMA2D_ROTATE_270) || ((ROT_TYPE) == DMA2D_ROTATE_270_FLIP))

#define IS_DMA2D_SKIP_PIXEL_VALUE(value) ((value) <= 0xFU)
#define IS_DMA2D_STENCIL_MODE(mode) (((mode) == DMA2D_STENCIL_MODE_A1) || ((mode) == DMA2D_STENCIL_MODE_A2) || ((mode) == DMA2D_STENCIL_MODE_A4) || ((mode) == DMA2D_STENCIL_MODE_A8))
...
#define IS_DMA2D_STENCIL_ALPHA_INVERTED(ALPHA_INV) (((ALPHA_INV) == DMA2D_REGULAR_ALPHA) || ((ALPHA_INV) == DMA2D_INVERTED_ALPHA))
#define IS_DMA2D_SCALE_SRC(SCALE_SRC)                                                                                                                                                                  \
	(((SCALE_SRC) == DMA2D_SOURCE_NONE) || ((SCALE_SRC) == DMA2D_SOURCE_FOREGROUND) || ((SCALE_SRC) == DMA2D_SOURCE_BACKGROUND) || ((SCALE_SRC) == DMA2D_SOURCE_BLENDER_OUTPUT))
...
#define IS_DMA2D_STENCIL_SRC(STENCIL_SRC)                                                                                                                                                              \
	(((STENCIL_SRC) == DMA2D_SOURCE_NONE) || ((STENCIL_SRC) == DMA2D_SOURCE_FOREGROUND) || ((STENCIL_SRC) == DMA2D_SOURCE_BACKGROUND) || ((STENCIL_SRC) == DMA2D_SOURCE_BLENDER_OUTPUT))
#define IS_DMA2D_CLUT_CM(CLUT_CM)                                                                                                                                                                      \
	(((CLUT_CM) == DMA2D_CCM_ARGB8888) || ((CLUT_CM) == DMA2D_CCM_RGB888) || ((CLUT_CM) == DMA2D_CCM_RGB565) || ((CLUT_CM) == DMA2D_CCM_ARGB1555) || ((CLUT_CM) == DMA2D_CCM_ARGB4444) ||          \
	 ((CLUT_CM) == DMA2D_CCM_ARGB2222))
#define IS_DMA2D_CLUT_SIZE(CLUT_SIZE) ((CLUT_SIZE) <= DMA2D_CLUT_SIZE)
#define IS_DMA2D_LINEWATERMARK(LineWatermark) ((LineWatermark) <= DMA2D_LINE_WATERMARK_MAX)
#define IS_DMA2D_IT(IT)                                                                                                                                                                                \
	(((IT) == DMA2D_IT_CE) || ((IT) == DMA2D_IT_CTC) || ((IT) == DMA2D_IT_CAE) || ((IT) == DMA2D_IT_TW) || ((IT) == DMA2D_IT_TC) || ((IT) == DMA2D_IT_TE) || ((IT) == DMA2D_IT_GPF3) ||            \
	 ((IT) == DMA2D_IT_GPF2) || ((IT) == DMA2D_IT_GPF1) || ((IT) == DMA2D_IT_GPF0) || ((IT) == DMA2D_IT_CLE) || ((IT) == DMA2D_IT_CLS) || ((IT) == DMA2D_IT_RBE) || ((IT) == DMA2D_IT_RBC) ||      \
	 ((IT) == DMA2D_IT_ALL))

#define IS_DMA2D_GET_FLAG(FLAG)                                                                                                                                                                        \
	(((FLAG) == DMA2D_FLAG_CE) || ((FLAG) == DMA2D_FLAG_CTC) || ((FLAG) == DMA2D_FLAG_CAE) || ((FLAG) == DMA2D_FLAG_TW) || ((FLAG) == DMA2D_FLAG_TC) || ((FLAG) == DMA2D_FLAG_TE) ||               \
	 ((FLAG) == DMA2D_FLAG_GPF3I) || ((FLAG) == DMA2D_FLAG_GPF2I) || ((FLAG) == DMA2D_FLAG_GPF1I) || ((FLAG) == DMA2D_FLAG_GPF0I) || ((FLAG) == DMA2D_FLAG_CLE) || ((FLAG) == DMA2D_FLAG_CLS) ||   \
	 ((FLAG) == DMA2D_FLAG_RBE) || ((FLAG) == DMA2D_FLAG_RBC) || ((FLAG) == DMA2D_FLAG_LCLMSE) || ((FLAG) == DMA2D_FLAG_LCLIE) || ((FLAG) == DMA2D_FLAG_LCLRE) || ((FLAG) == DMA2D_FLAG_GPF3S) ||  \
	 ((FLAG) == DMA2D_FLAG_GPF2S) || ((FLAG) == DMA2D_FLAG_GPF1S) || ((FLAG) == DMA2D_FLAG_GPF0S) || ((FLAG) == DMA2D_FLAG_SUSPS))
#define IS_DMA2D_CL_RB_SIZE(SIZE)                                                                                                                                                                      \
	(((SIZE) == DMA2D_RB_SIZE_64B) || ((SIZE) == DMA2D_RB_SIZE_128B) || ((SIZE) == DMA2D_RB_SIZE_256B) || ((SIZE) == DMA2D_RB_SIZE_512B) || ((SIZE) == DMA2D_RB_SIZE_1KB) ||                       \
	 ((SIZE) == DMA2D_RB_SIZE_2KB) || ((SIZE) == DMA2D_RB_SIZE_4KB) || ((SIZE) == DMA2D_RB_SIZE_8KB))
...
#define IS_DMA2D_CL_PRE_POST_FLAG_OPERATION(flag_operation)                                                                                                                                            \
	((flag_operation == DMA2D_GPFLAG_NOP) || (flag_operation == DMA2D_GPFLAG_SET) || (flag_operation == DMA2D_GPFLAG_RESET) || (flag_operation == DMA2D_GPFLAG_TOGGLE))
#define IS_DMA2D_CL_GPFLAG(GPFLAG) ((GPFLAG == DMA2D_GPFLAG0) || (GPFLAG == DMA2D_GPFLAG1) || (GPFLAG == DMA2D_GPFLAG2) || (GPFLAG == DMA2D_GPFLAG3))
#define IS_DMA2D_CL_GPFLAG_INTERRUPT_MODE(mode) (((mode) == DMA2D_GPFLAG_NONE) || ((mode) == DMA2D_GPFLAG_RISING) || ((mode) == DMA2D_GPFLAG_FALLING) || ((mode) == DMA2D_GPFLAG_RISING_FALLING))
#define IS_DMA2D_CL_IT(IT)                                                                                                                                                                             \
	(((IT) == DMA2D_IT_CE) || ((IT) == DMA2D_IT_CTC) || ((IT) == DMA2D_IT_CAE) || ((IT) == DMA2D_IT_TW) || ((IT) == DMA2D_IT_TC) || ((IT) == DMA2D_IT_TE) || ((IT) == DMA2D_IT_GPF3) ||            \
	 ((IT) == DMA2D_IT_GPF2) || ((IT) == DMA2D_IT_GPF1) || ((IT) == DMA2D_IT_GPF0) || ((IT) == DMA2D_IT_CLE) || ((IT) == DMA2D_IT_CLS) || ((IT) == DMA2D_IT_RBE) || ((IT) == DMA2D_IT_RBC) ||      \
	 ((IT) == DMA2D_IT_ALL))
/**
