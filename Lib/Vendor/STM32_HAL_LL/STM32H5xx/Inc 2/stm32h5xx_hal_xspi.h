...
/**
  @cond 0
  */
#define IS_XSPI_FIFO_THRESHOLD_BYTE(THRESHOLD) (((THRESHOLD) >= 1U) && ((THRESHOLD) <= ((XSPI_CR_FTHRES >> XSPI_CR_FTHRES_Pos) + 1U)))
...
#if defined(XSPI_CR_CSSEL)
#define IS_XSPI_CSSEL(CSSEL) (((CSSEL) == HAL_XSPI_CSSEL_NCS1) || ((CSSEL) == HAL_XSPI_CSSEL_NCS2))

#endif /* XSPI_CR_CSSEL */
#if defined(XSPI_DCR1_EXTENDMEM)
#define IS_XSPI_EXTENDMEM(EXTENDMEM) (((EXTENDMEM) == HAL_XSPI_CSSEL_SW) || ((EXTENDMEM) == HAL_XSPI_CSSEL_HW))
...
#define IS_XSPI_IO_SELECT(MEMSEL) (((MEMSEL) == HAL_XSPI_SELECT_IO_3_0) || ((MEMSEL) == HAL_XSPI_SELECT_IO_7_4) || ((MEMSEL) == HAL_XSPI_SELECT_IO_7_0))
...
#if defined(XSPI_CR_NOPREF)
#define IS_XSPI_NO_PREFETCH_DATA(MODE) (((MODE) == HAL_XSPI_AUTOMATIC_PREFETCH_ENABLE) || ((MODE) == HAL_XSPI_AUTOMATIC_PREFETCH_DISABLE))
#endif /* XSPI_CR_NOPREF */
...
#if defined(OCTOSPIM)
#define IS_XSPIM_IO_PORT(PORT) (((PORT) == HAL_XSPIM_IOPORT_1) || ((PORT) == HAL_XSPIM_IOPORT_2))

#define IS_XSPIM_NCS_OVR(PORT) (((PORT) == HAL_XSPI_CSSEL_OVR_DISABLED) || ((PORT) == HAL_XSPI_CSSEL_OVR_NCS1) || ((PORT) == HAL_XSPI_CSSEL_OVR_NCS2))
