...
#else
#define IS_LL_DAC_CHANNEL(__DAC_CHANNEL__) (((__DAC_CHANNEL__) == LL_DAC_CHANNEL_1))
...
#define IS_LL_DAC_TRIGGER_SOURCE(__TRIGGER_SOURCE__)                                                                                                                                                   \
	(((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM1_TRGO) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM2_TRGO) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM4_TRGO) ||                          \
	 ...
	 ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM8_TRGO) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM15_TRGO) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_LPTIM1_OUT) ||                        \
	 ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_LPTIM2_OUT) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_EXTI_LINE9) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_SOFTWARE))
#else
#define IS_LL_DAC_TRIGGER_SOURCE(__TRIGGER_SOURCE__)                                                                                                                                                   \
	(((__TRIGGER_SOURCE__) == LL_DAC_TRIG_SOFTWARE) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM2_TRGO) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM4_TRGO) ||                               \
	 ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM5_TRGO) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM6_TRGO) || ((__TRIGGER_SOURCE__) == LL_DAC_TRIG_EXT_TIM7_TRGO) ||                          \
