...
#define IS_LL_RCC_SDMMC_KERNELCLKSOURCE(__VALUE__)                             \
	(((__VALUE__) == LL_RCC_SDMMC1_KERNELCLKSOURCE))
...
#if defined(SWPMI1)
#define IS_LL_RCC_SWPMI_CLKSOURCE(__VALUE__)                                   \
	(((__VALUE__) == LL_RCC_SWPMI1_CLKSOURCE))
#endif /* SWPMI1 */

#if defined(DFSDM1_Channel0)
#define IS_LL_RCC_DFSDM_CLKSOURCE(__VALUE__)                                   \
	(((__VALUE__) == LL_RCC_DFSDM1_CLKSOURCE))
...
#if defined(RCC_CCIPR_SAI1SEL) || defined(RCC_CCIPR_SAI2SEL) ||                \
    defined(RCC_CCIPR2_SAI1SEL) || defined(RCC_CCIPR2_SAI2SEL)
...
ErrorStatus LL_RCC_DeInit(void)
{
	...
	CLEAR_BIT(vl_mask, (RCC_CR_HSION | RCC_CR_HSIASFS | RCC_CR_HSIKERON |
...
uint32_t LL_RCC_GetUSARTClockFreq(uint32_t USARTxSource)
{
	...
	if (USARTxSource == LL_RCC_USART1_CLKSOURCE) {
		...
		if (USARTxSource == LL_RCC_USART3_CLKSOURCE) {
			...
			switch (LL_RCC_GetUSARTClockSource(USARTxSource)) {
				case LL_RCC_USART3_CLKSOURCE_SYSCLK: /* USART3
									Clock is
									System
									Clock */
					usart_frequency =
				...
				case LL_RCC_USART3_CLKSOURCE_HSI: /* USART3
								     Clock is
								     HSI Osc. */
					if (LL_RCC_HSI_IsReady() != 0U) {
						usart_frequency = HSI_VALUE;
				...
				case LL_RCC_USART3_CLKSOURCE_LSE: /* USART3
								     Clock is
								     LSE Osc. */
					if (LL_RCC_LSE_IsReady() != 0U) {
						usart_frequency = LSE_VALUE;
				...
				case LL_RCC_USART3_CLKSOURCE_PCLK1: /* USART3
								       Clock is
								       PCLK1 */
...
uint32_t LL_RCC_GetI2CClockFreq(uint32_t I2CxSource)
{
	...
	if (I2CxSource == LL_RCC_I2C1_CLKSOURCE) {
		...
		if (I2CxSource == LL_RCC_I2C3_CLKSOURCE) {
			...
			switch (LL_RCC_GetI2CClockSource(I2CxSource)) {
				case LL_RCC_I2C3_CLKSOURCE_SYSCLK: /* I2C3 Clock
								      is System
								      Clock */
					i2c_frequency =
					    RCC_GetSystemClockFreq();
				...
				case LL_RCC_I2C3_CLKSOURCE_HSI: /* I2C3 Clock is
								   HSI Osc. */
					if (LL_RCC_HSI_IsReady() != 0U) {
						i2c_frequency = HSI_VALUE;
					}
				...
				case LL_RCC_I2C3_CLKSOURCE_PCLK1: /* I2C3 Clock
								   * is PCLK1
								   */
			...
			if (I2CxSource == LL_RCC_I2C4_CLKSOURCE) {
				...
				switch (LL_RCC_GetI2CClockSource(I2CxSource)) {
					case LL_RCC_I2C4_CLKSOURCE_SYSCLK: /* I2C4
									      Clock
									      is
									      System
									      Clock
					...
					case LL_RCC_I2C4_CLKSOURCE_HSI: /* I2C4
									   Clock
									   is
									   HSI
									   Osc.
					...
					case LL_RCC_I2C4_CLKSOURCE_PCLK1: /* I2C4
									     Clock
									     is
									     PCLK1
									   */
...
uint32_t LL_RCC_GetLPTIMClockFreq(uint32_t LPTIMxSource)
{
	...
	if (LPTIMxSource == LL_RCC_LPTIM1_CLKSOURCE) {
		...
		switch (LL_RCC_GetLPTIMClockSource(LPTIMxSource)) {
			...
			case LL_RCC_LPTIM1_CLKSOURCE_PCLK1: /* LPTIM1 Clock is
							       PCLK1 */
				lptim_frequency =
				    RCC_GetPCLK1ClockFreq(RCC_GetHCLKClockFreq(
					RCC_GetSystemClockFreq()));
		...
		if (LPTIMxSource == LL_RCC_LPTIM2_CLKSOURCE) {
			...
			switch (LL_RCC_GetLPTIMClockSource(LPTIMxSource)) {
				case LL_RCC_LPTIM2_CLKSOURCE_LSI: /* LPTIM2
								     Clock is
								     LSI Osc. */
					if (LL_RCC_LSI_IsReady() != 0U) {
#if defined(RCC_CSR_LSIPREDIV)
				...
				case LL_RCC_LPTIM2_CLKSOURCE_HSI: /* LPTIM2
								     Clock is
								     HSI Osc. */
					if (LL_RCC_HSI_IsReady() != 0U) {
						lptim_frequency = HSI_VALUE;
				...
				case LL_RCC_LPTIM2_CLKSOURCE_LSE: /* LPTIM2
								     Clock is
								     LSE Osc. */
					if (LL_RCC_LSE_IsReady() != 0U) {
						lptim_frequency = LSE_VALUE;
				...
				case LL_RCC_LPTIM2_CLKSOURCE_PCLK1: /* LPTIM2
								       Clock is
								       PCLK1 */
...
uint32_t LL_RCC_GetSAIClockFreq(uint32_t SAIxSource)
{
	...
	if (SAIxSource == LL_RCC_SAI1_CLKSOURCE) {
		...
		switch (LL_RCC_GetSAIClockSource(SAIxSource)) {
			case LL_RCC_SAI1_CLKSOURCE_PLLSAI1: /* PLLSAI1 clock
							       used as SAI1
							       clock source */
				if (LL_RCC_PLLSAI1_IsReady() != 0U) {
					if (LL_RCC_PLLSAI1_IsEnabledDomain_SAI() !=
					    0U) {
						sai_frequency =
...
#if defined(RCC_PLLSAI2_SUPPORT)
			case LL_RCC_SAI1_CLKSOURCE_PLLSAI2: /* PLLSAI2 clock
							       used as SAI1
							       clock source */
				if (LL_RCC_PLLSAI2_IsReady() != 0U) {
					if (LL_RCC_PLLSAI2_IsEnabledDomain_SAI() !=
					    0U) {
						sai_frequency =
...
#endif /* RCC_PLLSAI2_SUPPORT */
			case LL_RCC_SAI1_CLKSOURCE_PLL: /* PLL clock used as
							   SAI1 clock source */
				if (LL_RCC_PLL_IsReady() != 0U) {
					if (LL_RCC_PLL_IsEnabledDomain_SAI() !=
					    0U) {
						sai_frequency =
		...
		if (SAIxSource == LL_RCC_SAI2_CLKSOURCE) {
			...
			switch (LL_RCC_GetSAIClockSource(SAIxSource)) {
				case LL_RCC_SAI2_CLKSOURCE_PLLSAI1: /* PLLSAI1
								       clock
								       used as
								       SAI2
								       clock
...
#if defined(RCC_PLLSAI2_SUPPORT)
				case LL_RCC_SAI2_CLKSOURCE_PLLSAI2: /* PLLSAI2
								       clock
								       used as
								       SAI2
								       clock
...
#endif /* RCC_PLLSAI2_SUPPORT */
				case LL_RCC_SAI2_CLKSOURCE_PLL: /* PLL clock
								   used as SAI2
								   clock source
								 */
					if (LL_RCC_PLL_IsReady() != 0U) {
				...
				case LL_RCC_SAI2_CLKSOURCE_PIN: /* External
								   input clock
								   used as SAI2
								   clock source
								 */
...
#endif /* RCC_CCIPR_SAI1SEL || RCC_CCIPR_SAI2SEL || RCC_CCIPR2_SAI1SEL ||      \
	  RCC_CCIPR2_SAI2SEL*/
...
uint32_t LL_RCC_GetSDMMCKernelClockFreq(uint32_t SDMMCxSource)
{
	...
	switch (LL_RCC_GetSDMMCKernelClockSource(SDMMCxSource)) {
		case LL_RCC_SDMMC1_KERNELCLKSOURCE_48CLK: /* 48MHz clock from
							     internal
							     multiplexor used as
							     SDMMC1 clock source
							   */
		...
		case LL_RCC_SDMMC1_KERNELCLKSOURCE_PLLP: /* PLL "P" output
							    (PLLSAI3CLK) clock
							    used as SDMMC1 clock
							    source */
			if (LL_RCC_PLL_IsReady() != 0U) {
...
uint32_t LL_RCC_GetSDMMCClockFreq(uint32_t SDMMCxSource)
{
	...
	switch (LL_RCC_GetSDMMCClockSource(SDMMCxSource)) {
		...
		case LL_RCC_SDMMC1_CLKSOURCE_PLLSAI1: /* PLLSAI1 clock used as
							 SDMMC1 clock source */
			if (LL_RCC_PLLSAI1_IsReady() != 0U) {
				if (LL_RCC_PLLSAI1_IsEnabledDomain_48M() !=
				    0U) {
					sdmmc_frequency =
		...
		case LL_RCC_SDMMC1_CLKSOURCE_PLL: /* PLL clock used as SDMMC1
						     clock source */
			if (LL_RCC_PLL_IsReady() != 0U) {
		...
		case LL_RCC_SDMMC1_CLKSOURCE_MSI: /* MSI clock used as SDMMC1
						     clock source */
			if (LL_RCC_MSI_IsReady() != 0U) {
				sdmmc_frequency = __LL_RCC_CALC_MSI_FREQ(
...
#if defined(RCC_HSI48_SUPPORT)
		case LL_RCC_SDMMC1_CLKSOURCE_HSI48: /* HSI48 used as SDMMC1
						     * clock source
						     */
			...
			break;
#else
		case LL_RCC_SDMMC1_CLKSOURCE_NONE: /* No clock used as SDMMC1
						      clock source */
#endif
		default:
			sdmmc_frequency = LL_RCC_PERIPH_FREQUENCY_NA;
...
uint32_t LL_RCC_GetRNGClockFreq(uint32_t RNGxSource)
{
	...
	switch (LL_RCC_GetRNGClockSource(RNGxSource)) {
#if defined(RCC_PLLSAI1_SUPPORT)
		case LL_RCC_RNG_CLKSOURCE_PLLSAI1: /* PLLSAI1 clock used as RNG
						      clock source */
			if (LL_RCC_PLLSAI1_IsReady() != 0U) {
				if (LL_RCC_PLLSAI1_IsEnabledDomain_48M() !=
				    0U) {
		...
		case LL_RCC_RNG_CLKSOURCE_PLL: /* PLL clock used as RNG clock
						  source */
			if (LL_RCC_PLL_IsReady() != 0U) {
				if (LL_RCC_PLL_IsEnabledDomain_48M() != 0U) {
					rng_frequency =
		...
		case LL_RCC_RNG_CLKSOURCE_MSI: /* MSI clock used as RNG clock
						  source */
			if (LL_RCC_MSI_IsReady() != 0U) {
				rng_frequency = __LL_RCC_CALC_MSI_FREQ(
				    LL_RCC_MSI_IsEnabledRangeSelect(),
				    ((LL_RCC_MSI_IsEnabledRangeSelect() != 0U)
					 ? LL_RCC_MSI_GetRange()
					 : LL_RCC_MSI_GetRangeAfterStandby()));
...
#if defined(RCC_HSI48_SUPPORT)
		case LL_RCC_RNG_CLKSOURCE_HSI48: /* HSI48 used as RNG clock
						    source */
			if (LL_RCC_HSI48_IsReady() != 0U) {
			...
			break;
#else
		case LL_RCC_RNG_CLKSOURCE_NONE: /* No clock used as RNG clock
						   source */
#endif
		default:
...
uint32_t LL_RCC_GetUSBClockFreq(uint32_t USBxSource)
{
	...
	switch (LL_RCC_GetUSBClockSource(USBxSource)) {
#if defined(RCC_PLLSAI1_SUPPORT)
		case LL_RCC_USB_CLKSOURCE_PLLSAI1: /* PLLSAI1 clock used as USB
						      clock source */
			if (LL_RCC_PLLSAI1_IsReady() != 0U) {
				if (LL_RCC_PLLSAI1_IsEnabledDomain_48M() !=
				    0U) {
		...
		case LL_RCC_USB_CLKSOURCE_PLL: /* PLL clock used as USB clock
						  source */
			if (LL_RCC_PLL_IsReady() != 0U) {
				if (LL_RCC_PLL_IsEnabledDomain_48M() != 0U) {
					usb_frequency =
		...
		case LL_RCC_USB_CLKSOURCE_MSI: /* MSI clock used as USB clock
						  source */
			if (LL_RCC_MSI_IsReady() != 0U) {
				usb_frequency = __LL_RCC_CALC_MSI_FREQ(
				    LL_RCC_MSI_IsEnabledRangeSelect(),
				    ((LL_RCC_MSI_IsEnabledRangeSelect() != 0U)
					 ? LL_RCC_MSI_GetRange()
					 : LL_RCC_MSI_GetRangeAfterStandby()));
...
#if defined(RCC_HSI48_SUPPORT)
		case LL_RCC_USB_CLKSOURCE_HSI48: /* HSI48 used as USB clock
						    source */
			if (LL_RCC_HSI48_IsReady() != 0U) {
			...
			break;
#else
		case LL_RCC_USB_CLKSOURCE_NONE: /* No clock used as USB clock
						   source */
#endif
		default:
...
uint32_t LL_RCC_GetADCClockFreq(uint32_t ADCxSource)
{
	...
	switch (LL_RCC_GetADCClockSource(ADCxSource)) {
#if defined(RCC_PLLSAI1_SUPPORT)
		case LL_RCC_ADC_CLKSOURCE_PLLSAI1: /* PLLSAI1 clock used as ADC
						      clock source */
			if (LL_RCC_PLLSAI1_IsReady() != 0U) {
		...
		case LL_RCC_ADC_CLKSOURCE_PLLSAI2: /* PLLSAI2 clock used as ADC
						      clock source */
			if (LL_RCC_PLLSAI2_IsReady() != 0U) {
				if (LL_RCC_PLLSAI2_IsEnabledDomain_ADC() !=
				    0U) {
					adc_frequency =
		...
		case LL_RCC_ADC_CLKSOURCE_SYSCLK: /* SYSCLK clock used as ADC
						     clock source */
			adc_frequency = RCC_GetSystemClockFreq();
			break;

		case LL_RCC_ADC_CLKSOURCE_NONE: /* No clock used as ADC clock
						   source */
		default:
 ...
 *         - @ref  LL_RCC_PERIPH_FREQUENCY_NO indicates that oscillator (HSI) is
 * not ready
 */
uint32_t LL_RCC_GetSWPMIClockFreq(uint32_t SWPMIxSource)
{
	...
	switch (LL_RCC_GetSWPMIClockSource(SWPMIxSource)) {
		...
		case LL_RCC_SWPMI1_CLKSOURCE_PCLK1: /* SWPMI1 Clock is PCLK1 */
			swpmi_frequency = RCC_GetPCLK1ClockFreq(
			    RCC_GetHCLKClockFreq(RCC_GetSystemClockFreq()));
			break;
...
uint32_t LL_RCC_GetDFSDMClockFreq(uint32_t DFSDMxSource)
{
	...
	switch (LL_RCC_GetDFSDMClockSource(DFSDMxSource)) {
		...
		case LL_RCC_DFSDM1_CLKSOURCE_PCLK2: /* DFSDM1 Clock is PCLK2 */
			dfsdm_frequency = RCC_GetPCLK2ClockFreq(
			    RCC_GetHCLKClockFreq(RCC_GetSystemClockFreq()));
			break;
...
uint32_t LL_RCC_GetDFSDMAudioClockFreq(uint32_t DFSDMxSource)
{
	...
	switch (LL_RCC_GetDFSDMAudioClockSource(DFSDMxSource)) {
		case LL_RCC_DFSDM1_AUDIO_CLKSOURCE_SAI1: /* SAI1 clock used as
							    DFSDM1 audio clock
							  */
			dfsdm_frequency =
		...
		case LL_RCC_DFSDM1_AUDIO_CLKSOURCE_MSI: /* MSI clock used as
							   DFSDM1 audio clock */
			if (LL_RCC_MSI_IsReady() != 0U) {
				dfsdm_frequency = __LL_RCC_CALC_MSI_FREQ(
				    LL_RCC_MSI_IsEnabledRangeSelect(),
				    ((LL_RCC_MSI_IsEnabledRangeSelect() != 0U)
					 ? LL_RCC_MSI_GetRange()
					 : LL_RCC_MSI_GetRangeAfterStandby()));
		...
		case LL_RCC_DFSDM1_AUDIO_CLKSOURCE_HSI: /* HSI clock used as
							   DFSDM1 audio clock */
		default:
			if (LL_RCC_HSI_IsReady() != 0U) {
...
uint32_t LL_RCC_GetDSIClockFreq(uint32_t DSIxSource)
{
	...
	switch (LL_RCC_GetDSIClockSource(DSIxSource)) {
		case LL_RCC_DSI_CLKSOURCE_PLL: /* DSI Clock is PLLSAI2 Osc. */
			if (LL_RCC_PLLSAI2_IsReady() != 0U) {
				if (LL_RCC_PLLSAI2_IsEnabledDomain_DSI() !=
				    0U) {
					dsi_frequency =
		...
		case LL_RCC_DSI_CLKSOURCE_PHY: /* DSI Clock is DSI physical
						  clock. */
		default:
 ...
 *         - @ref  LL_RCC_PERIPH_FREQUENCY_NO indicates that oscillator PLLSAI
 * is not ready
 */
...
uint32_t LL_RCC_GetOCTOSPIClockFreq(uint32_t OCTOSPIxSource)
{
	...
	switch (LL_RCC_GetOCTOSPIClockSource(OCTOSPIxSource)) {
		...
		case LL_RCC_OCTOSPI_CLKSOURCE_MSI: /* MSI clock used as OCTOSPI
						      clock */
			if (LL_RCC_MSI_IsReady() != 0U) {
				octospi_frequency = __LL_RCC_CALC_MSI_FREQ(
				    LL_RCC_MSI_IsEnabledRangeSelect(),
				    ((LL_RCC_MSI_IsEnabledRangeSelect() != 0U)
					 ? LL_RCC_MSI_GetRange()
					 : LL_RCC_MSI_GetRangeAfterStandby()));
		...
		case LL_RCC_OCTOSPI_CLKSOURCE_PLL: /* PLL clock used as OCTOSPI
						    * source
						    */
			if (LL_RCC_PLL_IsReady() != 0U) {
				if (LL_RCC_PLL_IsEnabledDomain_48M() != 0U) {
...
static uint32_t RCC_GetSystemClockFreq(void)
{
	...
	switch (LL_RCC_GetSysClkSource()) {
		case LL_RCC_SYS_CLKSOURCE_STATUS_MSI: /* MSI used as system
						       * clock source
						       */
			frequency = __LL_RCC_CALC_MSI_FREQ(
			    LL_RCC_MSI_IsEnabledRangeSelect(),
			    ((LL_RCC_MSI_IsEnabledRangeSelect() != 0U)
				 ? LL_RCC_MSI_GetRange()
				 : LL_RCC_MSI_GetRangeAfterStandby()));
		...
		case LL_RCC_SYS_CLKSOURCE_STATUS_PLL: /* PLL used as system
						       * clock source
						       */
	...
	*/
	...
	switch (pllsource) {
		case LL_RCC_PLLSOURCE_MSI: /* MSI used as PLL clock source */
			pllinputfreq = __LL_RCC_CALC_MSI_FREQ(
			    LL_RCC_MSI_IsEnabledRangeSelect(),
			    ((LL_RCC_MSI_IsEnabledRangeSelect() != 0U)
				 ? LL_RCC_MSI_GetRange()
				 : LL_RCC_MSI_GetRangeAfterStandby()));
...
static uint32_t RCC_PLL_GetFreqDomain_SAI(void)
{
	...
	*/
	...
	return __LL_RCC_CALC_PLLCLK_SAI_FREQ(
...
static uint32_t RCC_PLL_GetFreqDomain_48M(void)
{
	...
	*/
	...
	return __LL_RCC_CALC_PLLCLK_48M_FREQ(
	    pllinputfreq, LL_RCC_PLL_GetDivider(), LL_RCC_PLL_GetN(),
	    LL_RCC_PLL_GetQ());
}
#if defined(DSI)
...
static uint32_t RCC_PLLSAI2_GetFreqDomain_DSI(void)
{
	...
	/* PLLSAI2_VCO = (HSE_VALUE or HSI_VALUE or MSI_VALUE/ PLLSAI2M) *
	 * PLLSAI2N */
	...
	return __LL_RCC_CALC_PLLSAI2_DSI_FREQ(
	    pllinputfreq, LL_RCC_PLLSAI2_GetDivider(), LL_RCC_PLLSAI2_GetN(),
	    LL_RCC_PLLSAI2_GetR());
}
#endif /* DSI */
...
static uint32_t RCC_PLLSAI1_GetFreqDomain_SAI(void)
{
	...
	/* PLLSAI1_VCO = (HSE_VALUE or HSI_VALUE or MSI_VALUE/ PLLSAI1M) *
	 * PLLSAI1N */
#else
	...
	return __LL_RCC_CALC_PLLSAI1_SAI_FREQ(
	    pllinputfreq, LL_RCC_PLL_GetDivider(), LL_RCC_PLLSAI1_GetN(),
	    LL_RCC_PLLSAI1_GetP());
}
...
static uint32_t RCC_PLLSAI1_GetFreqDomain_48M(void)
{
	...
	return __LL_RCC_CALC_PLLSAI1_48M_FREQ(
	    pllinputfreq, LL_RCC_PLL_GetDivider(), LL_RCC_PLLSAI1_GetN(),
	    LL_RCC_PLLSAI1_GetQ());
}
...
static uint32_t RCC_PLLSAI1_GetFreqDomain_ADC(void)
{
	...
	return __LL_RCC_CALC_PLLSAI1_ADC_FREQ(
	    pllinputfreq, LL_RCC_PLL_GetDivider(), LL_RCC_PLLSAI1_GetN(),
	    LL_RCC_PLLSAI1_GetR());
}
#endif /* RCC_PLLSAI1_SUPPORT */
...
#if defined(RCC_PLLSAI2M_DIV_1_16_SUPPORT)
	return __LL_RCC_CALC_PLLSAI2_SAI_FREQ(
	    pllinputfreq, LL_RCC_PLLSAI2_GetDivider(), LL_RCC_PLLSAI2_GetN(),
	    LL_RCC_PLLSAI2_GetP());
#else
	return __LL_RCC_CALC_PLLSAI2_SAI_FREQ(
	    pllinputfreq, LL_RCC_PLL_GetDivider(), LL_RCC_PLLSAI2_GetN(),
	    LL_RCC_PLLSAI2_GetP());
#endif
}
...
static uint32_t RCC_PLLSAI2_GetFreqDomain_LTDC(void)
{
	...
	return __LL_RCC_CALC_PLLSAI2_LTDC_FREQ(
	    pllinputfreq, LL_RCC_PLLSAI2_GetDivider(), LL_RCC_PLLSAI2_GetN(),
	    LL_RCC_PLLSAI2_GetR(), LL_RCC_PLLSAI2_GetDIVR());
}
...
static uint32_t RCC_PLLSAI2_GetFreqDomain_ADC(void)
{
	...
	return __LL_RCC_CALC_PLLSAI2_ADC_FREQ(
	    pllinputfreq, LL_RCC_PLL_GetDivider(), LL_RCC_PLLSAI2_GetN(),
	    LL_RCC_PLLSAI2_GetR());
}
#endif /* LTDC */
