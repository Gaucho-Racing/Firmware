...
#define DSI_FLOW_CONTROL_ALL (DSI_FLOW_CONTROL_CRC_RX | DSI_FLOW_CONTROL_ECC_RX | DSI_FLOW_CONTROL_BTA | DSI_FLOW_CONTROL_EOTP_RX | DSI_FLOW_CONTROL_EOTP_TX)
/**
 * @}
 */
...
#define IS_DSI_PLL_IDF(IDF)                                                                                                                                                                            \
	(((IDF) == DSI_PLL_IN_DIV1) || ((IDF) == DSI_PLL_IN_DIV2) || ((IDF) == DSI_PLL_IN_DIV3) || ((IDF) == DSI_PLL_IN_DIV4) || ((IDF) == DSI_PLL_IN_DIV5) || ((IDF) == DSI_PLL_IN_DIV6) ||           \
	 ((IDF) == DSI_PLL_IN_DIV7))
...
#define IS_DSI_PHY_TIMING(Timing)                                                                                                                                                                      \
	(((Timing) == DSI_TCLK_POST) || ((Timing) == DSI_TLPX_CLK) || ((Timing) == DSI_THS_EXIT) || ((Timing) == DSI_TLPX_DATA) || ((Timing) == DSI_THS_ZERO) || ((Timing) == DSI_THS_TRAIL) ||        \
