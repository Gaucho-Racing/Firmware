...
extern "C" {
    ...
    defined(STM32L496xx) || defined(STM32L4A6xx) || defined(STM32L4R5xx) || defined(STM32L4R7xx) || defined(STM32L4R9xx) || defined(STM32L4S5xx) || defined(STM32L4S7xx) || defined(STM32L4S9xx) ||    \
...
#if defined(STM32L451xx) || defined(STM32L452xx) || defined(STM32L462xx) || defined(STM32L496xx) || defined(STM32L4A6xx) || defined(STM32L4R5xx) || defined(STM32L4R7xx) || defined(STM32L4R9xx) ||    \
    defined(STM32L4S5xx) || defined(STM32L4S7xx) || defined(STM32L4S9xx) || defined(STM32L4P5xx) || defined(STM32L4Q5xx)
#define DFSDM_CHANNEL_ADC_OUTPUT DFSDM_CHCFGR1_DATMPX_0 /*!< Data are taken from ADC output */
#endif /* STM32L451xx || STM32L452xx || STM32L462xx || STM32L496xx || STM32L4A6xx || STM32L4R5xx || STM32L4R7xx || STM32L4R9xx || STM32L4S5xx || STM32L4S7xx || STM32L4S9xx || STM32L4P5xx ||          \
	  STM32L4Q5xx */
...
#elif defined(STM32L4R5xx) || defined(STM32L4R7xx) || defined(STM32L4R9xx) || defined(STM32L4S5xx) || defined(STM32L4S7xx) || defined(STM32L4S9xx) || defined(STM32L4P5xx) || defined(STM32L4Q5xx)
...
#define DFSDM_FILTER_EXT_TRIG_TIM6_TRGO (DFSDM_FLTCR1_JEXTSEL_0 | DFSDM_FLTCR1_JEXTSEL_1 | DFSDM_FLTCR1_JEXTSEL_2)  /*!< For all DFSDM filters */
...
#define DFSDM_FILTER_EXT_TRIG_EXTI15 (DFSDM_FLTCR1_JEXTSEL_0 | DFSDM_FLTCR1_JEXTSEL_3 | DFSDM_FLTCR1_JEXTSEL_4)	    /*!< For all DFSDM filters */
#define DFSDM_FILTER_EXT_TRIG_LPTIM1_OUT (DFSDM_FLTCR1_JEXTSEL_1 | DFSDM_FLTCR1_JEXTSEL_3 | DFSDM_FLTCR1_JEXTSEL_4) /*!< For all DFSDM filters */
#else
#define DFSDM_FILTER_EXT_TRIG_TIM1_TRGO 0x00000000U					   /*!< For DFSDM filter 0, 1, 2 and 3 */
#define DFSDM_FILTER_EXT_TRIG_TIM1_TRGO2 DFSDM_FLTCR1_JEXTSEL_0				   /*!< For DFSDM filter 0, 1, 2 and 3 */
 ...
 * @{
 */
#define IS_DFSDM_CHANNEL_OUTPUT_CLOCK(CLOCK) (((CLOCK) == DFSDM_CHANNEL_OUTPUT_CLOCK_SYSTEM) || ((CLOCK) == DFSDM_CHANNEL_OUTPUT_CLOCK_AUDIO))
#define IS_DFSDM_CHANNEL_OUTPUT_CLOCK_DIVIDER(DIVIDER) ((2U <= (DIVIDER)) && ((DIVIDER) <= 256U))
#if defined(STM32L451xx) || defined(STM32L452xx) || defined(STM32L462xx) || defined(STM32L496xx) || defined(STM32L4A6xx) || defined(STM32L4R5xx) || defined(STM32L4R7xx) || defined(STM32L4R9xx) ||    \
    defined(STM32L4S5xx) || defined(STM32L4S7xx) || defined(STM32L4S9xx) || defined(STM32L4P5xx) || defined(STM32L4Q5xx)
#define IS_DFSDM_CHANNEL_INPUT(INPUT) (((INPUT) == DFSDM_CHANNEL_EXTERNAL_INPUTS) || ((INPUT) == DFSDM_CHANNEL_ADC_OUTPUT) || ((INPUT) == DFSDM_CHANNEL_INTERNAL_REGISTER))
#else
#define IS_DFSDM_CHANNEL_INPUT(INPUT) (((INPUT) == DFSDM_CHANNEL_EXTERNAL_INPUTS) || ((INPUT) == DFSDM_CHANNEL_INTERNAL_REGISTER))
#endif /* STM32L451xx || STM32L452xx || STM32L462xx || */
/* STM32L496xx || STM32L4A6xx || */
/* STM32L4R5xx || STM32L4R7xx || STM32L4R9xx || STM32L4S5xx || STM32L4S7xx || STM32L4S9xx || */
/* STM32L4P5xx || STM32L4Q5xx || */
#define IS_DFSDM_CHANNEL_DATA_PACKING(MODE) (((MODE) == DFSDM_CHANNEL_STANDARD_MODE) || ((MODE) == DFSDM_CHANNEL_INTERLEAVED_MODE) || ((MODE) == DFSDM_CHANNEL_DUAL_MODE))
#define IS_DFSDM_CHANNEL_INPUT_PINS(PINS) (((PINS) == DFSDM_CHANNEL_SAME_CHANNEL_PINS) || ((PINS) == DFSDM_CHANNEL_FOLLOWING_CHANNEL_PINS))
#define IS_DFSDM_CHANNEL_SERIAL_INTERFACE_TYPE(MODE)                                                                                                                                                   \
	(((MODE) == DFSDM_CHANNEL_SPI_RISING) || ((MODE) == DFSDM_CHANNEL_SPI_FALLING) || ((MODE) == DFSDM_CHANNEL_MANCHESTER_RISING) || ((MODE) == DFSDM_CHANNEL_MANCHESTER_FALLING))
#define IS_DFSDM_CHANNEL_SPI_CLOCK(TYPE)                                                                                                                                                               \
	(((TYPE) == DFSDM_CHANNEL_SPI_CLOCK_EXTERNAL) || ((TYPE) == DFSDM_CHANNEL_SPI_CLOCK_INTERNAL) || ((TYPE) == DFSDM_CHANNEL_SPI_CLOCK_INTERNAL_DIV2_FALLING) ||                                  \
	 ((TYPE) == DFSDM_CHANNEL_SPI_CLOCK_INTERNAL_DIV2_RISING))
#define IS_DFSDM_CHANNEL_FILTER_ORDER(ORDER)                                                                                                                                                           \
	(((ORDER) == DFSDM_CHANNEL_FASTSINC_ORDER) || ((ORDER) == DFSDM_CHANNEL_SINC1_ORDER) || ((ORDER) == DFSDM_CHANNEL_SINC2_ORDER) || ((ORDER) == DFSDM_CHANNEL_SINC3_ORDER))
...
#define IS_DFSDM_FILTER_INJ_TRIGGER(TRIG) (((TRIG) == DFSDM_FILTER_SW_TRIGGER) || ((TRIG) == DFSDM_FILTER_SYNC_TRIGGER) || ((TRIG) == DFSDM_FILTER_EXT_TRIGGER))
#if defined(STM32L451xx) || defined(STM32L452xx) || defined(STM32L462xx)
#define IS_DFSDM_FILTER_EXT_TRIG(TRIG)                                                                                                                                                                 \
	(((TRIG) == DFSDM_FILTER_EXT_TRIG_TIM1_TRGO) || ((TRIG) == DFSDM_FILTER_EXT_TRIG_TIM1_TRGO2) || ((TRIG) == DFSDM_FILTER_EXT_TRIG_TIM3_TRGO) || ((TRIG) == DFSDM_FILTER_EXT_TRIG_TIM16_OC1) ||  \
	 ((TRIG) == DFSDM_FILTER_EXT_TRIG_TIM6_TRGO) || ((TRIG) == DFSDM_FILTER_EXT_TRIG_EXTI11) || ((TRIG) == DFSDM_FILTER_EXT_TRIG_EXTI15))
#elif defined(STM32L4R5xx) || defined(STM32L4R7xx) || defined(STM32L4R9xx) || defined(STM32L4S5xx) || defined(STM32L4S7xx) || defined(STM32L4S9xx) || defined(STM32L4P5xx) || defined(STM32L4Q5xx)
#define IS_DFSDM_FILTER_EXT_TRIG(TRIG)                                                                                                                                                                 \
	(((TRIG) == DFSDM_FILTER_EXT_TRIG_TIM1_TRGO) || ((TRIG) == DFSDM_FILTER_EXT_TRIG_TIM1_TRGO2) || ((TRIG) == DFSDM_FILTER_EXT_TRIG_TIM8_TRGO) || ((TRIG) == DFSDM_FILTER_EXT_TRIG_TIM8_TRGO2) || \
	 ((TRIG) == DFSDM_FILTER_EXT_TRIG_TIM3_TRGO) || ((TRIG) == DFSDM_FILTER_EXT_TRIG_TIM4_TRGO) || ((TRIG) == DFSDM_FILTER_EXT_TRIG_TIM16_OC1) || ((TRIG) == DFSDM_FILTER_EXT_TRIG_TIM6_TRGO) ||   \
	 ((TRIG) == DFSDM_FILTER_EXT_TRIG_TIM7_TRGO) || ((TRIG) == DFSDM_FILTER_EXT_TRIG_EXTI11) || ((TRIG) == DFSDM_FILTER_EXT_TRIG_EXTI15) || ((TRIG) == DFSDM_FILTER_EXT_TRIG_LPTIM1_OUT))
#else
#define IS_DFSDM_FILTER_EXT_TRIG(TRIG)                                                                                                                                                                 \
	(((TRIG) == DFSDM_FILTER_EXT_TRIG_TIM1_TRGO) || ((TRIG) == DFSDM_FILTER_EXT_TRIG_TIM1_TRGO2) || ((TRIG) == DFSDM_FILTER_EXT_TRIG_TIM8_TRGO) || ((TRIG) == DFSDM_FILTER_EXT_TRIG_TIM8_TRGO2) || \
	 ((TRIG) == DFSDM_FILTER_EXT_TRIG_TIM3_TRGO) || ((TRIG) == DFSDM_FILTER_EXT_TRIG_TIM4_TRGO) || ((TRIG) == DFSDM_FILTER_EXT_TRIG_TIM16_OC1) || ((TRIG) == DFSDM_FILTER_EXT_TRIG_TIM6_TRGO) ||   \
	 ((TRIG) == DFSDM_FILTER_EXT_TRIG_TIM7_TRGO) || ((TRIG) == DFSDM_FILTER_EXT_TRIG_EXTI11) || ((TRIG) == DFSDM_FILTER_EXT_TRIG_EXTI15))
#endif /* STM32L451xx || STM32L452xx || STM32L462xx */
#define IS_DFSDM_FILTER_EXT_TRIG_EDGE(EDGE) (((EDGE) == DFSDM_FILTER_EXT_TRIG_RISING_EDGE) || ((EDGE) == DFSDM_FILTER_EXT_TRIG_FALLING_EDGE) || ((EDGE) == DFSDM_FILTER_EXT_TRIG_BOTH_EDGES))
#define IS_DFSDM_FILTER_SINC_ORDER(ORDER)                                                                                                                                                              \
	(((ORDER) == DFSDM_FILTER_FASTSINC_ORDER) || ((ORDER) == DFSDM_FILTER_SINC1_ORDER) || ((ORDER) == DFSDM_FILTER_SINC2_ORDER) || ((ORDER) == DFSDM_FILTER_SINC3_ORDER) ||                        \
...
#define IS_DFSDM_FILTER_AWD_DATA_SOURCE(DATA) (((DATA) == DFSDM_FILTER_AWD_FILTER_DATA) || ((DATA) == DFSDM_FILTER_AWD_CHANNEL_DATA))
#define IS_DFSDM_FILTER_AWD_THRESHOLD(VALUE) ((-8388608 <= (VALUE)) && ((VALUE) <= 8388607))
#define IS_DFSDM_BREAK_SIGNALS(VALUE) ((VALUE) <= 0xFU)
#if defined(STM32L451xx) || defined(STM32L452xx) || defined(STM32L462xx) || defined(STM32L4P5xx) || defined(STM32L4Q5xx)
#define IS_DFSDM_REGULAR_CHANNEL(CHANNEL) (((CHANNEL) == DFSDM_CHANNEL_0) || ((CHANNEL) == DFSDM_CHANNEL_1) || ((CHANNEL) == DFSDM_CHANNEL_2) || ((CHANNEL) == DFSDM_CHANNEL_3))
#define IS_DFSDM_INJECTED_CHANNEL(CHANNEL) (((CHANNEL) != 0U) && ((CHANNEL) <= 0x0003000FU))
#else
#define IS_DFSDM_REGULAR_CHANNEL(CHANNEL)                                                                                                                                                              \
	(((CHANNEL) == DFSDM_CHANNEL_0) || ((CHANNEL) == DFSDM_CHANNEL_1) || ((CHANNEL) == DFSDM_CHANNEL_2) || ((CHANNEL) == DFSDM_CHANNEL_3) || ((CHANNEL) == DFSDM_CHANNEL_4) ||                     \
	 ((CHANNEL) == DFSDM_CHANNEL_5) || ((CHANNEL) == DFSDM_CHANNEL_6) || ((CHANNEL) == DFSDM_CHANNEL_7))
