...
#define DCMI_OEBS_EVEN                                                                                                                                                                                 \
	((uint32_t)DCMI_CR_OEBS) /*!< Interface captures second data from the                                                                                                                          \
...
#define DCMI_FLAG_FRAMEMI                                                                                                                                                                              \
	((uint32_t)DCMI_MIS_INDEX | DCMI_MIS_FRAME_MIS)		      /*!< DCMI Capture complete masked interrupt                                                                                      \
									 status      */
...
#define DCMI_FLAG_ERRMI                                                                                                                                                                                \
	((uint32_t)DCMI_MIS_INDEX | DCMI_MIS_ERR_MIS)			  /*!< DCMI Synchronization error masked interrupt                                                                             \
									     status */
...
#define IS_DCMI_CAPTURE_RATE(RATE) (((RATE) == DCMI_CR_ALL_FRAME) || ((RATE) == DCMI_CR_ALTERNATE_2_FRAME) || ((RATE) == DCMI_CR_ALTERNATE_4_FRAME))

#define IS_DCMI_EXTENDED_DATA(DATA) (((DATA) == DCMI_EXTEND_DATA_8B) || ((DATA) == DCMI_EXTEND_DATA_10B) || ((DATA) == DCMI_EXTEND_DATA_12B) || ((DATA) == DCMI_EXTEND_DATA_14B))

#define IS_DCMI_WINDOW_COORDINATE(COORDINATE) ((COORDINATE) <= DCMI_WINDOW_COORDINATE)

#define IS_DCMI_WINDOW_HEIGHT(HEIGHT) ((HEIGHT) <= DCMI_WINDOW_HEIGHT)

#define IS_DCMI_BYTE_SELECT_MODE(MODE) (((MODE) == DCMI_BSM_ALL) || ((MODE) == DCMI_BSM_OTHER) || ((MODE) == DCMI_BSM_ALTERNATE_4) || ((MODE) == DCMI_BSM_ALTERNATE_2))
