...
typedef struct {
	...
	uint32_t ClockBypass; /*!< Specifies whether the SDMMC Clock divider
				 bypass is enabled or disabled. This parameter
				 can be a value of @ref SDMMC_LL_Clock_Bypass */
...
#if defined(STM32L4P5xx) || defined(STM32L4Q5xx) || defined(STM32L4R5xx) || defined(STM32L4R7xx) || defined(STM32L4R9xx) || defined(STM32L4S5xx) || defined(STM32L4S7xx) || defined(STM32L4S9xx)
	uint32_t Transceiver; /*!< Specifies whether external Transceiver is
				 enabled or disabled. This parameter can be a
				 value of @ref SDMMC_LL_Transceiver */
#endif			      /* STM32L4P5xx || STM32L4Q5xx || STM32L4R5xx || STM32L4R7xx ||                                                                                                           \
				 STM32L4R9xx || STM32L4S5xx || STM32L4S7xx || STM32L4S9xx */
...
#define SDMMC_ERROR_BLOCK_LEN_ERR                                                                                                                                                                      \
	((uint32_t)0x00000080U) /*!< Transferred block length is not allowed                                                                                                                           \
...
#define SDMMC_ERROR_CARD_ECC_FAILED                                                                                                                                                                    \
	((uint32_t)0x00004000U)					/*!< Card internal ECC was applied but failed                                                                                          \
								   to correct the data  */
...
#define SDMMC_ERROR_STREAM_READ_UNDERRUN                                                                                                                                                               \
	((uint32_t)0x00020000U) /*!< The card could not sustain data reading                                                                                                                           \
				   in stream rmode       */
...
#define SDMMC_CMD_SET_REL_ADDR                                                                                                                                                                         \
	((uint8_t)3U)			/*!< Asks the card to publish a new relative address                                                                                                           \
					   (RCA).                                   */
#define SDMMC_CMD_SET_DSR ((uint8_t)4U) /*!< Programs the DSR of all cards. */
#define SDMMC_CMD_SDMMC_SEN_OP_COND                                                                                                                                                                    \
	((uint8_t)5U) /*!< Sends host capacity support information (HCS) and                                                                                                                           \
			 asks the accessed card to send its operating                                                                                                                                  \
...
#define SDMMC_CMD_SEL_DESEL_CARD                                                                                                                                                                       \
	((uint8_t)7U) /*!< Selects the card by its own relative address and                                                                                                                            \
			 gets deselected by any other address    */
#define SDMMC_CMD_HS_SEND_EXT_CSD                                                                                                                                                                      \
	((uint8_t)8U) /*!< Sends SD Memory Card interface condition, which                                                                                                                             \
			 includes host supply voltage information and asks the                                                                                                                         \
			 card whether card supports voltage. */
#define SDMMC_CMD_SEND_CSD                                                                                                                                                                             \
	((uint8_t)9U) /*!< Addressed card sends its card specific data (CSD)                                                                                                                           \
			 on the CMD line.                       */
#define SDMMC_CMD_SEND_CID                                                                                                                                                                             \
	((uint8_t)10U) /*!< Addressed card sends its card identification (CID)                                                                                                                         \
			  on the CMD line.                      */
#if defined(STM32L4P5xx) || defined(STM32L4Q5xx) || defined(STM32L4R5xx) || defined(STM32L4R7xx) || defined(STM32L4R9xx) || defined(STM32L4S5xx) || defined(STM32L4S7xx) || defined(STM32L4S9xx)
...
#define SDMMC_CMD_SET_BLOCKLEN                                                                                                                                                                         \
	((uint8_t)16U) /*!< Sets the block length (in bytes for SDSC) for all                                                                                                                          \
			  following block commands (read, write, lock).                                                                                                                                \
			  Default block length is fixed to 512 Bytes. Not                                                                                                                              \
			  effective for SDHS and SDXC. */
#define SDMMC_CMD_READ_SINGLE_BLOCK                                                                                                                                                                    \
	((uint8_t)17U) /*!< Reads single block of size selected by                                                                                                                                     \
			  SET_BLOCKLEN in case of SDSC, and a block of fixed                                                                                                                           \
			  512 bytes in case of SDHC and SDXC. */
#define SDMMC_CMD_READ_MULT_BLOCK                                                                                                                                                                      \
	((uint8_t)18U) /*!< Continuously transfers data blocks from card to                                                                                                                            \
			  host until interrupted by STOP_TRANSMISSION command.                                                                                                                         \
			*/
...
#define SDMMC_CMD_SET_WRITE_PROT                                                                                                                                                                       \
	((uint8_t)28U) /*!< Sets the write protection bit of the addressed                                                                                                                             \
			  group.                                    */
#define SDMMC_CMD_CLR_WRITE_PROT                                                                                                                                                                       \
	((uint8_t)29U) /*!< Clears the write protection bit of the addressed                                                                                                                           \
			  group.                                  */
...
#define SDMMC_CMD_SD_ERASE_GRP_START                                                                                                                                                                   \
	((uint8_t)32U) /*!< Sets the address of the first write block to be                                                                                                                            \
			  erased. (For SD card only).              */
...
#define SDMMC_CMD_ERASE_GRP_START                                                                                                                                                                      \
	((uint8_t)35U) /*!< Sets the address of the first write block to be                                                                                                                            \
			  erased. Reserved for each command system set by                                                                                                                              \
			  switch function command (CMD6). */
#define SDMMC_CMD_ERASE_GRP_END                                                                                                                                                                        \
	((uint8_t)36U)			      /*!< Sets the address of the last write block of the                                                                                                     \
						 continuous range to be erased. Reserved for each                                                                                                      \
						 command system set by switch function command                                                                                                         \
						 (CMD6).                  */
...
#define SDMMC_CMD_LOCK_UNLOCK                                                                                                                                                                          \
	((uint8_t)42U) /*!< Sets/resets the password or lock/unlock the card.                                                                                                                          \
			  The size of the data block is set by the                                                                                                                                     \
...
#define SDMMC_CMD_GEN_CMD                                                                                                                                                                              \
	((uint8_t)56U)			/*!< Used either to transfer a data block to the card                                                                                                          \
...
#define SDMMC_CMD_APP_SD_SET_BUSWIDTH                                                                                                                                                                  \
	((uint8_t)6U)			       /*!< (ACMD6) Defines the data bus width to be used for                                                                                                  \
						  data transfer. The allowed data bus widths are given                                                                                                 \
						  in SCR register. */
...
#define SDMMC_CMD_SD_APP_SEND_NUM_WRITE_BLOCKS                                                                                                                                                         \
	((uint8_t)22U) /*!< (ACMD22) Sends the number of the written (without                                                                                                                          \
			  errors) write blocks. Responds with 32bit+CRC data                                                                                                                           \
			  block. */
#define SDMMC_CMD_SD_APP_OP_COND                                                                                                                                                                       \
	((uint8_t)41U) /*!< (ACMD41) Sends host capacity support information                                                                                                                           \
			  (HCS) and asks the accessed card to send its                                                                                                                                 \
			  operating condition register (OCR) content in the                                                                                                                            \
...
#define SDMMC_CMD_MMC_SLEEP_AWAKE                                                                                                                                                                      \
	((uint8_t)5U) /*!< Toggle the device between Sleep state and Standby                                                                                                                           \
			 state.                                 */
...
#define IS_SDMMC_CLOCK_BYPASS(BYPASS) (((BYPASS) == SDMMC_CLOCK_BYPASS_DISABLE) || ((BYPASS) == SDMMC_CLOCK_BYPASS_ENABLE))
/**
 * @}
 */
#endif /* STM32L4P5xx || STM32L4Q5xx || STM32L4R5xx || STM32L4R7xx ||                                                                                                                                  \
...
#define IS_SDMMC_CLOCK_POWER_SAVE(SAVE) (((SAVE) == SDMMC_CLOCK_POWER_SAVE_DISABLE) || ((SAVE) == SDMMC_CLOCK_POWER_SAVE_ENABLE))
/**
 * @}
 */
...
#define IS_SDMMC_BUS_WIDE(WIDE) (((WIDE) == SDMMC_BUS_WIDE_1B) || ((WIDE) == SDMMC_BUS_WIDE_4B) || ((WIDE) == SDMMC_BUS_WIDE_8B))
/**
 * @}
 */
...
#define IS_SDMMC_SPEED_MODE(MODE)                                                                                                                                                                      \
	(((MODE) == SDMMC_SPEED_MODE_AUTO) || ((MODE) == SDMMC_SPEED_MODE_DEFAULT) || ((MODE) == SDMMC_SPEED_MODE_HIGH) || ((MODE) == SDMMC_SPEED_MODE_ULTRA) || ((MODE) == SDMMC_SPEED_MODE_DDR))
...
#define IS_SDMMC_HARDWARE_FLOW_CONTROL(CONTROL) (((CONTROL) == SDMMC_HARDWARE_FLOW_CONTROL_DISABLE) || ((CONTROL) == SDMMC_HARDWARE_FLOW_CONTROL_ENABLE))
/**
 * @}
 */
...
#define IS_SDMMC_RESPONSE(RESPONSE) (((RESPONSE) == SDMMC_RESPONSE_NO) || ((RESPONSE) == SDMMC_RESPONSE_SHORT) || ((RESPONSE) == SDMMC_RESPONSE_LONG))
/**
 * @}
 */
...
#define IS_SDMMC_RESP(RESP) (((RESP) == SDMMC_RESP1) || ((RESP) == SDMMC_RESP2) || ((RESP) == SDMMC_RESP3) || ((RESP) == SDMMC_RESP4))
...
#define IS_SDMMC_BLOCK_SIZE(SIZE)                                                                                                                                                                      \
	(((SIZE) == SDMMC_DATABLOCK_SIZE_1B) || ((SIZE) == SDMMC_DATABLOCK_SIZE_2B) || ((SIZE) == SDMMC_DATABLOCK_SIZE_4B) || ((SIZE) == SDMMC_DATABLOCK_SIZE_8B) ||                                   \
	 ((SIZE) == SDMMC_DATABLOCK_SIZE_16B) || ((SIZE) == SDMMC_DATABLOCK_SIZE_32B) || ((SIZE) == SDMMC_DATABLOCK_SIZE_64B) || ((SIZE) == SDMMC_DATABLOCK_SIZE_128B) ||                              \
	 ((SIZE) == SDMMC_DATABLOCK_SIZE_256B) || ((SIZE) == SDMMC_DATABLOCK_SIZE_512B) || ((SIZE) == SDMMC_DATABLOCK_SIZE_1024B) || ((SIZE) == SDMMC_DATABLOCK_SIZE_2048B) ||                         \
	 ((SIZE) == SDMMC_DATABLOCK_SIZE_4096B) || ((SIZE) == SDMMC_DATABLOCK_SIZE_8192B) || ((SIZE) == SDMMC_DATABLOCK_SIZE_16384B))
/**
 * @}
 */
...
#define SDMMC_STATIC_FLAGS                                                                                                                                                                             \
	((uint32_t)(SDMMC_FLAG_CCRCFAIL | SDMMC_FLAG_DCRCFAIL | SDMMC_FLAG_CTIMEOUT | SDMMC_FLAG_DTIMEOUT | SDMMC_FLAG_TXUNDERR | SDMMC_FLAG_RXOVERR | SDMMC_FLAG_CMDREND | SDMMC_FLAG_CMDSENT |       \
		    SDMMC_FLAG_DATAEND | SDMMC_FLAG_DHOLD | SDMMC_FLAG_DBCKEND | SDMMC_FLAG_DABORT | SDMMC_FLAG_BUSYD0END | SDMMC_FLAG_SDIOIT | SDMMC_FLAG_ACKFAIL | SDMMC_FLAG_ACKTIMEOUT |           \
		    SDMMC_FLAG_VSWEND | SDMMC_FLAG_CKSTOP | SDMMC_FLAG_IDMATE | SDMMC_FLAG_IDMABTC))

#define SDMMC_STATIC_CMD_FLAGS ((uint32_t)(SDMMC_FLAG_CCRCFAIL | SDMMC_FLAG_CTIMEOUT | SDMMC_FLAG_CMDREND | SDMMC_FLAG_CMDSENT | SDMMC_FLAG_BUSYD0END))

#define SDMMC_STATIC_DATA_FLAGS                                                                                                                                                                        \
	((uint32_t)(SDMMC_FLAG_DCRCFAIL | SDMMC_FLAG_DTIMEOUT | SDMMC_FLAG_TXUNDERR | SDMMC_FLAG_RXOVERR | SDMMC_FLAG_DATAEND | SDMMC_FLAG_DHOLD | SDMMC_FLAG_DBCKEND | SDMMC_FLAG_DABORT |            \
...
#define SDMMC_STATIC_CMD_FLAGS ((uint32_t)(SDMMC_FLAG_CCRCFAIL | SDMMC_FLAG_CTIMEOUT | SDMMC_FLAG_CMDREND | SDMMC_FLAG_CMDSENT))

#define SDMMC_STATIC_DATA_FLAGS ((uint32_t)(SDMMC_FLAG_DCRCFAIL | SDMMC_FLAG_DTIMEOUT | SDMMC_FLAG_TXUNDERR | SDMMC_FLAG_RXOVERR | SDMMC_FLAG_DATAEND | SDMMC_FLAG_DBCKEND))
#endif /* STM32L4P5xx || STM32L4Q5xx || STM32L4R5xx || STM32L4R7xx ||                                                                                                                                  \
	  STM32L4R9xx || STM32L4S5xx || STM32L4S7xx || STM32L4S9xx */
...
#else
#define CLKCR_CLEAR_MASK ((uint32_t)(SDMMC_CLKCR_CLKDIV | SDMMC_CLKCR_PWRSAV | SDMMC_CLKCR_BYPASS | SDMMC_CLKCR_WIDBUS | SDMMC_CLKCR_NEGEDGE | SDMMC_CLKCR_HWFC_EN))
#endif /* STM32L4P5xx || STM32L4Q5xx || STM32L4R5xx || STM32L4R7xx ||                                                                                                                                  \
	  STM32L4R9xx || STM32L4S5xx || STM32L4S7xx || STM32L4S9xx */

/* --- DCTRL Register ---*/
/* SDMMC DCTRL Clear Mask */
#define DCTRL_CLEAR_MASK ((uint32_t)(SDMMC_DCTRL_DTEN | SDMMC_DCTRL_DTDIR | SDMMC_DCTRL_DTMODE | SDMMC_DCTRL_DBLOCKSIZE))

/* --- CMD Register ---*/
/* CMD Register clear mask */
#if defined(STM32L4P5xx) || defined(STM32L4Q5xx) || defined(STM32L4R5xx) || defined(STM32L4R7xx) || defined(STM32L4R9xx) || defined(STM32L4S5xx) || defined(STM32L4S7xx) || defined(STM32L4S9xx)
#define CMD_CLEAR_MASK ((uint32_t)(SDMMC_CMD_CMDINDEX | SDMMC_CMD_WAITRESP | SDMMC_CMD_WAITINT | SDMMC_CMD_WAITPEND | SDMMC_CMD_CPSMEN | SDMMC_CMD_CMDSUSPEND))
#else
#define CMD_CLEAR_MASK ((uint32_t)(SDMMC_CMD_CMDINDEX | SDMMC_CMD_WAITRESP | SDMMC_CMD_WAITINT | SDMMC_CMD_WAITPEND | SDMMC_CMD_CPSMEN | SDMMC_CMD_SDIOSUSPEND))
#endif /* STM32L4P5xx || STM32L4Q5xx || STM32L4R5xx || STM32L4R7xx ||                                                                                                                                  \
	  STM32L4R9xx || STM32L4S5xx || STM32L4S7xx || STM32L4S9xx */
