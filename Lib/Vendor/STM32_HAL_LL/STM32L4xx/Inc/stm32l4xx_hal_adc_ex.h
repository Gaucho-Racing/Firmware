...
#define ADC_CFGR_FIELDS                                                                                                                                                                                \
	(ADC_CFGR_AWD1CH | ADC_CFGR_JAUTO | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL | ADC_CFGR_JQM | ADC_CFGR_JDISCEN | ADC_CFGR_DISCNUM | ADC_CFGR_DISCEN | ADC_CFGR_AUTDLY |           \
	 ADC_CFGR_CONT | ADC_CFGR_OVRMOD | ADC_CFGR_EXTEN | ADC_CFGR_EXTSEL | ADC_CFGR_ALIGN | ADC_CFGR_RES | ADC_CFGR_DFSDMCFG | ADC_CFGR_DMACFG | ADC_CFGR_DMAEN)
#else
#define ADC_CFGR_FIELDS                                                                                                                                                                                \
	(ADC_CFGR_AWD1CH | ADC_CFGR_JAUTO | ADC_CFGR_JAWD1EN | ADC_CFGR_AWD1EN | ADC_CFGR_AWD1SGL | ADC_CFGR_JQM | ADC_CFGR_JDISCEN | ADC_CFGR_DISCNUM | ADC_CFGR_DISCEN | ADC_CFGR_AUTDLY |           \
...
#define ADC_CLEAR_COMMON_CONTROL_REGISTER(__HANDLE__)                                                                                                                                                  \
	CLEAR_BIT(__LL_ADC_COMMON_INSTANCE((__HANDLE__)->Instance)->CCR,                                                                                                                               \
		  ADC_CCR_CKMODE | ADC_CCR_PRESC | ADC_CCR_VBATEN | ADC_CCR_TSEN | ADC_CCR_VREFEN | ADC_CCR_MDMA | ADC_CCR_DMACFG | ADC_CCR_DELAY | ADC_CCR_DUAL)
#else
...
#if defined(STM32L412xx) || defined(STM32L422xx) || defined(STM32L471xx) || defined(STM32L475xx) || defined(STM32L476xx) || defined(STM32L485xx) || defined(STM32L486xx) || defined(STM32L496xx) ||    \
 ...
 */
    ...
    defined(STM32L452xx) || defined(STM32L462xx) || defined(STM32L4P5xx) || defined(STM32L4Q5xx) || defined(STM32L4R5xx) || defined(STM32L4R7xx) || defined(STM32L4R9xx) || defined(STM32L4S5xx) ||    \
...
#elif defined(STM32L471xx) || defined(STM32L475xx) || defined(STM32L476xx) || defined(STM32L485xx) || defined(STM32L486xx) || defined(STM32L496xx) || defined(STM32L4A6xx)
/*  The battery voltage measurement path (channel 18) is available on ADC1 and
 * ADC3 */
 ...
 * @retval SET (ADC instance is valid) or RESET (ADC instance is invalid)
 */
/*  The internal voltage reference  VREFINT measurement path (channel 0) is
 * available on ADC1 */
...
#define IS_ADC_CHANNEL(__HANDLE__, __CHANNEL__)                                                                                                                                                        \
	((((__HANDLE__)->Instance) == ADC1) &&                                                                                                                                                         \
	 (((__CHANNEL__) == ADC_CHANNEL_1) || ((__CHANNEL__) == ADC_CHANNEL_2) || ((__CHANNEL__) == ADC_CHANNEL_3) || ((__CHANNEL__) == ADC_CHANNEL_4) || ((__CHANNEL__) == ADC_CHANNEL_5) ||          \
	  ...
	  ((__CHANNEL__) == ADC_CHANNEL_16) || ((__CHANNEL__) == ADC_CHANNEL_17) || ((__CHANNEL__) == ADC_CHANNEL_18) || ((__CHANNEL__) == ADC_CHANNEL_VREFINT) ||                                     \
	  ((__CHANNEL__) == ADC_CHANNEL_TEMPSENSOR) || ((__CHANNEL__) == ADC_CHANNEL_VBAT) || ((__CHANNEL__) == ADC_CHANNEL_DAC1CH1) || ((__CHANNEL__) == ADC_CHANNEL_DAC1CH2)))
...
#define IS_ADC_CHANNEL(__HANDLE__, __CHANNEL__)                                                                                                                                                        \
	(((((__HANDLE__)->Instance) == ADC1) &&                                                                                                                                                        \
	  (((__CHANNEL__) == ADC_CHANNEL_1) || ((__CHANNEL__) == ADC_CHANNEL_2) || ((__CHANNEL__) == ADC_CHANNEL_3) || ((__CHANNEL__) == ADC_CHANNEL_4) || ((__CHANNEL__) == ADC_CHANNEL_5) ||         \
	   ((__CHANNEL__) == ADC_CHANNEL_6) || ((__CHANNEL__) == ADC_CHANNEL_7) || ((__CHANNEL__) == ADC_CHANNEL_8) || ((__CHANNEL__) == ADC_CHANNEL_9) || ((__CHANNEL__) == ADC_CHANNEL_10) ||        \
	   ((__CHANNEL__) == ADC_CHANNEL_11) || ((__CHANNEL__) == ADC_CHANNEL_12) || ((__CHANNEL__) == ADC_CHANNEL_13) || ((__CHANNEL__) == ADC_CHANNEL_14) || ((__CHANNEL__) == ADC_CHANNEL_15) ||    \
	   ((__CHANNEL__) == ADC_CHANNEL_16) || ((__CHANNEL__) == ADC_CHANNEL_VREFINT) || ((__CHANNEL__) == ADC_CHANNEL_TEMPSENSOR) || ((__CHANNEL__) == ADC_CHANNEL_VBAT))) ||                        \
	 ((((__HANDLE__)->Instance) == ADC2) &&                                                                                                                                                        \
	  (((__CHANNEL__) == ADC_CHANNEL_1) || ((__CHANNEL__) == ADC_CHANNEL_2) || ((__CHANNEL__) == ADC_CHANNEL_3) || ((__CHANNEL__) == ADC_CHANNEL_4) || ((__CHANNEL__) == ADC_CHANNEL_7) ||         \
	   ...
	   ((__CHANNEL__) == ADC_CHANNEL_13) || ((__CHANNEL__) == ADC_CHANNEL_14) || ((__CHANNEL__) == ADC_CHANNEL_15) || ((__CHANNEL__) == ADC_CHANNEL_16))))
	...
	(((((__HANDLE__)->Instance) == ADC1) &&                                                                                                                                                        \
	 ...
	 ((((__HANDLE__)->Instance) == ADC2) &&                                                                                                                                                        \
	  (((__CHANNEL__) == ADC_CHANNEL_1) || ((__CHANNEL__) == ADC_CHANNEL_2) || ((__CHANNEL__) == ADC_CHANNEL_3) || ((__CHANNEL__) == ADC_CHANNEL_4) || ((__CHANNEL__) == ADC_CHANNEL_5) ||         \
	   ((__CHANNEL__) == ADC_CHANNEL_6) || ((__CHANNEL__) == ADC_CHANNEL_7) || ((__CHANNEL__) == ADC_CHANNEL_8) || ((__CHANNEL__) == ADC_CHANNEL_9) || ((__CHANNEL__) == ADC_CHANNEL_10) ||        \
	   ((__CHANNEL__) == ADC_CHANNEL_11) || ((__CHANNEL__) == ADC_CHANNEL_12) || ((__CHANNEL__) == ADC_CHANNEL_13) || ((__CHANNEL__) == ADC_CHANNEL_14) || ((__CHANNEL__) == ADC_CHANNEL_15) ||    \
	   ((__CHANNEL__) == ADC_CHANNEL_16) || ((__CHANNEL__) == ADC_CHANNEL_17) || ((__CHANNEL__) == ADC_CHANNEL_18) || ((__CHANNEL__) == ADC_CHANNEL_DAC1CH1_ADC2) ||                               \
...
#define IS_ADC_CHANNEL(__HANDLE__, __CHANNEL__)                                                                                                                                                        \
	(((((__HANDLE__)->Instance) == ADC1) &&                                                                                                                                                        \
	 ...
	 ((((__HANDLE__)->Instance) == ADC3) &&                                                                                                                                                        \
	  (((__CHANNEL__) == ADC_CHANNEL_1) || ((__CHANNEL__) == ADC_CHANNEL_2) || ((__CHANNEL__) == ADC_CHANNEL_3) || ((__CHANNEL__) == ADC_CHANNEL_4) || ((__CHANNEL__) == ADC_CHANNEL_6) ||         \
	   ...
	   ((__CHANNEL__) == ADC_CHANNEL_TEMPSENSOR) || ((__CHANNEL__) == ADC_CHANNEL_VBAT) || ((__CHANNEL__) == ADC_CHANNEL_DAC1CH1_ADC3) || ((__CHANNEL__) == ADC_CHANNEL_DAC1CH2_ADC3))))
...
/* For ADC1 and ADC2, channels 1 to 15 are available in differential mode,
		      channels 0, 16 to 18 can be only used in single-ended
   mode. For ADC3, channels 1 to 3 and 6 to 12 are available in differential
   mode, channels 4, 5 and 13 to 18 can only be used in single-ended mode. */
#define IS_ADC_DIFF_CHANNEL(__HANDLE__, __CHANNEL__)                                                                                                                                                   \
	((((((__HANDLE__)->Instance) == ADC1) || (((__HANDLE__)->Instance) == ADC2)) &&                                                                                                                \
	  (((__CHANNEL__) == ADC_CHANNEL_1) || ((__CHANNEL__) == ADC_CHANNEL_2) || ((__CHANNEL__) == ADC_CHANNEL_3) || ((__CHANNEL__) == ADC_CHANNEL_4) || ((__CHANNEL__) == ADC_CHANNEL_5) ||         \
	   ...
	   ((__CHANNEL__) == ADC_CHANNEL_11) || ((__CHANNEL__) == ADC_CHANNEL_12) || ((__CHANNEL__) == ADC_CHANNEL_13) || ((__CHANNEL__) == ADC_CHANNEL_14) || ((__CHANNEL__) == ADC_CHANNEL_15))) ||  \
	 ((((__HANDLE__)->Instance) == ADC3) &&                                                                                                                                                        \
	  (((__CHANNEL__) == ADC_CHANNEL_1) || ((__CHANNEL__) == ADC_CHANNEL_2) || ((__CHANNEL__) == ADC_CHANNEL_3) || ((__CHANNEL__) == ADC_CHANNEL_6) || ((__CHANNEL__) == ADC_CHANNEL_7) ||         \
	   ((__CHANNEL__) == ADC_CHANNEL_8) || ((__CHANNEL__) == ADC_CHANNEL_9) || ((__CHANNEL__) == ADC_CHANNEL_10) || ((__CHANNEL__) == ADC_CHANNEL_11) || ((__CHANNEL__) == ADC_CHANNEL_12))))
#endif /* defined (STM32L412xx) || defined (STM32L422xx) || defined                                                                                                                                    \
	  (STM32L431xx) || defined (STM32L432xx) || defined (STM32L433xx) ||                                                                                                                           \
	  defined (STM32L442xx) || defined (STM32L443xx) || defined                                                                                                                                    \
...
#define IS_ADC_EXTTRIGINJEC(__HANDLE__, __INJTRIG__)                                                                                                                                                   \
	(((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T1_TRGO) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T1_CC4) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T2_TRGO) ||                                    \
	 ...
	 ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T15_TRGO) || ((__INJTRIG__) == ADC_INJECTED_SOFTWARE_START))
 ...
 */
#if defined(ADC_CFGR_DFSDMCFG) && defined(DFSDM1_Channel0)
#define IS_ADC_DFSDMCFG_MODE(__HANDLE__) (((__HANDLE__)->Init.DFSDMConfig == ADC_DFSDM_MODE_DISABLE) || ((__HANDLE__)->Init.DFSDMConfig == ADC_DFSDM_MODE_ENABLE))
#else
