...
#define IS_DMAMUX_SYNC_SIGNAL_ID(SIGNAL_ID) (((SIGNAL_ID) == HAL_DMAMUX1_SYNC_EXTI0) || (((SIGNAL_ID) >= HAL_DMAMUX1_SYNC_EXTI1) && ((SIGNAL_ID) <= HAL_DMAMUX1_MAX_SYNC)))
...
#define IS_DMAMUX_REQUEST_GEN_SIGNAL_ID(SIGNAL_ID) (((SIGNAL_ID) == HAL_DMAMUX1_REQ_GEN_EXTI0) || (((SIGNAL_ID) >= HAL_DMAMUX1_REQ_GEN_EXTI1) && ((SIGNAL_ID) <= HAL_DMAMUX1_MAX_REQ_GEN)))
