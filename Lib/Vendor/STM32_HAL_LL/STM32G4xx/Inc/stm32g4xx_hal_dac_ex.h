...
#define IS_DAC_TRIGGER(DACX, TRIGGER)                                                                                  \
	(((TRIGGER) == DAC_TRIGGER_NONE) || ((TRIGGER) == DAC_TRIGGER_SOFTWARE) ||                                     \
	 ...
	 ((TRIGGER) == DAC_TRIGGER_HRTIM_RST_TRG2) || ((TRIGGER) == DAC_TRIGGER_HRTIM_RST_TRG3) ||                     \
	 ((TRIGGER) == DAC_TRIGGER_HRTIM_RST_TRG4) || ((TRIGGER) == DAC_TRIGGER_HRTIM_RST_TRG5) ||                     \
...
#define IS_DAC_TRIGGER2(DACX, TRIGGER)                                                                                 \
	(((TRIGGER) == DAC_TRIGGER_NONE) || ((TRIGGER) == DAC_TRIGGER_SOFTWARE) ||                                     \
	 ...
	 ((TRIGGER) == DAC_TRIGGER_HRTIM_STEP_TRG2) || ((TRIGGER) == DAC_TRIGGER_HRTIM_STEP_TRG3) ||                   \
	 ((TRIGGER) == DAC_TRIGGER_HRTIM_STEP_TRG4) || ((TRIGGER) == DAC_TRIGGER_HRTIM_STEP_TRG5) ||                   \
	 ((TRIGGER) == DAC_TRIGGER_HRTIM_STEP_TRG6) || (((DACX) == DAC1) && ((TRIGGER) == DAC_TRIGGER_T8_TRGO)) ||     \
...
#define IS_DAC_SAWTOOTH_POLARITY(POLARITY)                                                                             \
	(((POLARITY) == DAC_SAWTOOTH_POLARITY_DECREMENT) || ((POLARITY) == DAC_SAWTOOTH_POLARITY_INCREMENT))
