...
#endif /* USE_HAL_HRTIM_REGISTER_CALLBACKS */
{
...
#if (USE_HAL_HRTIM_REGISTER_CALLBACKS == 1)
	void (*Fault1Callback)(
	    struct __HRTIM_HandleTypeDef *hhrtim); /*!< Fault 1 interrupt callback function pointer */
	void (*Fault2Callback)(
	    struct __HRTIM_HandleTypeDef *hhrtim); /*!< Fault 2 interrupt callback function pointer */
	void (*Fault3Callback)(
	    struct __HRTIM_HandleTypeDef *hhrtim); /*!< Fault 3 interrupt callback function pointer */
	void (*Fault4Callback)(
	    struct __HRTIM_HandleTypeDef *hhrtim); /*!< Fault 4 interrupt callback function pointer */
	void (*Fault5Callback)(
	    struct __HRTIM_HandleTypeDef *hhrtim); /*!< Fault 5 interrupt callback function pointer */
	void (*Fault6Callback)(
	    struct __HRTIM_HandleTypeDef *hhrtim); /*!< Fault 6 interrupt callback function pointer */
	void (*SystemFaultCallback)(struct __HRTIM_HandleTypeDef *hhrtim); /*!< System fault interrupt
									      callback function pointer */
	void (*DLLCalibrationReadyCallback)(
	    struct __HRTIM_HandleTypeDef *hhrtim); /*!< DLL Ready interrupt callback function pointer */
	...
	void (*SynchronizationEventCallback)(
	    struct __HRTIM_HandleTypeDef *hhrtim); /*!< Sync Input interrupt callback function pointer */
...
typedef void (*pHRTIM_TIMxCallbackTypeDef)(
    HRTIM_HandleTypeDef *hhrtim, /*!< HRTIM Timer x related callback function pointer */
    uint32_t TimerIdx);
#endif /* USE_HAL_HRTIM_REGISTER_CALLBACKS */
...
#define IS_HRTIM_ADCTRIGGER(ADCTRIGGER)                                                                                \
	(((ADCTRIGGER) == HRTIM_ADCTRIGGER_1) || ((ADCTRIGGER) == HRTIM_ADCTRIGGER_2) ||                               \
	 ...
	 ((ADCTRIGGER) == HRTIM_ADCTRIGGER_5) || ((ADCTRIGGER) == HRTIM_ADCTRIGGER_6) ||                               \
	 ((ADCTRIGGER) == HRTIM_ADCTRIGGER_7) || ((ADCTRIGGER) == HRTIM_ADCTRIGGER_8) ||                               \
...
#define HRTIM_UPDATEGATING_UPDEN2_UPDATE                                                                               \
	(HRTIM_TIMCR_UPDGAT_2 | HRTIM_TIMCR_UPDGAT_1 |                                                                 \
	 HRTIM_TIMCR_UPDGAT_0) /*!< Slave timer only -  Update done on the                                             \
				  update event following a rising edge of                                              \
...
#define HRTIM_TIMER_A_B_C_DELAYEDPROTECTION_BALANCED_EEV7                                                              \
	(HRTIM_OUTR_DLYPRT_2 | HRTIM_OUTR_DLYPRT_1 | HRTIM_OUTR_DLYPRT_0 |                                             \
	 HRTIM_OUTR_DLYPRTEN) /*!< Timers A, B, C: Balanced Idle on external                                           \
				 Event 7U */
...
#define HRTIM_TIMER_F_DELAYEDPROTECTION_BALANCED_EEV9                                                                  \
	(HRTIM_OUTR_DLYPRT_2 | HRTIM_OUTR_DLYPRT_1 | HRTIM_OUTR_DLYPRT_0 |                                             \
	 HRTIM_OUTR_DLYPRTEN) /*!< Timers F: Balanced Idle on external Event                                           \
				 7U */
/**
 * @}
 */
...
#define IS_HRTIM_ROLLOVERMODE(ROLLOVER)                                                                                \
	((((ROLLOVER) == HRTIM_TIM_FEROM_BOTH) || ((ROLLOVER) == HRTIM_TIM_FEROM_CREST) ||                             \
	  ((ROLLOVER) == HRTIM_TIM_FEROM_VALLEY)) ||                                                                   \
	 (((ROLLOVER) == HRTIM_TIM_ADROM_BOTH) || ((ROLLOVER) == HRTIM_TIM_ADROM_CREST) ||                             \
	  ((ROLLOVER) == HRTIM_TIM_ADROM_VALLEY)) ||                                                                   \
	 (((ROLLOVER) == HRTIM_TIM_BMROM_BOTH) || ((ROLLOVER) == HRTIM_TIM_BMROM_CREST) ||                             \
	  ((ROLLOVER) == HRTIM_TIM_BMROM_VALLEY)) ||                                                                   \
	 (((ROLLOVER) == HRTIM_TIM_OUTROM_BOTH) || ((ROLLOVER) == HRTIM_TIM_OUTROM_CREST) ||                           \
	  ((ROLLOVER) == HRTIM_TIM_OUTROM_VALLEY)) ||                                                                  \
	 (((ROLLOVER) == HRTIM_TIM_ROM_BOTH) || ((ROLLOVER) == HRTIM_TIM_ROM_CREST) ||                                 \
...
#define IS_HRTIM_BASICOCMODE(BASICOCMODE)                                                                              \
	(((BASICOCMODE) == HRTIM_BASICOCMODE_TOGGLE) || ((BASICOCMODE) == HRTIM_BASICOCMODE_INACTIVE) ||               \
...
#define HRTIM_TIMDEADTIME_PRESCALERRATIO_DIV16                                                                         \
	(HRTIM_DTR_DTPRSC_2 | HRTIM_DTR_DTPRSC_1 | HRTIM_DTR_DTPRSC_0) /*!< fDTG = fHRTIM / 16U */
/**
 * @}
 */
...
#define HRTIM_EVENTFILTER_7                                                                                            \
	(HRTIM_EECR3_EE6F_2 | HRTIM_EECR3_EE6F_1 | HRTIM_EECR3_EE6F_0) /*!< fSAMPLING= fEEVS/4U, N=8U */
...
#define HRTIM_EVENTFILTER_11                                                                                           \
	(HRTIM_EECR3_EE6F_3 | HRTIM_EECR3_EE6F_1 | HRTIM_EECR3_EE6F_0) /*!< fSAMPLING= fEEVS/16U, N=6U */
#define HRTIM_EVENTFILTER_12 (HRTIM_EECR3_EE6F_3 | HRTIM_EECR3_EE6F_2) /*!< fSAMPLING= fEEVS/16U, N=8U */
#define HRTIM_EVENTFILTER_13                                                                                           \
	(HRTIM_EECR3_EE6F_3 | HRTIM_EECR3_EE6F_2 | HRTIM_EECR3_EE6F_0) /*!< fSAMPLING= fEEVS/32U, N=5U */
#define HRTIM_EVENTFILTER_14                                                                                           \
	(HRTIM_EECR3_EE6F_3 | HRTIM_EECR3_EE6F_2 | HRTIM_EECR3_EE6F_1) /*!< fSAMPLING= fEEVS/32U, N=6U */
...
#define HRTIM_FAULTFILTER_7                                                                                            \
	(HRTIM_FLTINR1_FLT1F_2 | HRTIM_FLTINR1_FLT1F_1 | HRTIM_FLTINR1_FLT1F_0) /*!< fSAMPLING= fFLTS/4U, N=8U */
...
#define HRTIM_FAULTFILTER_11                                                                                           \
	(HRTIM_FLTINR1_FLT1F_3 | HRTIM_FLTINR1_FLT1F_1 | HRTIM_FLTINR1_FLT1F_0) /*!< fSAMPLING= fFLTS/16U, N=6U */
...
#define HRTIM_FAULTFILTER_13                                                                                           \
	(HRTIM_FLTINR1_FLT1F_3 | HRTIM_FLTINR1_FLT1F_2 | HRTIM_FLTINR1_FLT1F_0) /*!< fSAMPLING= fFLTS/32U, N=5U */
#define HRTIM_FAULTFILTER_14                                                                                           \
	(HRTIM_FLTINR1_FLT1F_3 | HRTIM_FLTINR1_FLT1F_2 | HRTIM_FLTINR1_FLT1F_1) /*!< fSAMPLING= fFLTS/32U, N=6U */
...
#define HRTIM_BURSTMODEPRESCALER_DIV128                                                                                \
	(HRTIM_BMCR_BMPRSC_2 | HRTIM_BMCR_BMPRSC_1 | HRTIM_BMCR_BMPRSC_0) /*!< fBRST = fHRTIM/128U */
...
#define HRTIM_BURSTMODEPRESCALER_DIV2048                                                                               \
	(HRTIM_BMCR_BMPRSC_3 | HRTIM_BMCR_BMPRSC_1 | HRTIM_BMCR_BMPRSC_0) /*!< fBRST = fHRTIM/2048U*/
...
#define HRTIM_BURSTMODEPRESCALER_DIV8192                                                                               \
	(HRTIM_BMCR_BMPRSC_3 | HRTIM_BMCR_BMPRSC_2 | HRTIM_BMCR_BMPRSC_0) /*!< fBRST = fHRTIM/8192U */
#define HRTIM_BURSTMODEPRESCALER_DIV16384                                                                              \
	(HRTIM_BMCR_BMPRSC_3 | HRTIM_BMCR_BMPRSC_2 | HRTIM_BMCR_BMPRSC_1) /*!< fBRST = fHRTIM/16384U */
...
#define IS_HRTIM_TIMERINDEX(TIMERINDEX)                                                                                \
	(((TIMERINDEX) == HRTIM_TIMERINDEX_MASTER) || ((TIMERINDEX) == HRTIM_TIMERINDEX_TIMER_A) ||                    \
...
#define IS_HRTIM_TIMING_UNIT(TIMERINDEX)                                                                               \
	(((TIMERINDEX) == HRTIM_TIMERINDEX_TIMER_A) || ((TIMERINDEX) == HRTIM_TIMERINDEX_TIMER_B) ||                   \
	 ((TIMERINDEX) == HRTIM_TIMERINDEX_TIMER_C) || ((TIMERINDEX) == HRTIM_TIMERINDEX_TIMER_D) ||                   \
...
#define IS_HRTIM_TIMEEVENT_RESETMODE(EVENT)                                                                            \
	(((EVENT) == HRTIM_EVENTCOUNTER_RSTMODE_UNCONDITIONAL) || ((EVENT) == HRTIM_EVENTCOUNTER_RSTMODE_CONDITIONAL))

#define IS_HRTIM_TIMSYNCUPDATE(EVENT)                                                                                  \
	(((EVENT) == HRTIM_TIMERESYNC_UPDATE_UNCONDITIONAL) || ((EVENT) == HRTIM_TIMERESYNC_UPDATE_CONDITIONAL))

#define IS_HRTIM_TIMEEVENT_COUNTER(COUNTER)                                                                            \
	((((COUNTER) > (uint32_t)0x00U) && ((COUNTER) <= (uint32_t)0x3FU)) || ((COUNTER) == (uint32_t)0x00U))

#define IS_HRTIM_TIMEEVENT_SOURCE(SOURCE) (((SOURCE) >= (uint32_t)0x00U) && ((SOURCE) <= (uint32_t)0x9U))

#define IS_HRTIM_EVENT(EVENT)                                                                                          \
	(((EVENT) == HRTIM_EVENT_NONE) || ((EVENT) == HRTIM_EVENT_1) || ((EVENT) == HRTIM_EVENT_2) ||                  \
	 ((EVENT) == HRTIM_EVENT_3) || ((EVENT) == HRTIM_EVENT_4) || ((EVENT) == HRTIM_EVENT_5) ||                     \
	 ((EVENT) == HRTIM_EVENT_6) || ((EVENT) == HRTIM_EVENT_7) || ((EVENT) == HRTIM_EVENT_8) ||                     \
	 ((EVENT) == HRTIM_EVENT_9) || ((EVENT) == HRTIM_EVENT_10))

#define IS_HRTIM_FAULT(FAULT)                                                                                          \
	(((FAULT) == HRTIM_FAULT_1) || ((FAULT) == HRTIM_FAULT_2) || ((FAULT) == HRTIM_FAULT_3) ||                     \
	 ((FAULT) == HRTIM_FAULT_4) || ((FAULT) == HRTIM_FAULT_5) || ((FAULT) == HRTIM_FAULT_6))

#define IS_HRTIM_PRESCALERRATIO(PRESCALERRATIO)                                                                        \
	(((PRESCALERRATIO) == HRTIM_PRESCALERRATIO_MUL32) || ((PRESCALERRATIO) == HRTIM_PRESCALERRATIO_MUL16) ||       \
	 ((PRESCALERRATIO) == HRTIM_PRESCALERRATIO_MUL8) || ((PRESCALERRATIO) == HRTIM_PRESCALERRATIO_MUL4) ||         \
	 ((PRESCALERRATIO) == HRTIM_PRESCALERRATIO_MUL2) || ((PRESCALERRATIO) == HRTIM_PRESCALERRATIO_DIV1) ||         \
...
#define IS_HRTIM_INTERLEAVEDMODE(INTLVDMODE)                                                                           \
	(((INTLVDMODE) == HRTIM_INTERLEAVED_MODE_DISABLED) || ((INTLVDMODE) == HRTIM_INTERLEAVED_MODE_DUAL) ||         \
	 ((INTLVDMODE) == HRTIM_INTERLEAVED_MODE_DISABLED) || ((INTLVDMODE) == HRTIM_INTERLEAVED_MODE_TRIPLE) ||       \
	 ((INTLVDMODE) == HRTIM_INTERLEAVED_MODE_DISABLED) || ((INTLVDMODE) == HRTIM_INTERLEAVED_MODE_QUAD))
...
#define IS_HRTIM_UPDATEGATING_MASTER(UPDATEGATING)                                                                     \
	(((UPDATEGATING) == HRTIM_UPDATEGATING_INDEPENDENT) || ((UPDATEGATING) == HRTIM_UPDATEGATING_DMABURST) ||      \
	 ((UPDATEGATING) == HRTIM_UPDATEGATING_DMABURST_UPDATE))

#define IS_HRTIM_UPDATEGATING_TIM(UPDATEGATING)                                                                        \
	(((UPDATEGATING) == HRTIM_UPDATEGATING_INDEPENDENT) || ((UPDATEGATING) == HRTIM_UPDATEGATING_DMABURST) ||      \
	 ((UPDATEGATING) == HRTIM_UPDATEGATING_DMABURST_UPDATE) || ((UPDATEGATING) == HRTIM_UPDATEGATING_UPDEN1) ||    \
	 ((UPDATEGATING) == HRTIM_UPDATEGATING_UPDEN2) || ((UPDATEGATING) == HRTIM_UPDATEGATING_UPDEN3) ||             \
	 ((UPDATEGATING) == HRTIM_UPDATEGATING_UPDEN1_UPDATE) ||                                                       \
	 ((UPDATEGATING) == HRTIM_UPDATEGATING_UPDEN2_UPDATE) || ((UPDATEGATING) == HRTIM_UPDATEGATING_UPDEN3_UPDATE))

#define IS_HRTIM_TIMERBURSTMODE(MODE)                                                                                  \
	(((MODE) == HRTIM_TIMERBURSTMODE_MAINTAINCLOCK) || ((MODE) == HRTIM_TIMERBURSTMODE_RESETCOUNTER))
...
#define IS_HRTIM_TIMERTRGHLFMODE(MODE)                                                                                 \
	(((MODE) == HRTIM_TIMERTRIGHALF_DISABLED) || ((MODE) == HRTIM_TIMERTRIGHALF_ENABLED))
...
#define IS_HRTIM_DUALDAC_RESET(DUALCHANNELDAC)                                                                         \
	(((DUALCHANNELDAC) == HRTIM_TIMER_DCDR_COUNTER) || ((DUALCHANNELDAC) == HRTIM_TIMER_DCDR_OUT1SET))

#define IS_HRTIM_DUALDAC_STEP(DUALCHANNELDAC)                                                                          \
	(((DUALCHANNELDAC) == HRTIM_TIMER_DCDS_CMP2) || ((DUALCHANNELDAC) == HRTIM_TIMER_DCDS_OUT1RST))

#define IS_HRTIM_DUALDAC_ENABLE(DUALCHANNELDAC)                                                                        \
	(((DUALCHANNELDAC) == HRTIM_TIMER_DCDE_DISABLED) || ((DUALCHANNELDAC) == HRTIM_TIMER_DCDE_ENABLED))
...
#define IS_HRTIM_TIMPUSHPULLMODE(TIMPUSHPULLMODE)                                                                      \
	(((TIMPUSHPULLMODE) == HRTIM_TIMPUSHPULLMODE_DISABLED) || ((TIMPUSHPULLMODE) == HRTIM_TIMPUSHPULLMODE_ENABLED))
...
#define IS_HRTIM_TIMFAULTLOCK(TIMFAULTLOCK)                                                                            \
	(((TIMFAULTLOCK) == HRTIM_TIMFAULTLOCK_READWRITE) || ((TIMFAULTLOCK) == HRTIM_TIMFAULTLOCK_READONLY))
...
#define IS_HRTIM_OUTPUTPOLARITY(OUTPUTPOLARITY)                                                                        \
	(((OUTPUTPOLARITY) == HRTIM_OUTPUTPOLARITY_HIGH) || ((OUTPUTPOLARITY) == HRTIM_OUTPUTPOLARITY_LOW))
...
#define IS_HRTIM_OUTPUTSET(OUTPUTSET)                                                                                  \
	(((OUTPUTSET) == HRTIM_OUTPUTSET_NONE) || ((OUTPUTSET) == HRTIM_OUTPUTSET_RESYNC) ||                           \
	 ...
	 ((OUTPUTSET) == HRTIM_OUTPUTSET_MASTERCMP1) || ((OUTPUTSET) == HRTIM_OUTPUTSET_MASTERCMP2) ||                 \
	 ((OUTPUTSET) == HRTIM_OUTPUTSET_MASTERCMP3) || ((OUTPUTSET) == HRTIM_OUTPUTSET_MASTERCMP4) ||                 \
	 ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMAEV1_TIMBCMP1) || ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMAEV2_TIMBCMP2) ||     \
	 ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMAEV3_TIMCCMP2) || ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMAEV4_TIMCCMP3) ||     \
	 ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMAEV5_TIMDCMP1) || ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMAEV6_TIMDCMP2) ||     \
	 ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMAEV7_TIMECMP3) || ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMAEV8_TIMECMP4) ||     \
	 ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMAEV9_TIMFCMP4) || ((OUTPUTSET) == HRTIM_OUTPUTSET_EEV_1) ||                \
...
#define IS_HRTIM_OUTPUTRESET(OUTPUTRESET)                                                                              \
	(((OUTPUTRESET) == HRTIM_OUTPUTRESET_NONE) || ((OUTPUTRESET) == HRTIM_OUTPUTRESET_RESYNC) ||                   \
	 ((OUTPUTRESET) == HRTIM_OUTPUTRESET_TIMPER) || ((OUTPUTRESET) == HRTIM_OUTPUTRESET_TIMCMP1) ||                \
	 ((OUTPUTRESET) == HRTIM_OUTPUTRESET_TIMCMP2) || ((OUTPUTRESET) == HRTIM_OUTPUTRESET_TIMCMP3) ||               \
	 ((OUTPUTRESET) == HRTIM_OUTPUTRESET_TIMCMP4) || ((OUTPUTRESET) == HRTIM_OUTPUTRESET_MASTERPER) ||             \
	 ((OUTPUTRESET) == HRTIM_OUTPUTRESET_MASTERCMP1) || ((OUTPUTRESET) == HRTIM_OUTPUTRESET_MASTERCMP2) ||         \
	 ((OUTPUTRESET) == HRTIM_OUTPUTRESET_MASTERCMP3) || ((OUTPUTRESET) == HRTIM_OUTPUTRESET_MASTERCMP4) ||         \
	 ...
	 ((OUTPUTRESET) == HRTIM_OUTPUTRESET_TIMAEV9_TIMFCMP4) || ((OUTPUTRESET) == HRTIM_OUTPUTRESET_EEV_1) ||        \
	 ((OUTPUTRESET) == HRTIM_OUTPUTRESET_EEV_2) || ((OUTPUTRESET) == HRTIM_OUTPUTRESET_EEV_3) ||                   \
	 ((OUTPUTRESET) == HRTIM_OUTPUTRESET_EEV_4) || ((OUTPUTRESET) == HRTIM_OUTPUTRESET_EEV_5) ||                   \
	 ((OUTPUTRESET) == HRTIM_OUTPUTRESET_EEV_6) || ((OUTPUTRESET) == HRTIM_OUTPUTRESET_EEV_7) ||                   \
	 ((OUTPUTRESET) == HRTIM_OUTPUTRESET_EEV_8) || ((OUTPUTRESET) == HRTIM_OUTPUTRESET_EEV_9) ||                   \
	 ((OUTPUTRESET) == HRTIM_OUTPUTRESET_EEV_10) || ((OUTPUTRESET) == HRTIM_OUTPUTRESET_UPDATE))

#define IS_HRTIM_OUTPUTIDLEMODE(OUTPUTIDLEMODE)                                                                        \
	(((OUTPUTIDLEMODE) == HRTIM_OUTPUTIDLEMODE_NONE) || ((OUTPUTIDLEMODE) == HRTIM_OUTPUTIDLEMODE_IDLE))

#define IS_HRTIM_OUTPUTIDLELEVEL(OUTPUTIDLELEVEL)                                                                      \
	(((OUTPUTIDLELEVEL) == HRTIM_OUTPUTIDLELEVEL_INACTIVE) || ((OUTPUTIDLELEVEL) == HRTIM_OUTPUTIDLELEVEL_ACTIVE))
...
#define IS_HRTIM_OUTPUTBALANCEDIDLE(OUTPUTBIAR)                                                                        \
	(((OUTPUTBIAR) == HRTIM_OUTPUTBIAR_DISABLED) || ((OUTPUTBIAR) == HRTIM_OUTPUTBIAR_ENABLED))

#define IS_HRTIM_TIMER_CAPTURETRIGGER(TIMER, CAPTURETRIGGER)                                                           \
	(((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_NONE) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_UPDATE) ||       \
	 ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_EEV_1) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_EEV_2) ||       \
	 ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_EEV_3) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_EEV_4) ||       \
	 ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_EEV_5) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_EEV_6) ||       \
	 ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_EEV_7) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_EEV_8) ||       \
	 ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_EEV_9) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_EEV_10) ||      \
	 (((TIMER) == HRTIM_TIMERINDEX_TIMER_A) && (((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TB1_SET) ||              \
	 ...
	 (((TIMER) == HRTIM_TIMERINDEX_TIMER_B) && (((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TA1_SET) ||              \
						    ...
						    ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERE_CMP1) ||          \
						    ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERE_CMP2))) ||        \
	 (((TIMER) == HRTIM_TIMERINDEX_TIMER_C) && (((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TA1_SET) ||              \
						    ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TA1_RESET) ||            \
						    ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERA_CMP1) ||          \
						    ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERA_CMP2) ||          \
						    ...
						    ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERE_CMP1) ||          \
						    ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERE_CMP2))) ||        \
	 (((TIMER) == HRTIM_TIMERINDEX_TIMER_D) && (((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TA1_SET) ||              \
						    ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TA1_RESET) ||            \
						    ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERA_CMP1) ||          \
						    ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERA_CMP2) ||          \
						    ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TB1_SET) ||              \
						    ...
						    ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERE_CMP1) ||          \
						    ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERE_CMP2))) ||        \
	 (((TIMER) == HRTIM_TIMERINDEX_TIMER_E) && (((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TA1_SET) ||              \
						    ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TA1_RESET) ||            \
						    ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERA_CMP1) ||          \
						    ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERA_CMP2) ||          \
						    ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TB1_SET) ||              \
						    ...
						    ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERD_CMP1) ||          \
						    ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERD_CMP2))) ||        \
	 (((TIMER) == HRTIM_TIMERINDEX_TIMER_F) && (((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TA1_SET) ||              \
						    ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TA1_RESET) ||            \
						    ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERA_CMP1) ||          \
						    ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERA_CMP2) ||          \
						    ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TB1_SET) ||              \
...
#define IS_HRTIM_TIMER_CAPTUREFTRIGGER(TIMER, CAPTUREFTRIGGER)                                                         \
	(((CAPTUREFTRIGGER) == HRTIM_CAPTUREFTRIGGER_NONE) || ((CAPTUREFTRIGGER) == HRTIM_CAPTUREFTRIGGER_TF1_SET) ||  \
...
#define IS_HRTIM_TIMEVENTFILTER(TIMER, TIMEVENTFILTER)                                                                 \
	(((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_NONE) || ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKINGCMP1) ||           \
	 ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKINGCMP2) || ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKINGCMP3) ||   \
	 ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKINGCMP4) || ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_WINDOWINGCMP2) ||  \
...
#define IS_HRTIM_TIMEVENTLATCH(TIMEVENTLATCH)                                                                          \
	(((TIMEVENTLATCH) == HRTIM_TIMEVENTLATCH_DISABLED) || ((TIMEVENTLATCH) == HRTIM_TIMEVENTLATCH_ENABLED))
...
#define IS_HRTIM_CHOPPER_DUTYCYCLE(DUTYCYCLE)                                                                          \
	(((DUTYCYCLE) == HRTIM_CHOPPER_DUTYCYCLE_0) || ((DUTYCYCLE) == HRTIM_CHOPPER_DUTYCYCLE_125) ||                 \
	 ((DUTYCYCLE) == HRTIM_CHOPPER_DUTYCYCLE_250) || ((DUTYCYCLE) == HRTIM_CHOPPER_DUTYCYCLE_375) ||               \
	 ((DUTYCYCLE) == HRTIM_CHOPPER_DUTYCYCLE_500) || ((DUTYCYCLE) == HRTIM_CHOPPER_DUTYCYCLE_625) ||               \
	 ((DUTYCYCLE) == HRTIM_CHOPPER_DUTYCYCLE_750) || ((DUTYCYCLE) == HRTIM_CHOPPER_DUTYCYCLE_875))

#define IS_HRTIM_CHOPPER_PULSEWIDTH(PULSEWIDTH)                                                                        \
	(((PULSEWIDTH) == HRTIM_CHOPPER_PULSEWIDTH_16) || ((PULSEWIDTH) == HRTIM_CHOPPER_PULSEWIDTH_32) ||             \
	 ((PULSEWIDTH) == HRTIM_CHOPPER_PULSEWIDTH_48) || ((PULSEWIDTH) == HRTIM_CHOPPER_PULSEWIDTH_64) ||             \
	 ((PULSEWIDTH) == HRTIM_CHOPPER_PULSEWIDTH_80) || ((PULSEWIDTH) == HRTIM_CHOPPER_PULSEWIDTH_96) ||             \
	 ((PULSEWIDTH) == HRTIM_CHOPPER_PULSEWIDTH_112) || ((PULSEWIDTH) == HRTIM_CHOPPER_PULSEWIDTH_128) ||           \
	 ((PULSEWIDTH) == HRTIM_CHOPPER_PULSEWIDTH_144) || ((PULSEWIDTH) == HRTIM_CHOPPER_PULSEWIDTH_160) ||           \
	 ((PULSEWIDTH) == HRTIM_CHOPPER_PULSEWIDTH_176) || ((PULSEWIDTH) == HRTIM_CHOPPER_PULSEWIDTH_192) ||           \
	 ((PULSEWIDTH) == HRTIM_CHOPPER_PULSEWIDTH_208) || ((PULSEWIDTH) == HRTIM_CHOPPER_PULSEWIDTH_224) ||           \
	 ((PULSEWIDTH) == HRTIM_CHOPPER_PULSEWIDTH_240) || ((PULSEWIDTH) == HRTIM_CHOPPER_PULSEWIDTH_256))
...
#define IS_HRTIM_EVENTSRC(EVENT, EVENTSRC)                                                                             \
	((((EVENT) == HRTIM_EVENT_1) &&                                                                                \
	  (((EVENTSRC) == HRTIM_EEV1SRC_GPIO) || ((EVENTSRC) == HRTIM_EEV1SRC_COMP2_OUT) ||                            \
	   ((EVENTSRC) == HRTIM_EEV1SRC_TIM1_TRGO) || ((EVENTSRC) == HRTIM_EEV1SRC_ADC1_AWD1))) ||                     \
	 (((EVENT) == HRTIM_EVENT_2) &&                                                                                \
	  (((EVENTSRC) == HRTIM_EEV2SRC_GPIO) || ((EVENTSRC) == HRTIM_EEV2SRC_COMP4_OUT) ||                            \
	   ((EVENTSRC) == HRTIM_EEV2SRC_TIM2_TRGO) || ((EVENTSRC) == HRTIM_EEV2SRC_ADC1_AWD2))) ||                     \
	 (((EVENT) == HRTIM_EVENT_3) &&                                                                                \
	  (((EVENTSRC) == HRTIM_EEV3SRC_GPIO) || ((EVENTSRC) == HRTIM_EEV3SRC_COMP6_OUT) ||                            \
	   ((EVENTSRC) == HRTIM_EEV3SRC_TIM3_TRGO) || ((EVENTSRC) == HRTIM_EEV3SRC_ADC1_AWD3))) ||                     \
	 (((EVENT) == HRTIM_EVENT_4) &&                                                                                \
	  (((EVENTSRC) == HRTIM_EEV4SRC_GPIO) || ((EVENTSRC) == HRTIM_EEV4SRC_COMP1_OUT) ||                            \
	   ((EVENTSRC) == HRTIM_EEV4SRC_COMP5_OUT) || ((EVENTSRC) == HRTIM_EEV4SRC_ADC2_AWD1))) ||                     \
	 (((EVENT) == HRTIM_EVENT_5) &&                                                                                \
	  (((EVENTSRC) == HRTIM_EEV5SRC_GPIO) || ((EVENTSRC) == HRTIM_EEV5SRC_COMP3_OUT) ||                            \
	   ((EVENTSRC) == HRTIM_EEV5SRC_COMP7_OUT) || ((EVENTSRC) == HRTIM_EEV5SRC_ADC2_AWD2))) ||                     \
	 (((EVENT) == HRTIM_EVENT_6) &&                                                                                \
	  (((EVENTSRC) == HRTIM_EEV6SRC_GPIO) || ((EVENTSRC) == HRTIM_EEV6SRC_COMP2_OUT) ||                            \
	   ((EVENTSRC) == HRTIM_EEV6SRC_COMP1_OUT) || ((EVENTSRC) == HRTIM_EEV6SRC_ADC2_AWD3))) ||                     \
	 (((EVENT) == HRTIM_EVENT_7) &&                                                                                \
	  (((EVENTSRC) == HRTIM_EEV7SRC_GPIO) || ((EVENTSRC) == HRTIM_EEV7SRC_COMP4_OUT) ||                            \
	   ((EVENTSRC) == HRTIM_EEV7SRC_TIM7_TRGO) || ((EVENTSRC) == HRTIM_EEV7SRC_ADC3_AWD1))) ||                     \
	 (((EVENT) == HRTIM_EVENT_8) &&                                                                                \
	  (((EVENTSRC) == HRTIM_EEV8SRC_GPIO) || ((EVENTSRC) == HRTIM_EEV8SRC_COMP6_OUT) ||                            \
	   ((EVENTSRC) == HRTIM_EEV8SRC_COMP3_OUT) || ((EVENTSRC) == HRTIM_EEV8SRC_ADC4_AWD1))) ||                     \
	 (((EVENT) == HRTIM_EVENT_9) &&                                                                                \
	  (((EVENTSRC) == HRTIM_EEV9SRC_GPIO) || ((EVENTSRC) == HRTIM_EEV9SRC_COMP5_OUT) ||                            \
	   ((EVENTSRC) == HRTIM_EEV9SRC_TIM15_TRGO) || ((EVENTSRC) == HRTIM_EEV9SRC_COMP4_OUT))) ||                    \
	 (((EVENT) == HRTIM_EVENT_10) &&                                                                               \
	  (((EVENTSRC) == HRTIM_EEV10SRC_GPIO) || ((EVENTSRC) == HRTIM_EEV10SRC_COMP7_OUT) ||                          \
	   ((EVENTSRC) == HRTIM_EEV10SRC_TIM6_TRGO) || ((EVENTSRC) == HRTIM_EEV10SRC_ADC5_AWD1))))

#define IS_HRTIM_EVENTPOLARITY(EVENTSENSITIVITY, EVENTPOLARITY)                                                        \
	((((EVENTSENSITIVITY) == HRTIM_EVENTSENSITIVITY_LEVEL) &&                                                      \
	  (((EVENTPOLARITY) == HRTIM_EVENTPOLARITY_HIGH) || ((EVENTPOLARITY) == HRTIM_EVENTPOLARITY_LOW))) ||          \
...
#define IS_HRTIM_EVENTFILTER(EVENT, FILTER)                                                                            \
	((((EVENT) == HRTIM_EVENT_1) || ((EVENT) == HRTIM_EVENT_2) || ((EVENT) == HRTIM_EVENT_3) ||                    \
	 ...
	 ((((EVENT) == HRTIM_EVENT_6) || ((EVENT) == HRTIM_EVENT_7) || ((EVENT) == HRTIM_EVENT_8) ||                   \
	   ((EVENT) == HRTIM_EVENT_9) || ((EVENT) == HRTIM_EVENT_10)) &&                                               \
	  (((FILTER) == HRTIM_EVENTFILTER_NONE) || ((FILTER) == HRTIM_EVENTFILTER_1) ||                                \
	   ((FILTER) == HRTIM_EVENTFILTER_2) || ((FILTER) == HRTIM_EVENTFILTER_3) ||                                   \
	   ((FILTER) == HRTIM_EVENTFILTER_4) || ((FILTER) == HRTIM_EVENTFILTER_5) ||                                   \
	   ((FILTER) == HRTIM_EVENTFILTER_6) || ((FILTER) == HRTIM_EVENTFILTER_7) ||                                   \
	   ((FILTER) == HRTIM_EVENTFILTER_8) || ((FILTER) == HRTIM_EVENTFILTER_9) ||                                   \
	   ((FILTER) == HRTIM_EVENTFILTER_10) || ((FILTER) == HRTIM_EVENTFILTER_11) ||                                 \
	   ((FILTER) == HRTIM_EVENTFILTER_12) || ((FILTER) == HRTIM_EVENTFILTER_13) ||                                 \
	   ((FILTER) == HRTIM_EVENTFILTER_14) || ((FILTER) == HRTIM_EVENTFILTER_15))))

#define IS_HRTIM_EVENTPRESCALER(EVENTPRESCALER)                                                                        \
	(((EVENTPRESCALER) == HRTIM_EVENTPRESCALER_DIV1) || ((EVENTPRESCALER) == HRTIM_EVENTPRESCALER_DIV2) ||         \
	 ((EVENTPRESCALER) == HRTIM_EVENTPRESCALER_DIV4) || ((EVENTPRESCALER) == HRTIM_EVENTPRESCALER_DIV8))

#define IS_HRTIM_FAULTSOURCE(FAULTSOURCE)                                                                              \
	(((FAULTSOURCE) == HRTIM_FAULTSOURCE_DIGITALINPUT) || ((FAULTSOURCE) == HRTIM_FAULTSOURCE_INTERNAL) ||         \
	 ((FAULTSOURCE) == HRTIM_FAULTSOURCE_EEVINPUT))

#define IS_HRTIM_FAULTPOLARITY(HRTIM_FAULTPOLARITY)                                                                    \
	(((HRTIM_FAULTPOLARITY) == HRTIM_FAULTPOLARITY_LOW) || ((HRTIM_FAULTPOLARITY) == HRTIM_FAULTPOLARITY_HIGH))

#define IS_HRTIM_FAULTMODECTL(FAULTMODECTL)                                                                            \
	(((FAULTMODECTL) == HRTIM_FAULTMODECTL_DISABLED) || ((FAULTMODECTL) == HRTIM_FAULTMODECTL_ENABLED))
...
#define IS_HRTIM_FAULTBLANKING(FAULTBLANKINGCTL)                                                                       \
	(((FAULTBLANKINGCTL) == HRTIM_FAULTBLANKING_DISABLED) || ((FAULTBLANKINGCTL) == HRTIM_FAULTBLANKING_ENABLED))
...
#define IS_HRTIM_FAULTCOUNTER(FAULTCOUNTER)                                                                            \
	(((FAULTCOUNTER) == HRTIM_FAULTCOUNTER_NONE) || ((FAULTCOUNTER) == HRTIM_FAULTCOUNTER_1) ||                    \
	 ((FAULTCOUNTER) == HRTIM_FAULTCOUNTER_2) || ((FAULTCOUNTER) == HRTIM_FAULTCOUNTER_3) ||                       \
	 ((FAULTCOUNTER) == HRTIM_FAULTCOUNTER_4) || ((FAULTCOUNTER) == HRTIM_FAULTCOUNTER_5) ||                       \
	 ((FAULTCOUNTER) == HRTIM_FAULTCOUNTER_6) || ((FAULTCOUNTER) == HRTIM_FAULTCOUNTER_7) ||                       \
	 ((FAULTCOUNTER) == HRTIM_FAULTCOUNTER_8) || ((FAULTCOUNTER) == HRTIM_FAULTCOUNTER_9) ||                       \
	 ((FAULTCOUNTER) == HRTIM_FAULTCOUNTER_10) || ((FAULTCOUNTER) == HRTIM_FAULTCOUNTER_11) ||                     \
	 ((FAULTCOUNTER) == HRTIM_FAULTCOUNTER_12) || ((FAULTCOUNTER) == HRTIM_FAULTCOUNTER_13) ||                     \
	 ((FAULTCOUNTER) == HRTIM_FAULTCOUNTER_14) || ((FAULTCOUNTER) == HRTIM_FAULTCOUNTER_15))
...
#define IS_HRTIM_FAULTPRESCALER(FAULTPRESCALER)                                                                        \
	(((FAULTPRESCALER) == HRTIM_FAULTPRESCALER_DIV1) || ((FAULTPRESCALER) == HRTIM_FAULTPRESCALER_DIV2) ||         \
	 ((FAULTPRESCALER) == HRTIM_FAULTPRESCALER_DIV4) || ((FAULTPRESCALER) == HRTIM_FAULTPRESCALER_DIV8))
...
#define IS_HRTIM_CALIBRATIONRATE(CALIBRATIONRATE)                                                                      \
	(((CALIBRATIONRATE) == HRTIM_SINGLE_CALIBRATION) || ((CALIBRATIONRATE) == HRTIM_CALIBRATIONRATE_0) ||          \
	 ((CALIBRATIONRATE) == HRTIM_CALIBRATIONRATE_1) || ((CALIBRATIONRATE) == HRTIM_CALIBRATIONRATE_2) ||           \
...
#define IS_HRTIM_BURSTMODECTL(BURSTMODECTL)                                                                            \
	(((BURSTMODECTL) == HRTIM_BURSTMODECTL_DISABLED) || ((BURSTMODECTL) == HRTIM_BURSTMODECTL_ENABLED))
...
#define __HAL_HRTIM_COUNTER_MODE_UP(__HANDLE__, __TIMERS__)                                                            \
	do {                                                                                                           \
		if (((__TIMERS__) & HRTIM_TIMERINDEX_TIMER_A) == HRTIM_TIMERINDEX_TIMER_A) {                           \
			CLEAR_BIT((__HANDLE__)->Instance->sTimerxRegs[(HRTIM_TIMERINDEX_TIMER_A)].TIMxCR2,             \
				  (HRTIM_TIMCR2_UDM));                                                                 \
		}                                                                                                      \
		if (((__TIMERS__) & HRTIM_TIMERINDEX_TIMER_B) == HRTIM_TIMERINDEX_TIMER_B) {                           \
			CLEAR_BIT((__HANDLE__)->Instance->sTimerxRegs[(HRTIM_TIMERINDEX_TIMER_B)].TIMxCR2,             \
				  (HRTIM_TIMCR2_UDM));                                                                 \
		}                                                                                                      \
		if (((__TIMERS__) & HRTIM_TIMERINDEX_TIMER_C) == HRTIM_TIMERINDEX_TIMER_C) {                           \
			CLEAR_BIT((__HANDLE__)->Instance->sTimerxRegs[(HRTIM_TIMERINDEX_TIMER_C)].TIMxCR2,             \
				  (HRTIM_TIMCR2_UDM));                                                                 \
		}                                                                                                      \
		if (((__TIMERS__) & HRTIM_TIMERINDEX_TIMER_D) == HRTIM_TIMERINDEX_TIMER_D) {                           \
			CLEAR_BIT((__HANDLE__)->Instance->sTimerxRegs[(HRTIM_TIMERINDEX_TIMER_D)].TIMxCR2,             \
				  (HRTIM_TIMCR2_UDM));                                                                 \
		}                                                                                                      \
		if (((__TIMERS__) & HRTIM_TIMERINDEX_TIMER_E) == HRTIM_TIMERINDEX_TIMER_E) {                           \
			CLEAR_BIT((__HANDLE__)->Instance->sTimerxRegs[(HRTIM_TIMERINDEX_TIMER_E)].TIMxCR2,             \
				  (HRTIM_TIMCR2_UDM));                                                                 \
		}                                                                                                      \
		if (((__TIMERS__) & HRTIM_TIMERINDEX_TIMER_F) == HRTIM_TIMERINDEX_TIMER_F) {                           \
			CLEAR_BIT((__HANDLE__)->Instance->sTimerxRegs[(HRTIM_TIMERINDEX_TIMER_F)].TIMxCR2,             \
				  (HRTIM_TIMCR2_UDM));                                                                 \
		}                                                                                                      \
	} while (0U)
...
#define __HAL_HRTIM_COUNTER_MODE_UPDOWN(__HANDLE__, __TIMERS__)                                                        \
	do {                                                                                                           \
		if (((__TIMERS__) & HRTIM_TIMERINDEX_TIMER_A) == HRTIM_TIMERINDEX_TIMER_A) {                           \
			SET_BIT((__HANDLE__)->Instance->sTimerxRegs[(HRTIM_TIMERINDEX_TIMER_A)].TIMxCR2,               \
				(HRTIM_TIMCR2_UDM));                                                                   \
		}                                                                                                      \
		if (((__TIMERS__) & HRTIM_TIMERINDEX_TIMER_B) == HRTIM_TIMERINDEX_TIMER_B) {                           \
			SET_BIT((__HANDLE__)->Instance->sTimerxRegs[(HRTIM_TIMERINDEX_TIMER_B)].TIMxCR2,               \
				(HRTIM_TIMCR2_UDM));                                                                   \
		}                                                                                                      \
		if (((__TIMERS__) & HRTIM_TIMERINDEX_TIMER_C) == HRTIM_TIMERINDEX_TIMER_C) {                           \
			SET_BIT((__HANDLE__)->Instance->sTimerxRegs[(HRTIM_TIMERINDEX_TIMER_C)].TIMxCR2,               \
				(HRTIM_TIMCR2_UDM));                                                                   \
		}                                                                                                      \
		if (((__TIMERS__) & HRTIM_TIMERINDEX_TIMER_D) == HRTIM_TIMERINDEX_TIMER_D) {                           \
			SET_BIT((__HANDLE__)->Instance->sTimerxRegs[(HRTIM_TIMERINDEX_TIMER_D)].TIMxCR2,               \
				(HRTIM_TIMCR2_UDM));                                                                   \
		}                                                                                                      \
		if (((__TIMERS__) & HRTIM_TIMERINDEX_TIMER_E) == HRTIM_TIMERINDEX_TIMER_E) {                           \
			SET_BIT((__HANDLE__)->Instance->sTimerxRegs[(HRTIM_TIMERINDEX_TIMER_E)].TIMxCR2,               \
				(HRTIM_TIMCR2_UDM));                                                                   \
		}                                                                                                      \
		if (((__TIMERS__) & HRTIM_TIMERINDEX_TIMER_F) == HRTIM_TIMERINDEX_TIMER_F) {                           \
			SET_BIT((__HANDLE__)->Instance->sTimerxRegs[(HRTIM_TIMERINDEX_TIMER_F)].TIMxCR2,               \
				(HRTIM_TIMCR2_UDM));                                                                   \
		}                                                                                                      \
	} while (0U)
	...
	do {                                                                                                           \
		if (((__TIMER__) & HRTIM_TIMERINDEX_TIMER_A) == HRTIM_TIMERINDEX_TIMER_A) {                            \
			if (((__EVENT__) & HRTIM_EVENTCOUNTER_A) == HRTIM_EVENTCOUNTER_A) {                            \
				((__HANDLE__)->Instance->sTimerxRegs[HRTIM_TIMERINDEX_TIMER_A].EEFxR3) |=              \
				    HRTIM_EEFR3_EEVACE;                                                                \
			}                                                                                              \
		...
		if (((__TIMER__) & HRTIM_TIMERINDEX_TIMER_B) == HRTIM_TIMERINDEX_TIMER_B) {                            \
			if (((__EVENT__) & HRTIM_EVENTCOUNTER_A) == HRTIM_EVENTCOUNTER_A) {                            \
				((__HANDLE__)->Instance->sTimerxRegs[HRTIM_TIMERINDEX_TIMER_B].EEFxR3) |=              \
				    HRTIM_EEFR3_EEVACE;                                                                \
			}                                                                                              \
		...
		if (((__TIMER__) & HRTIM_TIMERINDEX_TIMER_C) == HRTIM_TIMERINDEX_TIMER_C) {                            \
			if (((__EVENT__) & HRTIM_EVENTCOUNTER_A) == HRTIM_EVENTCOUNTER_A) {                            \
				((__HANDLE__)->Instance->sTimerxRegs[HRTIM_TIMERINDEX_TIMER_C].EEFxR3) |=              \
				    HRTIM_EEFR3_EEVACE;                                                                \
			}                                                                                              \
			if (((__EVENT__) & HRTIM_EVENTCOUNTER_B) == HRTIM_EVENTCOUNTER_B) {                            \
				((__HANDLE__)->Instance->sTimerxRegs[HRTIM_TIMERINDEX_TIMER_C].EEFxR3) |=              \
		...
		if (((__TIMER__) & HRTIM_TIMERINDEX_TIMER_D) == HRTIM_TIMERINDEX_TIMER_D) {                            \
			if (((__EVENT__) & HRTIM_EVENTCOUNTER_A) == HRTIM_EVENTCOUNTER_A) {                            \
				((__HANDLE__)->Instance->sTimerxRegs[HRTIM_TIMERINDEX_TIMER_D].EEFxR3) |=              \
				    HRTIM_EEFR3_EEVACE;                                                                \
			}                                                                                              \
			if (((__EVENT__) & HRTIM_EVENTCOUNTER_B) == HRTIM_EVENTCOUNTER_B) {                            \
				((__HANDLE__)->Instance->sTimerxRegs[HRTIM_TIMERINDEX_TIMER_D].EEFxR3) |=              \
		...
		if (((__TIMER__) & HRTIM_TIMERINDEX_TIMER_E) == HRTIM_TIMERINDEX_TIMER_E) {                            \
			if (((__EVENT__) & HRTIM_EVENTCOUNTER_A) == HRTIM_EVENTCOUNTER_A) {                            \
				((__HANDLE__)->Instance->sTimerxRegs[HRTIM_TIMERINDEX_TIMER_E].EEFxR3) |=              \
				    HRTIM_EEFR3_EEVACE;                                                                \
			}                                                                                              \
			if (((__EVENT__) & HRTIM_EVENTCOUNTER_B) == HRTIM_EVENTCOUNTER_B) {                            \
				((__HANDLE__)->Instance->sTimerxRegs[HRTIM_TIMERINDEX_TIMER_E].EEFxR3) |=              \
		...
		if (((__TIMER__) & HRTIM_TIMERINDEX_TIMER_F) == HRTIM_TIMERINDEX_TIMER_F) {                            \
			if (((__EVENT__) & HRTIM_EVENTCOUNTER_A) == HRTIM_EVENTCOUNTER_A) {                            \
				((__HANDLE__)->Instance->sTimerxRegs[HRTIM_TIMERINDEX_TIMER_F].EEFxR3) |=              \
				    HRTIM_EEFR3_EEVACE;                                                                \
			}                                                                                              \
			if (((__EVENT__) & HRTIM_EVENTCOUNTER_B) == HRTIM_EVENTCOUNTER_B) {                            \
				((__HANDLE__)->Instance->sTimerxRegs[HRTIM_TIMERINDEX_TIMER_F].EEFxR3) |=              \
...
#define __HAL_HRTIM_GET_ITSTATUS(__HANDLE__, __INTERRUPT__)                                                            \
	((((__HANDLE__)->Instance->sCommonRegs.IER & (__INTERRUPT__)) == (__INTERRUPT__)) ? SET : RESET)
...
#define __HAL_HRTIM_MASTER_GET_ITSTATUS(__HANDLE__, __INTERRUPT__)                                                     \
	((((__HANDLE__)->Instance->sMasterRegs.MDIER & (__INTERRUPT__)) == (__INTERRUPT__)) ? SET : RESET)
...
#define __HAL_HRTIM_TIMER_GET_ITSTATUS(__HANDLE__, __TIMER__, __INTERRUPT__)                                           \
	((((__HANDLE__)->Instance->sTimerxRegs[(__TIMER__)].TIMxDIER & (__INTERRUPT__)) == (__INTERRUPT__)) ? SET      \
													    : RESET)
...
#define __HAL_HRTIM_TIMER_GET_FLAG(__HANDLE__, __TIMER__, __FLAG__)                                                    \
	(((__HANDLE__)->Instance->sTimerxRegs[(__TIMER__)].TIMxISR & (__FLAG__)) == (__FLAG__))
...
#define __HAL_HRTIM_SETCLOCKPRESCALER(__HANDLE__, __TIMER__, __PRESCALER__)                                            \
	(((__TIMER__) == HRTIM_TIMERINDEX_MASTER)                                                                      \
	     ? (MODIFY_REG((__HANDLE__)->Instance->sMasterRegs.MCR, HRTIM_MCR_CK_PSC, (__PRESCALER__)))                \
...
#define __HAL_HRTIM_SETCOMPARE(__HANDLE__, __TIMER__, __COMPAREUNIT__, __COMPARE__)                                    \
	(((__TIMER__) == HRTIM_TIMERINDEX_MASTER)                                                                      \
		...
		: ((__COMPAREUNIT__) == HRTIM_COMPAREUNIT_3)                                                           \
	     ...
	     : (((__COMPAREUNIT__) == HRTIM_COMPAREUNIT_1)                                                             \
		    ? ((__HANDLE__)->Instance->sTimerxRegs[(__TIMER__)].CMP1xR = (__COMPARE__))                        \
		: ((__COMPAREUNIT__) == HRTIM_COMPAREUNIT_2)                                                           \
		    ? ((__HANDLE__)->Instance->sTimerxRegs[(__TIMER__)].CMP2xR = (__COMPARE__))                        \
		: ((__COMPAREUNIT__) == HRTIM_COMPAREUNIT_3)                                                           \
		    ? ((__HANDLE__)->Instance->sTimerxRegs[(__TIMER__)].CMP3xR = (__COMPARE__))                        \
...
HAL_StatusTypeDef HAL_HRTIM_SimpleOnePulseStop(HRTIM_HandleTypeDef *hhrtim, uint32_t TimerIdx,
					       uint32_t OnePulseChannel);
...
HAL_StatusTypeDef HAL_HRTIM_ExtEventCounterEnable(HRTIM_HandleTypeDef *hhrtim, uint32_t TimerIdx,
