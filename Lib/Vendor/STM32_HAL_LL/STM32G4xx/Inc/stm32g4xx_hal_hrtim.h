...
#define IS_HRTIM_ADCTRIGGER(ADCTRIGGER)                                                                                                                                                                \
	(((ADCTRIGGER) == HRTIM_ADCTRIGGER_1) || ((ADCTRIGGER) == HRTIM_ADCTRIGGER_2) || ((ADCTRIGGER) == HRTIM_ADCTRIGGER_3) || ((ADCTRIGGER) == HRTIM_ADCTRIGGER_4) ||                               \
	 ((ADCTRIGGER) == HRTIM_ADCTRIGGER_5) || ((ADCTRIGGER) == HRTIM_ADCTRIGGER_6) || ((ADCTRIGGER) == HRTIM_ADCTRIGGER_7) || ((ADCTRIGGER) == HRTIM_ADCTRIGGER_8) ||                               \
	 ((ADCTRIGGER) == HRTIM_ADCTRIGGER_9) || ((ADCTRIGGER) == HRTIM_ADCTRIGGER_10))
...
#define HRTIM_PRESCALERRATIO_MUL32                                                                                                                                                                     \
	(0x00000000U) /*!< fHRCK: fHRTIM x 32U = 4.608 GHz - Resolution: 217                                                                                                                           \
			 ps - Min PWM frequency: 70.3 kHz (fHRTIM=144MHz) */
#define HRTIM_PRESCALERRATIO_MUL16                                                                                                                                                                     \
	(0x00000001U) /*!< fHRCK: fHRTIM x 16U = 2.304 GHz - Resolution: 434                                                                                                                           \
			 ps - Min PWM frequency: 35.1 KHz (fHRTIM=144MHz) */
...
#define HRTIM_PRESCALERRATIO_DIV1                                                                                                                                                                      \
	(0x00000005U) /*!< fHRCK: fHRTIM = 144 MHz - Resolution: 6.95 ns - Min                                                                                                                         \
			 PWM frequency: 2.2 kHz (fHRTIM=144MHz)         */
#define HRTIM_PRESCALERRATIO_DIV2                                                                                                                                                                      \
	(0x00000006U) /*!< fHRCK: fHRTIM / 2U = 72 MHz - Resolution: 13.88 ns-                                                                                                                         \
			 Min PWM frequency: 1.1 kHz (fHRTIM=144MHz)     */
#define HRTIM_PRESCALERRATIO_DIV4                                                                                                                                                                      \
	(0x00000007U) /*!< fHRCK: fHRTIM / 4U = 36 MHz - Resolution: 27.7 ns-                                                                                                                          \
			 Min PWM frequency: 550Hz (fHRTIM=144MHz)        */
/**
 * @}
 */
...
#define HRTIM_MODE_CONTINUOUS                                                                                                                                                                          \
	(0x00000008U) /*!< The timer operates in continuous (free-running)                                                                                                                             \
			 mode */
...
#define HRTIM_MODE_SINGLESHOT_RETRIGGERABLE                                                                                                                                                            \
	(0x00000010U) /*!< The timer operates in retriggerable single-shot                                                                                                                             \
			 mode */
/**
 * @}
 */
...
#define HRTIM_SYNCSTART_ENABLED                                                                                                                                                                        \
	(HRTIM_MCR_SYNCSTRTM) /*!< Synchronization input event starts the                                                                                                                              \
				 timer */
/**
 * @}
 */
...
#define HRTIM_DACSYNC_DACTRIGOUT_3                                                                                                                                                                     \
	(HRTIM_MCR_DACSYNC_1 | HRTIM_MCR_DACSYNC_0) /*!< DAC update generated on DACTrigOut3 output                                                                                                    \
						       upon timer update */
/**
 * @}
 */
...
#define HRTIM_PRELOAD_ENABLED                                                                                                                                                                          \
	(HRTIM_MCR_PREEN) /*!< Preload enabled: the write access is done into                                                                                                                          \
...
#define HRTIM_UPDATEGATING_DMABURST_UPDATE                                                                                                                                                             \
	(HRTIM_TIMCR_UPDGAT_1) /*!< Update done on timer roll-over following a                                                                                                                         \
				  DMA burst transfer completion*/
#define HRTIM_UPDATEGATING_UPDEN1                                                                                                                                                                      \
	(HRTIM_TIMCR_UPDGAT_1 | HRTIM_TIMCR_UPDGAT_0) /*!< Slave timer only - Update done on a rising                                                                                                  \
...
#define HRTIM_UPDATEGATING_UPDEN3                                                                                                                                                                      \
	(HRTIM_TIMCR_UPDGAT_2 | HRTIM_TIMCR_UPDGAT_0) /*!< Slave timer only - Update done on a rising                                                                                                  \
							 edge of HRTIM update enable input 3U */
#define HRTIM_UPDATEGATING_UPDEN1_UPDATE                                                                                                                                                               \
	(HRTIM_TIMCR_UPDGAT_2 | HRTIM_TIMCR_UPDGAT_1) /*!< Slave timer only -  Update done on the                                                                                                      \
							 update event following a rising edge of                                                                                                       \
							 HRTIM update enable input 1U */
#define HRTIM_UPDATEGATING_UPDEN2_UPDATE                                                                                                                                                               \
	(HRTIM_TIMCR_UPDGAT_2 | HRTIM_TIMCR_UPDGAT_1 | HRTIM_TIMCR_UPDGAT_0) /*!< Slave timer only -  Update done on the                                                                               \
										update event following a rising edge of                                                                                \
										HRTIM update enable input 2U */
#define HRTIM_UPDATEGATING_UPDEN3_UPDATE                                                                                                                                                               \
	(HRTIM_TIMCR_UPDGAT_3) /*!< Slave timer only -  Update done on the                                                                                                                             \
				  update event following a rising edge of                                                                                                                              \
				  HRTIM update enable input 3U */
/**
 * @}
 */
...
#define HRTIM_TIMERBURSTMODE_RESETCOUNTER                                                                                                                                                              \
	(HRTIM_BMCR_MTBM) /*!< Timer counter clock is stopped and the counter                                                                                                                          \
			     is reset */
/**
 * @}
 */
...
#define HRTIM_TIMERGTCMP3_EQUAL                                                                                                                                                                        \
	0x00000000U /*!< Timer Compare 3 event is generated when counter is                                                                                                                            \
		       equal */
#define HRTIM_TIMERGTCMP3_GREATER                                                                                                                                                                      \
	(HRTIM_TIMCR2_GTCMP3) /*!< Timer Compare 3 Reset event is generated                                                                                                                            \
				 when counter is greater */
/**
 * @}
 */
...
#define HRTIM_TIMERGTCMP1_EQUAL                                                                                                                                                                        \
	0x00000000U /*!< Timer Compare 1 event is generated when counter is                                                                                                                            \
		       equal */
#define HRTIM_TIMERGTCMP1_GREATER                                                                                                                                                                      \
	(HRTIM_TIMCR2_GTCMP1) /*!< Timer Compare 1 event is generated when                                                                                                                             \
				 counter is greater */
/**
 * @}
 */
...
#define HRTIM_TIMER_DCDR_COUNTER                                                                                                                                                                       \
	0x00000000U /*!< the trigger is generated on counter reset or                                                                                                                                  \
		       roll-over event */
#define HRTIM_TIMER_DCDR_OUT1SET                                                                                                                                                                       \
	(HRTIM_TIMCR2_DCDR) /*!< the trigger is generated on output 1 set                                                                                                                              \
			       event */
/**
 * @}
 */
...
#define HRTIM_TIMER_DCDS_OUT1RST                                                                                                                                                                       \
	(HRTIM_TIMCR2_DCDS) /*!< the trigger is generated on output 1 reset                                                                                                                            \
			       event */
/**
 * @}
 */
...
#define HRTIM_TIMDEADTIMEINSERTION_ENABLED                                                                                                                                                             \
	HRTIM_OUTR_DTEN /*!< Dead-time is inserted between output 1 and output                                                                                                                         \
			   2U */
/**
 * @}
 */
...
#define HRTIM_TIMER_A_B_C_DELAYEDPROTECTION_DELAYEDOUT2_EEV6                                                                                                                                           \
	(HRTIM_OUTR_DLYPRT_0 | HRTIM_OUTR_DLYPRTEN) /*!< Timers A, B, C: Output 2 delayed Idle on                                                                                                      \
						       external Event 6U */
#define HRTIM_TIMER_A_B_C_DELAYEDPROTECTION_DELAYEDBOTH_EEV6                                                                                                                                           \
	(HRTIM_OUTR_DLYPRT_1 | HRTIM_OUTR_DLYPRTEN) /*!< Timers A, B, C: Output 1 and output 2                                                                                                         \
						       delayed Idle on external Event 6U */
#define HRTIM_TIMER_A_B_C_DELAYEDPROTECTION_BALANCED_EEV6                                                                                                                                              \
	(HRTIM_OUTR_DLYPRT_1 | HRTIM_OUTR_DLYPRT_0 | HRTIM_OUTR_DLYPRTEN) /*!< Timers A, B, C: Balanced Idle on                                                                                        \
									     external Event 6U */
#define HRTIM_TIMER_A_B_C_DELAYEDPROTECTION_DELAYEDOUT1_DEEV7                                                                                                                                          \
	(HRTIM_OUTR_DLYPRT_2 | HRTIM_OUTR_DLYPRTEN) /*!< Timers A, B, C: Output 1 delayed Idle on                                                                                                      \
						       external Event 7U */
#define HRTIM_TIMER_A_B_C_DELAYEDPROTECTION_DELAYEDOUT2_DEEV7                                                                                                                                          \
	(HRTIM_OUTR_DLYPRT_2 | HRTIM_OUTR_DLYPRT_0 | HRTIM_OUTR_DLYPRTEN) /*!< Timers A, B, C: Output 2 delayed Idle                                                                                   \
									     on external Event 7U */
#define HRTIM_TIMER_A_B_C_DELAYEDPROTECTION_DELAYEDBOTH_EEV7                                                                                                                                           \
	(HRTIM_OUTR_DLYPRT_2 | HRTIM_OUTR_DLYPRT_1 | HRTIM_OUTR_DLYPRTEN) /*!< Timers A, B, C: Output 1 and output2                                                                                    \
									     delayed Idle on external Event 7U */
#define HRTIM_TIMER_A_B_C_DELAYEDPROTECTION_BALANCED_EEV7                                                                                                                                              \
	(HRTIM_OUTR_DLYPRT_2 | HRTIM_OUTR_DLYPRT_1 | HRTIM_OUTR_DLYPRT_0 | HRTIM_OUTR_DLYPRTEN) /*!< Timers A, B, C: Balanced Idle on external                                                         \
												   Event 7U */
...
#define HRTIM_TIMER_D_E_DELAYEDPROTECTION_DELAYEDOUT2_EEV8                                                                                                                                             \
	(HRTIM_OUTR_DLYPRT_0 | HRTIM_OUTR_DLYPRTEN) /*!< Timers D, E: Output 2 delayed Idle on                                                                                                         \
						       external Event 6U */
#define HRTIM_TIMER_D_E_DELAYEDPROTECTION_DELAYEDBOTH_EEV8                                                                                                                                             \
	(HRTIM_OUTR_DLYPRT_1 | HRTIM_OUTR_DLYPRTEN) /*!< Timers D, E: Output 1 and output 2 delayed                                                                                                    \
						       Idle on external Event 6U */
#define HRTIM_TIMER_D_E_DELAYEDPROTECTION_BALANCED_EEV8                                                                                                                                                \
	(HRTIM_OUTR_DLYPRT_1 | HRTIM_OUTR_DLYPRT_0 | HRTIM_OUTR_DLYPRTEN) /*!< Timers D, E: Balanced Idle on external                                                                                  \
									     Event 6U */
#define HRTIM_TIMER_D_E_DELAYEDPROTECTION_DELAYEDOUT1_DEEV9                                                                                                                                            \
	(HRTIM_OUTR_DLYPRT_2 | HRTIM_OUTR_DLYPRTEN) /*!< Timers D, E: Output 1 delayed Idle on                                                                                                         \
						       external Event 7U */
#define HRTIM_TIMER_D_E_DELAYEDPROTECTION_DELAYEDOUT2_DEEV9                                                                                                                                            \
	(HRTIM_OUTR_DLYPRT_2 | HRTIM_OUTR_DLYPRT_0 | HRTIM_OUTR_DLYPRTEN) /*!< Timers D, E: Output 2 delayed Idle on                                                                                   \
									     external Event 7U */
#define HRTIM_TIMER_D_E_DELAYEDPROTECTION_DELAYEDBOTH_EEV9                                                                                                                                             \
	(HRTIM_OUTR_DLYPRT_2 | HRTIM_OUTR_DLYPRT_1 | HRTIM_OUTR_DLYPRTEN) /*!< Timers D, E: Output 1 and output2                                                                                       \
									     delayed Idle on external Event 7U */
#define HRTIM_TIMER_D_E_DELAYEDPROTECTION_BALANCED_EEV9                                                                                                                                                \
	(HRTIM_OUTR_DLYPRT_2 | HRTIM_OUTR_DLYPRT_1 | HRTIM_OUTR_DLYPRT_0 | HRTIM_OUTR_DLYPRTEN) /*!< Timers D, E: Balanced Idle on external                                                            \
												   Event 7U */
...
#define HRTIM_TIMER_F_DELAYEDPROTECTION_DELAYEDOUT2_EEV8                                                                                                                                               \
	(HRTIM_OUTR_DLYPRT_0 | HRTIM_OUTR_DLYPRTEN) /*!< Timers F: Output 2 delayed Idle on external                                                                                                   \
						       Event 6U */
#define HRTIM_TIMER_F_DELAYEDPROTECTION_DELAYEDBOTH_EEV8                                                                                                                                               \
	(HRTIM_OUTR_DLYPRT_1 | HRTIM_OUTR_DLYPRTEN) /*!< Timers F: Output 1 and output 2 delayed                                                                                                       \
						       Idle on external Event 6U */
#define HRTIM_TIMER_F_DELAYEDPROTECTION_BALANCED_EEV8                                                                                                                                                  \
	(HRTIM_OUTR_DLYPRT_1 | HRTIM_OUTR_DLYPRT_0 | HRTIM_OUTR_DLYPRTEN) /*!< Timers F: Balanced Idle on external                                                                                     \
									     Event 6U */
#define HRTIM_TIMER_F_DELAYEDPROTECTION_DELAYEDOUT1_DEEV9                                                                                                                                              \
	(HRTIM_OUTR_DLYPRT_2 | HRTIM_OUTR_DLYPRTEN) /*!< Timers F: Output 1 delayed Idle on external                                                                                                   \
						       Event 7U */
#define HRTIM_TIMER_F_DELAYEDPROTECTION_DELAYEDOUT2_DEEV9                                                                                                                                              \
	(HRTIM_OUTR_DLYPRT_2 | HRTIM_OUTR_DLYPRT_0 | HRTIM_OUTR_DLYPRTEN) /*!< Timers F: Output 2 delayed Idle on                                                                                      \
									     external Event 7U */
#define HRTIM_TIMER_F_DELAYEDPROTECTION_DELAYEDBOTH_EEV9                                                                                                                                               \
	(HRTIM_OUTR_DLYPRT_2 | HRTIM_OUTR_DLYPRT_1 | HRTIM_OUTR_DLYPRTEN) /*!< Timers F: Output 1 and output2 delayed                                                                                  \
									     Idle on external Event 7U */
#define HRTIM_TIMER_F_DELAYEDPROTECTION_BALANCED_EEV9                                                                                                                                                  \
	(HRTIM_OUTR_DLYPRT_2 | HRTIM_OUTR_DLYPRT_1 | HRTIM_OUTR_DLYPRT_0 | HRTIM_OUTR_DLYPRTEN) /*!< Timers F: Balanced Idle on external Event                                                         \
												   7U */
/**
 * @}
 */
...
#define HRTIM_TIMUPDATETRIGGER_TIMER_F                                                                                                                                                                 \
	(HRTIM_TIMCR_TFU) /*!< Register update is triggered by the timer F                                                                                                                             \
			     update */
/**
 * @}
 */
...
#define HRTIM_TIM_OUTROM_BOTH                                                                                                                                                                          \
	0x00000000U					/*!< Roll-over event which sets and/or resets the outputs                                                                                      \
							 */
...
#define HRTIM_TIM_ROM_BOTH                                                                                                                                                                             \
	0x00000000U /*!< Roll-over event with the following destinations: IRQ                                                                                                                          \
		       and DMA requests,*/
#define HRTIM_TIM_ROM_CREST                                                                                                                                                                            \
	(HRTIM_TIMCR2_ROM_1) /*!< Update trigger (to transfer content from                                                                                                                             \
				preload to active registers), */
#define HRTIM_TIM_ROM_VALLEY                                                                                                                                                                           \
	(HRTIM_TIMCR2_ROM_0) /*!< repetition counter decrement and External                                                                                                                            \
				Event filtering */
...
#define HRTIM_AUTODELAYEDMODE_AUTODELAYED_NOTIMEOUT                                                                                                                                                    \
	(HRTIM_TIMCR_DELCMP2_0) /*!< Compare event generated only if a capture                                                                                                                         \
				   has occurred */
#define HRTIM_AUTODELAYEDMODE_AUTODELAYED_TIMEOUTCMP1                                                                                                                                                  \
	(HRTIM_TIMCR_DELCMP2_1) /*!< Compare event generated if a capture has                                                                                                                          \
				   occurred or after a Compare 1 match                                                                                                                                 \
				   (timeout if capture event is missing) */
#define HRTIM_AUTODELAYEDMODE_AUTODELAYED_TIMEOUTCMP3                                                                                                                                                  \
	(HRTIM_TIMCR_DELCMP2_1 | HRTIM_TIMCR_DELCMP2_0) /*!< Compare event generated if a capture has                                                                                                  \
							   occurred or after a Compare 3 match                                                                                                         \
							   (timeout if capture event is missing) */
/**
 * @}
 */
...
#define HRTIM_BASICOCMODE_ACTIVE                                                                                                                                                                       \
	(0x00000003U) /*!< Output forced to inactive level when the timer                                                                                                                              \
			 counter reaches the compare value */
...
#define HRTIM_OUTPUTSET_RESYNC                                                                                                                                                                         \
	(HRTIM_SET1R_RESYNC) /*!< Timer reset event coming solely from                                                                                                                                 \
				software or SYNC input forces the output to                                                                                                                            \
				its active state */
#define HRTIM_OUTPUTSET_TIMPER                                                                                                                                                                         \
	(HRTIM_SET1R_PER) /*!< Timer period event forces the output to its                                                                                                                             \
			     active state */
...
#define HRTIM_OUTPUTSET_MASTERPER                                                                                                                                                                      \
	(HRTIM_SET1R_MSTPER) /*!< The master timer period event forces the                                                                                                                             \
				output to its active state */
#define HRTIM_OUTPUTSET_MASTERCMP1                                                                                                                                                                     \
	(HRTIM_SET1R_MSTCMP1) /*!< Master Timer compare 1 event forces the                                                                                                                             \
				 output to its active state */
#define HRTIM_OUTPUTSET_MASTERCMP2                                                                                                                                                                     \
	(HRTIM_SET1R_MSTCMP2) /*!< Master Timer compare 2 event forces the                                                                                                                             \
				 output to its active state */
#define HRTIM_OUTPUTSET_MASTERCMP3                                                                                                                                                                     \
	(HRTIM_SET1R_MSTCMP3) /*!< Master Timer compare 3 event forces the                                                                                                                             \
				 output to its active state */
#define HRTIM_OUTPUTSET_MASTERCMP4                                                                                                                                                                     \
	(HRTIM_SET1R_MSTCMP4) /*!< Master Timer compare 4 event forces the                                                                                                                             \
				 output to its active state */
...
#define HRTIM_OUTPUTSET_TIMCEV1_TIMACMP2                                                                                                                                                               \
	(HRTIM_SET1R_TIMEVNT1) /*!< Timer event 1 forces the output to its                                                                                                                             \
				  active state */
#define HRTIM_OUTPUTSET_TIMCEV2_TIMACMP3                                                                                                                                                               \
	(HRTIM_SET1R_TIMEVNT2) /*!< Timer event 2 forces the output to its                                                                                                                             \
				  active state */
...
#define HRTIM_OUTPUTSET_TIMEEV4_TIMCCMP1                                                                                                                                                               \
	(HRTIM_SET1R_TIMEVNT4) /*!< Timer event 4 forces the output to its                                                                                                                             \
				  active state */
#define HRTIM_OUTPUTSET_TIMEEV5_TIMCCMP2                                                                                                                                                               \
	(HRTIM_SET1R_TIMEVNT5) /*!< Timer event 5 forces the output to its                                                                                                                             \
				  active state */
...
#define HRTIM_OUTPUTRESET_MASTERPER                                                                                                                                                                    \
	(HRTIM_RST1R_MSTPER) /*!< The master timer period event forces the                                                                                                                             \
				output to its inactive state */
#define HRTIM_OUTPUTRESET_MASTERCMP1                                                                                                                                                                   \
	(HRTIM_RST1R_MSTCMP1) /*!< Master Timer compare 1 event forces the                                                                                                                             \
				 output to its inactive state */
#define HRTIM_OUTPUTRESET_MASTERCMP2                                                                                                                                                                   \
	(HRTIM_RST1R_MSTCMP2) /*!< Master Timer compare 2 event forces the                                                                                                                             \
				 output to its inactive state */
#define HRTIM_OUTPUTRESET_MASTERCMP3                                                                                                                                                                   \
	(HRTIM_RST1R_MSTCMP3) /*!< Master Timer compare 3 event forces the                                                                                                                             \
				 output to its inactive state */
#define HRTIM_OUTPUTRESET_MASTERCMP4                                                                                                                                                                   \
	(HRTIM_RST1R_MSTCMP4) /*!< Master Timer compare 4 event forces the                                                                                                                             \
				 output to its inactive state */
/* Timer Events mapping for Timer A */
...
#define HRTIM_OUTPUTRESET_TIMBEV9_TIMFCMP3                                                                                                                                                             \
	(HRTIM_RST1R_TIMEVNT9) /*!< Timer event 9 forces the output to its                                                                                                                             \
				  inactive state */
/* Timer Events mapping for Timer C */
#define HRTIM_OUTPUTRESET_TIMCEV1_TIMACMP2                                                                                                                                                             \
	(HRTIM_RST1R_TIMEVNT1) /*!< Timer event 1 forces the output to its                                                                                                                             \
				  inactive state */
#define HRTIM_OUTPUTRESET_TIMCEV2_TIMACMP3                                                                                                                                                             \
	(HRTIM_RST1R_TIMEVNT2) /*!< Timer event 2 forces the output to its                                                                                                                             \
				  inactive state */
...
#define HRTIM_OUTPUTRESET_TIMEEV4_TIMCCMP1                                                                                                                                                             \
	(HRTIM_RST1R_TIMEVNT4) /*!< Timer event 4 forces the output to its                                                                                                                             \
				  inactive state */
#define HRTIM_OUTPUTRESET_TIMEEV5_TIMCCMP2                                                                                                                                                             \
	(HRTIM_RST1R_TIMEVNT5) /*!< Timer event 5 forces the output to its                                                                                                                             \
				  inactive state */
...
#define HRTIM_OUTPUTIDLEMODE_IDLE                                                                                                                                                                      \
	(HRTIM_OUTR_IDLM1) /*!< The output is in idle state when requested by                                                                                                                          \
...
#define HRTIM_OUTPUTFAULTLEVEL_INACTIVE                                                                                                                                                                \
	(HRTIM_OUTR_FAULT1_1)							 /*!< Output at inactive level when in FAULT                                                                           \
										    state */
...
#define HRTIM_OUTPUTBURSTMODEENTRY_REGULAR                                                                                                                                                             \
	0x00000000U /*!< The programmed Idle state is applied immediately to                                                                                                                           \
		       the Output */
...
#define HRTIM_CAPTURETRIGGER_TA1_SET                                                                                                                                                                   \
	(HRTIM_CPT1CR_TA1SET) /*!< Capture is triggered by TA1 output inactive                                                                                                                         \
...
#define HRTIM_CAPTURETRIGGER_TB1_SET                                                                                                                                                                   \
	(HRTIM_CPT1CR_TB1SET) /*!< Capture is triggered by TB1 output inactive                                                                                                                         \
				 to active transition */
...
#define HRTIM_CAPTURETRIGGER_TC1_SET                                                                                                                                                                   \
	(HRTIM_CPT1CR_TC1SET) /*!< Capture is triggered by TC1 output inactive                                                                                                                         \
				 to active transition */
...
#define HRTIM_CAPTURETRIGGER_TD1_SET                                                                                                                                                                   \
	(HRTIM_CPT1CR_TD1SET) /*!< Capture is triggered by TD1 output inactive                                                                                                                         \
				 to active transition */
...
#define HRTIM_CAPTURETRIGGER_TE1_SET                                                                                                                                                                   \
	(HRTIM_CPT1CR_TE1SET) /*!< Capture is triggered by TE1 output inactive                                                                                                                         \
				 to active transition */
...
#define HRTIM_CAPTURETRIGGER_TF1_SET                                                                                                                                                                   \
	((uint64_t)(HRTIM_CPT1CR_TF1SET) << 32) /*!< Capture is triggered by TF1 output inactive to active                                                                                             \
						   transition */
#define HRTIM_CAPTURETRIGGER_TF1_RESET                                                                                                                                                                 \
	((uint64_t)(HRTIM_CPT1CR_TF1RST) << 32)					   /*!< Capture is triggered by TF1 output active to inactive                                                          \
										      transition */
...
#define HRTIM_TIMEEVFLT_BLANKINGCMP3                                                                                                                                                                   \
	(HRTIM_EEFR1_EE1FLTR_1 | HRTIM_EEFR1_EE1FLTR_0) /*!< Blanking from counter reset/roll-over to                                                                                                  \
							   Compare 3U */
...
#define HRTIM_TIMEEVFLT_BLANKING_TIMAEEF1_TIMBCMP1                                                                                                                                                     \
	(HRTIM_EEFR1_EE1FLTR_2 | HRTIM_EEFR1_EE1FLTR_0) /*!< Blanking from another timing unit:                                                                                                        \
							   TIMFLTR1 source */
#define HRTIM_TIMEEVFLT_BLANKING_TIMAEEF2_TIMBCMP4                                                                                                                                                     \
	(HRTIM_EEFR1_EE1FLTR_2 | HRTIM_EEFR1_EE1FLTR_1) /*!< Blanking from another timing unit:                                                                                                        \
							   TIMFLTR2 source */
#define HRTIM_TIMEEVFLT_BLANKING_TIMAEEF3_TIMBOUT2                                                                                                                                                     \
	(HRTIM_EEFR1_EE1FLTR_2 | HRTIM_EEFR1_EE1FLTR_1 | HRTIM_EEFR1_EE1FLTR_0) /*!< Blanking from another timing                                                                                      \
										   unit: TIMFLTR3 source */
...
#define HRTIM_TIMEEVFLT_BLANKING_TIMAEEF5_TIMCCMP4                                                                                                                                                     \
	(HRTIM_EEFR1_EE1FLTR_3 | HRTIM_EEFR1_EE1FLTR_0) /*!< Blanking from another timing unit:                                                                                                        \
							   TIMFLTR5 source */
#define HRTIM_TIMEEVFLT_BLANKING_TIMAEEF6_TIMFCMP1                                                                                                                                                     \
	(HRTIM_EEFR1_EE1FLTR_3 | HRTIM_EEFR1_EE1FLTR_1) /*!< Blanking from another timing unit:                                                                                                        \
							   TIMFLTR6 source */
#define HRTIM_TIMEEVFLT_BLANKING_TIMAEEF7_TIMDCMP1                                                                                                                                                     \
	(HRTIM_EEFR1_EE1FLTR_3 | HRTIM_EEFR1_EE1FLTR_1 | HRTIM_EEFR1_EE1FLTR_0) /*!< Blanking from another timing                                                                                      \
										   unit: TIMFLTR7 source */
#define HRTIM_TIMEEVFLT_BLANKING_TIMAEEF8_TIMECMP2                                                                                                                                                     \
	(HRTIM_EEFR1_EE1FLTR_3 | HRTIM_EEFR1_EE1FLTR_2) /*!< Blanking from another timing unit:                                                                                                        \
							   TIMFLTR8 source */
...
#define HRTIM_TIMEEVFLT_WINDOWINGCMP2                                                                                                                                                                  \
	(HRTIM_EEFR1_EE1FLTR_3 | HRTIM_EEFR1_EE1FLTR_2 | HRTIM_EEFR1_EE1FLTR_0) /*!< Windowing from counter                                                                                            \
										   reset/roll-over to Compare 2U */
#define HRTIM_TIMEEVFLT_WINDOWINGCMP3                                                                                                                                                                  \
	(HRTIM_EEFR1_EE1FLTR_3 | HRTIM_EEFR1_EE1FLTR_2 | HRTIM_EEFR1_EE1FLTR_1) /*!< Windowing from counter                                                                                            \
										   reset/roll-over to Compare 3U */
#define HRTIM_TIMEEVFLT_WINDOWINGTIM                                                                                                                                                                   \
	(HRTIM_EEFR1_EE1FLTR_3 | HRTIM_EEFR1_EE1FLTR_2 | HRTIM_EEFR1_EE1FLTR_1 | HRTIM_EEFR1_EE1FLTR_0) /*!< Windowing from another timing unit:                                                       \
													   TIMWIN source */
/**
 * @}
 */
...
#define HRTIM_TIMEVENTLATCH_ENABLED                                                                                                                                                                    \
	HRTIM_EEFR1_EE1LTCH /*!< Event is latched and delayed till the end of                                                                                                                          \
			       the blanking or windowing period */
/**
 * @}
 */
 ...
 */
#define HRTIM_EVENTCOUNTER_RSTMODE_UNCONDITIONAL                                                                                                                                                       \
...
#define HRTIM_CHOPPER_DUTYCYCLE_375                                                                                                                                                                    \
	(HRTIM_CHPR_CARDTY_1 | HRTIM_CHPR_CARDTY_0) /*!< Duty cycle of the carrier signal is 37.5U %                                                                                                   \
						     */
...
#define HRTIM_CHOPPER_DUTYCYCLE_625                                                                                                                                                                    \
	(HRTIM_CHPR_CARDTY_2 | HRTIM_CHPR_CARDTY_0) /*!< Duty cycle of the carrier signal is 62.5U %                                                                                                   \
						     */
#define HRTIM_CHOPPER_DUTYCYCLE_750                                                                                                                                                                    \
	(HRTIM_CHPR_CARDTY_2 | HRTIM_CHPR_CARDTY_1) /*!< Duty cycle of the carrier signal is 75U %                                                                                                     \
						     */
#define HRTIM_CHOPPER_DUTYCYCLE_875                                                                                                                                                                    \
	(HRTIM_CHPR_CARDTY_2 | HRTIM_CHPR_CARDTY_1 | HRTIM_CHPR_CARDTY_0) /*!< Duty cycle of the carrier signal is 87.5U %                                                                             \
									   */
/**
 * @}
 */
...
#define HRTIM_SYNCINPUTSOURCE_EXTERNALEVENT                                                                                                                                                            \
	(HRTIM_MCR_SYNC_IN_1 | HRTIM_MCR_SYNC_IN_0) /*!< A positive pulse on SYNCIN input triggers                                                                                                     \
						       the HRTIM */
/**
 * @}
 */
...
#define HRTIM_SYNCOUTPUTSOURCE_MASTER_START                                                                                                                                                            \
	0x00000000U /*!< A pulse is sent on HRTIM_SCOUT output and                                                                                                                                     \
		       hrtim_out_sync2 upon master timer start event      */
#define HRTIM_SYNCOUTPUTSOURCE_MASTER_CMP1                                                                                                                                                             \
	(HRTIM_MCR_SYNC_SRC_0) /*!< A pulse is sent on HRTIM_SCOUT output and                                                                                                                          \
				  hrtim_out_sync2 upon master timer compare 1                                                                                                                          \
				  event  */
#define HRTIM_SYNCOUTPUTSOURCE_TIMA_START                                                                                                                                                              \
	(HRTIM_MCR_SYNC_SRC_1) /*!< A pulse is sent on HRTIM_SCOUT output and                                                                                                                          \
				  hrtim_out_sync2 upon timer A start or reset                                                                                                                          \
				  events */
#define HRTIM_SYNCOUTPUTSOURCE_TIMA_CMP1                                                                                                                                                               \
	(HRTIM_MCR_SYNC_SRC_1 | HRTIM_MCR_SYNC_SRC_0) /*!< A pulse is sent on HRTIM_SCOUT output and                                                                                                   \
...
#define HRTIM_SYNCOUTPUTPOLARITY_POSITIVE                                                                                                                                                              \
	(HRTIM_MCR_SYNC_OUT_1) /*!< SCOUT pin has a low idle level and issues                                                                                                                          \
				  a positive pulse of 16 fHRTIM clock cycles                                                                                                                           \
				  length for the synchronization */
#define HRTIM_SYNCOUTPUTPOLARITY_NEGATIVE                                                                                                                                                              \
	(HRTIM_MCR_SYNC_OUT_1 | HRTIM_MCR_SYNC_OUT_0) /*!< SCOUT pin has a high idle level and issues                                                                                                  \
							 a negative pulse of 16 fHRTIM clock cycles                                                                                                    \
							 length for the synchronization */
/**
 * @}
 */
...
#define HRTIM_EEV1SRC_COMP2_OUT                                                                                                                                                                        \
	(HRTIM_EECR1_EE1SRC_0) /*!< External event source 2U for External                                                                                                                              \
				  Event 1 */
...
#define HRTIM_EEV1SRC_TIM1_TRGO                                                                                                                                                                        \
	(HRTIM_EECR1_EE1SRC_1) /*!< External event source 3U for External                                                                                                                              \
				  Event 1 */
...
#define HRTIM_EEV1SRC_ADC1_AWD1                                                                                                                                                                        \
	(HRTIM_EECR1_EE1SRC_1 | HRTIM_EECR1_EE1SRC_0) /*!< External event source 4U for External                                                                                                       \
							 Event 1 */
...
#define HRTIM_EVENTSENSITIVITY_BOTHEDGES                                                                                                                                                               \
	(HRTIM_EECR1_EE1SNS_1 | HRTIM_EECR1_EE1SNS_0) /*!< External event is active on Rising and                                                                                                      \
							 Falling edges */
/**
 * @}
 */
...
#define HRTIM_FAULTCOUNTERRST_UNCONDITIONAL                                                                                                                                                            \
	(0x00000000U) /*!< Fault counter is reset on each reset / roll-over                                                                                                                            \
			 event */
#define HRTIM_FAULTCOUNTERRST_CONDITIONAL                                                                                                                                                              \
	(0x00000001U) /*!< Fault counter is reset on each reset / roll-over                                                                                                                            \
			 event only if no fault occurred during last                                                                                                                                   \
			 countingperiod.*/
/**
 * @}
 */
...
#define HRTIM_BURSTMODECLOCKSOURCE_TIMER_A                                                                                                                                                             \
	(HRTIM_BMCR_BMCLK_0) /*!< Timer A counter reset/roll-over is used as                                                                                                                           \
				clock source for the burst mode counter */
#define HRTIM_BURSTMODECLOCKSOURCE_TIMER_B                                                                                                                                                             \
	(HRTIM_BMCR_BMCLK_1) /*!< Timer B counter reset/roll-over is used as                                                                                                                           \
				clock source for the burst mode counter */
#define HRTIM_BURSTMODECLOCKSOURCE_TIMER_C                                                                                                                                                             \
	(HRTIM_BMCR_BMCLK_1 | HRTIM_BMCR_BMCLK_0) /*!< Timer C counter reset/roll-over is used as                                                                                                      \
						     clock source for the burst mode counter */
#define HRTIM_BURSTMODECLOCKSOURCE_TIMER_D                                                                                                                                                             \
	(HRTIM_BMCR_BMCLK_2) /*!< Timer D counter reset/roll-over is used as                                                                                                                           \
				clock source for the burst mode counter */
#define HRTIM_BURSTMODECLOCKSOURCE_TIMER_E                                                                                                                                                             \
	(HRTIM_BMCR_BMCLK_2 | HRTIM_BMCR_BMCLK_0) /*!< Timer E counter reset/roll-over is used as                                                                                                      \
						     clock source for the burst mode counter */
#define HRTIM_BURSTMODECLOCKSOURCE_TIMER_F                                                                                                                                                             \
	(HRTIM_BMCR_BMCLK_2 | HRTIM_BMCR_BMCLK_0) /*!< Timer F counter reset/roll-over is used as                                                                                                      \
						     clock source for the burst mode counter */
#define HRTIM_BURSTMODECLOCKSOURCE_TIM16_OC                                                                                                                                                            \
	(HRTIM_BMCR_BMCLK_2 | HRTIM_BMCR_BMCLK_1) /*!< On-chip Event 1 (BMClk[1]), acting as a                                                                                                         \
						     burst mode counter clock */
#define HRTIM_BURSTMODECLOCKSOURCE_TIM17_OC                                                                                                                                                            \
	(HRTIM_BMCR_BMCLK_2 | HRTIM_BMCR_BMCLK_1 | HRTIM_BMCR_BMCLK_0) /*!< On-chip Event 2 (BMClk[2]), acting as a                                                                                    \
									  burst mode counter clock */
#define HRTIM_BURSTMODECLOCKSOURCE_TIM7_TRGO                                                                                                                                                           \
	(HRTIM_BMCR_BMCLK_3) /*!< On-chip Event 3 (BMClk[3]), acting as a                                                                                                                              \
				burst mode counter clock */
#define HRTIM_BURSTMODECLOCKSOURCE_FHRTIM                                                                                                                                                              \
	(HRTIM_BMCR_BMCLK_3 | HRTIM_BMCR_BMCLK_1) /*!< Prescaled fHRTIM clock is used as clock                                                                                                         \
...
#define HRIM_BURSTMODEPRELOAD_ENABLED                                                                                                                                                                  \
	(HRTIM_BMCR_BMPREN) /*!< Preload enabled: the write access is done                                                                                                                             \
...
#define HRTIM_CALIBRATIONRATE_0                                                                                                                                                                        \
	0x00000000U /*!< Periodic DLL calibration: T = 1048576U * tHRTIM                                                                                                                               \
		       (6.168 ms) */
#define HRTIM_CALIBRATIONRATE_1                                                                                                                                                                        \
	(HRTIM_DLLCR_CALRTE_0) /*!< Periodic DLL calibration: T = 131072U *                                                                                                                            \
				  tHRTIM (0.771 ms) */
#define HRTIM_CALIBRATIONRATE_2                                                                                                                                                                        \
	(HRTIM_DLLCR_CALRTE_1) /*!< Periodic DLL calibration: T = 16384U *                                                                                                                             \
				  tHRTIM (0.096 ms) */
#define HRTIM_CALIBRATIONRATE_3                                                                                                                                                                        \
	(HRTIM_DLLCR_CALRTE_1 | HRTIM_DLLCR_CALRTE_0) /*!< Periodic DLL calibration: T = 2048U *                                                                                                       \
							 tHRTIM (0.012 ms) */
/**
 * @}
 */
...
#define HRTIM_BURSTDMA_CR                                                                                                                                                                              \
	(HRTIM_BDTUPR_TIMCR) /*!< MCR or TIMxCR register is updated by Burst                                                                                                                           \
				DMA accesses */
#define HRTIM_BURSTDMA_ICR                                                                                                                                                                             \
	(HRTIM_BDTUPR_TIMICR) /*!< MICR or TIMxICR register is updated by                                                                                                                              \
				 Burst DMA accesses */
#define HRTIM_BURSTDMA_DIER                                                                                                                                                                            \
	(HRTIM_BDTUPR_TIMDIER) /*!< MDIER or TIMxDIER register is updated by                                                                                                                           \
				  Burst DMA accesses */
#define HRTIM_BURSTDMA_CNT                                                                                                                                                                             \
	(HRTIM_BDTUPR_TIMCNT) /*!< MCNTR or CNTxCR register is updated by                                                                                                                              \
				 Burst DMA accesses */
#define HRTIM_BURSTDMA_PER                                                                                                                                                                             \
	(HRTIM_BDTUPR_TIMPER) /*!< MPER or PERxR register is updated by Burst                                                                                                                          \
				 DMA accesses */
#define HRTIM_BURSTDMA_REP                                                                                                                                                                             \
	(HRTIM_BDTUPR_TIMREP) /*!< MREPR or REPxR register is updated by Burst                                                                                                                         \
				 DMA accesses */
#define HRTIM_BURSTDMA_CMP1                                                                                                                                                                            \
	(HRTIM_BDTUPR_TIMCMP1) /*!< MCMP1R or CMP1xR register is updated by                                                                                                                            \
				  Burst DMA accesses */
#define HRTIM_BURSTDMA_CMP2                                                                                                                                                                            \
	(HRTIM_BDTUPR_TIMCMP2) /*!< MCMP2R or CMP2xR register is updated by                                                                                                                            \
				  Burst DMA accesses */
#define HRTIM_BURSTDMA_CMP3                                                                                                                                                                            \
	(HRTIM_BDTUPR_TIMCMP3) /*!< MCMP3R or CMP3xR register is updated by                                                                                                                            \
				  Burst DMA accesses */
#define HRTIM_BURSTDMA_CMP4                                                                                                                                                                            \
	(HRTIM_BDTUPR_TIMCMP4) /*!< MCMP4R or CMP4xR register is updated by                                                                                                                            \
				  Burst DMA accesses */
...
#define HRTIM_TIMERUPDATE_MASTER                                                                                                                                                                       \
	(HRTIM_CR2_MSWU) /*!< Force an immediate transfer from the preload to                                                                                                                          \
			    the active register in the master timer */
#define HRTIM_TIMERUPDATE_A                                                                                                                                                                            \
	(HRTIM_CR2_TASWU) /*!< Force an immediate transfer from the preload to                                                                                                                         \
			     the active register in the timer A */
#define HRTIM_TIMERUPDATE_B                                                                                                                                                                            \
	(HRTIM_CR2_TBSWU) /*!< Force an immediate transfer from the preload to                                                                                                                         \
			     the active register in the timer B */
#define HRTIM_TIMERUPDATE_C                                                                                                                                                                            \
	(HRTIM_CR2_TCSWU) /*!< Force an immediate transfer from the preload to                                                                                                                         \
			     the active register in the timer C */
#define HRTIM_TIMERUPDATE_D                                                                                                                                                                            \
	(HRTIM_CR2_TDSWU) /*!< Force an immediate transfer from the preload to                                                                                                                         \
			     the active register in the timer D */
#define HRTIM_TIMERUPDATE_E                                                                                                                                                                            \
	(HRTIM_CR2_TESWU) /*!< Force an immediate transfer from the preload to                                                                                                                         \
			     the active register in the timer E */
#define HRTIM_TIMERUPDATE_F                                                                                                                                                                            \
	(HRTIM_CR2_TFSWU) /*!< Forces an immediate transfer from the preload                                                                                                                           \
			     to the active register in the timer F */
/**
 * @}
 */
...
#define HRTIM_PUSHPULL_CURRENTSTATUS_OUTPUT2                                                                                                                                                           \
	(HRTIM_TIMISR_CPPSTAT) /*!< Signal applied on output 2 and output 1                                                                                                                            \
				  forced inactive */
/**
 * @}
 */
...
#define HRTIM_CAPTUREFTRIGGER_TF1_SET                                                                                                                                                                  \
	(HRTIM_CPT1CR_TF1SET) /*!< 32bit value Capture is triggered by TF1                                                                                                                             \
				 output inactive to active transition */
#define HRTIM_CAPTUREFTRIGGER_TF1_RESET                                                                                                                                                                \
	(HRTIM_CPT1CR_TF1RST) /*!< 32bit value Capture is triggered by TF1                                                                                                                             \
...
#define IS_HRTIM_TIMERINDEX(TIMERINDEX)                                                                                                                                                                \
	(((TIMERINDEX) == HRTIM_TIMERINDEX_MASTER) || ((TIMERINDEX) == HRTIM_TIMERINDEX_TIMER_A) || ((TIMERINDEX) == HRTIM_TIMERINDEX_TIMER_B) || ((TIMERINDEX) == HRTIM_TIMERINDEX_TIMER_C) ||        \
	 ((TIMERINDEX) == HRTIM_TIMERINDEX_TIMER_D) || ((TIMERINDEX) == HRTIM_TIMERINDEX_TIMER_E) || ((TIMERINDEX) == HRTIM_TIMERINDEX_TIMER_F))

#define IS_HRTIM_TIMING_UNIT(TIMERINDEX)                                                                                                                                                               \
	(((TIMERINDEX) == HRTIM_TIMERINDEX_TIMER_A) || ((TIMERINDEX) == HRTIM_TIMERINDEX_TIMER_B) || ((TIMERINDEX) == HRTIM_TIMERINDEX_TIMER_C) || ((TIMERINDEX) == HRTIM_TIMERINDEX_TIMER_D) ||       \
	 ((TIMERINDEX) == HRTIM_TIMERINDEX_TIMER_E) || ((TIMERINDEX) == HRTIM_TIMERINDEX_TIMER_F))

#define IS_HRTIM_TIMERID(TIMERID) (((TIMERID) & 0xFF80FFFFU) == 0x00000000U)

#define IS_HRTIM_COMPAREUNIT(COMPAREUNIT)                                                                                                                                                              \
	(((COMPAREUNIT) == HRTIM_COMPAREUNIT_1) || ((COMPAREUNIT) == HRTIM_COMPAREUNIT_2) || ((COMPAREUNIT) == HRTIM_COMPAREUNIT_3) || ((COMPAREUNIT) == HRTIM_COMPAREUNIT_4))
...
#define IS_HRTIM_TIMER_OUTPUT(TIMER, OUTPUT)                                                                                                                                                           \
	((((TIMER) == HRTIM_TIMERINDEX_TIMER_A) && (((OUTPUT) == HRTIM_OUTPUT_TA1) || ((OUTPUT) == HRTIM_OUTPUT_TA2))) ||                                                                              \
	 (((TIMER) == HRTIM_TIMERINDEX_TIMER_B) && (((OUTPUT) == HRTIM_OUTPUT_TB1) || ((OUTPUT) == HRTIM_OUTPUT_TB2))) ||                                                                              \
	 (((TIMER) == HRTIM_TIMERINDEX_TIMER_C) && (((OUTPUT) == HRTIM_OUTPUT_TC1) || ((OUTPUT) == HRTIM_OUTPUT_TC2))) ||                                                                              \
	 (((TIMER) == HRTIM_TIMERINDEX_TIMER_D) && (((OUTPUT) == HRTIM_OUTPUT_TD1) || ((OUTPUT) == HRTIM_OUTPUT_TD2))) ||                                                                              \
	 (((TIMER) == HRTIM_TIMERINDEX_TIMER_E) && (((OUTPUT) == HRTIM_OUTPUT_TE1) || ((OUTPUT) == HRTIM_OUTPUT_TE2))) ||                                                                              \
	 (((TIMER) == HRTIM_TIMERINDEX_TIMER_F) && (((OUTPUT) == HRTIM_OUTPUT_TF1) || ((OUTPUT) == HRTIM_OUTPUT_TF2))))

#define IS_HRTIM_TIMEEVENT(EVENT) (((EVENT) == HRTIM_EVENTCOUNTER_A) || ((EVENT) == HRTIM_EVENTCOUNTER_B))

#define IS_HRTIM_TIMEEVENT_RESETMODE(EVENT) (((EVENT) == HRTIM_EVENTCOUNTER_RSTMODE_UNCONDITIONAL) || ((EVENT) == HRTIM_EVENTCOUNTER_RSTMODE_CONDITIONAL))

#define IS_HRTIM_TIMSYNCUPDATE(EVENT) (((EVENT) == HRTIM_TIMERESYNC_UPDATE_UNCONDITIONAL) || ((EVENT) == HRTIM_TIMERESYNC_UPDATE_CONDITIONAL))

#define IS_HRTIM_TIMEEVENT_COUNTER(COUNTER) ((((COUNTER) > (uint32_t)0x00U) && ((COUNTER) <= (uint32_t)0x3FU)) || ((COUNTER) == (uint32_t)0x00U))

#define IS_HRTIM_TIMEEVENT_SOURCE(SOURCE) (((SOURCE) >= (uint32_t)0x00U) && ((SOURCE) <= (uint32_t)0x9U))

#define IS_HRTIM_EVENT(EVENT)                                                                                                                                                                          \
	(((EVENT) == HRTIM_EVENT_NONE) || ((EVENT) == HRTIM_EVENT_1) || ((EVENT) == HRTIM_EVENT_2) || ((EVENT) == HRTIM_EVENT_3) || ((EVENT) == HRTIM_EVENT_4) || ((EVENT) == HRTIM_EVENT_5) ||        \
	 ((EVENT) == HRTIM_EVENT_6) || ((EVENT) == HRTIM_EVENT_7) || ((EVENT) == HRTIM_EVENT_8) || ((EVENT) == HRTIM_EVENT_9) || ((EVENT) == HRTIM_EVENT_10))

#define IS_HRTIM_FAULT(FAULT)                                                                                                                                                                          \
	(((FAULT) == HRTIM_FAULT_1) || ((FAULT) == HRTIM_FAULT_2) || ((FAULT) == HRTIM_FAULT_3) || ((FAULT) == HRTIM_FAULT_4) || ((FAULT) == HRTIM_FAULT_5) || ((FAULT) == HRTIM_FAULT_6))

#define IS_HRTIM_PRESCALERRATIO(PRESCALERRATIO)                                                                                                                                                        \
	(((PRESCALERRATIO) == HRTIM_PRESCALERRATIO_MUL32) || ((PRESCALERRATIO) == HRTIM_PRESCALERRATIO_MUL16) || ((PRESCALERRATIO) == HRTIM_PRESCALERRATIO_MUL8) ||                                    \
	 ((PRESCALERRATIO) == HRTIM_PRESCALERRATIO_MUL4) || ((PRESCALERRATIO) == HRTIM_PRESCALERRATIO_MUL2) || ((PRESCALERRATIO) == HRTIM_PRESCALERRATIO_DIV1) ||                                      \
	 ((PRESCALERRATIO) == HRTIM_PRESCALERRATIO_DIV2) || ((PRESCALERRATIO) == HRTIM_PRESCALERRATIO_DIV4))

#define IS_HRTIM_MODE(MODE) (((MODE) == HRTIM_MODE_CONTINUOUS) || ((MODE) == HRTIM_MODE_SINGLESHOT) || ((MODE) == HRTIM_MODE_SINGLESHOT_RETRIGGERABLE))
...
#define IS_HRTIM_INTERLEAVEDMODE(INTLVDMODE)                                                                                                                                                           \
	(((INTLVDMODE) == HRTIM_INTERLEAVED_MODE_DISABLED) || ((INTLVDMODE) == HRTIM_INTERLEAVED_MODE_DUAL) || ((INTLVDMODE) == HRTIM_INTERLEAVED_MODE_DISABLED) ||                                    \
	 ((INTLVDMODE) == HRTIM_INTERLEAVED_MODE_TRIPLE) || ((INTLVDMODE) == HRTIM_INTERLEAVED_MODE_DISABLED) || ((INTLVDMODE) == HRTIM_INTERLEAVED_MODE_QUAD))
...
#define IS_HRTIM_UPDATEGATING_TIM(UPDATEGATING)                                                                                                                                                        \
	(((UPDATEGATING) == HRTIM_UPDATEGATING_INDEPENDENT) || ((UPDATEGATING) == HRTIM_UPDATEGATING_DMABURST) || ((UPDATEGATING) == HRTIM_UPDATEGATING_DMABURST_UPDATE) ||                            \
	 ((UPDATEGATING) == HRTIM_UPDATEGATING_UPDEN1) || ((UPDATEGATING) == HRTIM_UPDATEGATING_UPDEN2) || ((UPDATEGATING) == HRTIM_UPDATEGATING_UPDEN3) ||                                            \
	 ((UPDATEGATING) == HRTIM_UPDATEGATING_UPDEN1_UPDATE) || ((UPDATEGATING) == HRTIM_UPDATEGATING_UPDEN2_UPDATE) || ((UPDATEGATING) == HRTIM_UPDATEGATING_UPDEN3_UPDATE))

#define IS_HRTIM_TIMERBURSTMODE(MODE) (((MODE) == HRTIM_TIMERBURSTMODE_MAINTAINCLOCK) || ((MODE) == HRTIM_TIMERBURSTMODE_RESETCOUNTER))
#define IS_HRTIM_TIMERUPDOWNMODE(MODE) (((MODE) == HRTIM_TIMERUPDOWNMODE_UP) || ((MODE) == HRTIM_TIMERUPDOWNMODE_UPDOWN))

#define IS_HRTIM_TIMERTRGHLFMODE(MODE) (((MODE) == HRTIM_TIMERTRIGHALF_DISABLED) || ((MODE) == HRTIM_TIMERTRIGHALF_ENABLED))

#define IS_HRTIM_TIMERGTCMP3(MODE) (((MODE) == HRTIM_TIMERGTCMP3_EQUAL) || ((MODE) == HRTIM_TIMERGTCMP3_GREATER))

#define IS_HRTIM_TIMERGTCMP1(MODE) (((MODE) == HRTIM_TIMERGTCMP1_EQUAL) || ((MODE) == HRTIM_TIMERGTCMP1_GREATER))

#define IS_HRTIM_DUALDAC_RESET(DUALCHANNELDAC) (((DUALCHANNELDAC) == HRTIM_TIMER_DCDR_COUNTER) || ((DUALCHANNELDAC) == HRTIM_TIMER_DCDR_OUT1SET))

#define IS_HRTIM_DUALDAC_STEP(DUALCHANNELDAC) (((DUALCHANNELDAC) == HRTIM_TIMER_DCDS_CMP2) || ((DUALCHANNELDAC) == HRTIM_TIMER_DCDS_OUT1RST))

#define IS_HRTIM_DUALDAC_ENABLE(DUALCHANNELDAC) (((DUALCHANNELDAC) == HRTIM_TIMER_DCDE_DISABLED) || ((DUALCHANNELDAC) == HRTIM_TIMER_DCDE_ENABLED))
...
#define IS_HRTIM_TIMDELAYEDPROTECTION(TIMPUSHPULLMODE, TIMDELAYEDPROTECTION)                                                                                                                           \
	((((TIMDELAYEDPROTECTION) == HRTIM_TIMER_A_B_C_DELAYEDPROTECTION_DISABLED) || ((TIMDELAYEDPROTECTION) == HRTIM_TIMER_A_B_C_DELAYEDPROTECTION_DELAYEDOUT1_EEV6) ||                              \
	  ((TIMDELAYEDPROTECTION) == HRTIM_TIMER_A_B_C_DELAYEDPROTECTION_DELAYEDOUT2_EEV6) || ((TIMDELAYEDPROTECTION) == HRTIM_TIMER_A_B_C_DELAYEDPROTECTION_DELAYEDBOTH_EEV6) ||                      \
	  ((TIMDELAYEDPROTECTION) == HRTIM_TIMER_A_B_C_DELAYEDPROTECTION_DELAYEDOUT1_DEEV7) || ((TIMDELAYEDPROTECTION) == HRTIM_TIMER_A_B_C_DELAYEDPROTECTION_DELAYEDOUT2_DEEV7) ||                    \
	  ((TIMDELAYEDPROTECTION) == HRTIM_TIMER_A_B_C_DELAYEDPROTECTION_DELAYEDBOTH_EEV7)) ||                                                                                                         \
	 (((TIMPUSHPULLMODE) == HRTIM_TIMPUSHPULLMODE_ENABLED) &&                                                                                                                                      \
	  (((TIMDELAYEDPROTECTION) == HRTIM_TIMER_A_B_C_DELAYEDPROTECTION_BALANCED_EEV6) || ((TIMDELAYEDPROTECTION) == HRTIM_TIMER_A_B_C_DELAYEDPROTECTION_BALANCED_EEV7))))
...
#define IS_HRTIM_AUTODELAYEDMODE(AUTODELAYEDMODE)                                                                                                                                                      \
	(((AUTODELAYEDMODE) == HRTIM_AUTODELAYEDMODE_REGULAR) || ((AUTODELAYEDMODE) == HRTIM_AUTODELAYEDMODE_AUTODELAYED_NOTIMEOUT) ||                                                                 \
	 ((AUTODELAYEDMODE) == HRTIM_AUTODELAYEDMODE_AUTODELAYED_TIMEOUTCMP1) || ((AUTODELAYEDMODE) == HRTIM_AUTODELAYEDMODE_AUTODELAYED_TIMEOUTCMP3))
...
#define IS_HRTIM_COMPAREUNIT_AUTODELAYEDMODE(COMPAREUNIT, AUTODELAYEDMODE)                                                                                                                             \
	((((COMPAREUNIT) == HRTIM_COMPAREUNIT_2) && (((AUTODELAYEDMODE) == HRTIM_AUTODELAYEDMODE_REGULAR) || ((AUTODELAYEDMODE) == HRTIM_AUTODELAYEDMODE_AUTODELAYED_NOTIMEOUT) ||                     \
						     ((AUTODELAYEDMODE) == HRTIM_AUTODELAYEDMODE_AUTODELAYED_TIMEOUTCMP1) || ((AUTODELAYEDMODE) == HRTIM_AUTODELAYEDMODE_AUTODELAYED_TIMEOUTCMP3))) || \
	 (((COMPAREUNIT) == HRTIM_COMPAREUNIT_4) && (((AUTODELAYEDMODE) == HRTIM_AUTODELAYEDMODE_REGULAR) || ((AUTODELAYEDMODE) == HRTIM_AUTODELAYEDMODE_AUTODELAYED_NOTIMEOUT) ||                     \
						     ((AUTODELAYEDMODE) == HRTIM_AUTODELAYEDMODE_AUTODELAYED_TIMEOUTCMP1) || ((AUTODELAYEDMODE) == HRTIM_AUTODELAYEDMODE_AUTODELAYED_TIMEOUTCMP3))))
...
#define IS_HRTIM_OUTPUTSET(OUTPUTSET)                                                                                                                                                                  \
	(((OUTPUTSET) == HRTIM_OUTPUTSET_NONE) || ((OUTPUTSET) == HRTIM_OUTPUTSET_RESYNC) || ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMPER) || ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMCMP1) ||                    \
	 ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMCMP2) || ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMCMP3) || ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMCMP4) || ((OUTPUTSET) == HRTIM_OUTPUTSET_MASTERPER) ||             \
	 ((OUTPUTSET) == HRTIM_OUTPUTSET_MASTERCMP1) || ((OUTPUTSET) == HRTIM_OUTPUTSET_MASTERCMP2) || ((OUTPUTSET) == HRTIM_OUTPUTSET_MASTERCMP3) || ((OUTPUTSET) == HRTIM_OUTPUTSET_MASTERCMP4) ||   \
	 ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMAEV1_TIMBCMP1) || ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMAEV2_TIMBCMP2) || ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMAEV3_TIMCCMP2) ||                                \
	 ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMAEV4_TIMCCMP3) || ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMAEV5_TIMDCMP1) || ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMAEV6_TIMDCMP2) ||                                \
	 ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMAEV7_TIMECMP3) || ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMAEV8_TIMECMP4) || ((OUTPUTSET) == HRTIM_OUTPUTSET_TIMAEV9_TIMFCMP4) ||                                \
	 ((OUTPUTSET) == HRTIM_OUTPUTSET_EEV_1) || ((OUTPUTSET) == HRTIM_OUTPUTSET_EEV_2) || ((OUTPUTSET) == HRTIM_OUTPUTSET_EEV_3) || ((OUTPUTSET) == HRTIM_OUTPUTSET_EEV_4) ||                       \
	 ((OUTPUTSET) == HRTIM_OUTPUTSET_EEV_5) || ((OUTPUTSET) == HRTIM_OUTPUTSET_EEV_6) || ((OUTPUTSET) == HRTIM_OUTPUTSET_EEV_7) || ((OUTPUTSET) == HRTIM_OUTPUTSET_EEV_8) ||                       \
	 ((OUTPUTSET) == HRTIM_OUTPUTSET_EEV_9) || ((OUTPUTSET) == HRTIM_OUTPUTSET_EEV_10) || ((OUTPUTSET) == HRTIM_OUTPUTSET_UPDATE))

#define IS_HRTIM_OUTPUTRESET(OUTPUTRESET)                                                                                                                                                              \
	(((OUTPUTRESET) == HRTIM_OUTPUTRESET_NONE) || ((OUTPUTRESET) == HRTIM_OUTPUTRESET_RESYNC) || ((OUTPUTRESET) == HRTIM_OUTPUTRESET_TIMPER) || ((OUTPUTRESET) == HRTIM_OUTPUTRESET_TIMCMP1) ||    \
	 ((OUTPUTRESET) == HRTIM_OUTPUTRESET_TIMCMP2) || ((OUTPUTRESET) == HRTIM_OUTPUTRESET_TIMCMP3) || ((OUTPUTRESET) == HRTIM_OUTPUTRESET_TIMCMP4) ||                                               \
	 ((OUTPUTRESET) == HRTIM_OUTPUTRESET_MASTERPER) || ((OUTPUTRESET) == HRTIM_OUTPUTRESET_MASTERCMP1) || ((OUTPUTRESET) == HRTIM_OUTPUTRESET_MASTERCMP2) ||                                       \
	 ((OUTPUTRESET) == HRTIM_OUTPUTRESET_MASTERCMP3) || ((OUTPUTRESET) == HRTIM_OUTPUTRESET_MASTERCMP4) || ((OUTPUTRESET) == HRTIM_OUTPUTRESET_TIMAEV1_TIMBCMP1) ||                                \
	 ((OUTPUTRESET) == HRTIM_OUTPUTRESET_TIMAEV2_TIMBCMP2) || ((OUTPUTRESET) == HRTIM_OUTPUTRESET_TIMAEV3_TIMCCMP2) || ((OUTPUTRESET) == HRTIM_OUTPUTRESET_TIMAEV4_TIMCCMP3) ||                    \
	 ((OUTPUTRESET) == HRTIM_OUTPUTRESET_TIMAEV5_TIMDCMP1) || ((OUTPUTRESET) == HRTIM_OUTPUTRESET_TIMAEV6_TIMDCMP2) || ((OUTPUTRESET) == HRTIM_OUTPUTRESET_TIMAEV7_TIMECMP3) ||                    \
	 ((OUTPUTRESET) == HRTIM_OUTPUTRESET_TIMAEV8_TIMECMP4) || ((OUTPUTRESET) == HRTIM_OUTPUTRESET_TIMAEV9_TIMFCMP4) || ((OUTPUTRESET) == HRTIM_OUTPUTRESET_EEV_1) ||                               \
	 ((OUTPUTRESET) == HRTIM_OUTPUTRESET_EEV_2) || ((OUTPUTRESET) == HRTIM_OUTPUTRESET_EEV_3) || ((OUTPUTRESET) == HRTIM_OUTPUTRESET_EEV_4) || ((OUTPUTRESET) == HRTIM_OUTPUTRESET_EEV_5) ||       \
	 ((OUTPUTRESET) == HRTIM_OUTPUTRESET_EEV_6) || ((OUTPUTRESET) == HRTIM_OUTPUTRESET_EEV_7) || ((OUTPUTRESET) == HRTIM_OUTPUTRESET_EEV_8) || ((OUTPUTRESET) == HRTIM_OUTPUTRESET_EEV_9) ||       \
	 ((OUTPUTRESET) == HRTIM_OUTPUTRESET_EEV_10) || ((OUTPUTRESET) == HRTIM_OUTPUTRESET_UPDATE))
...
#define IS_HRTIM_OUTPUTIDLELEVEL(OUTPUTIDLELEVEL) (((OUTPUTIDLELEVEL) == HRTIM_OUTPUTIDLELEVEL_INACTIVE) || ((OUTPUTIDLELEVEL) == HRTIM_OUTPUTIDLELEVEL_ACTIVE))

#define IS_HRTIM_OUTPUTFAULTLEVEL(OUTPUTFAULTLEVEL)                                                                                                                                                    \
	(((OUTPUTFAULTLEVEL) == HRTIM_OUTPUTFAULTLEVEL_NONE) || ((OUTPUTFAULTLEVEL) == HRTIM_OUTPUTFAULTLEVEL_ACTIVE) || ((OUTPUTFAULTLEVEL) == HRTIM_OUTPUTFAULTLEVEL_INACTIVE) ||                    \
...
#define IS_HRTIM_OUTPUTBALANCEDIDLE(OUTPUTBIAR) (((OUTPUTBIAR) == HRTIM_OUTPUTBIAR_DISABLED) || ((OUTPUTBIAR) == HRTIM_OUTPUTBIAR_ENABLED))

#define IS_HRTIM_TIMER_CAPTURETRIGGER(TIMER, CAPTURETRIGGER)                                                                                                                                           \
	(((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_NONE) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_UPDATE) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_EEV_1) ||                                   \
	 ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_EEV_2) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_EEV_3) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_EEV_4) ||                                   \
	 ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_EEV_5) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_EEV_6) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_EEV_7) ||                                   \
	 ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_EEV_8) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_EEV_9) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_EEV_10) ||                                  \
	 (((TIMER) == HRTIM_TIMERINDEX_TIMER_A) &&                                                                                                                                                     \
	  (((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TB1_SET) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TB1_RESET) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERB_CMP1) ||                     \
	   ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERB_CMP2) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TC1_SET) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TC1_RESET) ||                     \
	   ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERC_CMP1) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERC_CMP2) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TD1_SET) ||                   \
	   ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TD1_RESET) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERD_CMP1) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERD_CMP2) ||                 \
	 ...
	 (((TIMER) == HRTIM_TIMERINDEX_TIMER_B) &&                                                                                                                                                     \
	  (((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TA1_SET) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TA1_RESET) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERA_CMP1) ||                     \
	   ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERA_CMP2) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TC1_SET) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TC1_RESET) ||                     \
	   ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERC_CMP1) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERC_CMP2) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TD1_SET) ||                   \
	   ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TD1_RESET) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERD_CMP1) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERD_CMP2) ||                 \
	   ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TE1_SET) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TE1_RESET) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERE_CMP1) ||                     \
	   ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERE_CMP2))) ||                                                                                                                                 \
	 (((TIMER) == HRTIM_TIMERINDEX_TIMER_C) &&                                                                                                                                                     \
	  (((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TA1_SET) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TA1_RESET) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERA_CMP1) ||                     \
	   ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERA_CMP2) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TB1_SET) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TB1_RESET) ||                     \
	   ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERB_CMP1) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERB_CMP2) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TD1_SET) ||                   \
	   ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TD1_RESET) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERD_CMP1) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERD_CMP2) ||                 \
	   ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TE1_SET) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TE1_RESET) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERE_CMP1) ||                     \
	   ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERE_CMP2))) ||                                                                                                                                 \
	 (((TIMER) == HRTIM_TIMERINDEX_TIMER_D) &&                                                                                                                                                     \
	  (((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TA1_SET) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TA1_RESET) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERA_CMP1) ||                     \
	   ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERA_CMP2) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TB1_SET) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TB1_RESET) ||                     \
	   ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERB_CMP1) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERB_CMP2) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TC1_SET) ||                   \
	   ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TC1_RESET) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERC_CMP1) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERC_CMP2) ||                 \
	   ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TE1_SET) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TE1_RESET) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERE_CMP1) ||                     \
	   ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERE_CMP2))) ||                                                                                                                                 \
	 ...
	 (((TIMER) == HRTIM_TIMERINDEX_TIMER_F) &&                                                                                                                                                     \
	  (((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TA1_SET) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TA1_RESET) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERA_CMP1) ||                     \
	   ...
	   ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TC1_RESET) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERC_CMP1) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERC_CMP2) ||                 \
	   ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TD1_SET) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TD1_RESET) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERD_CMP1) ||                     \
	   ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERD_CMP2) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TE1_SET) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TE1_RESET) ||                     \
	   ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERE_CMP1) || ((CAPTURETRIGGER) == HRTIM_CAPTURETRIGGER_TIMERE_CMP2))))

#define IS_HRTIM_TIMER_CAPTUREFTRIGGER(TIMER, CAPTUREFTRIGGER)                                                                                                                                         \
	(((CAPTUREFTRIGGER) == HRTIM_CAPTUREFTRIGGER_NONE) || ((CAPTUREFTRIGGER) == HRTIM_CAPTUREFTRIGGER_TF1_SET) || ((CAPTUREFTRIGGER) == HRTIM_CAPTUREFTRIGGER_TF1_RESET) ||                        \
	 ((CAPTUREFTRIGGER) == HRTIM_CAPTUREFTRIGGER_TIMERF_CMP1) || ((CAPTUREFTRIGGER) == HRTIM_CAPTUREFTRIGGER_TIMERF_CMP2))

#define IS_HRTIM_TIMEVENTFILTER(TIMER, TIMEVENTFILTER)                                                                                                                                                 \
	(((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_NONE) || ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKINGCMP1) || ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKINGCMP2) ||                                     \
	 ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKINGCMP3) || ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKINGCMP4) || ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_WINDOWINGCMP2) ||                            \
	 ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_WINDOWINGCMP3) || ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_WINDOWINGTIM) ||                                                                                  \
	 (((TIMER) == HRTIM_TIMERINDEX_TIMER_A) && (((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMAEEF1_TIMBCMP1) || ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMAEEF2_TIMBCMP4) ||            \
						    ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMAEEF3_TIMBOUT2) || ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMAEEF4_TIMCCMP1) ||            \
						    ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMAEEF5_TIMCCMP4) || ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMAEEF6_TIMFCMP1) ||            \
						    ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMAEEF7_TIMDCMP1) || ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMAEEF8_TIMECMP2))) ||          \
	 (((TIMER) == HRTIM_TIMERINDEX_TIMER_B) && (((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMBEEF1_TIMACMP1) || ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMBEEF2_TIMACMP4) ||            \
						    ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMBEEF3_TIMAOUT2) || ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMBEEF4_TIMCCMP1) ||            \
						    ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMBEEF5_TIMCCMP2) || ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMBEEF6_TIMFCMP2) ||            \
						    ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMBEEF7_TIMDCMP2) || ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMBEEF8_TIMECMP1))) ||          \
	 (((TIMER) == HRTIM_TIMERINDEX_TIMER_C) && (((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMCEEF1_TIMACMP2) || ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMCEEF2_TIMBCMP1) ||            \
						    ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMCEEF3_TIMBCMP4) || ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMCEEF4_TIMFCMP1) ||            \
						    ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMCEEF5_TIMDCMP1) || ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMCEEF6_TIMDCMP4) ||            \
						    ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMCEEF7_TIMDOUT2) || ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMCEEF8_TIMECMP4))) ||          \
	 (((TIMER) == HRTIM_TIMERINDEX_TIMER_D) && (((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMDEEF1_TIMACMP1) || ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMDEEF2_TIMBCMP2) ||            \
						    ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMDEEF3_TIMCCMP1) || ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMDEEF4_TIMCCMP2) ||            \
						    ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMDEEF5_TIMCOUT2) || ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMDEEF6_TIMECMP1) ||            \
						    ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMDEEF7_TIMECMP4) || ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMDEEF8_TIMFCMP4))) ||          \
	 (((TIMER) == HRTIM_TIMERINDEX_TIMER_E) && (((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMEEEF1_TIMACMP2) || ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMEEEF2_TIMBCMP1) ||            \
						    ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMEEEF3_TIMCCMP1) || ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMEEEF4_TIMFCMP4) ||            \
						    ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMEEEF5_TIMFOUT2) || ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMEEEF6_TIMDCMP1) ||            \
						    ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMEEEF7_TIMDCMP4) || ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMEEEF8_TIMDOUT2))) ||          \
	 (((TIMER) == HRTIM_TIMERINDEX_TIMER_F) && (((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMFEEF1_TIMACMP4) || ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMFEEF2_TIMBCMP2) ||            \
						    ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMFEEF3_TIMCCMP4) || ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMFEEF4_TIMDCMP2) ||            \
						    ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMFEEF5_TIMDCMP4) || ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMFEEF6_TIMECMP1) ||            \
						    ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMFEEF7_TIMECMP4) || ((TIMEVENTFILTER) == HRTIM_TIMEEVFLT_BLANKING_TIMFEEF8_TIMEOUT2))))
...
#define IS_HRTIM_TIMDEADTIME_PRESCALERRATIO(PRESCALERRATIO)                                                                                                                                            \
	(((PRESCALERRATIO) == HRTIM_TIMDEADTIME_PRESCALERRATIO_MUL8) || ((PRESCALERRATIO) == HRTIM_TIMDEADTIME_PRESCALERRATIO_MUL4) || ((PRESCALERRATIO) == HRTIM_TIMDEADTIME_PRESCALERRATIO_MUL2) ||  \
	 ((PRESCALERRATIO) == HRTIM_TIMDEADTIME_PRESCALERRATIO_DIV1) || ((PRESCALERRATIO) == HRTIM_TIMDEADTIME_PRESCALERRATIO_DIV2) || ((PRESCALERRATIO) == HRTIM_TIMDEADTIME_PRESCALERRATIO_DIV4) ||  \
	 ((PRESCALERRATIO) == HRTIM_TIMDEADTIME_PRESCALERRATIO_DIV8) || ((PRESCALERRATIO) == HRTIM_TIMDEADTIME_PRESCALERRATIO_DIV16))
...
#define IS_HRTIM_CHOPPER_PRESCALERRATIO(PRESCALERRATIO)                                                                                                                                                \
	(((PRESCALERRATIO) == HRTIM_CHOPPER_PRESCALERRATIO_DIV16) || ((PRESCALERRATIO) == HRTIM_CHOPPER_PRESCALERRATIO_DIV32) || ((PRESCALERRATIO) == HRTIM_CHOPPER_PRESCALERRATIO_DIV48) ||           \
	 ((PRESCALERRATIO) == HRTIM_CHOPPER_PRESCALERRATIO_DIV64) || ((PRESCALERRATIO) == HRTIM_CHOPPER_PRESCALERRATIO_DIV80) || ((PRESCALERRATIO) == HRTIM_CHOPPER_PRESCALERRATIO_DIV96) ||           \
	 ((PRESCALERRATIO) == HRTIM_CHOPPER_PRESCALERRATIO_DIV112) || ((PRESCALERRATIO) == HRTIM_CHOPPER_PRESCALERRATIO_DIV128) || ((PRESCALERRATIO) == HRTIM_CHOPPER_PRESCALERRATIO_DIV144) ||        \
	 ((PRESCALERRATIO) == HRTIM_CHOPPER_PRESCALERRATIO_DIV160) || ((PRESCALERRATIO) == HRTIM_CHOPPER_PRESCALERRATIO_DIV176) || ((PRESCALERRATIO) == HRTIM_CHOPPER_PRESCALERRATIO_DIV192) ||        \
	 ((PRESCALERRATIO) == HRTIM_CHOPPER_PRESCALERRATIO_DIV208) || ((PRESCALERRATIO) == HRTIM_CHOPPER_PRESCALERRATIO_DIV224) || ((PRESCALERRATIO) == HRTIM_CHOPPER_PRESCALERRATIO_DIV240) ||        \
	 ((PRESCALERRATIO) == HRTIM_CHOPPER_PRESCALERRATIO_DIV256))

#define IS_HRTIM_CHOPPER_DUTYCYCLE(DUTYCYCLE)                                                                                                                                                          \
	(((DUTYCYCLE) == HRTIM_CHOPPER_DUTYCYCLE_0) || ((DUTYCYCLE) == HRTIM_CHOPPER_DUTYCYCLE_125) || ((DUTYCYCLE) == HRTIM_CHOPPER_DUTYCYCLE_250) || ((DUTYCYCLE) == HRTIM_CHOPPER_DUTYCYCLE_375) || \
	 ((DUTYCYCLE) == HRTIM_CHOPPER_DUTYCYCLE_500) || ((DUTYCYCLE) == HRTIM_CHOPPER_DUTYCYCLE_625) || ((DUTYCYCLE) == HRTIM_CHOPPER_DUTYCYCLE_750) || ((DUTYCYCLE) == HRTIM_CHOPPER_DUTYCYCLE_875))

#define IS_HRTIM_CHOPPER_PULSEWIDTH(PULSEWIDTH)                                                                                                                                                        \
	(((PULSEWIDTH) == HRTIM_CHOPPER_PULSEWIDTH_16) || ((PULSEWIDTH) == HRTIM_CHOPPER_PULSEWIDTH_32) || ((PULSEWIDTH) == HRTIM_CHOPPER_PULSEWIDTH_48) ||                                            \
	 ((PULSEWIDTH) == HRTIM_CHOPPER_PULSEWIDTH_64) || ((PULSEWIDTH) == HRTIM_CHOPPER_PULSEWIDTH_80) || ((PULSEWIDTH) == HRTIM_CHOPPER_PULSEWIDTH_96) ||                                            \
	 ((PULSEWIDTH) == HRTIM_CHOPPER_PULSEWIDTH_112) || ((PULSEWIDTH) == HRTIM_CHOPPER_PULSEWIDTH_128) || ((PULSEWIDTH) == HRTIM_CHOPPER_PULSEWIDTH_144) ||                                         \
	 ((PULSEWIDTH) == HRTIM_CHOPPER_PULSEWIDTH_160) || ((PULSEWIDTH) == HRTIM_CHOPPER_PULSEWIDTH_176) || ((PULSEWIDTH) == HRTIM_CHOPPER_PULSEWIDTH_192) ||                                         \
	 ((PULSEWIDTH) == HRTIM_CHOPPER_PULSEWIDTH_208) || ((PULSEWIDTH) == HRTIM_CHOPPER_PULSEWIDTH_224) || ((PULSEWIDTH) == HRTIM_CHOPPER_PULSEWIDTH_240) ||                                         \
	 ((PULSEWIDTH) == HRTIM_CHOPPER_PULSEWIDTH_256))

#define IS_HRTIM_SYNCINPUTSOURCE(SYNCINPUTSOURCE)                                                                                                                                                      \
	(((SYNCINPUTSOURCE) == HRTIM_SYNCINPUTSOURCE_NONE) || ((SYNCINPUTSOURCE) == HRTIM_SYNCINPUTSOURCE_INTERNALEVENT) || ((SYNCINPUTSOURCE) == HRTIM_SYNCINPUTSOURCE_EXTERNALEVENT))

#define IS_HRTIM_SYNCOUTPUTSOURCE(SYNCOUTPUTSOURCE)                                                                                                                                                    \
	(((SYNCOUTPUTSOURCE) == HRTIM_SYNCOUTPUTSOURCE_MASTER_START) || ((SYNCOUTPUTSOURCE) == HRTIM_SYNCOUTPUTSOURCE_MASTER_CMP1) || ((SYNCOUTPUTSOURCE) == HRTIM_SYNCOUTPUTSOURCE_TIMA_START) ||     \
	 ((SYNCOUTPUTSOURCE) == HRTIM_SYNCOUTPUTSOURCE_TIMA_CMP1))

#define IS_HRTIM_SYNCOUTPUTPOLARITY(SYNCOUTPUTPOLARITY)                                                                                                                                                \
	(((SYNCOUTPUTPOLARITY) == HRTIM_SYNCOUTPUTPOLARITY_NONE) || ((SYNCOUTPUTPOLARITY) == HRTIM_SYNCOUTPUTPOLARITY_POSITIVE) || ((SYNCOUTPUTPOLARITY) == HRTIM_SYNCOUTPUTPOLARITY_NEGATIVE))

#define IS_HRTIM_EVENTSRC(EVENT, EVENTSRC)                                                                                                                                                             \
	((((EVENT) == HRTIM_EVENT_1) &&                                                                                                                                                                \
	  (((EVENTSRC) == HRTIM_EEV1SRC_GPIO) || ((EVENTSRC) == HRTIM_EEV1SRC_COMP2_OUT) || ((EVENTSRC) == HRTIM_EEV1SRC_TIM1_TRGO) || ((EVENTSRC) == HRTIM_EEV1SRC_ADC1_AWD1))) ||                    \
	 (((EVENT) == HRTIM_EVENT_2) &&                                                                                                                                                                \
	  (((EVENTSRC) == HRTIM_EEV2SRC_GPIO) || ((EVENTSRC) == HRTIM_EEV2SRC_COMP4_OUT) || ((EVENTSRC) == HRTIM_EEV2SRC_TIM2_TRGO) || ((EVENTSRC) == HRTIM_EEV2SRC_ADC1_AWD2))) ||                    \
	 (((EVENT) == HRTIM_EVENT_3) &&                                                                                                                                                                \
	  (((EVENTSRC) == HRTIM_EEV3SRC_GPIO) || ((EVENTSRC) == HRTIM_EEV3SRC_COMP6_OUT) || ((EVENTSRC) == HRTIM_EEV3SRC_TIM3_TRGO) || ((EVENTSRC) == HRTIM_EEV3SRC_ADC1_AWD3))) ||                    \
	 (((EVENT) == HRTIM_EVENT_4) &&                                                                                                                                                                \
	  (((EVENTSRC) == HRTIM_EEV4SRC_GPIO) || ((EVENTSRC) == HRTIM_EEV4SRC_COMP1_OUT) || ((EVENTSRC) == HRTIM_EEV4SRC_COMP5_OUT) || ((EVENTSRC) == HRTIM_EEV4SRC_ADC2_AWD1))) ||                    \
	 (((EVENT) == HRTIM_EVENT_5) &&                                                                                                                                                                \
	  (((EVENTSRC) == HRTIM_EEV5SRC_GPIO) || ((EVENTSRC) == HRTIM_EEV5SRC_COMP3_OUT) || ((EVENTSRC) == HRTIM_EEV5SRC_COMP7_OUT) || ((EVENTSRC) == HRTIM_EEV5SRC_ADC2_AWD2))) ||                    \
	 (((EVENT) == HRTIM_EVENT_6) &&                                                                                                                                                                \
	  (((EVENTSRC) == HRTIM_EEV6SRC_GPIO) || ((EVENTSRC) == HRTIM_EEV6SRC_COMP2_OUT) || ((EVENTSRC) == HRTIM_EEV6SRC_COMP1_OUT) || ((EVENTSRC) == HRTIM_EEV6SRC_ADC2_AWD3))) ||                    \
	 (((EVENT) == HRTIM_EVENT_7) &&                                                                                                                                                                \
	  (((EVENTSRC) == HRTIM_EEV7SRC_GPIO) || ((EVENTSRC) == HRTIM_EEV7SRC_COMP4_OUT) || ((EVENTSRC) == HRTIM_EEV7SRC_TIM7_TRGO) || ((EVENTSRC) == HRTIM_EEV7SRC_ADC3_AWD1))) ||                    \
	 (((EVENT) == HRTIM_EVENT_8) &&                                                                                                                                                                \
	  (((EVENTSRC) == HRTIM_EEV8SRC_GPIO) || ((EVENTSRC) == HRTIM_EEV8SRC_COMP6_OUT) || ((EVENTSRC) == HRTIM_EEV8SRC_COMP3_OUT) || ((EVENTSRC) == HRTIM_EEV8SRC_ADC4_AWD1))) ||                    \
	 (((EVENT) == HRTIM_EVENT_9) &&                                                                                                                                                                \
	  (((EVENTSRC) == HRTIM_EEV9SRC_GPIO) || ((EVENTSRC) == HRTIM_EEV9SRC_COMP5_OUT) || ((EVENTSRC) == HRTIM_EEV9SRC_TIM15_TRGO) || ((EVENTSRC) == HRTIM_EEV9SRC_COMP4_OUT))) ||                   \
	 (((EVENT) == HRTIM_EVENT_10) &&                                                                                                                                                               \
	  (((EVENTSRC) == HRTIM_EEV10SRC_GPIO) || ((EVENTSRC) == HRTIM_EEV10SRC_COMP7_OUT) || ((EVENTSRC) == HRTIM_EEV10SRC_TIM6_TRGO) || ((EVENTSRC) == HRTIM_EEV10SRC_ADC5_AWD1))))

#define IS_HRTIM_EVENTPOLARITY(EVENTSENSITIVITY, EVENTPOLARITY)                                                                                                                                        \
	((((EVENTSENSITIVITY) == HRTIM_EVENTSENSITIVITY_LEVEL) && (((EVENTPOLARITY) == HRTIM_EVENTPOLARITY_HIGH) || ((EVENTPOLARITY) == HRTIM_EVENTPOLARITY_LOW))) ||                                  \
	 (((EVENTSENSITIVITY) == HRTIM_EVENTSENSITIVITY_RISINGEDGE) || ((EVENTSENSITIVITY) == HRTIM_EVENTSENSITIVITY_FALLINGEDGE) || ((EVENTSENSITIVITY) == HRTIM_EVENTSENSITIVITY_BOTHEDGES)))

#define IS_HRTIM_EVENTSENSITIVITY(EVENTSENSITIVITY)                                                                                                                                                    \
	(((EVENTSENSITIVITY) == HRTIM_EVENTSENSITIVITY_LEVEL) || ((EVENTSENSITIVITY) == HRTIM_EVENTSENSITIVITY_RISINGEDGE) || ((EVENTSENSITIVITY) == HRTIM_EVENTSENSITIVITY_FALLINGEDGE) ||            \
	 ((EVENTSENSITIVITY) == HRTIM_EVENTSENSITIVITY_BOTHEDGES))

#define IS_HRTIM_EVENTFASTMODE(EVENT, FASTMODE)                                                                                                                                                        \
	(((((EVENT) == HRTIM_EVENT_1) || ((EVENT) == HRTIM_EVENT_2) || ((EVENT) == HRTIM_EVENT_3) || ((EVENT) == HRTIM_EVENT_4) || ((EVENT) == HRTIM_EVENT_5)) &&                                      \
	  (((FASTMODE) == HRTIM_EVENTFASTMODE_ENABLE) || ((FASTMODE) == HRTIM_EVENTFASTMODE_DISABLE))) ||                                                                                              \
	 (((EVENT) == HRTIM_EVENT_6) || ((EVENT) == HRTIM_EVENT_7) || ((EVENT) == HRTIM_EVENT_8) || ((EVENT) == HRTIM_EVENT_9) || ((EVENT) == HRTIM_EVENT_10)))

#define IS_HRTIM_EVENTFILTER(EVENT, FILTER)                                                                                                                                                            \
	((((EVENT) == HRTIM_EVENT_1) || ((EVENT) == HRTIM_EVENT_2) || ((EVENT) == HRTIM_EVENT_3) || ((EVENT) == HRTIM_EVENT_4) || ((EVENT) == HRTIM_EVENT_5)) ||                                       \
	 ((((EVENT) == HRTIM_EVENT_6) || ((EVENT) == HRTIM_EVENT_7) || ((EVENT) == HRTIM_EVENT_8) || ((EVENT) == HRTIM_EVENT_9) || ((EVENT) == HRTIM_EVENT_10)) &&                                     \
	  (((FILTER) == HRTIM_EVENTFILTER_NONE) || ((FILTER) == HRTIM_EVENTFILTER_1) || ((FILTER) == HRTIM_EVENTFILTER_2) || ((FILTER) == HRTIM_EVENTFILTER_3) || ((FILTER) == HRTIM_EVENTFILTER_4) || \
	   ((FILTER) == HRTIM_EVENTFILTER_5) || ((FILTER) == HRTIM_EVENTFILTER_6) || ((FILTER) == HRTIM_EVENTFILTER_7) || ((FILTER) == HRTIM_EVENTFILTER_8) || ((FILTER) == HRTIM_EVENTFILTER_9) ||    \
	   ((FILTER) == HRTIM_EVENTFILTER_10) || ((FILTER) == HRTIM_EVENTFILTER_11) || ((FILTER) == HRTIM_EVENTFILTER_12) || ((FILTER) == HRTIM_EVENTFILTER_13) ||                                     \
	   ((FILTER) == HRTIM_EVENTFILTER_14) || ((FILTER) == HRTIM_EVENTFILTER_15))))

#define IS_HRTIM_EVENTPRESCALER(EVENTPRESCALER)                                                                                                                                                        \
	(((EVENTPRESCALER) == HRTIM_EVENTPRESCALER_DIV1) || ((EVENTPRESCALER) == HRTIM_EVENTPRESCALER_DIV2) || ((EVENTPRESCALER) == HRTIM_EVENTPRESCALER_DIV4) ||                                      \
	 ((EVENTPRESCALER) == HRTIM_EVENTPRESCALER_DIV8))

#define IS_HRTIM_FAULTSOURCE(FAULTSOURCE) (((FAULTSOURCE) == HRTIM_FAULTSOURCE_DIGITALINPUT) || ((FAULTSOURCE) == HRTIM_FAULTSOURCE_INTERNAL) || ((FAULTSOURCE) == HRTIM_FAULTSOURCE_EEVINPUT))
...
#define IS_HRTIM_FAULTMODECTL(FAULTMODECTL) (((FAULTMODECTL) == HRTIM_FAULTMODECTL_DISABLED) || ((FAULTMODECTL) == HRTIM_FAULTMODECTL_ENABLED))

#define IS_HRTIM_FAULTBLANKNGMODE(FAULTBLANKINGMODE) (((FAULTBLANKINGMODE) == HRTIM_FAULTBLANKINGMODE_RSTALIGNED) || ((FAULTBLANKINGMODE) == HRTIM_FAULTBLANKINGMODE_MOVING))

#define IS_HRTIM_FAULTBLANKING(FAULTBLANKINGCTL) (((FAULTBLANKINGCTL) == HRTIM_FAULTBLANKING_DISABLED) || ((FAULTBLANKINGCTL) == HRTIM_FAULTBLANKING_ENABLED))

#define IS_HRTIM_FAULTCOUNTERRST(HRTIM_FAULTCOUNTERRST) (((HRTIM_FAULTCOUNTERRST) == HRTIM_FAULTCOUNTERRST_UNCONDITIONAL) || ((HRTIM_FAULTCOUNTERRST) == HRTIM_FAULTCOUNTERRST_CONDITIONAL))

#define IS_HRTIM_FAULTBLANKINGCTL(FAULTBLANKINGCTL) (((FAULTBLANKINGCTL) == HRTIM_FAULTBLANKINGCTL_DISABLED) || ((FAULTBLANKINGCTL) == HRTIM_FAULTBLANKINGCTL_ENABLED))

#define IS_HRTIM_FAULTCOUNTER(FAULTCOUNTER)                                                                                                                                                            \
	(((FAULTCOUNTER) == HRTIM_FAULTCOUNTER_NONE) || ((FAULTCOUNTER) == HRTIM_FAULTCOUNTER_1) || ((FAULTCOUNTER) == HRTIM_FAULTCOUNTER_2) || ((FAULTCOUNTER) == HRTIM_FAULTCOUNTER_3) ||            \
	 ((FAULTCOUNTER) == HRTIM_FAULTCOUNTER_4) || ((FAULTCOUNTER) == HRTIM_FAULTCOUNTER_5) || ((FAULTCOUNTER) == HRTIM_FAULTCOUNTER_6) || ((FAULTCOUNTER) == HRTIM_FAULTCOUNTER_7) ||               \
	 ((FAULTCOUNTER) == HRTIM_FAULTCOUNTER_8) || ((FAULTCOUNTER) == HRTIM_FAULTCOUNTER_9) || ((FAULTCOUNTER) == HRTIM_FAULTCOUNTER_10) || ((FAULTCOUNTER) == HRTIM_FAULTCOUNTER_11) ||             \
	 ((FAULTCOUNTER) == HRTIM_FAULTCOUNTER_12) || ((FAULTCOUNTER) == HRTIM_FAULTCOUNTER_13) || ((FAULTCOUNTER) == HRTIM_FAULTCOUNTER_14) || ((FAULTCOUNTER) == HRTIM_FAULTCOUNTER_15))

#define IS_HRTIM_FAULTFILTER(FAULTFILTER)                                                                                                                                                              \
	(((FAULTFILTER) == HRTIM_FAULTFILTER_NONE) || ((FAULTFILTER) == HRTIM_FAULTFILTER_1) || ((FAULTFILTER) == HRTIM_FAULTFILTER_2) || ((FAULTFILTER) == HRTIM_FAULTFILTER_3) ||                    \
	 ((FAULTFILTER) == HRTIM_FAULTFILTER_4) || ((FAULTFILTER) == HRTIM_FAULTFILTER_5) || ((FAULTFILTER) == HRTIM_FAULTFILTER_6) || ((FAULTFILTER) == HRTIM_FAULTFILTER_7) ||                       \
	 ((FAULTFILTER) == HRTIM_FAULTFILTER_8) || ((FAULTFILTER) == HRTIM_FAULTFILTER_9) || ((FAULTFILTER) == HRTIM_FAULTFILTER_10) || ((FAULTFILTER) == HRTIM_FAULTFILTER_11) ||                     \
	 ((FAULTFILTER) == HRTIM_FAULTFILTER_12) || ((FAULTFILTER) == HRTIM_FAULTFILTER_13) || ((FAULTFILTER) == HRTIM_FAULTFILTER_14) || ((FAULTFILTER) == HRTIM_FAULTFILTER_15))
...
#define IS_HRTIM_FAULTPRESCALER(FAULTPRESCALER)                                                                                                                                                        \
	(((FAULTPRESCALER) == HRTIM_FAULTPRESCALER_DIV1) || ((FAULTPRESCALER) == HRTIM_FAULTPRESCALER_DIV2) || ((FAULTPRESCALER) == HRTIM_FAULTPRESCALER_DIV4) ||                                      \
...
#define IS_HRTIM_BURSTMODECLOCKSOURCE(BURSTMODECLOCKSOURCE)                                                                                                                                            \
	(((BURSTMODECLOCKSOURCE) == HRTIM_BURSTMODECLOCKSOURCE_MASTER) || ((BURSTMODECLOCKSOURCE) == HRTIM_BURSTMODECLOCKSOURCE_TIMER_A) ||                                                            \
	 ((BURSTMODECLOCKSOURCE) == HRTIM_BURSTMODECLOCKSOURCE_TIMER_B) || ((BURSTMODECLOCKSOURCE) == HRTIM_BURSTMODECLOCKSOURCE_TIMER_C) ||                                                           \
	 ((BURSTMODECLOCKSOURCE) == HRTIM_BURSTMODECLOCKSOURCE_TIMER_D) || ((BURSTMODECLOCKSOURCE) == HRTIM_BURSTMODECLOCKSOURCE_TIMER_E) ||                                                           \
	 ((BURSTMODECLOCKSOURCE) == HRTIM_BURSTMODECLOCKSOURCE_TIMER_F) || ((BURSTMODECLOCKSOURCE) == HRTIM_BURSTMODECLOCKSOURCE_TIM16_OC) ||                                                          \
	 ((BURSTMODECLOCKSOURCE) == HRTIM_BURSTMODECLOCKSOURCE_TIM17_OC) || ((BURSTMODECLOCKSOURCE) == HRTIM_BURSTMODECLOCKSOURCE_TIM7_TRGO) ||                                                        \
	 ((BURSTMODECLOCKSOURCE) == HRTIM_BURSTMODECLOCKSOURCE_FHRTIM))

#define IS_HRTIM_HRTIM_BURSTMODEPRESCALER(BURSTMODEPRESCALER)                                                                                                                                          \
	(((BURSTMODEPRESCALER) == HRTIM_BURSTMODEPRESCALER_DIV1) || ((BURSTMODEPRESCALER) == HRTIM_BURSTMODEPRESCALER_DIV2) || ((BURSTMODEPRESCALER) == HRTIM_BURSTMODEPRESCALER_DIV4) ||              \
	 ((BURSTMODEPRESCALER) == HRTIM_BURSTMODEPRESCALER_DIV8) || ((BURSTMODEPRESCALER) == HRTIM_BURSTMODEPRESCALER_DIV16) || ((BURSTMODEPRESCALER) == HRTIM_BURSTMODEPRESCALER_DIV32) ||            \
	 ((BURSTMODEPRESCALER) == HRTIM_BURSTMODEPRESCALER_DIV64) || ((BURSTMODEPRESCALER) == HRTIM_BURSTMODEPRESCALER_DIV128) || ((BURSTMODEPRESCALER) == HRTIM_BURSTMODEPRESCALER_DIV256) ||         \
	 ((BURSTMODEPRESCALER) == HRTIM_BURSTMODEPRESCALER_DIV512) || ((BURSTMODEPRESCALER) == HRTIM_BURSTMODEPRESCALER_DIV1024) || ((BURSTMODEPRESCALER) == HRTIM_BURSTMODEPRESCALER_DIV2048) ||      \
	 ((BURSTMODEPRESCALER) == HRTIM_BURSTMODEPRESCALER_DIV4096) || ((BURSTMODEPRESCALER) == HRTIM_BURSTMODEPRESCALER_DIV8192) || ((BURSTMODEPRESCALER) == HRTIM_BURSTMODEPRESCALER_DIV16384) ||    \
...
#define IS_HRTIM_BURSTMODETRIGGER(BURSTMODETRIGGER)                                                                                                                                                    \
	(((BURSTMODETRIGGER) == HRTIM_BURSTMODETRIGGER_NONE) || ((BURSTMODETRIGGER) == HRTIM_BURSTMODETRIGGER_MASTER_RESET) || ((BURSTMODETRIGGER) == HRTIM_BURSTMODETRIGGER_MASTER_REPETITION) ||     \
	 ((BURSTMODETRIGGER) == HRTIM_BURSTMODETRIGGER_MASTER_CMP1) || ((BURSTMODETRIGGER) == HRTIM_BURSTMODETRIGGER_MASTER_CMP2) || ((BURSTMODETRIGGER) == HRTIM_BURSTMODETRIGGER_MASTER_CMP3) ||     \
	 ((BURSTMODETRIGGER) == HRTIM_BURSTMODETRIGGER_MASTER_CMP4) || ((BURSTMODETRIGGER) == HRTIM_BURSTMODETRIGGER_TIMERA_RESET) ||                                                                  \
	 ((BURSTMODETRIGGER) == HRTIM_BURSTMODETRIGGER_TIMERA_REPETITION) || ((BURSTMODETRIGGER) == HRTIM_BURSTMODETRIGGER_TIMERA_CMP1) ||                                                             \
	 ((BURSTMODETRIGGER) == HRTIM_BURSTMODETRIGGER_TIMERA_CMP2) || ((BURSTMODETRIGGER) == HRTIM_BURSTMODETRIGGER_TIMERB_RESET) ||                                                                  \
	 ((BURSTMODETRIGGER) == HRTIM_BURSTMODETRIGGER_TIMERB_REPETITION) || ((BURSTMODETRIGGER) == HRTIM_BURSTMODETRIGGER_TIMERB_CMP1) ||                                                             \
	 ((BURSTMODETRIGGER) == HRTIM_BURSTMODETRIGGER_TIMERB_CMP2) || ((BURSTMODETRIGGER) == HRTIM_BURSTMODETRIGGER_TIMERC_RESET) ||                                                                  \
	 ((BURSTMODETRIGGER) == HRTIM_BURSTMODETRIGGER_TIMERC_REPETITION) || ((BURSTMODETRIGGER) == HRTIM_BURSTMODETRIGGER_TIMERC_CMP1) ||                                                             \
	 ((BURSTMODETRIGGER) == HRTIM_BURSTMODETRIGGER_TIMERF_RESET) || ((BURSTMODETRIGGER) == HRTIM_BURSTMODETRIGGER_TIMERD_RESET) ||                                                                 \
	 ((BURSTMODETRIGGER) == HRTIM_BURSTMODETRIGGER_TIMERD_REPETITION) || ((BURSTMODETRIGGER) == HRTIM_BURSTMODETRIGGER_TIMERF_REPETITION) ||                                                       \
	 ((BURSTMODETRIGGER) == HRTIM_BURSTMODETRIGGER_TIMERD_CMP2) || ((BURSTMODETRIGGER) == HRTIM_BURSTMODETRIGGER_TIMERF_CMP1) ||                                                                   \
	 ((BURSTMODETRIGGER) == HRTIM_BURSTMODETRIGGER_TIMERE_REPETITION) || ((BURSTMODETRIGGER) == HRTIM_BURSTMODETRIGGER_TIMERE_CMP1) ||                                                             \
	 ((BURSTMODETRIGGER) == HRTIM_BURSTMODETRIGGER_TIMERE_CMP2) || ((BURSTMODETRIGGER) == HRTIM_BURSTMODETRIGGER_TIMERA_EVENT7) || ((BURSTMODETRIGGER) == HRTIM_BURSTMODETRIGGER_TIMERD_EVENT8) || \
	 ((BURSTMODETRIGGER) == HRTIM_BURSTMODETRIGGER_EVENT_7) || ((BURSTMODETRIGGER) == HRTIM_BURSTMODETRIGGER_EVENT_8) || ((BURSTMODETRIGGER) == HRTIM_BURSTMODETRIGGER_EVENT_ONCHIP))

#define IS_HRTIM_ADCTRIGGERUPDATE(ADCTRIGGERUPDATE)                                                                                                                                                    \
	(((ADCTRIGGERUPDATE) == HRTIM_ADCTRIGGERUPDATE_MASTER) || ((ADCTRIGGERUPDATE) == HRTIM_ADCTRIGGERUPDATE_TIMER_A) || ((ADCTRIGGERUPDATE) == HRTIM_ADCTRIGGERUPDATE_TIMER_B) ||                  \
	 ((ADCTRIGGERUPDATE) == HRTIM_ADCTRIGGERUPDATE_TIMER_C) || ((ADCTRIGGERUPDATE) == HRTIM_ADCTRIGGERUPDATE_TIMER_D) || ((ADCTRIGGERUPDATE) == HRTIM_ADCTRIGGERUPDATE_TIMER_E) ||                 \
	 ((ADCTRIGGERUPDATE) == HRTIM_ADCTRIGGERUPDATE_TIMER_F))

#define IS_HRTIM_CALIBRATIONRATE(CALIBRATIONRATE)                                                                                                                                                      \
	(((CALIBRATIONRATE) == HRTIM_SINGLE_CALIBRATION) || ((CALIBRATIONRATE) == HRTIM_CALIBRATIONRATE_0) || ((CALIBRATIONRATE) == HRTIM_CALIBRATIONRATE_1) ||                                        \
	 ((CALIBRATIONRATE) == HRTIM_CALIBRATIONRATE_2) || ((CALIBRATIONRATE) == HRTIM_CALIBRATIONRATE_3))

#define IS_HRTIM_TIMER_BURSTDMA(TIMER, BURSTDMA)                                                                                                                                                       \
	((((TIMER) == HRTIM_TIMERINDEX_MASTER) && (((BURSTDMA) & 0xFFFFC000U) == 0x00000000U)) || (((TIMER) == HRTIM_TIMERINDEX_TIMER_A) && (((BURSTDMA) & 0xFF800000U) == 0x00000000U)) ||            \
	 (((TIMER) == HRTIM_TIMERINDEX_TIMER_B) && (((BURSTDMA) & 0xFF800000U) == 0x00000000U)) || (((TIMER) == HRTIM_TIMERINDEX_TIMER_C) && (((BURSTDMA) & 0xFF800000U) == 0x00000000U)) ||           \
	 (((TIMER) == HRTIM_TIMERINDEX_TIMER_D) && (((BURSTDMA) & 0xFF800000U) == 0x00000000U)) || (((TIMER) == HRTIM_TIMERINDEX_TIMER_E) && (((BURSTDMA) & 0xFF800000U) == 0x00000000U)) ||           \
...
#define __HAL_HRTIM_SETCOUNTER(__HANDLE__, __TIMER__, __COUNTER__)                                                                                                                                     \
	(((__TIMER__) == HRTIM_TIMERINDEX_MASTER) ? ((__HANDLE__)->Instance->sMasterRegs.MCNTR = (__COUNTER__)) : ((__HANDLE__)->Instance->sTimerxRegs[(__TIMER__)].CNTxR = (__COUNTER__)))
...
#define __HAL_HRTIM_GETCOUNTER(__HANDLE__, __TIMER__)                                                                                                                                                  \
	(((__TIMER__) == HRTIM_TIMERINDEX_MASTER) ? ((__HANDLE__)->Instance->sMasterRegs.MCNTR) : ((__HANDLE__)->Instance->sTimerxRegs[(__TIMER__)].CNTxR))
...
#define __HAL_HRTIM_SETPERIOD(__HANDLE__, __TIMER__, __PERIOD__)                                                                                                                                       \
	(((__TIMER__) == HRTIM_TIMERINDEX_MASTER) ? ((__HANDLE__)->Instance->sMasterRegs.MPER = (__PERIOD__)) : ((__HANDLE__)->Instance->sTimerxRegs[(__TIMER__)].PERxR = (__PERIOD__)))
 ...
 */
#define __HAL_HRTIM_GETPERIOD(__HANDLE__, __TIMER__) (((__TIMER__) == HRTIM_TIMERINDEX_MASTER) ? ((__HANDLE__)->Instance->sMasterRegs.MPER) : ((__HANDLE__)->Instance->sTimerxRegs[(__TIMER__)].PERxR))
...
#define __HAL_HRTIM_GETCLOCKPRESCALER(__HANDLE__, __TIMER__)                                                                                                                                           \
	(((__TIMER__) == HRTIM_TIMERINDEX_MASTER) ? ((__HANDLE__)->Instance->sMasterRegs.MCR & HRTIM_MCR_CK_PSC) : ((__HANDLE__)->Instance->sTimerxRegs[(__TIMER__)].TIMxCR & HRTIM_TIMCR_CK_PSC))
...
#define __HAL_HRTIM_SETCOMPARE(__HANDLE__, __TIMER__, __COMPAREUNIT__, __COMPARE__)                                                                                                                    \
	(((__TIMER__) == HRTIM_TIMERINDEX_MASTER) ? (((__COMPAREUNIT__) == HRTIM_COMPAREUNIT_1)	  ? ((__HANDLE__)->Instance->sMasterRegs.MCMP1R = (__COMPARE__))                                       \
...
#define __HAL_HRTIM_GETCOMPARE(__HANDLE__, __TIMER__, __COMPAREUNIT__)                                                                                                                                 \
	(((__TIMER__) == HRTIM_TIMERINDEX_MASTER) ? (((__COMPAREUNIT__) == HRTIM_COMPAREUNIT_1)	  ? ((__HANDLE__)->Instance->sMasterRegs.MCMP1R)                                                       \
