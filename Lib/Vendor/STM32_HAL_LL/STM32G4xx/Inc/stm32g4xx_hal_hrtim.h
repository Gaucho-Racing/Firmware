...
#define HRTIM_UPDATEGATING_UPDEN1_UPDATE                                                                                                                                                               \
	(HRTIM_TIMCR_UPDGAT_2 | HRTIM_TIMCR_UPDGAT_1) /*!< Slave timer only -  Update done on the update event following a rising edge of HRTIM update enable input 1U */
#define HRTIM_UPDATEGATING_UPDEN2_UPDATE                                                                                                                                                               \
	(HRTIM_TIMCR_UPDGAT_2 | HRTIM_TIMCR_UPDGAT_1 | HRTIM_TIMCR_UPDGAT_0) /*!< Slave timer only -  Update done on the update event following a rising edge of HRTIM update enable input 2U */
...
#define HRTIM_TIMER_A_B_C_DELAYEDPROTECTION_DELAYEDBOTH_EEV7                                                                                                                                           \
	(HRTIM_OUTR_DLYPRT_2 | HRTIM_OUTR_DLYPRT_1 | HRTIM_OUTR_DLYPRTEN) /*!< Timers A, B, C: Output 1 and output2 delayed Idle on external Event 7U */
#define HRTIM_TIMER_A_B_C_DELAYEDPROTECTION_BALANCED_EEV7                                                                                                                                              \
	(HRTIM_OUTR_DLYPRT_2 | HRTIM_OUTR_DLYPRT_1 | HRTIM_OUTR_DLYPRT_0 | HRTIM_OUTR_DLYPRTEN) /*!< Timers A, B, C: Balanced Idle on external Event 7U */
...
#define HRTIM_TIMEEVFLT_WINDOWINGTIM (HRTIM_EEFR1_EE1FLTR_3 | HRTIM_EEFR1_EE1FLTR_2 | HRTIM_EEFR1_EE1FLTR_1 | HRTIM_EEFR1_EE1FLTR_0) /*!< Windowing from another timing unit: TIMWIN source */
/**
 * @}
 */
...
#define HRTIM_EVENTCOUNTER_RSTMODE_CONDITIONAL                                                                                                                                                         \
	(0x00000001U) /*!< External Event Counter is reset on each reset / roll-over event only                                                                                                        \
...
#define HRTIM_SYNCOUTPUTPOLARITY_NEGATIVE                                                                                                                                                              \
	(HRTIM_MCR_SYNC_OUT_1 | HRTIM_MCR_SYNC_OUT_0) /*!< SCOUT pin has a high idle level and issues a negative pulse of 16 fHRTIM clock cycles length for the synchronization */
/**
 * @}
 */
...
#define HRTIM_OUTPUTSTATE_IDLE                                                                                                                                                                         \
	(0x00000001U) /*!< Main operating mode, where the output can take the active or                                                                                                                \
				  inactive level as programmed in the crossbar unit */
#define HRTIM_OUTPUTSTATE_RUN                                                                                                                                                                          \
	(0x00000002U) /*!< Default operating state (e.g. after an HRTIM reset, when the                                                                                                                \
...
#define IS_HRTIM_TIMDEADTIME_PRESCALERRATIO(PRESCALERRATIO)                                                                                                                                            \
	(((PRESCALERRATIO) == HRTIM_TIMDEADTIME_PRESCALERRATIO_DIV8) || ((PRESCALERRATIO) == HRTIM_TIMDEADTIME_PRESCALERRATIO_DIV4) || ((PRESCALERRATIO) == HRTIM_TIMDEADTIME_PRESCALERRATIO_DIV2) ||  \
	 ((PRESCALERRATIO) == HRTIM_TIMDEADTIME_PRESCALERRATIO_DIV1) || ((PRESCALERRATIO) == HRTIM_TIMDEADTIME_PRESCALERRATIO_MUL2) || ((PRESCALERRATIO) == HRTIM_TIMDEADTIME_PRESCALERRATIO_MUL4) ||  \
	 ((PRESCALERRATIO) == HRTIM_TIMDEADTIME_PRESCALERRATIO_MUL8) || ((PRESCALERRATIO) == HRTIM_TIMDEADTIME_PRESCALERRATIO_MUL16))
