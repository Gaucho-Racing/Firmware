...
#define RTC_ALARMSUBSECONDMASK_SS14_7                                                                                                                                                                  \
	(RTC_ALRMASSR_MASKSS_0 | RTC_ALRMASSR_MASKSS_1 | RTC_ALRMASSR_MASKSS_2) /*!< SS[14:7] not used in Alarm                                                                                        \
...
#define RTC_ALARMSUBSECONDMASK_SS14_11                                                                                                                                                                 \
	(RTC_ALRMASSR_MASKSS_0 | RTC_ALRMASSR_MASKSS_1 | RTC_ALRMASSR_MASKSS_3) /*!< SS[14:11] not used in Alarm                                                                                       \
...
#define RTC_ALARMSUBSECONDMASK_SS14_13                                                                                                                                                                 \
	(RTC_ALRMASSR_MASKSS_0 | RTC_ALRMASSR_MASKSS_2 | RTC_ALRMASSR_MASKSS_3) /*!< SS[14:13] not used in Alarm                                                                                       \
										     comparison. Only SS[12:0] are compared */
#define RTC_ALARMSUBSECONDMASK_SS14                                                                                                                                                                    \
	(RTC_ALRMASSR_MASKSS_1 | RTC_ALRMASSR_MASKSS_2 | RTC_ALRMASSR_MASKSS_3) /*!< SS[14] not used in Alarm                                                                                          \
...
#define RTC_ICSR_RESERVED_MASK (RTC_ICSR_RECALPF | RTC_ICSR_INIT | RTC_ICSR_INITF | RTC_ICSR_RSF | RTC_ICSR_INITS | RTC_ICSR_SHPF | RTC_ICSR_WUTWF | RTC_ICSR_ALRBWF | RTC_ICSR_ALRAWF)
