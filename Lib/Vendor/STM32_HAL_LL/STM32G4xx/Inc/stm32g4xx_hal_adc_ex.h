	...
	typedef struct
	{
		...
		uint32_t InjectedOffsetSign;		  /*!< Define if the offset should be subtracted
							     ...
							     can be a value of @ref ADCEx_OffsetSign.
							      Note: This parameter must be modified when
							     no conversion is on going on both regular and
							     injected groups (ADC disabled, or ADC enabled
		...
		FunctionalState AutoInjectedConv; /*!< Enables or disables the selected ADC group
						     ...
						     DISABLE) Note: To use Automatic injected
						     conversion, injected group external triggers
						     must be disabled ('ExternalTrigInjecConv' set
						     to ADC_INJECTED_SOFTWARE_START) Note: In case
						     of DMA used with regular group: if DMA
						     configured in normal mode (single shot) JAUTO
						     will be stopped upon DMA transfer complete. To
						     maintain JAUTO always enabled, DMA must be
						     configured in circular mode. Caution: this
		...
		FunctionalState QueueInjectedContext; /*!< Specifies whether the context queue
							 ...
							 as the 'InjectedNbrOfConversion' parameter.
		...
		uint32_t ExternalTrigInjecConv; /*!< Selects the external event used to
						   ...
						   impact the configuration of other channels
							      previously set. */
...
#define ADC_DUALMODE_REGINTERL_INJECSIMULT                                                                                                                                                             \
	...
	Combined group regular interleaved + group injected simultaneous */
...
#define ADC_DMAACCESSMODE_12_10_BITS                                                                                                                                                                   \
	(ADC_CCR_MDMA_1) /*!< DMA multimode enabled (one DMA channel for both                                                                                                                          \
      ADC, DMA of ADC master) for 12 and 10 bits resolution */
...
#define ADC_TWOSAMPLINGDELAY_5CYCLES                                                                                                                                                                   \
	(LL_ADC_MULTI_TWOSMP_DELAY_5CYCLES) /*!< ADC multimode delay between                                                                                                                           \
      two sampling phases: 5 ADC clock cycles */
...
#define ADC_TWOSAMPLINGDELAY_9CYCLES                                                                                                                                                                   \
	(LL_ADC_MULTI_TWOSMP_DELAY_9CYCLES) /*!< ADC multimode delay between                                                                                                                           \
      two sampling phases: 9 ADC clock cycles */
...
#define ADC_SMPR1_FIELDS                                                                                                                                                                               \
	(ADC_SMPR1_SMP9 | ADC_SMPR1_SMP8 | ADC_SMPR1_SMP7 | ADC_SMPR1_SMP6 | ADC_SMPR1_SMP5 | ADC_SMPR1_SMP4 | ADC_SMPR1_SMP3 | ADC_SMPR1_SMP2 | ADC_SMPR1_SMP1 | ADC_SMPR1_SMP0 | ADC_SMPR1_SMPPLUS)
#else
...
#define ADC_AWD23THRESHOLD_SHIFT_RESOLUTION(__HANDLE__, __THRESHOLD__)                                                                                                                                 \
	((((__HANDLE__)->Instance->CFGR & ADC_CFGR_RES) != (ADC_CFGR_RES_1 | ADC_CFGR_RES_0)) ? ((__THRESHOLD__) >> ((4UL - ((((__HANDLE__)->Instance->CFGR & ADC_CFGR_RES) >> 3UL) * 2UL)) & 0x1FUL)) \
											      : ((__THRESHOLD__) << 2UL))
...
#define ADC_CLEAR_COMMON_CONTROL_REGISTER(__HANDLE__)                                                                                                                                                  \
	CLEAR_BIT(__LL_ADC_COMMON_INSTANCE((__HANDLE__)->Instance)->CCR,                                                                                                                               \
		  ADC_CCR_CKMODE | ADC_CCR_PRESC | ADC_CCR_VBATSEL | ADC_CCR_VSENSESEL | ADC_CCR_VREFEN | ADC_CCR_MDMA | ADC_CCR_DMACFG | ADC_CCR_DELAY | ADC_CCR_DUAL)
#endif /* ADC_MULTIMODE_SUPPORT */
...
#elif defined(STM32G411xB) || defined(STM32G411xC) || defined(STM32G414xx) || defined(STM32GBK1CB) || defined(STM32G431xx) || defined(STM32G441xx) || defined(STM32G471xx) || defined(STM32G491xx) ||  \
    defined(STM32G4A1xx)
/**
 * @brief Set handle instance of the ADC slave associated to the ADC master.
 * @param __HANDLE_MASTER__ ADC master handle.
...
#define IS_ADC_CHANNEL(__HANDLE__, __CHANNEL__)                                                                                                                                                        \
	((((__CHANNEL__) == ADC_CHANNEL_0) || ((__CHANNEL__) == ADC_CHANNEL_1) || ((__CHANNEL__) == ADC_CHANNEL_2) || ((__CHANNEL__) == ADC_CHANNEL_6) || ((__CHANNEL__) == ADC_CHANNEL_7) ||          \
	  ((__CHANNEL__) == ADC_CHANNEL_8) || ((__CHANNEL__) == ADC_CHANNEL_9) || ((__CHANNEL__) == ADC_CHANNEL_10) || ((__CHANNEL__) == ADC_CHANNEL_11) || ((__CHANNEL__) == ADC_CHANNEL_12) ||       \
	  ((__CHANNEL__) == ADC_CHANNEL_14) || ((__CHANNEL__) == ADC_CHANNEL_15)) ||                                                                                                                   \
	 ((((__HANDLE__)->Instance) == ADC1) && (((__CHANNEL__) == ADC_CHANNEL_3) || ((__CHANNEL__) == ADC_CHANNEL_4) || ((__CHANNEL__) == ADC_CHANNEL_5) || ((__CHANNEL__) == ADC_CHANNEL_VOPAMP1) || \
						 ((__CHANNEL__) == ADC_CHANNEL_TEMPSENSOR_ADC1) || ((__CHANNEL__) == ADC_CHANNEL_VBAT) || ((__CHANNEL__) == ADC_CHANNEL_VREFINT))) ||                  \
	 ((((__HANDLE__)->Instance) == ADC2) && (((__CHANNEL__) == ADC_CHANNEL_3) || ((__CHANNEL__) == ADC_CHANNEL_4) || ((__CHANNEL__) == ADC_CHANNEL_5) || ((__CHANNEL__) == ADC_CHANNEL_13) ||      \
						 ((__CHANNEL__) == ADC_CHANNEL_VOPAMP2) || ((__CHANNEL__) == ADC_CHANNEL_17) || ((__CHANNEL__) == ADC_CHANNEL_VOPAMP3_ADC2))) ||                       \
	 ((((__HANDLE__)->Instance) == ADC3) &&                                                                                                                                                        \
	  (((__CHANNEL__) == ADC_CHANNEL_3) || ((__CHANNEL__) == ADC_CHANNEL_4) || ((__CHANNEL__) == ADC_CHANNEL_5) || ((__CHANNEL__) == ADC_CHANNEL_VOPAMP3_ADC3) ||                                  \
	   ((__CHANNEL__) == ADC_CHANNEL_16) || ((__CHANNEL__) == ADC_CHANNEL_VBAT) || ((__CHANNEL__) == ADC_CHANNEL_VREFINT))) ||                                                                     \
	 ((((__HANDLE__)->Instance) == ADC4) && (((__CHANNEL__) == ADC_CHANNEL_3) || ((__CHANNEL__) == ADC_CHANNEL_4) || ((__CHANNEL__) == ADC_CHANNEL_5) || ((__CHANNEL__) == ADC_CHANNEL_13) ||      \
						 ((__CHANNEL__) == ADC_CHANNEL_16) || ((__CHANNEL__) == ADC_CHANNEL_VOPAMP6) || ((__CHANNEL__) == ADC_CHANNEL_VREFINT))) ||                            \
	 ((((__HANDLE__)->Instance) == ADC5) &&                                                                                                                                                        \
	  (((__CHANNEL__) == ADC_CHANNEL_VOPAMP5) || ((__CHANNEL__) == ADC_CHANNEL_TEMPSENSOR_ADC5) || ((__CHANNEL__) == ADC_CHANNEL_VOPAMP4) || ((__CHANNEL__) == ADC_CHANNEL_13) ||                  \
	   ((__CHANNEL__) == ADC_CHANNEL_16) || ((__CHANNEL__) == ADC_CHANNEL_VBAT) || ((__CHANNEL__) == ADC_CHANNEL_VREFINT))))
...
#define IS_ADC_CHANNEL(__HANDLE__, __CHANNEL__)                                                                                                                                                        \
	((((__CHANNEL__) == ADC_CHANNEL_0) || ((__CHANNEL__) == ADC_CHANNEL_1) || ((__CHANNEL__) == ADC_CHANNEL_2) || ((__CHANNEL__) == ADC_CHANNEL_3) || ((__CHANNEL__) == ADC_CHANNEL_4) ||          \
	  ...
	  ((__CHANNEL__) == ADC_CHANNEL_10) || ((__CHANNEL__) == ADC_CHANNEL_11) || ((__CHANNEL__) == ADC_CHANNEL_12) || ((__CHANNEL__) == ADC_CHANNEL_14) || ((__CHANNEL__) == ADC_CHANNEL_15)) ||    \
	 ((((__HANDLE__)->Instance) == ADC1) &&                                                                                                                                                        \
	  (((__CHANNEL__) == ADC_CHANNEL_VOPAMP1) || ((__CHANNEL__) == ADC_CHANNEL_TEMPSENSOR_ADC1) || ((__CHANNEL__) == ADC_CHANNEL_VBAT) || ((__CHANNEL__) == ADC_CHANNEL_VREFINT))) ||              \
	 ((((__HANDLE__)->Instance) == ADC2) &&                                                                                                                                                        \
	  (((__CHANNEL__) == ADC_CHANNEL_13) || ((__CHANNEL__) == ADC_CHANNEL_VOPAMP2) || ((__CHANNEL__) == ADC_CHANNEL_17) || ((__CHANNEL__) == ADC_CHANNEL_VOPAMP3_ADC2))) ||                        \
	 ((((__HANDLE__)->Instance) == ADC3) &&                                                                                                                                                        \
	  (((__CHANNEL__) == ADC_CHANNEL_VOPAMP3_ADC3) || ((__CHANNEL__) == ADC_CHANNEL_16) || ((__CHANNEL__) == ADC_CHANNEL_VBAT) || ((__CHANNEL__) == ADC_CHANNEL_VREFINT))))
...
#define IS_ADC_CHANNEL(__HANDLE__, __CHANNEL__)                                                                                                                                                        \
	((((__CHANNEL__) == ADC_CHANNEL_0) || ((__CHANNEL__) == ADC_CHANNEL_1) || ((__CHANNEL__) == ADC_CHANNEL_2) || ((__CHANNEL__) == ADC_CHANNEL_3) || ((__CHANNEL__) == ADC_CHANNEL_4) ||          \
	 ...
	 ((((__HANDLE__)->Instance) == ADC2) &&                                                                                                                                                        \
	  (((__CHANNEL__) == ADC_CHANNEL_13) || ((__CHANNEL__) == ADC_CHANNEL_VOPAMP2) || ((__CHANNEL__) == ADC_CHANNEL_17) || ((__CHANNEL__) == ADC_CHANNEL_VOPAMP3_ADC2))) ||                        \
	 ((((__HANDLE__)->Instance) == ADC3) &&                                                                                                                                                        \
	  (((__CHANNEL__) == ADC_CHANNEL_VOPAMP3_ADC3) || ((__CHANNEL__) == ADC_CHANNEL_16) || ((__CHANNEL__) == ADC_CHANNEL_VOPAMP6) || ((__CHANNEL__) == ADC_CHANNEL_VREFINT))))
#endif /* defined(STM32G474xx) || defined(STM32G484xx) || defined(STM32G473xx)                                                                                                                         \
	  || defined(STM32G483xx) */
...
#define IS_ADC_DIFF_CHANNEL(__HANDLE__, __CHANNEL__)                                                                                                                                                   \
	((((__CHANNEL__) == ADC_CHANNEL_1) || ((__CHANNEL__) == ADC_CHANNEL_6) || ((__CHANNEL__) == ADC_CHANNEL_7) || ((__CHANNEL__) == ADC_CHANNEL_8) || ((__CHANNEL__) == ADC_CHANNEL_9) ||          \
	  ((__CHANNEL__) == ADC_CHANNEL_10) || ((__CHANNEL__) == ADC_CHANNEL_11) || ((__CHANNEL__) == ADC_CHANNEL_14)) ||                                                                              \
	 ((((__HANDLE__)->Instance) == ADC1) && (((__CHANNEL__) == ADC_CHANNEL_2) || ((__CHANNEL__) == ADC_CHANNEL_3) || ((__CHANNEL__) == ADC_CHANNEL_4) || ((__CHANNEL__) == ADC_CHANNEL_5))) ||     \
	 ((((__HANDLE__)->Instance) == ADC2) && (((__CHANNEL__) == ADC_CHANNEL_2) || ((__CHANNEL__) == ADC_CHANNEL_3) || ((__CHANNEL__) == ADC_CHANNEL_4) || ((__CHANNEL__) == ADC_CHANNEL_5) ||       \
						 ((__CHANNEL__) == ADC_CHANNEL_12) || ((__CHANNEL__) == ADC_CHANNEL_13))) ||                                                                           \
	 ((((__HANDLE__)->Instance) == ADC3) &&                                                                                                                                                        \
	  (((__CHANNEL__) == ADC_CHANNEL_2) || ((__CHANNEL__) == ADC_CHANNEL_3) || ((__CHANNEL__) == ADC_CHANNEL_4) || ((__CHANNEL__) == ADC_CHANNEL_5) || ((__CHANNEL__) == ADC_CHANNEL_15))) ||      \
	 ((((__HANDLE__)->Instance) == ADC4) && (((__CHANNEL__) == ADC_CHANNEL_2) || ((__CHANNEL__) == ADC_CHANNEL_3) || ((__CHANNEL__) == ADC_CHANNEL_4) || ((__CHANNEL__) == ADC_CHANNEL_5) ||       \
						 ((__CHANNEL__) == ADC_CHANNEL_12) || ((__CHANNEL__) == ADC_CHANNEL_13) || ((__CHANNEL__) == ADC_CHANNEL_15))) ||                                      \
...
#define IS_ADC_DIFF_CHANNEL(__HANDLE__, __CHANNEL__)                                                                                                                                                   \
	((((__CHANNEL__) == ADC_CHANNEL_1) ||                                                                                                                                                          \
	  (((__CHANNEL__) == ADC_CHANNEL_2) || ((__CHANNEL__) == ADC_CHANNEL_3) || ((__CHANNEL__) == ADC_CHANNEL_4) || ((__CHANNEL__) == ADC_CHANNEL_5) || ((__CHANNEL__) == ADC_CHANNEL_6) ||         \
	   ((__CHANNEL__) == ADC_CHANNEL_7) || ((__CHANNEL__) == ADC_CHANNEL_8) || ((__CHANNEL__) == ADC_CHANNEL_9) || ((__CHANNEL__) == ADC_CHANNEL_10) || ((__CHANNEL__) == ADC_CHANNEL_11) ||       \
	   ((__CHANNEL__) == ADC_CHANNEL_14)) ||                                                                                                                                                       \
	  ((((__HANDLE__)->Instance) == ADC2) && (((__CHANNEL__) == ADC_CHANNEL_12) || ((__CHANNEL__) == ADC_CHANNEL_13))) ||                                                                          \
...
#define IS_ADC_EXTTRIGINJEC(__HANDLE__, __INJTRIG__)                                                                                                                                                   \
	(((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T1_TRGO) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T1_TRGO2) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T1_CC4) ||                                   \
	 ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T2_TRGO) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T3_TRGO) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T4_TRGO) ||                                   \
	 ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T6_TRGO) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T7_TRGO) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T8_TRGO) ||                                   \
	 ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T8_TRGO2) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T8_CC4) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T15_TRGO) ||                                  \
	 ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T20_TRGO) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T20_TRGO2) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_HRTIM_TRG2) ||                             \
	 ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_HRTIM_TRG4) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_HRTIM_TRG5) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_HRTIM_TRG6) ||                          \
	 ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_HRTIM_TRG7) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_HRTIM_TRG8) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_HRTIM_TRG9) ||                          \
	 ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_HRTIM_TRG10) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_LPTIM_OUT) ||                                                                                 \
	 ((((__HANDLE__)->Instance == ADC1) || ((__HANDLE__)->Instance == ADC2)) &&                                                                                                                    \
	  (((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T2_CC1) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T3_CC1) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T3_CC3) ||                                    \
	   ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T3_CC4) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T16_CC1) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T20_CC4) ||                                  \
	   ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_EXT_IT15))) ||                                                                                                                                      \
	 ((((__HANDLE__)->Instance == ADC3) || ((__HANDLE__)->Instance == ADC4) || ((__HANDLE__)->Instance == ADC5)) &&                                                                                \
	  (((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T1_CC3) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T4_CC3) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T4_CC4) ||                                    \
	   ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T8_CC2) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T20_CC2) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_HRTIM_TRG1) ||                               \
	   ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_HRTIM_TRG3) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_EXT_IT3))) ||                                                                                \
...
#define IS_ADC_EXTTRIGINJEC(__HANDLE__, __INJTRIG__)                                                                                                                                                   \
	(((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T1_TRGO) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T1_TRGO2) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T1_CC4) ||                                   \
	 ...
	 ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T6_TRGO) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T7_TRGO) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T8_TRGO) ||                                   \
	 ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T8_TRGO2) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T8_CC4) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T15_TRGO) ||                                  \
	 ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T20_TRGO) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T20_TRGO2) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_LPTIM_OUT) ||                              \
	 ((((__HANDLE__)->Instance == ADC1) || ((__HANDLE__)->Instance == ADC2)) &&                                                                                                                    \
	  (((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T2_CC1) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T3_CC1) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T3_CC3) ||                                    \
	   ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T3_CC4) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T16_CC1) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T20_CC4) ||                                  \
	   ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_EXT_IT15))) ||                                                                                                                                      \
	 ((((__HANDLE__)->Instance == ADC3) || ((__HANDLE__)->Instance == ADC4) || ((__HANDLE__)->Instance == ADC5)) &&                                                                                \
	  (((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T1_CC3) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T4_CC3) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T4_CC4) ||                                    \
	   ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T8_CC2) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T20_CC2) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_EXT_IT3))) ||                                \
	 ((__INJTRIG__) == ADC_INJECTED_SOFTWARE_START))
#elif defined(STM32G471xx)
#define IS_ADC_EXTTRIGINJEC(__HANDLE__, __INJTRIG__)                                                                                                                                                   \
	(((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T1_TRGO) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T1_TRGO2) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T1_CC4) ||                                   \
	 ...
	 ((((__HANDLE__)->Instance == ADC1) || ((__HANDLE__)->Instance == ADC2)) &&                                                                                                                    \
	  (((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T2_CC1) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T3_CC1) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T3_CC3) ||                                    \
	   ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T3_CC4) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T16_CC1) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_EXT_IT15))) ||                               \
	 ((((__HANDLE__)->Instance == ADC3)) &&                                                                                                                                                        \
	  (((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T1_CC3) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T4_CC3) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T4_CC4) ||                                    \
	   ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T8_CC2) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_EXT_IT3))) ||                                                                                    \
	 ((__INJTRIG__) == ADC_INJECTED_SOFTWARE_START))
#elif defined(STM32G411xB) || defined(STM32G414xx) || defined(STM32GBK1CB) || defined(STM32G431xx) || defined(STM32G441xx)
#define IS_ADC_EXTTRIGINJEC(__HANDLE__, __INJTRIG__)                                                                                                                                                   \
	(((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T1_TRGO) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T1_TRGO2) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T1_CC4) ||                                   \
	 ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T2_TRGO) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T2_CC1) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T3_TRGO) ||                                    \
	 ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T3_CC1) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T3_CC3) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T3_CC4) ||                                      \
	 ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T4_TRGO) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T6_TRGO) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T7_TRGO) ||                                   \
	 ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T8_TRGO) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T8_TRGO2) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T8_CC4) ||                                   \
	 ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T15_TRGO) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T16_CC1) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_EXT_IT15) ||                                 \
	 ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_LPTIM_OUT) || ((__INJTRIG__) == ADC_INJECTED_SOFTWARE_START))
#elif defined(STM32G491xx) || defined(STM32G4A1xx) || defined(STM32G411xC)
#define IS_ADC_EXTTRIGINJEC(__HANDLE__, __INJTRIG__)                                                                                                                                                   \
	(((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T1_TRGO) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T1_TRGO2) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T1_CC4) ||                                   \
	 ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T2_TRGO) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T3_TRGO) || ((__INJTRIG__) == ADC_EXTERNALTRIGINJEC_T4_TRGO) ||                                   \
