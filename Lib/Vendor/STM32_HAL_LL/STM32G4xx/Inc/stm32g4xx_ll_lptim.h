...
#define LL_LPTIM_TRIG_SOURCE_COMP2                                                                                                                                                                     \
	(LPTIM_CFGR_TRIGSEL_2 | LPTIM_CFGR_TRIGSEL_1 | LPTIM_CFGR_TRIGSEL_0) /*!<External input trigger is connected                                                                                   \
										to COMP2 output*/
...
#define LL_LPTIM_TRIG_SOURCE_COMP4                                                                                                                                                                     \
	(LPTIM_CFGR_TRIGSEL_3 | LPTIM_CFGR_TRIGSEL_0) /*!<External input trigger is connected to                                                                                                       \
							 COMP4 output*/
#if defined(COMP5)
#define LL_LPTIM_TRIG_SOURCE_COMP5                                                                                                                                                                     \
	(LPTIM_CFGR_TRIGSEL_3 | LPTIM_CFGR_TRIGSEL_1) /*!<External input trigger is connected to                                                                                                       \
							 COMP5 output*/
#endif						      /* COMP5 */
#if defined(COMP6)
#define LL_LPTIM_TRIG_SOURCE_COMP6                                                                                                                                                                     \
	(LPTIM_CFGR_TRIGSEL_3 | LPTIM_CFGR_TRIGSEL_1 | LPTIM_CFGR_TRIGSEL_0) /*!<External input trigger is connected                                                                                   \
										to COMP6 output*/
#endif									     /* COMP6 */
#if defined(COMP7)
#define LL_LPTIM_TRIG_SOURCE_COMP7                                                                                                                                                                     \
	(LPTIM_CFGR_TRIGSEL_3 | LPTIM_CFGR_TRIGSEL_2) /*!<External input trigger is connected to                                                                                                       \
							 COMP7 output*/
#endif						      /* COMP7 */
/**
 * @}
 ...
 * @retval None
 */
__STATIC_INLINE void LL_LPTIM_SetInput1Src(LPTIM_TypeDef *LPTIMx, uint32_t Src) { MODIFY_REG(LPTIMx->OR, LPTIM_OR_IN1, Src); }
 ...
 * @retval None
 */
__STATIC_INLINE void LL_LPTIM_SetInput2Src(LPTIM_TypeDef *LPTIMx, uint32_t Src) { MODIFY_REG(LPTIMx->OR, LPTIM_OR_IN2, Src); }
