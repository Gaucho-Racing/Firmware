...
#define IS_LL_COMP_INPUT_MINUS(__COMP_INSTANCE__, __INPUT_MINUS__)                                                     \
	(((__INPUT_MINUS__) == LL_COMP_INPUT_MINUS_1_4VREFINT) ||                                                      \
	 ...
	 ((__INPUT_MINUS__) == LL_COMP_INPUT_MINUS_VREFINT) || ((__INPUT_MINUS__) == LL_COMP_INPUT_MINUS_IO1) ||       \
	 ((__INPUT_MINUS__) == LL_COMP_INPUT_MINUS_IO2) ||                                                             \
	 (((__COMP_INSTANCE__) == COMP1) && (((__INPUT_MINUS__) == LL_COMP_INPUT_MINUS_DAC1_CH1) ||                    \
					     ((__INPUT_MINUS__) == LL_COMP_INPUT_MINUS_DAC3_CH1))) ||                  \
	 (((__COMP_INSTANCE__) == COMP2) && (((__INPUT_MINUS__) == LL_COMP_INPUT_MINUS_DAC1_CH2) ||                    \
					     ((__INPUT_MINUS__) == LL_COMP_INPUT_MINUS_DAC3_CH2))) ||                  \
	 (((__COMP_INSTANCE__) == COMP3) && (((__INPUT_MINUS__) == LL_COMP_INPUT_MINUS_DAC1_CH1) ||                    \
					     ((__INPUT_MINUS__) == LL_COMP_INPUT_MINUS_DAC3_CH1))) ||                  \
	 (((__COMP_INSTANCE__) == COMP4) && (((__INPUT_MINUS__) == LL_COMP_INPUT_MINUS_DAC1_CH1) ||                    \
					     ((__INPUT_MINUS__) == LL_COMP_INPUT_MINUS_DAC3_CH2))) ||                  \
	 (((__COMP_INSTANCE__) == COMP5) && (((__INPUT_MINUS__) == LL_COMP_INPUT_MINUS_DAC1_CH2) ||                    \
					     ((__INPUT_MINUS__) == LL_COMP_INPUT_MINUS_DAC4_CH1))) ||                  \
	 (((__COMP_INSTANCE__) == COMP6) && (((__INPUT_MINUS__) == LL_COMP_INPUT_MINUS_DAC2_CH1) ||                    \
					     ((__INPUT_MINUS__) == LL_COMP_INPUT_MINUS_DAC4_CH2))) ||                  \
	 (((__COMP_INSTANCE__) == COMP7) && (((__INPUT_MINUS__) == LL_COMP_INPUT_MINUS_DAC2_CH1) ||                    \
					     ((__INPUT_MINUS__) == LL_COMP_INPUT_MINUS_DAC4_CH1))))
...
#define IS_LL_COMP_INPUT_HYSTERESIS(__INPUT_HYSTERESIS__)                                                              \
	(((__INPUT_HYSTERESIS__) == LL_COMP_HYSTERESIS_NONE) || ((__INPUT_HYSTERESIS__) == LL_COMP_HYSTERESIS_10MV) || \
	 ((__INPUT_HYSTERESIS__) == LL_COMP_HYSTERESIS_20MV) || ((__INPUT_HYSTERESIS__) == LL_COMP_HYSTERESIS_30MV) || \
	 ((__INPUT_HYSTERESIS__) == LL_COMP_HYSTERESIS_40MV) || ((__INPUT_HYSTERESIS__) == LL_COMP_HYSTERESIS_50MV) || \
...
#define IS_LL_COMP_OUTPUT_BLANKING_SOURCE(__INSTANCE__, __OUTPUT_BLANKING_SOURCE__)                                    \
	((((__INSTANCE__) == COMP1) && (((__OUTPUT_BLANKING_SOURCE__) == LL_COMP_BLANKINGSRC_NONE) ||                  \
	 ...
	 (((__INSTANCE__) == COMP2) && (((__OUTPUT_BLANKING_SOURCE__) == LL_COMP_BLANKINGSRC_NONE) ||                  \
	 ...
	 (((__INSTANCE__) == COMP3) && (((__OUTPUT_BLANKING_SOURCE__) == LL_COMP_BLANKINGSRC_NONE) ||                  \
	 ...
	 (((__INSTANCE__) == COMP4) && (((__OUTPUT_BLANKING_SOURCE__) == LL_COMP_BLANKINGSRC_NONE) ||                  \
	 ...
	 (((__INSTANCE__) == COMP5) && (((__OUTPUT_BLANKING_SOURCE__) == LL_COMP_BLANKINGSRC_NONE) ||                  \
	 ...
	 (((__INSTANCE__) == COMP6) && (((__OUTPUT_BLANKING_SOURCE__) == LL_COMP_BLANKINGSRC_NONE) ||                  \
	 ...
	 (((__INSTANCE__) == COMP7) && (((__OUTPUT_BLANKING_SOURCE__) == LL_COMP_BLANKINGSRC_NONE) ||                  \
...
ErrorStatus LL_COMP_Init(COMP_TypeDef *COMPx, const LL_COMP_InitTypeDef *COMP_InitStruct)
{
	...
	if (LL_COMP_IsLocked(COMPx) == 0UL) {
		...
		MODIFY_REG(COMPx->CSR,
			   COMP_CSR_INPSEL | COMP_CSR_SCALEN | COMP_CSR_BRGEN | COMP_CSR_INMSEL | COMP_CSR_HYST |
			       COMP_CSR_POLARITY | COMP_CSR_BLANKING,
			   COMP_InitStruct->InputPlus | COMP_InitStruct->InputMinus | COMP_InitStruct->InputHysteresis |
