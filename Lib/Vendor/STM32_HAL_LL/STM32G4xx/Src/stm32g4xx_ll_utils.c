...
#define IS_LL_UTILS_PLLM_VALUE(__VALUE__)                                                                              \
	(((__VALUE__) == LL_RCC_PLLM_DIV_1) || ((__VALUE__) == LL_RCC_PLLM_DIV_2) ||                                   \
	 ...
	 ((__VALUE__) == LL_RCC_PLLM_DIV_9) || ((__VALUE__) == LL_RCC_PLLM_DIV_10) ||                                  \
...
/** @addtogroup UTILS_EF_SYSTEM
 ...
 <= 24    |
	   |-----------------|-------------------|-------------------|------------------|
	   |2WS(3 CPU cycles)|    HCLK <= 102    |    HCLK <= 90     |    HCLK
 <= 26    |
	   |-----------------|-------------------|-------------------|------------------|
...
ErrorStatus LL_SetFlashLatency(uint32_t HCLKFrequency)
{
	...
	if ((HCLKFrequency == 0U) || (HCLKFrequency > UTILS_SCALE1_LATENCY5_BOOST_FREQ)) {
		...
		if (status != ERROR) {
			...
			/* Check that the new number of wait states is taken
			   into account to access the Flash memory by reading
