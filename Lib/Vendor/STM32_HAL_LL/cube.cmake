...
target_sources(
	STM32_HAL_LL_G4xx
	INTERFACE
		${CMAKE_CURRENT_LIST_DIR}/CMSIS_5_Integration/system_stm32g4xx.c
)
...
target_sources(
	STM32_HAL_LL_U5xx
	INTERFACE
		${CMAKE_CURRENT_LIST_DIR}/CMSIS_5_Integration/system_stm32u5xx.c
)
...
target_sources(
	STM32_HAL_LL_L4xx
	INTERFACE
		${CMAKE_CURRENT_LIST_DIR}/CMSIS_5_Integration/system_stm32l4xx.c
)
