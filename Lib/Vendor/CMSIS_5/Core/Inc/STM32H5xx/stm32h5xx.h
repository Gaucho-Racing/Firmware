...
#if !defined(STM32H5F5xx) && !defined(STM32H5F4xx) && !defined(STM32H5F4xx) && !defined(STM32H5E4xx) && !defined(STM32H573xx) && !defined(STM32H563xx) && !defined(STM32H562xx) &&                     \
...
#define __STM32H5_CMSIS_VERSION ((__STM32H5_CMSIS_VERSION_MAIN << 24U) | (__STM32H5_CMSIS_VERSION_SUB1 << 16U) | (__STM32H5_CMSIS_VERSION_SUB2 << 8U) | (__STM32H5_CMSIS_VERSION_RC))
