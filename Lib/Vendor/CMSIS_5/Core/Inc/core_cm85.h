...
typedef union {
	struct {
		...
		uint32_t UBTI_EN : 1; /*!< bit:      5  Unprivileged branch
					 target identification enable */
		uint32_t PAC_EN : 1;  /*!< bit:      6  Privileged pointer
...
#define MEMSYSCTL_PFCR_DIS_NLP_Msk                                             \
	(0x1UL                                                                 \
	 << MEMSYSCTL_PFCR_DIS_NLP_Pos) /*!< MEMSYSCTL PFCR: DIS_NLP Mask */
