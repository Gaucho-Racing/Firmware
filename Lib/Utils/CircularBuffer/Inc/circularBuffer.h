...
Circular_Buffer_Ptr GR_CircularBuffer_Create(uint16_t capacity);
...
void GR_CircularBuffer_Free(Circular_Buffer_Ptr buffer);
...
uint16_t GR_CircularBuffer_GetCapacity(Circular_Buffer_Ptr buffer);

/// @brief Get a CircularBuffer's currently used size.
/// @param buffer The pointer to the CircularBuffer to inspect.
/// @return The buffer's usage, in number of items stored.
uint16_t GR_CircularBuffer_GetCurrentSize(Circular_Buffer_Ptr buffer);

/// @brief Check if a CircularBuffer is full.
/// @param buffer The pointer to the CircularBuffer to inspect.
/// @return true if full, false otherwise.
bool GR_CircularBuffer_IsFull(Circular_Buffer_Ptr buffer);

/// @brief Check if a CircularBuffer is empty.
/// @param buffer The pointer to the CircularBuffer to inspect.
/// @return true if empty, false otherwise.
bool GR_CircularBuffer_IsEmpty(Circular_Buffer_Ptr buffer);
...
void GR_CircularBuffer_Push(Circular_Buffer_Ptr buffer, void *object);
...
void *GR_CircularBuffer_Pop(Circular_Buffer_Ptr buffer);

/// @brief Retrives a CircularBuffer's buffer head.
/// @param buffer The CircularBuffer in subject.
/// @return The pointer to the retrived item.
void *GR_CircularBuffer_Peek(Circular_Buffer_Ptr *buffer);
