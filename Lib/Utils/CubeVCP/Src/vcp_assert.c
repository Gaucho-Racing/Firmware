...
static_assert(CUBE_VCP_RX_BUFFER_SIZE > 8,
	      "CUBE_VCP_RX_BUFFER_SIZE must be greater than 8 bytes to ensure useful command input is possible. It is recommended to set this to at least 32 bytes for practical use cases.");
