...
execute_process(
	COMMAND
		${PERL_EXECUTABLE} -MYAML::XS -e "1" ENVIRONMENT
...
if(NOT YAML_XS_FOUND EQUAL 0)
	...
	execute_process(
		COMMAND
			...
			ENVIRONMENT PERL_MM_OPT=INSTALL_BASE=${PERL_LOCAL_LIB}
...
function(run_can_parser script_name output_file)
	execute_process(
		COMMAND
			...
			"${INC_DIR}/${output_file}" ENVIRONMENT PERL5LIB=${PERL_LOCAL_LIB}/lib/perl5
