...
if(NOT YAML_XS_FOUND EQUAL 0)
  message(STATUS "Perl module YAML::XS not found. Installing locally via CPAN...")

  execute_process(
    COMMAND ${PERL_EXECUTABLE} -MCPAN -e "CPAN::HandleConfig->load; CPAN::Shell->notest('install','YAML::XS')"
