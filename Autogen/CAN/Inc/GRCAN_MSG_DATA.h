...
typedef struct {
	...
	/** Packed: bytes 2-2. bit 16: over_voltage_faults; bit 17: under_voltage_fault;
	 * bit 18: inv_overtemp_fault; bit 19: motor_overtemp_fault; bit 20: transistor_fault;
	 * bit 21: encoder_fault; bit 22: can_fault; bit 23: future_use; */
...
/** Dash Config */
typedef struct {
	/** Packed: bytes 0-0. bit 0: bms_led; bit 1: imd_led; bit 2: bspd_led; */
...
typedef struct {
	...
	/** Packed: bytes 1-1. bit 8: regen; bit 12: button_1; bit 13: button_2; bit 14: button_3;
	 * bit 15: button_4; */
...
/** TCM Status */
typedef struct {
	/** Packed: bytes 0-0. bit 0: connection_status; bit 1: mqtt_status; bit 2: epic_shelter_status;
...
/** Dash Warning Flags */
typedef struct {
	/** Packed: bytes 0-0. bit 0: bse_apps_violation; bit 1: reserved; bit 2: reserved; bit 3: reserved;
