...
void MX_ADC1_Init(void)
{
	...
	*/
	...
	GPIO_InitStruct.Pin = APPS1_SIGNAL_Pin;
	GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
	GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
	LL_GPIO_Init(APPS1_SIGNAL_GPIO_Port, &GPIO_InitStruct);

	GPIO_InitStruct.Pin = APPS2_SIGNAL_Pin;
	GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
	GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
	LL_GPIO_Init(APPS2_SIGNAL_GPIO_Port, &GPIO_InitStruct);

	GPIO_InitStruct.Pin = BRAKE_F_SIGNAL_Pin;
	GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
	GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
	LL_GPIO_Init(BRAKE_F_SIGNAL_GPIO_Port, &GPIO_InitStruct);

	GPIO_InitStruct.Pin = BRAKE_R_SIGNAL_Pin;
	GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
	GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
	LL_GPIO_Init(BRAKE_R_SIGNAL_GPIO_Port, &GPIO_InitStruct);

	GPIO_InitStruct.Pin = AUX_SIGNAL_Pin;
	GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
	GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
	LL_GPIO_Init(AUX_SIGNAL_GPIO_Port, &GPIO_InitStruct);
...
void MX_ADC2_Init(void)
{
	...
	*/
	...
	GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
	GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
	LL_GPIO_Init(BSE_SIGNAL_GPIO_Port, &GPIO_InitStruct);

	GPIO_InitStruct.Pin = BSPD_SENSE_Pin;
	GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
	GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
	LL_GPIO_Init(BSPD_SENSE_GPIO_Port, &GPIO_InitStruct);
	...
	LL_DMA_SetMemoryIncMode(DMA2, LL_DMA_CHANNEL_1,
				LL_DMA_MEMORY_INCREMENT);

	LL_DMA_SetPeriphSize(DMA2, LL_DMA_CHANNEL_1,
			     LL_DMA_PDATAALIGN_HALFWORD);

	LL_DMA_SetMemorySize(DMA2, LL_DMA_CHANNEL_1,
			     LL_DMA_MDATAALIGN_HALFWORD);
	...
	LL_ADC_SetChannelSamplingTime(ADC2, LL_ADC_CHANNEL_6,
				      LL_ADC_SAMPLINGTIME_92CYCLES_5);
	LL_ADC_SetChannelSingleDiff(ADC2, LL_ADC_CHANNEL_6,
				    LL_ADC_SINGLE_ENDED);
	...
	LL_ADC_SetChannelSamplingTime(ADC2, LL_ADC_CHANNEL_13,
				      LL_ADC_SAMPLINGTIME_92CYCLES_5);
	LL_ADC_SetChannelSingleDiff(ADC2, LL_ADC_CHANNEL_13,
				    LL_ADC_SINGLE_ENDED);
	...
	LL_ADC_REG_SetSequencerRanks(ADC2, LL_ADC_REG_RANK_5,
				     LL_ADC_CHANNEL_15);
	LL_ADC_SetChannelSamplingTime(ADC2, LL_ADC_CHANNEL_15,
				      LL_ADC_SAMPLINGTIME_92CYCLES_5);
	LL_ADC_SetChannelSingleDiff(ADC2, LL_ADC_CHANNEL_15,
				    LL_ADC_SINGLE_ENDED);
