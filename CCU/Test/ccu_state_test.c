...
{
    return sd->ACU_S2_OVERTEMP_ERROR ||
           sd->ACU_S2_OVERVOLT_ERROR ||
           sd->ACU_S2_UNDERVOLT_ERROR ||
           sd->ACU_S2_OVERCURR_ERROR ||
           sd->ACU_S2_UNDERCURR_ERROR;
}
...
{
    switch (state) {
        case CCU_STATE_IDLE:     return STATE_IDLE(sd, state);
        case CCU_STATE_CHARGING: return STATE_CHARGING(sd, state);
        default:                 return CCU_STATE_IDLE;
    }
}
