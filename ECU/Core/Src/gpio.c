...
void MX_GPIO_Init(void)
{
	...
	HAL_GPIO_WritePin(GPIOB, LED_TEST_Pin | BRAKE_LIGHT_Pin | TSSI_G_CONTROL_Pin | TSSI_R_CONTROL_Pin | RTD_CONTROL_Pin | AUX_CONTROL_Pin | SOFTWARE_OK_CONTROL_Pin, GPIO_PIN_RESET);
	...
	/*Configure GPIO pins : PC13 PC14 PC15 PC4
				 PC5 PC6 PC7 PC8
				 PC9 */
	GPIO_InitStruct.Pin = GPIO_PIN_13 | GPIO_PIN_14 | GPIO_PIN_15 | GPIO_PIN_4 | GPIO_PIN_5 | GPIO_PIN_6 | GPIO_PIN_7 | GPIO_PIN_8 | GPIO_PIN_9;
	...
	/*Configure GPIO pins : PA0 PA1 PA2 PA3
				 PA4 PA10 PA11 PA12 */
	GPIO_InitStruct.Pin = GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_2 | GPIO_PIN_3 | GPIO_PIN_4 | GPIO_PIN_10 | GPIO_PIN_11 | GPIO_PIN_12;
	GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
	GPIO_InitStruct.Pull = GPIO_NOPULL;
	...
	GPIO_InitStruct.Pin = LED_TEST_Pin | BRAKE_LIGHT_Pin | TSSI_G_CONTROL_Pin | TSSI_R_CONTROL_Pin | RTD_CONTROL_Pin | AUX_CONTROL_Pin | SOFTWARE_OK_CONTROL_Pin;
