...
{
	{
		...
		ECU_StateData stateLumpTest = {.ecu_state = GR_GLV_ON, .bms_sense = 1.5, .imd_sense = 1.5, .bspd_sense = 1.2};
...

	{
		...
		ECU_StateData stateLumpTest = {.ecu_state = GR_GLV_ON, .bms_sense = 1.5, .imd_sense = 1.5, .bspd_sense = 1.5};
