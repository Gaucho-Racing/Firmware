				    ...
				    uint8_t bitReverseFlag)
{
	...
	switch (S->fftLen) {
			/*  Initializations of structure parameters for 4096
			 * point FFT */
		case 4096U:
			...
			/*  Initializations of structure parameters for 2048
			 * point FFT */
		case 2048U:
			/*  Initialise the twiddle coef modifier value */
			...
			/*  Initializations of structure parameters for 1024
			 * point FFT */
		case 1024U:
			/*  Initialise the twiddle coef modifier value */
			...
			/*  Initializations of structure parameters for 512
			 * point FFT */
		case 512U:
			/*  Initialise the twiddle coef modifier value */
		...
		case 256U:
			/*  Initializations of structure parameters for 256
			 * point FFT */
		...
		case 128U:
			/*  Initializations of structure parameters for 128
			 * point FFT */
		...
		case 64U:
			/*  Initializations of structure parameters for 64 point
			 * FFT */
		...
		case 32U:
			/*  Initializations of structure parameters for 32 point
			 * FFT */
		...
		case 16U:
			/*  Initializations of structure parameters for 16 point
			 * FFT */
		...
		default:
			/*  Reporting argument error if fftSize is not valid
			 * value */
