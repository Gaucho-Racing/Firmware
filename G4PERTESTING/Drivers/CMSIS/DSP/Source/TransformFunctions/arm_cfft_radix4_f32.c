...
void arm_cfft_radix4_f32(const arm_cfft_radix4_instance_f32 *S, float32_t *pSrc)
{
	...
	if (S->bitReverseFlag == 1U) {
		/*  Bit Reversal */
		arm_bitreversal_f32(pSrc, S->fftLen, S->bitRevFactor,
				    S->pBitRevTable);
	}
}
			      ...
			      const float32_t *pCoef, uint16_t twidCoefModifier)
{
	...
	float32_t Xaplusc, Xbplusd, Yaplusc, Ybplusd, Xaminusc, Xbminusd,
	    Yaminusc, Ybminusd;
	float32_t Xb12C_out, Yb12C_out, Xc12C_out, Yc12C_out, Xd12C_out,
	    Yd12C_out;
