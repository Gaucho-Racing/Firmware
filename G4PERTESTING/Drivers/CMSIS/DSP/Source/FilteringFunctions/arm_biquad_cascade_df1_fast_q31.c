				     ...
				     uint32_t blockSize)
{
	...
	do {
		 ...
		 * simultaneously. */
		/* Variables acc ... acc3 hold output values that are being
		 * computed:
		 *
		...
		while (sample > 0U) {
			...
			/* acc +=  b1 * x[n-1] */
			/* acc = (q31_t) ((((q63_t) acc << 32) + ((q63_t) b0 *
			 * (Xn))) >> 32);*/
			multAcc_32x32_keep32_R(acc, b0, Xn);
			/* acc +=  b[2] * x[n-2] */
			/* acc = (q31_t) ((((q63_t) acc << 32) + ((q63_t) b2 *
			 * (Xn2))) >> 32);*/
			multAcc_32x32_keep32_R(acc, b2, Xn2);
			/* acc +=  a1 * y[n-1] */
			/* acc = (q31_t) ((((q63_t) acc << 32) + ((q63_t) a1 *
			 * (Yn1))) >> 32);*/
			multAcc_32x32_keep32_R(acc, a1, Yn1);
			/* acc +=  a2 * y[n-2] */
			/* acc = (q31_t) ((((q63_t) acc << 32) + ((q63_t) a2 *
			 * (Yn2))) >> 32);*/
			...
			*pOut = Yn2;
			...
			/* acc +=  b1 * x[n-1] */
			/* acc = (q31_t) ((((q63_t) acc << 32) + ((q63_t) b1 *
			 * (Xn))) >> 32);*/
