...
#define CFFT_FAMILY_DEFINE_TEST(                                               \
	...
	{                                                                      \
		arm_cfft_##fn_specifier##_instance_##type_suffix               \
		    cfft_inst_fut;                                             \
		arm_cfft_##fn_specifier##_instance_##type_suffix               \
		    cfft_inst_ref;                                             \
                                                                               \
		TEMPLATE_DO_ARR_DESC(                                          \
		    fftlen_idx, uint16_t, fftlen,                              \
...
JTEST_DEFINE_GROUP(cfft_family_tests)
{
	...
	/* Magnitude tests removed from the DSP Library. Keeping them here in
	   case minds are changed. */
