...
#define ARR_DESC_DEFINE(type, name, element_count, content)                    \
	...
	ARR_DESC_INTERNAL_DEFINE(                                              \
	    name, &ARR_DESC_ARR_NAME(name), element_count,                     \
...
#define ARR_DESC_DEFINE_SUBSET(name, original, element_cnt)                    \
	ARR_DESC_INTERNAL_DEFINE(                                              \
	    ...
	    sizeof(ARR_DESC_ARR_NAME(                                          \
		original)[0])) /* Note the lacking semicolon */
...
#define ARR_DESC_DEFINE_USING_ARR(type, name, array_ptr, start_idx,            \
				  element_cnt)                                 \
	ARR_DESC_INTERNAL_DEFINE(name, (type *)(array_ptr + start_idx),        \
				 element_cnt,                                  \
				 sizeof(type)) /* Note the lacking semicolon*/
