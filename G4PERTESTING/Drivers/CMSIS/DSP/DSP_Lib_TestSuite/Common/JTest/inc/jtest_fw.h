...
typedef struct JTEST_FW_struct {
	/* Action Triggers: The Keil debugger monitors these values for changes.
	 * In response to a change, the debugger executes code on the host. */
	 ...
	 * debugging framework. Instead, the debugger can be told to read 128
	 * byte (by default) chunks of memory.  Data received in this manner
	 * requires post-processing to be legible.*/
	char *str_buffer;
	char *data_buffer;
