	...
	do {                                                                   \
		TEMPLATE_DO_ARR_DESC(                                          \
		    ...
		    if (dim_validation_interface(input_type, input)) {         \
				...
				fut, fut_arg_interface(input), ref,            \
...
#define MATRIX_TEST_TEMPLATE_ELT2(                                             \
	...
	do {                                                                   \
		TEMPLATE_DO_ARR_DESC(                                          \
		    ...
		    input_type input_b = ARR_DESC_ELT(input_type, input_a_idx, \
						      &(arr_desc_inputs_b));   \
                                                                               \
		    JTEST_DUMP_STRF(                                           \
			...
			(int)input_b->numRows, (int)input_b->numCols);         \
                                                                               \
		    if (dim_validation_interface(input_type, input_a,          \
						 input_b)) {                   \
			    output_config_interface(input_type, input_a,       \
						    input_b);                  \
                                                                               \
			    TEST_CALL_FUT_AND_REF(                             \
				fut, fut_arg_interface(input_a, input_b), ref, \
