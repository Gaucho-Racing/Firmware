...
#define COMPLEX_MATH_COMPARE_CMPLX_INTERFACE(block_size, output_type)          \
	do {                                                                   \
		COMPLEX_MATH_COMPARE_RE_INTERFACE(block_size * 2,              \
						  output_type);                \
	} while (0)
...
#define COMPLEX_MATH_DEFINE_TEST_TEMPLATE_BUF1_BLK(                            \
	...
	{                                                                      \
		TEST_TEMPLATE_BUF1_BLK(                                        \
		    complex_math_f_all, complex_math_block_sizes, input_type,  \
...
#define COMPLEX_MATH_DEFINE_TEST_TEMPLATE_BUF2_BLK(                            \
	...
	{                                                                      \
		TEST_TEMPLATE_BUF2_BLK(                                        \
		    complex_math_f_all, complex_math_f_all,                    \
		    complex_math_block_sizes, input_type, output_type,         \
