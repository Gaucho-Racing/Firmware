...
#define BASIC_MATH_SNR_COMPARE_INTERFACE(block_size, output_type)              \
	do {                                                                   \
		TEST_CONVERT_AND_ASSERT_SNR(                                   \
		    ...
		    basic_math_output_f32_fut, basic_math_output_fut.data_ptr, \
...
#define BASIC_MATH_SNR_ELT1_COMPARE_INTERFACE(block_size, output_type)         \
	do {                                                                   \
		TEST_CONVERT_AND_ASSERT_SNR(                                   \
		    basic_math_output_f32_ref, basic_math_output_ref.data_ptr, \
		    basic_math_output_f32_fut, basic_math_output_fut.data_ptr, \
		    1, output_type, BASIC_MATH_SNR_THRESHOLD_##output_type);   \
	} while (0)
...
#define BASIC_MATH_DEFINE_TEST_TEMPLATE_BUF1_BLK(fn_name, suffix, input_type,  \
	...
	{                                                                      \
		TEST_TEMPLATE_BUF1_BLK(                                        \
		    basic_math_f_all, basic_math_block_sizes, input_type,      \
		    output_type, arm_##fn_name##_##suffix,                     \
...
#define BASIC_MATH_DEFINE_TEST_TEMPLATE_BUF2_BLK(                              \
	...
	{                                                                      \
		TEST_TEMPLATE_BUF2_BLK(                                        \
		    basic_math_f_all, basic_math_f_all,                        \
		    basic_math_block_sizes, input_type, output_type,           \
...
#define BASIC_MATH_DEFINE_TEST_TEMPLATE_BUF1_ELT1_BLK(                         \
	...
	{                                                                      \
		TEST_TEMPLATE_BUF1_ELT1_BLK(                                   \
		    basic_math_f_all, basic_math_elts, basic_math_block_sizes, \
...
#define BASIC_MATH_DEFINE_TEST_TEMPLATE_BUF1_ELT2_BLK(                         \
	...
	{                                                                      \
		TEST_TEMPLATE_BUF1_ELT2_BLK(                                   \
		    ...
		    basic_math_block_sizes, input_type, elt1_type, elt2_type,  \
		    output_type, arm_##fn_name##_##suffix,                     \
		    ARM_##fn_name##_INPUT_INTERFACE, ref_##fn_name##_##suffix, \
		    REF_##fn_name##_INPUT_INTERFACE,                           \
		    BASIC_MATH_COMPARE_INTERFACE);                             \
