...
void Reset_Handler(void)
{
	 ...
	 * schemes to copy. One can copy more than one sections. Another can
	 * only copy one section.  The former scheme needs more instructions and
	 ...
	 *    __etext: LMA of start of the section to copy from. Usually end of
	 * text
