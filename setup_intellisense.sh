#!/bin/bash
# Script to generate compile commands for all projects
# This ensures VS Code IntelliSense works properly for all boards

echo "Generating compile commands for all firmware boards..."

# Configure main project with debug preset
echo "Configuring main project..."
cmake --preset=Debug

# Ensure each board has compile commands
echo "Building compile commands for each board..."

# Build each board to generate compile commands
